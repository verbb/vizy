const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./code-editor-aFriQwFG.js","./decorate-R0X811qp-DTGsgM1e.js","./required-validator-CEg8dvjS-CQD5RH5r.js","./rolldown-runtime-DK3Fl9T5.js","./unsafe-html-DhD_KFJk.js","./w3c-keyname-BOAvb0qz.js","./field-labels-CmuAW8Cl-Dn227Qfy.js"])))=>i.map(i=>d[i]);
import{d as e,n as t,o as n,p as r,r as i,s as a,t as o}from"./decorate-R0X811qp-DTGsgM1e.js";import{Lt as s}from"./unsafe-html-DhD_KFJk.js";import"./has-slot-8BvCt_qo-HazXo5ZG.js";import{t as c}from"./preload-helper-HclGiUj8.js";import{a as l,n as u,o as d,r as f,s as p}from"./lightswitch-adK_MEo6.js";/* empty css               */import{t as m}from"./menu-chevron-D0Eaxe2T.js";var h=r`
    @layer pk-component {
        :host {
            display: block;
...
`,g={fromAttribute(e){if(!e)return[];try{let t=JSON.parse(e);return Array.isArray(t)?t.filter(e=>!!(e&&typeof e==`object`&&`value`in e)).map(e=>({label:String(e.label??e.value),value:String(e.value)})):[]}catch{return[]}},toAttribute(e){return JSON.stringify(e??[])}},_={fromAttribute(e){if(e==null||e===``)return[];if(e===`*`)return`*`;try{let t=JSON.parse(e);return t===`*`?`*`:Array.isArray(t)?t.map(String):[]}catch{return[]}},toAttribute(e){return e===`*`?`*`:JSON.stringify(e??[])}},v=class extends o{constructor(...e){super(...e),this.options=[],this.value=[],this.showAllOption=!1,this.allLabel=`All`,this.disabled=!1,this.orientation=`vertical`,this.ariaLabel=null,this.optionElements=[],this.allOptionElement=null,this.handleAllChange=e=>{e.stopPropagation(),this.value=e.detail.checked?`*`:[],this.dispatchValueChange()},this.handleItemChange=(e,t)=>{if(t.stopPropagation(),this.isAllSelected)return;let n=t.detail.checked,r=this.selectedValues;this.value=n?[...r,e]:r.filter(t=>t!==e),this.dispatchValueChange()}}static{this.styles=h}connectedCallback(){this.hasAttribute(`role`)||this.setAttribute(`role`,`group`),super.connectedCallback()}updated(e){if(e.has(`options`)||e.has(`showAllOption`)){this.rebuildOptionElements();return}(e.has(`value`)||e.has(`disabled`))&&this.updateOptionStates()}firstUpdated(){this.rebuildOptionElements()}focus(e){this.optionElements.find(e=>!e.disabled)?.focus(e)}get isAllSelected(){return this.value===`*`}get selectedValues(){return this.isAllSelected?this.options.map(e=>e.value):Array.isArray(this.value)?this.value:[]}dispatchValueChange(){let e=this.isAllSelected?`*`:[...this.selectedValues];this.dispatchEvent(new CustomEvent(`pk-change`,{detail:{value:e},bubbles:!0,composed:!0})),this.dispatchEvent(new Event(`change`,{bubbles:!0,composed:!0}))}rebuildOptionElements(){let e=this.shadowRoot?.querySelector(`.options`);if(e){for(let e of this.optionElements)e.remove();if(this.optionElements=[],this.allOptionElement=null,this.showAllOption){let t=document.createElement(`pk-checkbox`);t.classList.add(`all-option`),t.append(this.allLabel),t.addEventListener(`pk-change`,this.handleAllChange),e.append(t),this.allOptionElement=t,this.optionElements.push(t)}for(let t of this.options){let n=document.createElement(`pk-checkbox`);n.checkboxValue=t.value,n.append(t.label),n.addEventListener(`pk-change`,e=>{this.handleItemChange(t.value,e)}),e.append(n),this.optionElements.push(n)}this.updateOptionStates()}}updateOptionStates(){this.allOptionElement&&(this.allOptionElement.checked=this.isAllSelected,this.allOptionElement.disabled=this.disabled);for(let e of this.options){let t=this.optionElements.find(t=>t!==this.allOptionElement&&t.checkboxValue===e.value);t&&(t.checked=this.isAllSelected||this.selectedValues.includes(e.value),t.disabled=this.disabled||this.isAllSelected)}}render(){return e`
        ...
        `}#te(){let e=[...this.#i.nodes,...this.#i.marks,...this.#i.extensions],t=e.filter(e=>this.#e.capabilities.nodes.includes(e.value)||this.#e.capabilities.marks.includes(e.value)||this.#e.capabilities.extensions.includes(e.value));return`
            <details class="vizy-editor-config-section vizy-editor-config-schema" data-schema-details ${this.#o?`open`:``}>
                ...
                <p class="instructions">${k(`vizy`,`The nodes, marks, and behaviour extensions this editor understands. It governs pasted and imported content as well as the toolbar, so a content type can be allowed without being given a button — which is how existing formatting is preserved without authors being offered more of it.`)}</p>
                ...
                ${this.#i.extensions.length>0?`
                    <div class="vizy-editor-config-subhead">${k(`vizy`,`Behaviour extensions`)}</div>
                    <p class="instructions">${k(`vizy`,`TipTap modules that change editing behaviour without adding a document type. Enable them here so their JavaScript loads with this config.`)}</p>
                    ${this.#M(`extensions`,this.#i.extensions,this.#e.capabilities.extensions)}
                `:``}
            </details>
            ...
            <div class="vizy-editor-config">
                ...
                ${this.#a===`visual`?`
                    <div class="vizy-editor-config-panel">
                        ...
                        <section class="vizy-editor-config-section">
                            <h3>${k(`vizy`,`Block insertion`)}</h3>
                            <pk-field
                                class="vizy-editor-config-toggle"
                                label="${A(k(`vizy`,`Show gutter Add button`))}"
                                instructions="${A(k(`vizy`,`The + chip beside each block. Independent of the toolbar Add Block control.`))}"
                            >
                                <pk-lightswitch
                                    data-gutter-insert
                            ...
                            <pk-field
                                class="vizy-editor-config-toggle"
                                label="${A(k(`vizy`,`Enable slash Add shortcut`))}"
                                instructions="${A(k(`vizy`,`Typing / on a blank line opens the same Add Block palette as the gutter.`))}"
                            >
                                <pk-lightswitch
                                    data-slash-insert
