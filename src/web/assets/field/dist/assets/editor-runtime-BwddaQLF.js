...
`,nn=`data-pk-group-join`,rn=`data-pk-group-item-first`,an=`data-pk-group-item-last`,on=`data-pk-group-orientation`,sn=`data-tg-orientation`,cn=class extends l{constructor(...e){super(...e),this.orientation=`horizontal`,this.variant=`default`,this.size=`default`,this.spacing=0,this.joined=!0,this.multiple=!1,this.value=[],this.items=[],this.syncItems=()=>{let e=this.shadowRoot?.querySelector(`slot`);e&&(this.items=e.assignedElements({flatten:!0}),this.applyGroupProps(),this.syncGroupLayout(),this.applySelection())},this.handleClick=e=>{let t=e.target.closest(`[data-value]`);if(!t||!this.items.includes(t)||this.isItemDisabled(t))return;e.preventDefault();let n=this.getItemValue(t);n&&(this.value=this.multiple?this.value.includes(n)?this.value.filter(e=>e!==n):[...this.value,n]:this.value.includes(n)?[]:[n],this.applySelection(),this.dispatchEvent(new CustomEvent(`pk-value-change`,{detail:{value:[...this.value]},bubbles:!0,composed:!0})))}}static{this.styles=tn}connectedCallback(){super.connectedCallback(),this.syncJoinedFromSpacing(),this.addEventListener(`click`,this.handleClick),this.addEventListener(`slotchange`,this.syncItems)}disconnectedCallback(){this.removeEventListener(`click`,this.handleClick),this.removeEventListener(`slotchange`,this.syncItems),super.disconnectedCallback()}updated(e){e.has(`spacing`)&&this.syncJoinedFromSpacing(),e.has(`joined`)&&!e.has(`spacing`)&&(this.spacing=this.joined?0:2),(e.has(`variant`)||e.has(`size`)||e.has(`spacing`)||e.has(`orientation`))&&this.syncGroupLayout(),e.has(`value`)&&this.items.length&&this.applySelection()}clearLayoutAttrs(e){e.removeAttribute(nn),e.removeAttribute(rn),e.removeAttribute(an),e.removeAttribute(on),e.removeAttribute(sn)}syncGroupLayout(){for(let e of this.items)this.clearLayoutAttrs(e);for(let e of this.items)this.orientation!==`horizontal`&&e.setAttribute(sn,this.orientation);if(this.spacing===0)for(let e=0;e<this.items.length;e++){let t=this.items[e];t.setAttribute(on,this.orientation),t.setAttribute(nn,``),e===0&&t.setAttribute(rn,``),e===this.items.length-1&&t.setAttribute(an,``)}}syncJoinedFromSpacing(){this.joined=this.spacing===0}applyGroupProps(){for(let e of this.items)e.tagName===`PK-TOGGLE`&&(e.setAttribute(`variant`,this.variant),e.setAttribute(`size`,this.size))}getItemValue(e){return e.getAttribute(`data-value`)??e.dataset.value??null}isItemDisabled(e){return e.hasAttribute(`disabled`)||e.matches(`:disabled`)}applySelection(){for(let e of this.items){let t=this.getItemValue(e);if(!t)continue;let n=this.value.includes(t);e.setAttribute(`aria-pressed`,n?`true`:`false`),e.tagName===`PK-TOGGLE`&&(n?e.setAttribute(`pressed`,``):e.removeAttribute(`pressed`))}}render(){return n`
    ...
    `;render(){return n`
        ...
        `}#t(e){this.dispatchEvent(new CustomEvent(`vizy-layout-preset-select`,{bubbles:!0,composed:!0,detail:{presetId:e}}))}};P([c({attribute:!1})],hn.prototype,`presets`,null),hn=P([N(`vizy-layout-preset-chooser`)],hn);var gn=class{#e=null;#t=null;open(e,t,n,r){this.close();let i=document.createElement(`vizy-layout-preset-chooser`);i.presets=t;let a=document.createElement(`pk-popup`);a.className=`vizy-layout-preset-popup`,a.placement=`bottom-start`,a.distance=4,a.flip=!0,a.shift=!0,a.positionMethod=`fixed`,a.anchor=this.#n(e),a.append(i),document.body.append(a);let o={popup:a,chooser:i,returnFocus:r.returnFocus??null,onClose:r.onClose??(()=>void 0)};this.#e=o,a.active=!0;let s=!1,c=e=>{s=!0,r.onSelect(e),this.close()};i.addEventListener(`vizy-layout-preset-select`,(e=>{c(e.detail.presetId)}));let l=e=>{e.key===`Escape`&&(e.preventDefault(),this.close())},u=e=>{let t=e.composedPath();t.includes(a)||t.includes(i)||this.close()};document.addEventListener(`keydown`,l,!0),document.addEventListener(`pointerdown`,u,!0),this.#t=()=>{document.removeEventListener(`keydown`,l,!0),document.removeEventListener(`pointerdown`,u,!0)},o.onClose=()=>{s||r.onClose?.()}}close(){this.#t?.(),this.#t=null;let e=this.#e;this.#e=null,e&&(e.popup.active=!1,e.popup.remove(),e.returnFocus?.focus(),e.onClose())}get isOpen(){return this.#e!==null}#n(e){return{getBoundingClientRect:()=>e}}},_n=`ö`,vn=`ελ1υ2бг1ел3дети4ею2католик6ом3мкд2он1сква6онлайн5рг3рус2ф2сайт3рб3укр3қаз3հայ3ישראל5קום3ابوظبي5رامكو5لاردن4بحرين5جزائر5سعودية6عليان5مغرب5مارات5یران5بارت2زار4يتك3ھارت5تونس4سودان3رية5شبكة4عراق2ب2مان4فلسطين6قطر3كاثوليك6وم3مصر2ليسيا5وريتانيا7قع4همراه5پاکستان7ڀارت4कॉम3नेट3भारत0म्3ोत5संगठन5বাংলা5ভারত2ৰত4ਭਾਰਤ4ભારત4ଭାରତ4இந்தியா6லங்கை6சிங்கப்பூர்11భారత్5ಭಾರತ4ഭാരതം5ලංකා4คอม3ไทย3ລາວ3გე2みんな3アマゾン4クラウド4グーグル4コム2ストア3セール3ファッション6ポイント4世界2中信1国1國1文网3亚马逊3企业2佛山2信息2健康2八卦2公司1益2台湾1灣2商城1店1标2嘉里0大酒店5在线2大拿2天主教3娱乐2家電2广东2微博2慈善2我爱你3手机2招聘2政务1府2新加坡2闻2时尚2書籍2机构2淡马锡3游戏2澳門2点看2移动2组织机构4网址1店1站1络2联通2谷歌2购物2通販2集团2電訊盈科4飞利浦3食品2餐厅2香格里拉3港2닷넷1컴2삼성2한국2`,yn=`numeric`,bn=`ascii`,xn=`alpha`,Sn=`asciinumeric`,Cn=`alphanumeric`,wn=`domain`,Tn=`emoji`,En=`scheme`,Dn=`slashscheme`,On=`whitespace`;function kn(e,t){return e in t||(t[e]=[]),t[e]}function An(e,t,n){t[yn]&&(t[Sn]=!0,t[Cn]=!0),t[bn]&&(t[Sn]=!0,t[xn]=!0),t[Sn]&&(t[Cn]=!0),t[xn]&&(t[Cn]=!0),t[Cn]&&(t[wn]=!0),t[Tn]&&(t[wn]=!0);for(let r in t){let t=kn(r,n);t.indexOf(e)<0&&t.push(e)}}function jn(e,t){let n={};for(let r in t)t[r].indexOf(e)>=0&&(n[r]=!0);return n}function I(e=null){this.j={},this.jr=[],this.jd=null,this.t=e}I.groups={},I.prototype={accepts(){return!!this.t},go(e){let t=this,n=t.j[e];if(n)return n;for(let n=0;n<t.jr.length;n++){let r=t.jr[n][0],i=t.jr[n][1];if(i&&r.test(e))return i}return t.jd},has(e,t=!1){return t?e in this.j:!!this.go(e)},ta(e,t,n,r){for(let i=0;i<e.length;i++)this.tt(e[i],t,n,r)},tr(e,t,n,r){r||=I.groups;let i;return t&&t.j?i=t:(i=new I(t),n&&r&&An(t,n,r)),this.jr.push([e,i]),i},ts(e,t,n,r){let i=this,a=e.length;if(!a)return i;for(let t=0;t<a-1;t++)i=i.tt(e[t]);return i.tt(e[a-1],t,n,r)},tt(e,t,n,r){r||=I.groups;let i=this;if(t&&t.j)return i.j[e]=t,t;let a=t,o,s=i.go(e);return s?(o=new I,Object.assign(o.j,s.j),o.jr.push.apply(o.jr,s.jr),o.jd=s.jd,o.t=s.t):o=new I,a&&(r&&(o.t&&typeof o.t==`string`?An(a,Object.assign(jn(o.t,r),n),r):n&&An(a,n,r)),o.t=a),i.j[e]=o,o}};var L=(e,t,n,r,i)=>e.ta(t,n,r,i),R=(e,t,n,r,i)=>e.tr(t,n,r,i),Mn=(e,t,n,r,i)=>e.ts(t,n,r,i),z=(e,t,n,r,i)=>e.tt(t,n,r,i),Nn=`WORD`,Pn=`UWORD`,Fn=`ASCIINUMERICAL`,In=`ALPHANUMERICAL`,Ln=`LOCALHOST`,Rn=`TLD`,zn=`UTLD`,Bn=`SCHEME`,Vn=`SLASH_SCHEME`,Hn=`NUM`,Un=`WS`,Wn=`NL`,Gn=`OPENBRACE`,Kn=`CLOSEBRACE`,qn=`OPENBRACKET`,Jn=`CLOSEBRACKET`,Yn=`OPENPAREN`,Xn=`CLOSEPAREN`,Zn=`OPENANGLEBRACKET`,Qn=`CLOSEANGLEBRACKET`,$n=`FULLWIDTHLEFTPAREN`,er=`FULLWIDTHRIGHTPAREN`,tr=`LEFTCORNERBRACKET`,nr=`RIGHTCORNERBRACKET`,rr=`LEFTWHITECORNERBRACKET`,ir=`RIGHTWHITECORNERBRACKET`,ar=`FULLWIDTHLESSTHAN`,or=`FULLWIDTHGREATERTHAN`,sr=`AMPERSAND`,cr=`APOSTROPHE`,lr=`ASTERISK`,ur=`AT`,dr=`BACKSLASH`,fr=`BACKTICK`,pr=`CARET`,mr=`COLON`,hr=`COMMA`,gr=`DOLLAR`,_r=`DOT`,vr=`EQUALS`,yr=`EXCLAMATION`,B=`HYPHEN`,br=`PERCENT`,xr=`PIPE`,Sr=`PLUS`,Cr=`POUND`,wr=`QUERY`,Tr=`QUOTE`,Er=`FULLWIDTHMIDDLEDOT`,Dr=`SEMI`,Or=`SLASH`,kr=`TILDE`,Ar=`UNDERSCORE`,jr=`EMOJI`,Mr=`SYM`,Nr=Object.freeze({__proto__:null,ALPHANUMERICAL:In,AMPERSAND:sr,APOSTROPHE:cr,ASCIINUMERICAL:Fn,ASTERISK:lr,AT:ur,BACKSLASH:dr,BACKTICK:fr,CARET:pr,CLOSEANGLEBRACKET:Qn,CLOSEBRACE:Kn,CLOSEBRACKET:Jn,CLOSEPAREN:Xn,COLON:mr,COMMA:hr,DOLLAR:gr,DOT:_r,EMOJI:jr,EQUALS:vr,EXCLAMATION:yr,FULLWIDTHGREATERTHAN:or,FULLWIDTHLEFTPAREN:$n,FULLWIDTHLESSTHAN:ar,FULLWIDTHMIDDLEDOT:Er,FULLWIDTHRIGHTPAREN:er,HYPHEN:B,LEFTCORNERBRACKET:tr,LEFTWHITECORNERBRACKET:rr,LOCALHOST:Ln,NL:Wn,NUM:Hn,OPENANGLEBRACKET:Zn,OPENBRACE:Gn,OPENBRACKET:qn,OPENPAREN:Yn,PERCENT:br,PIPE:xr,PLUS:Sr,POUND:Cr,QUERY:wr,QUOTE:Tr,RIGHTCORNERBRACKET:nr,RIGHTWHITECORNERBRACKET:ir,SCHEME:Bn,SEMI:Dr,SLASH:Or,SLASH_SCHEME:Vn,SYM:Mr,TILDE:kr,TLD:Rn,UNDERSCORE:Ar,UTLD:zn,UWORD:Pn,WORD:Nn,WS:Un}),Pr=/[a-z]/,Fr=/\p{L}/u,Ir=/\p{Emoji}/u,Lr=/\d/,Rr=/\s/,zr=`\r`,Br=`
`,Vr=`️`,Hr=`‍`,Ur=`￼`,Wr=null,Gr=null;function Kr(e=[]){let t={};I.groups=t;let n=new I;Wr??=Xr(_n),Gr??=Xr(vn),z(n,`'`,cr),z(n,`{`,Gn),z(n,`}`,Kn),z(n,`[`,qn),z(n,`]`,Jn),z(n,`(`,Yn),z(n,`)`,Xn),z(n,`<`,Zn),z(n,`>`,Qn),z(n,`（`,$n),z(n,`）`,er),z(n,`「`,tr),z(n,`」`,nr),z(n,`『`,rr),z(n,`』`,ir),z(n,`＜`,ar),z(n,`＞`,or),z(n,`&`,sr),z(n,`*`,lr),z(n,`@`,ur),z(n,"`",fr),z(n,`^`,pr),z(n,`:`,mr),z(n,`,`,hr),z(n,`$`,gr),z(n,`.`,_r),z(n,`=`,vr),z(n,`!`,yr),z(n,`-`,B),z(n,`%`,br),z(n,`|`,xr),z(n,`+`,Sr),z(n,`#`,Cr),z(n,`?`,wr),z(n,`"`,Tr),z(n,`/`,Or),z(n,`;`,Dr),z(n,`~`,kr),z(n,`_`,Ar),z(n,`\\`,dr),z(n,`・`,Er);let r=R(n,Lr,Hn,{[yn]:!0});R(r,Lr,r);let i=R(r,Pr,Fn,{[Sn]:!0}),a=R(r,Fr,In,{[Cn]:!0}),o=R(n,Pr,Nn,{[bn]:!0});R(o,Lr,i),R(o,Pr,o),R(i,Lr,i),R(i,Pr,i);let s=R(n,Fr,Pn,{[xn]:!0});R(s,Pr),R(s,Lr,a),R(s,Fr,s),R(a,Lr,a),R(a,Pr),R(a,Fr,a);let c=z(n,Br,Wn,{[On]:!0}),l=z(n,zr,Un,{[On]:!0}),u=R(n,Rr,Un,{[On]:!0});z(n,Ur,u),z(l,Br,c),z(l,Ur,u),R(l,Rr,u),z(u,zr),z(u,Br),R(u,Rr,u),z(u,Ur,u);let d=R(n,Ir,jr,{[Tn]:!0});z(d,`#`),R(d,Ir,d),z(d,Vr,d);let f=z(d,Hr);z(f,`#`),R(f,Ir,d);let p=[[Pr,o],[Lr,i]],m=[[Pr,null],[Fr,s],[Lr,a]];for(let e=0;e<Wr.length;e++)Yr(n,Wr[e],Rn,Nn,p);for(let e=0;e<Gr.length;e++)Yr(n,Gr[e],zn,Pn,m);An(Rn,{tld:!0,ascii:!0},t),An(zn,{utld:!0,alpha:!0},t),Yr(n,`file`,Bn,Nn,p),Yr(n,`mailto`,Bn,Nn,p),Yr(n,`http`,Vn,Nn,p),Yr(n,`https`,Vn,Nn,p),Yr(n,`ftp`,Vn,Nn,p),Yr(n,`ftps`,Vn,Nn,p),An(Bn,{scheme:!0,ascii:!0},t),An(Vn,{slashscheme:!0,ascii:!0},t),e=e.sort((e,t)=>e[0]>t[0]?1:-1);for(let t=0;t<e.length;t++){let r=e[t][0],i=e[t][1]?{[En]:!0}:{[Dn]:!0};r.indexOf(`-`)>=0?i[wn]=!0:Pr.test(r)?Lr.test(r)?i[Sn]=!0:i[bn]=!0:i[yn]=!0,Mn(n,r,r,i)}return Mn(n,`localhost`,Ln,{ascii:!0}),n.jd=new I(Mr),{start:n,tokens:Object.assign({groups:t},Nr)}}function qr(e,t){let n=Jr(t.replace(/[A-Z]/g,e=>e.toLowerCase())),r=n.length,i=[],a=0,o=0;for(;o<r;){let s=e,c=null,l=0,u=null,d=-1,f=-1;for(;o<r&&(c=s.go(n[o]));)s=c,s.accepts()?(d=0,f=0,u=s):d>=0&&(d+=n[o].length,f++),l+=n[o].length,a+=n[o].length,o++;a-=d,o-=f,l-=d,i.push({t:u.t,v:t.slice(a-l,a),s:a-l,e:a})}return i}function Jr(e){let t=[],n=e.length,r=0;for(;r<n;){let i=e.charCodeAt(r),a,o=i<55296||i>56319||r+1===n||(a=e.charCodeAt(r+1))<56320||a>57343?e[r]:e.slice(r,r+2);t.push(o),r+=o.length}return t}function Yr(e,t,n,r,i){let a,o=t.length;for(let n=0;n<o-1;n++){let o=t[n];e.j[o]?a=e.j[o]:(a=new I(r),a.jr=i.slice(),e.j[o]=a),e=a}return a=new I(n),a.jr=i.slice(),e.j[t[o-1]]=a,a}function Xr(e){let t=[],n=[],r=0;for(;r<e.length;){let i=0;for(;`0123456789`.indexOf(e[r+i])>=0;)i++;if(i>0){t.push(n.join(``));for(let t=parseInt(e.substring(r,r+i),10);t>0;t--)n.pop();r+=i}else n.push(e[r]),r++}return t}var Zr={defaultProtocol:`http`,events:null,format:$r,formatHref:$r,nl2br:!1,tagName:`a`,target:null,rel:null,validate:!0,truncate:1/0,className:null,attributes:null,ignoreTags:[],render:null};function Qr(e,t=null){let n=Object.assign({},Zr);e&&(n=Object.assign(n,e instanceof Qr?e.o:e));let r=n.ignoreTags,i=[];for(let e=0;e<r.length;e++)i.push(r[e].toUpperCase());this.o=n,t&&(this.defaultRender=t),this.ignoreTags=i}Qr.prototype={o:Zr,ignoreTags:[],defaultRender(e){return e},check(e){return this.get(`validate`,e.toString(),e)},get(e,t,n){let r=t!=null,i=this.o[e];return i&&(typeof i==`object`?(i=n.t in i?i[n.t]:Zr[e],typeof i==`function`&&r&&(i=i(t,n))):typeof i==`function`&&r&&(i=i(t,n.t,n)),i)},getObj(e,t,n){let r=this.o[e];return typeof r==`function`&&t!=null&&(r=r(t,n.t,n)),r},render(e){let t=e.render(this);return(this.get(`render`,null,e)||this.defaultRender)(t,e.t,e)}};function $r(e){return e}function ei(e,t){this.t=`token`,this.v=e,this.tk=t}ei.prototype={isLink:!1,toString(){return this.v},toHref(e){return this.toString()},toFormattedString(e){let t=this.toString(),n=e.get(`truncate`,t,this),r=e.get(`format`,t,this);return n&&r.length>n?r.substring(0,n)+`…`:r},toFormattedHref(e){return e.get(`formatHref`,this.toHref(e.get(`defaultProtocol`)),this)},startIndex(){return this.tk[0].s},endIndex(){return this.tk[this.tk.length-1].e},toObject(e=Zr.defaultProtocol){return{type:this.t,value:this.toString(),isLink:this.isLink,href:this.toHref(e),start:this.startIndex(),end:this.endIndex()}},toFormattedObject(e){return{type:this.t,value:this.toFormattedString(e),isLink:this.isLink,href:this.toFormattedHref(e),start:this.startIndex(),end:this.endIndex()}},validate(e){return e.get(`validate`,this.toString(),this)},render(e){let t=this,n=this.toHref(e.get(`defaultProtocol`)),r=e.get(`formatHref`,n,this),i=e.get(`tagName`,n,t),a=this.toFormattedString(e),o={},s=e.get(`className`,n,t),c=e.get(`target`,n,t),l=e.get(`rel`,n,t),u=e.getObj(`attributes`,n,t),d=e.getObj(`events`,n,t);return o.href=r,s&&(o.class=s),c&&(o.target=c),l&&(o.rel=l),u&&Object.assign(o,u),{tagName:i,attributes:o,content:a,eventListeners:d}}};function ti(e,t){class n extends ei{constructor(t,n){super(t,n),this.t=e}}for(let e in t)n.prototype[e]=t[e];return n.t=e,n}var ni=ti(`email`,{isLink:!0,toHref(){return`mailto:`+this.toString()}}),ri=ti(`text`),ii=ti(`nl`),ai=ti(`url`,{isLink:!0,toHref(e=Zr.defaultProtocol){return this.hasProtocol()?this.v:`${e}://${this.v}`},hasProtocol(){let e=this.tk;return e.length>=2&&e[0].t!==Ln&&e[1].t===mr}}),V=e=>new I(e);function oi({groups:e}){let t=e.domain.concat([sr,lr,ur,dr,fr,pr,gr,vr,B,Hn,br,xr,Sr,Cr,Or,Mr,kr,Ar]),n=[cr,mr,hr,_r,yr,br,wr,Tr,Dr,Zn,Qn,Gn,Kn,Jn,qn,Yn,Xn,$n,er,tr,nr,rr,ir,ar,or],r=[sr,cr,lr,dr,fr,pr,gr,vr,B,Gn,Kn,br,xr,Sr,Cr,wr,Or,Mr,kr,Ar],i=V(),a=z(i,kr);L(a,r,a),L(a,e.domain,a);let o=V(),s=V(),c=V();L(i,e.domain,o),L(i,e.scheme,s),L(i,e.slashscheme,c),L(o,r,a),L(o,e.domain,o);let l=z(o,ur);z(a,ur,l),z(s,ur,l),z(c,ur,l);let u=z(a,_r);L(u,r,a),L(u,e.domain,a);let d=V();L(l,e.domain,d),L(d,e.domain,d);let f=z(d,_r);L(f,e.domain,d);let p=V(ni);L(f,e.tld,p),L(f,e.utld,p),z(l,Ln,p);let m=z(d,B);z(m,B,m),L(m,e.domain,d),L(p,e.domain,d),z(p,_r,f),z(p,B,m);let h=z(o,B),g=z(o,_r);z(h,B,h),L(h,e.domain,o),L(g,r,a),L(g,e.domain,o);let _=V(ai);L(g,e.tld,_),L(g,e.utld,_),L(_,e.domain,o),L(_,r,a),z(_,_r,g),z(_,B,h),z(_,ur,l);let ee=z(_,mr),v=V(ai);L(ee,e.numeric,v);let y=V(ai),b=V();L(y,t,y),L(y,n,b),L(b,t,y),L(b,n,b),z(_,Or,y),z(v,Or,y);let x=z(s,mr),te=z(z(z(c,mr),Or),Or);L(s,e.domain,o),z(s,_r,g),z(s,B,h),L(c,e.domain,o),z(c,_r,g),z(c,B,h),L(x,e.domain,y),z(x,Or,y),z(x,wr,y),L(te,e.domain,y),L(te,t,y),z(te,Or,y);let ne=[[Gn,Kn],[qn,Jn],[Yn,Xn],[Zn,Qn],[$n,er],[tr,nr],[rr,ir],[ar,or]];for(let e=0;e<ne.length;e++){let[r,i]=ne[e],a=z(y,r);z(b,r,a);let o=V(ai);L(a,t,o);let s=V();L(a,n,s),z(a,i,y),L(o,t,o),L(o,n,s),L(s,t,o),L(s,n,s),z(o,i,y),z(s,i,y)}return z(i,Ln,_),z(i,Wn,ii),{start:i,tokens:Nr}}function si(e,t,n){let r=n.length,i=0,a=[],o=[];for(;i<r;){let s=e,c=null,l=null,u=0,d=null,f=-1;for(;i<r&&!(c=s.go(n[i].t));)o.push(n[i++]);for(;i<r&&(l=c||s.go(n[i].t));)c=null,s=l,s.accepts()?(f=0,d=s):f>=0&&f++,i++,u++;if(f<0)i-=u,i<r&&(o.push(n[i]),i++);else{o.length>0&&(a.push(ci(ri,t,o)),o=[]),i-=f,u-=f;let e=d.t,r=n.slice(i-u,i);a.push(ci(e,t,r))}}return o.length>0&&a.push(ci(ri,t,o)),a}function ci(e,t,n){let r=n[0].s,i=n[n.length-1].e;return new e(t.slice(r,i),n)}var li=typeof console<`u`&&console&&console.warn||(()=>{}),ui=`until manual call of linkify.init(). Register all schemes and plugins before invoking linkify the first time.`,H={scanner:null,parser:null,tokenQueue:[],pluginQueue:[],customSchemes:[],initialized:!1};function di(){return I.groups={},H.scanner=null,H.parser=null,H.tokenQueue=[],H.pluginQueue=[],H.customSchemes=[],H.initialized=!1,H}function fi(e,t=!1){if(H.initialized&&li(`linkifyjs: already initialized - will not register custom scheme "${e}" ${ui}`),!/^[0-9a-z]+(-[0-9a-z]+)*$/.test(e))throw Error(`linkifyjs: incorrect scheme format.
1. Must only contain digits, lowercase ASCII letters or "-"
2. Cannot start or end with "-"
3. "-" cannot repeat`);H.customSchemes.push([e,t])}function pi(){H.scanner=Kr(H.customSchemes);for(let e=0;e<H.tokenQueue.length;e++)H.tokenQueue[e][1]({scanner:H.scanner});H.parser=oi(H.scanner.tokens);for(let e=0;e<H.pluginQueue.length;e++)H.pluginQueue[e][1]({scanner:H.scanner,parser:H.parser});return H.initialized=!0,H}function mi(e){return H.initialized||pi(),si(H.parser.start,e,qr(H.scanner.start,e))}mi.scan=qr;function hi(e,t=null,n=null){if(t&&typeof t==`object`){if(n)throw Error(`linkifyjs: Invalid link type ${t}; must be a string`);n=t,t=null}let r=new Qr(n),i=mi(e),a=[];for(let e=0;e<i.length;e++){let n=i[e];n.isLink&&(!t||n.t===t)&&r.check(n)&&a.push(n.toFormattedObject(r))}return a}var gi=`[\0- \xA0 ᠎ -\u2029 　]`,_i=new RegExp(gi),vi=RegExp(`${gi}$`),yi=new RegExp(gi,`g`);function bi(e){return e.length===1?e[0].isLink:e.length===3&&e[1].isLink?[`()`,`[]`].includes(e[0].value+e[2].value):!1}function xi(e){return new C({key:new T(`autolink`),appendTransaction:(t,n,r)=>{let i=t.some(e=>e.docChanged)&&!n.doc.eq(r.doc),a=t.some(e=>e.getMeta(`preventAutolink`));if(!i||a)return;let{tr:o}=r,s=Te(n.doc,[...t]);if(ke(s).forEach(({newRange:t})=>{let n=_e(r.doc,t,e=>e.isTextblock),i,a;if(n.length>1)i=n[0],a=r.doc.textBetween(i.pos,i.pos+i.node.nodeSize,void 0,` `);else if(n.length){let e=r.doc.textBetween(t.from,t.to,` `,` `);if(!vi.test(e))return;i=n[0],a=r.doc.textBetween(i.pos,t.to,void 0,` `)}if(i&&a){let t=a.split(_i).filter(Boolean);if(t.length<=0)return!1;let n=t[t.length-1],s=i.pos+a.lastIndexOf(n);if(!n)return!1;let c=mi(n).map(t=>t.toObject(e.defaultProtocol));if(!bi(c))return!1;c.filter(e=>e.isLink).map(e=>({...e,from:s+e.start+1,to:s+e.end+1})).filter(e=>!r.schema.marks.code||!r.doc.rangeHasMark(e.from,e.to,r.schema.marks.code)).filter(t=>e.validate(t.value)).filter(t=>e.shouldAutoLink(t.value)).forEach(t=>{Pe(t.from,t.to,r.doc).some(t=>t.mark.type===e.type)||o.addMark(t.from,t.to,e.type.create({href:t.href}))})}}),o.steps.length)return o}})}function Si(e){return new C({key:new T(`handleClickLink`),props:{handleClick:(t,n,r)=>{if(r.button!==0||!t.editable)return!1;let i=null;if(r.target instanceof HTMLAnchorElement)i=r.target;else{let t=r.target;if(!t)return!1;let n=e.editor.view.dom;i=t.closest(`a`),i&&!n.contains(i)&&(i=null)}if(!i)return!1;let a=!1;if(e.enableClickSelection&&(a=e.editor.commands.extendMarkRange(e.type.name)),e.openOnClick){let n=Ce(t.state,e.type.name),r=i.href??n.href,o=i.target??n.target;r&&(window.open(r,o),a=!0)}return a}}})}var Ci=/\[([^[\]]+)\]\(((?:[^\s()]|\([^\s()]*\))+)(?:\s+(?:(["'])(.*?)\3|“(.*?)”|‘(.*?)’))?\)$/,wi=/\[([^[\]]+)\]\(((?:[^\s()]|\([^\s()]*\))+)(?:\s+(?:(["'])(.*?)\3|“(.*?)”|‘(.*?)’))?\)/g;function Ti(e,t){let n=0;for(let r=t-1;r>=0&&e[r]===`\\`;--r)n+=1;return n%2==1}function Ei(e,t){let n=0,r=0;for(;r<t;){if(e[r]!=="`"){r+=1;continue}if(n===0&&Ti(e,r)){r+=1;continue}let i=0;for(;r<t&&e[r]==="`";)i+=1,r+=1;n===0?n=i:i===n&&(n=0)}return n>0}function Di(e,t,n){let[,r,i]=t;return(t.index?e[t.index-1]:void 0)===`!`||Ti(e,t.index??0)||Ei(e,t.index??0)?!1:!!r.trim()&&n(i)}function Oi(e){let[t,n,r,,i,a,o]=e,s=i??a??o;return{index:e.index??0,text:t,replaceWith:n,data:{href:r,title:s||null,markdown:!0}}}function ki(e,t){return e.index<t.index+t.text.length&&t.index<e.index+e.text.length}function Ai(e){return{href:e.data?.href,title:e.data?.title??null}}function ji(e){let t=Oe({find:t=>{let n=Ci.exec(t);return!n||!Di(t,n,e.isAllowedHref)?null:Oi(n)},type:e.type,getAttributes:Ai});return new ge({find:t.find,handler:e=>{let n=t.handler(e);return n!==null&&e.state.tr.steps.length&&e.state.tr.setMeta(`preventAutolink`,!0),n}})}function Mi(e){let t=de({find:t=>{let n=[];for(let r of t.matchAll(wi))Di(t,r,e.isAllowedHref)&&n.push(Oi(r));let r=(e.findPlainUrls?.call(e,t)??[]).filter(e=>!n.some(t=>ki(t,e)));return[...n,...r]},type:e.type,getAttributes:Ai});return new fe({find:t.find,handler:e=>{let n=t.handler(e);return n!==null&&e.state.tr.steps.length&&e.match.data?.markdown&&e.state.tr.setMeta(`preventAutolink`,!0),n}})}function Ni(e){return new C({key:new T(`handlePasteLink`),props:{handlePaste:(t,n,r)=>{let{shouldAutoLink:i}=e,{state:a}=t,{selection:o}=a,{empty:s}=o;if(s)return!1;let c=``;r.content.forEach(e=>{c+=e.textContent});let l=hi(c,{defaultProtocol:e.defaultProtocol}).find(e=>e.isLink&&e.value===c);return!c||!l||i!==void 0&&!i(l.value)?!1:e.editor.commands.setMark(e.type,{href:l.href})}}})}function Pi(e,t){let n=[`http`,`https`,`ftp`,`ftps`,`mailto`,`tel`,`callto`,`sms`,`cid`,`xmpp`];return t&&t.forEach(e=>{let t=typeof e==`string`?e:e.scheme;t&&n.push(t)}),!e||e.replace(yi,``).match(RegExp(`^(?:(?:${n.map(e=>e.replace(/[-/\\^$*+?.()|[\]{}]/g,`\\$&`)).join(`|`)}):|[^a-z]|[a-z0-9+.\\-]+(?:[^a-z+.\\-:]|$))`,`i`))}Ee.create({name:`link`,priority:1e3,keepOnSplit:!1,exitable:!0,onCreate(){this.options.validate&&!this.options.shouldAutoLink&&(this.options.shouldAutoLink=this.options.validate,console.warn("The `validate` option is deprecated. Rename to the `shouldAutoLink` option instead.")),this.options.protocols.forEach(e=>{if(typeof e==`string`){fi(e);return}fi(e.scheme,e.optionalSlashes)})},onDestroy(){di()},inclusive(){return this.options.autolink},addOptions(){return{openOnClick:!0,enableClickSelection:!1,linkOnPaste:!0,markdownLinks:!1,autolink:!0,protocols:[],defaultProtocol:`http`,HTMLAttributes:{target:`_blank`,rel:`noopener noreferrer nofollow`,class:null},isAllowedUri:(e,t)=>!!Pi(e,t.protocols),validate:e=>!!e,shouldAutoLink:e=>{let t=/^[a-z][a-z0-9+.-]*:\/\//i.test(e),n=/^[a-z][a-z0-9+.-]*:/i.test(e);if(t||n&&!e.includes(`@`))return!0;let r=(e.includes(`@`)?e.split(`@`).pop():e).split(/[/?#:]/)[0];return!(/^\d{1,3}(\.\d{1,3}){3}$/.test(r)||!/\./.test(r))}}},addAttributes(){return{href:{default:null,parseHTML(e){return e.getAttribute(`href`)}},target:{default:this.options.HTMLAttributes.target??null},rel:{default:this.options.HTMLAttributes.rel??null},class:{default:this.options.HTMLAttributes.class??null},title:{default:null}}},parseHTML(){return[{tag:`a[href]`,getAttrs:e=>{let t=e.getAttribute(`href`);return!t||!this.options.isAllowedUri(t,{defaultValidate:e=>!!Pi(e,this.options.protocols),protocols:this.options.protocols,defaultProtocol:this.options.defaultProtocol})?!1:null}}]},renderHTML({HTMLAttributes:e}){return this.options.isAllowedUri(e.href,{defaultValidate:e=>!!Pi(e,this.options.protocols),protocols:this.options.protocols,defaultProtocol:this.options.defaultProtocol})?[`a`,w(this.options.HTMLAttributes,e),0]:[`a`,w(this.options.HTMLAttributes,{...e,href:``}),0]},markdownTokenName:`link`,parseMarkdown:(e,t)=>t.applyMark(`link`,t.parseInline(e.tokens||[]),{href:e.href,title:e.title||null}),renderMarkdown:(e,t)=>{let n=e.attrs?.href??``,r=e.attrs?.title??``,i=t.renderChildren(e);return r?`[${i}](${n} "${r}")`:`[${i}](${n})`},addCommands(){return{setLink:e=>({chain:t})=>{let{href:n}=e;return this.options.isAllowedUri(n,{defaultValidate:e=>!!Pi(e,this.options.protocols),protocols:this.options.protocols,defaultProtocol:this.options.defaultProtocol})?t().setMark(this.name,e).setMeta(`preventAutolink`,!0).run():!1},toggleLink:e=>({chain:t})=>{let{href:n}=e||{};return n&&!this.options.isAllowedUri(n,{defaultValidate:e=>!!Pi(e,this.options.protocols),protocols:this.options.protocols,defaultProtocol:this.options.defaultProtocol})?!1:t().toggleMark(this.name,e,{extendEmptyMarkRange:!0}).setMeta(`preventAutolink`,!0).run()},unsetLink:()=>({chain:e})=>e().unsetMark(this.name,{extendEmptyMarkRange:!0}).setMeta(`preventAutolink`,!0).run()}},addInputRules(){return this.options.markdownLinks?[ji({type:this.type,isAllowedHref:e=>this.options.isAllowedUri(e,{defaultValidate:e=>!!Pi(e,this.options.protocols),protocols:this.options.protocols,defaultProtocol:this.options.defaultProtocol})})]:[]},addPasteRules(){let e=e=>{let t=[];if(e){let{protocols:n,defaultProtocol:r}=this.options;hi(e).filter(e=>e.isLink&&this.options.isAllowedUri(e.value,{defaultValidate:e=>!!Pi(e,n),protocols:n,defaultProtocol:r})).forEach(e=>{this.options.shouldAutoLink(e.value)&&t.push({text:e.value,data:{href:e.href},index:e.start})})}return t};return this.options.markdownLinks?[Mi({type:this.type,isAllowedHref:e=>this.options.isAllowedUri(e,{defaultValidate:e=>!!Pi(e,this.options.protocols),protocols:this.options.protocols,defaultProtocol:this.options.defaultProtocol}),findPlainUrls:e})]:[de({find:e,type:this.type,getAttributes:e=>({href:e.data?.href})})]},addProseMirrorPlugins(){let e=[],{protocols:t,defaultProtocol:n}=this.options;return this.options.autolink&&e.push(xi({type:this.type,defaultProtocol:this.options.defaultProtocol,validate:e=>this.options.isAllowedUri(e,{defaultValidate:e=>!!Pi(e,t),protocols:t,defaultProtocol:n}),shouldAutoLink:this.options.shouldAutoLink})),e.push(Si({type:this.type,editor:this.editor,openOnClick:this.options.openOnClick===`whenNotEditable`||this.options.openOnClick,enableClickSelection:this.options.enableClickSelection})),this.options.linkOnPaste&&e.push(Ni({editor:this.editor,defaultProtocol:this.options.defaultProtocol,type:this.type,shouldAutoLink:this.options.shouldAutoLink})),e}});function Fi(e){return Array.isArray(e)&&e.length>0}function Ii(e){if(!e)return[];if(Fi(e))return e;let t=[];return e.linkToEntry&&t.push({...e.linkToEntry,optionTitle:`Link to an entry`}),e.linkToAsset&&t.push({...e.linkToAsset,optionTitle:`Link to an asset`}),e.linkToCategory&&t.push({...e.linkToCategory,optionTitle:`Link to a category`}),t}function Li(e,t){return`${e.url||``}#${t}:${e.id}@${e.siteId}`}var Ri=/^[0-9a-f]{8}-[0-9a-f]{4}-[1-5][0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/i;function U(e){return Ri.test(e)}function zi(e={}){return{type:`url`,targetUid:null,siteMode:`current`,siteUid:null,value:null,suffix:null,newWindow:!1,title:null,ariaLabel:null,rel:[],class:null,id:null,download:null,...e}}function Bi(e){return zi({type:e.type??`url`,targetUid:typeof e.targetUid==`string`?e.targetUid:null,siteMode:e.siteMode===`fixed`?`fixed`:`current`,siteUid:typeof e.siteUid==`string`?e.siteUid:null,value:typeof e.value==`string`?e.value:null,suffix:typeof e.suffix==`string`?e.suffix:null,newWindow:e.newWindow===!0,title:typeof e.title==`string`?e.title:null,ariaLabel:typeof e.ariaLabel==`string`?e.ariaLabel:null,rel:Array.isArray(e.rel)?e.rel.filter(e=>typeof e==`string`):[],class:typeof e.class==`string`?e.class:null,id:typeof e.id==`string`?e.id:null,download:e.download===!0||typeof e.download==`string`?e.download:null,linkUid:typeof e.linkUid==`string`?e.linkUid:null})}function Vi(e,t=!1){return zi({type:`url`,value:e,newWindow:t})}function Hi(e){switch(e.type){case`url`:return e.value??`#`;case`email`:return e.value?`mailto:${e.value}`:`#`;case`tel`:return e.value?`tel:${e.value}`:`#`;case`sms`:return e.value?`sms:${e.value}`:`#`;case`entry`:case`asset`:case`category`:return e.targetUid?`#vizy-link:${e.type}:${e.targetUid}`:`#`;default:return`#`}}function Ui(e){if(e<1)return[];let t=Math.floor(1e3/e),n=1e3-t*e;return Array.from({length:e},(e,r)=>t+ +(r<n))}function Wi(e){return e.reduce((e,t)=>e+t,0)}function Gi(e){if(e.childCount===0)return 0;let t=e.child(0),n=0;for(let e=0;e<t.childCount;e++){let r=Number(t.child(e).attrs.colspan??1);n+=Number.isFinite(r)&&r>0?r:1}return n}function Ki(e){let{from:t,to:n}=e.state.selection;return e.state.doc.textBetween(t,n,` `)}function qi(e){let t=Qi(e),{state:n}=e,r=n.schema.marks.link,i=r?pe(n.selection.$from,r):null,a=i?.from??n.selection.from,o=i?.to??n.selection.to;return{from:a,to:o,text:e.state.doc.textBetween(a,o,` `),openInNewTab:t.newWindow,url:Hi(t),semantic:t}}function Ji(e){let{from:t,to:n}=e.state.selection;return{url:``,text:Ki(e),openInNewTab:!1,from:t===n?void 0:t,to:t===n?void 0:n}}function Yi(e,t){let n=t.focus??!0,r=()=>n?e.chain().focus():e.chain(),i=typeof t.from==`number`&&typeof t.to==`number`,a=i?t.from:e.state.selection.from,o=i?t.to:e.state.selection.to,s=e.state.doc.textBetween(a,o,` `),c=a!==o&&t.text===s?t.text:t.text.trim()||$i(t.attrs),l={type:`link`,attrs:t.attrs};if(a!==o){c===s?r().setTextSelection({from:a,to:o}).setSemanticLink(t.attrs).run():r().insertContentAt({from:a,to:o},[{type:`text`,text:c,marks:[l]}]).run();return}r().setTextSelection(a).insertContent([{type:`text`,text:c,marks:[l]}]).run()}function Xi(e,t){(t?.focus??!0?e.chain().focus():e.chain()).extendMarkRange(`link`).unsetSemanticLink().run()}function Zi(e,t){let n=e.trim();return n.toLowerCase().startsWith(`mailto:`)?zi({type:`email`,value:n.slice(7),newWindow:t}):n.toLowerCase().startsWith(`tel:`)?zi({type:`tel`,value:n.slice(4),newWindow:t}):n.toLowerCase().startsWith(`sms:`)?zi({type:`sms`,value:n.slice(4),newWindow:t}):Vi(n,t)}function Qi(e){return Bi(e.getAttributes(`link`))}function $i(e){return e.type===`url`||e.type===`email`||e.type===`tel`||e.type===`sms`?e.value??Hi(e):Hi(e)}var ea=e=>e??r,ta=x(class extends ne{constructor(e){if(super(e),e.type!==b.PROPERTY&&e.type!==b.ATTRIBUTE&&e.type!==b.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!ce(e))throw Error("`live` bindings can only contain a single expression")}render(e){return e}update(e,[t]){if(t===u||t===r)return t;let n=e.element,i=e.name;if(e.type===b.PROPERTY){if(t===n[i])return u}else if(e.type===b.BOOLEAN_ATTRIBUTE){if(!!t===n.hasAttribute(i))return u}else if(e.type===b.ATTRIBUTE&&n.getAttribute(i)===t+``)return u;return le(e),t}}),na=new Set([`button`,`submit`,`reset`,`checkbox`,`radio`,`file`,`image`,`hidden`]),ra=`pk-implicit-submit`,ia=(e,t)=>{if(e.key!==`Enter`||e.defaultPrevented||e.isComposing||e.altKey||e.ctrlKey||e.metaKey||e.shiftKey)return!1;let n=(t||`text`).toLowerCase();return!na.has(n)},aa=e=>{let t=e.closest?.(`pk-dialog`);if(t){let e=t.querySelector(`form`);if(e)return e}let n=e.form;return n&&n.id===`main`?e.closest?.(`form`)===n?null:e.closest(`form`):n},oa=(e,t,n)=>{if(e.disabled||e.readonly||!ia(t,n))return!1;let r=aa(e);return!r||r.id===`main`?!1:(t.preventDefault(),t.stopPropagation(),r.dispatchEvent(new CustomEvent(ra,{bubbles:!1,cancelable:!0})),!0)},sa=o`
    @layer pk-component {
        :host {
            display: block;
            width: 100%;
...
`,W=class extends oe{constructor(...e){super(...e),this.assumeInteractionOn=[`blur`,`input`],this.hasSlotController=new re(this,`instructions`,`hint`,`label`,`start`,`end`),this.inputId=ee(`pk-input`),this.type=`text`,this._value=null,this.defaultValue=null,this.size=`default`,this.label=``,this.instructions=``,this.withClear=!1,this.placeholder=``,this.readonly=!1,this.invalid=!1,this.fitCell=!1,this.mono=!1,this.autofocus=!1,this.withLabel=!1,this.withInstructions=!1}static{this.styles=[Tt,p(),d(`.input`,`var(--pk-input-border-radius, var(--pk-radius-sm))`),f(`.input`),sa]}static get validators(){return[...super.validators,ae(),se()]}get value(){return this.valueHasChanged?this._value??``:this._value??this.defaultValue??``}set value(e){let t=e??``;this._value!==t&&(this.valueHasChanged=!0,this._value=t)}connectedCallback(){this.instructions=wt(this,this.instructions),this.hasAttribute(`with-hint`)&&(this.withInstructions=!0),super.connectedCallback()}syncFormValue(){this.setValue(this.value||``)}resetToDefaultValue(){this.valueHasChanged=!1,this._value=null}restoreFormState(e){typeof e==`string`&&(this.value=e)}formResetCallback(){this.valueHasChanged=!1,this._value=null,this.input&&(this.input.value=this.defaultValue??``),super.formResetCallback()}updated(e){(e.has(`value`)||e.has(`defaultValue`))&&this.setState(`blank`,!this.value),super.updated(e)}syncStandaloneAria(){if(!this.input)return;let e=!!this.label||this.hasSlotController.test(`label`,this.withLabel),t=Et((e,t)=>this.hasSlotController.test(e,t),this.instructions,this.withInstructions);ie({control:this.input,labelId:`${this.inputId}-label`,instructionsId:`${this.inputId}-instructions`,hasLabel:e,hasInstructions:t,required:this.required,invalid:this.invalid||!this.internals.validity.valid})}hasLabelContent(){return!!this.label||this.hasSlotController.test(`label`,this.withLabel)}hasInstructionsContent(){return Et((e,t)=>this.hasSlotController.test(e,t),this.instructions,this.withInstructions)}focus(e){this.input?.focus(e)}blur(){this.input?.blur()}select(){this.input?.select()}handleInput(){this.value=this.input.value,this.dispatchEvent(new Event(`input`,{bubbles:!0,composed:!0}))}handleChange(e){this.value=this.input.value,e.stopPropagation(),this.dispatchEvent(new Event(`change`,{bubbles:!0,composed:!0}))}handleKeyDown(e){oa(this,e,this.type)}handleClearClick(e){e.preventDefault(),this.value!==``&&(this.value=``,this.dispatchEvent(new Ct),this.dispatchEvent(new Event(`input`,{bubbles:!0,composed:!0})),this.dispatchEvent(new Event(`change`,{bubbles:!0,composed:!0})),this.input.focus())}render(){let e=this.hasLabelContent(),t=this.hasInstructionsContent(),i=this.withClear&&!this.disabled&&!this.readonly&&this.value.length>0,a=this.hasSlotController.test(`start`),o=this.hasSlotController.test(`end`);return n`
            <div part="form-control" class="form-control">
                ...
                <div part="base" class="form-control__input">
                    ...
                    <input
                        ...
                        pattern=${ea(this.pattern)}
                        minlength=${ea(this.minlength)}
                        maxlength=${ea(this.maxlength)}
                        min=${ea(this.min)}
                        max=${ea(this.max)}
                        step=${ea(this.step)}
                        autocomplete=${ea(this.autocomplete)}
                        ?disabled=${this.disabled}
    ...
    `;async openForEditor(e,t,n){await la(),this.#n=e,this.#r={...t},this.#i=n?.focus??!0;let r=!!(t.url.trim()||t.semantic);this.dialogTitle=r?`Update Link`:`Insert Link`,this.submitLabel=r?`Update`:`Insert`,await this.updateComplete,this.#f(),await this.dialog?.updateComplete,await this.dialog?.show()}render(){return n`
            <pk-dialog
                class="link-dialog"
                size="wide"
        ...
        `}#f(){this.urlInput&&(this.urlInput.value=this.#r.url??``),this.textInput&&(this.textInput.value=this.#r.text??``),this.newTabCheckbox&&(this.newTabCheckbox.checked=!!this.#r.openInNewTab),this.#p()}#p(){let e=!!(this.urlInput?.value.trim()||this.#r.semantic);this.submitButton&&(this.submitButton.disabled=!e)}#m=()=>{this.#r={...this.#r,semantic:void 0},this.#p()};#h=e=>{if(e.key!==`Enter`)return;let t=e.composedPath();t.some(e=>e instanceof HTMLElement&&e.localName===`pk-checkbox`)||t.some(e=>e instanceof HTMLElement&&(e.localName===`pk-button`||e instanceof HTMLButtonElement))||(e.preventDefault(),e.stopPropagation(),this.#g())};#g=()=>{let e=this.#n,t=this.urlInput?.value.trim()??``;if(!e||!t&&!this.#r.semantic)return;let n=!!this.newTabCheckbox?.checked,r=this.textInput?.value??``;Yi(e,{attrs:this.#r.semantic?{...this.#r.semantic,newWindow:n}:Zi(t,n),text:r,from:this.#r.from,to:this.#r.to,focus:this.#i}),this.dialog?.hide(`submit`)};#_=()=>{this.#n=null}};P([c()],da.prototype,`dialogTitle`,null),P([c()],da.prototype,`submitLabel`,null),P([e(`pk-dialog`)],da.prototype,`dialog`,null),P([e(`.link-dialog__url-input`)],da.prototype,`urlInput`,null),P([e(`.link-dialog__text-input`)],da.prototype,`textInput`,null),P([e(`pk-checkbox`)],da.prototype,`newTabCheckbox`,null),P([e(`.link-dialog__submit`)],da.prototype,`submitButton`,null),da=P([N(`vizy-link-dialog`)],da);async function fa(e,t,n){await la(),(!ua||!ua.isConnected)&&(ua=document.createElement(`vizy-link-dialog`),document.body.append(ua),await ua.updateComplete),await ua.openForEditor(e,t,n)}function pa(){return{openElementSelector:(e,t)=>{let n=window.Craft;if(!n?.createElementSelectorModal)throw Error(`Craft element selector is not available in this environment.`);n.createElementSelectorModal(e,t)}}}function ma(e){let{from:t,to:n}=e.state.selection;return e.state.doc.textBetween(t,n,` `)}function ha(e,t,n){if(t!==`link`){(n?.focus??e.view.hasFocus()?e.chain().focus():e.chain()).toggleMark(t).run();return}ga(e,n)}async function ga(e,t){await fa(e,e.isActive(`link`)?qi(e):Ji(e),t)}function _a(e,t){Xi(e,t)}function va(e){return Ii(e?.linkOptions)}function ya(e,t,n,r){let i=n.linkSelectorStorageKeyPrefix||`VizyInput.LinkTo.${n.elementSiteId??`site`}`;pa().openElementSelector(t.elementType,{storageKey:`${i}.${t.elementType}`,sources:t.sources,criteria:t.criteria,defaultSiteId:n.elementSiteId,autoFocusSearchBox:!1,closeOtherModals:!1,onSelect:i=>{if(!i?.length)return;let[a]=i,o=ma(e)||a.label||``,s=ba(a),c=xa(t.refHandle),l=Sa(n.elementSiteId,a.siteId);if(s&&c){fa(e,{url:a.url||``,text:o,openInNewTab:!1,semantic:zi({type:c,targetUid:s,siteMode:l.siteMode,siteUid:l.siteUid,newWindow:!1})},r);return}fa(e,{url:Li(a,t.refHandle),text:o,openInNewTab:!1},r)}})}function ba(e){if(typeof e.uid==`string`&&U(e.uid))return e.uid;let t=e.$element?.data?.(`uid`);if(typeof t==`string`&&U(t))return t;let n=e.$element?.attr?.(`data-uid`);return typeof n==`string`&&U(n)?n:null}function xa(e){switch(e){case`entry`:return`entry`;case`asset`:return`asset`;case`category`:return`category`;default:return null}}function Sa(e,t){if(!t||!e||t===e)return{siteMode:`current`,siteUid:null};let n=window.Craft?.sites?.find(e=>e.id===t);return{siteMode:`fixed`,siteUid:typeof n?.uid==`string`&&U(n.uid)?n.uid:null}}var Ca=new Map,wa=new Map;function Ta(e,t){let n=wa.get(e)??new Set;return n.add(t),wa.set(e,n),()=>{n.delete(t),n.size===0&&wa.delete(e)}}function Ea(e,t){Ca.set(e,t);for(let t of[...wa.get(e)??[]])t()}function Da(e){return Ca.get(e)??null}function Oa(e){if(e)for(let[t,n]of Object.entries(e))!t||!n?.url||Ea(t,{assetId:Number(n.assetId)||0,url:n.url,label:n.label||`Image`,transform:n.transform??``})}function ka(e){let t=Ca.get(e);if(!t)return null;let n=t.url.indexOf(`#`),r=n<0?t.url:t.url.slice(0,n),i=n<0?``:t.url.slice(n),a=r.includes(`?`)?t.url:`${r}?v=${Date.now()}${i}`;return Ea(e,{...t,url:a}),a}var Aa=[{value:`default`,label:`Default`},{value:`small`,label:`Small`},{value:`medium`,label:`Medium`},{value:`large`,label:`Large`},{value:`full`,label:`Full`}];function ja(e){return e.isActive(`image`)?Ia(e.getAttributes(`image`)):null}function Ma(e){let t=ja(e);if(!t)return null;let n=Da(t.assetUid),r=t.link;return{assetUid:t.assetUid,assetId:n?.assetId??0,previewUrl:n?.url??``,alt:t.alt??``,title:t.title??``,linkUrl:r?Hi(r):``,openInNewTab:r?.newWindow??!1,size:t.size,transform:n?.transform??``,updating:!0,originalAttrs:t}}function Na(e,t){Ea(t.attrs.assetUid,{assetId:t.preview.assetId,url:t.preview.url,label:t.preview.label,transform:t.preview.transform});let n=t.focus??!0?e.chain().focus():e.chain();return t.replaceSelection&&e.isActive(`image`)?n.updateAttributes(`image`,t.attrs).run():n.setSemanticImage(t.attrs).run()}function Pa(e,t){let n=t?.focus??!0?e.chain().focus():e.chain();if(e.state.selection instanceof A&&e.state.selection.node.type.name===`image`){n.deleteSelection().run();return}if(e.isActive(`image`)){let t=e.state.selection.$from.before(e.state.selection.$from.depth);e.state.doc.nodeAt(t)?.type.name===`image`&&n.setNodeSelection(t).deleteSelection().run()}}function Fa(e){let t=e.alt.trim(),n=e.title.trim(),r=e.linkUrl.trim(),i=e.originalAttrs,a=i?.link,o=a?Hi(a):``,s=a&&r===o?{...a,newWindow:e.openInNewTab}:r?Zi(r,e.openInNewTab):null,c=i&&e.alt===(i.alt??``);return{assetUid:e.assetUid,siteMode:i?.siteMode??`current`,siteUid:i?.siteUid??null,altMode:c?i.altMode:t?`custom`:`asset`,alt:c?i.alt:t||null,title:n||null,size:e.size,link:s,imageUid:i?.imageUid??null}}function Ia(e){let t=typeof e.assetUid==`string`?e.assetUid:``;if(!t)return null;let n=[`default`,`small`,`medium`,`large`,`full`].includes(String(e.size))?e.size:`default`,r=[`asset`,`custom`,`decorative`,`missing`].includes(String(e.altMode))?e.altMode:`asset`,i=null;if(e.link&&typeof e.link==`object`){let t=e.link;i=Bi(t)}return{assetUid:t,siteMode:e.siteMode===`fixed`?`fixed`:`current`,siteUid:typeof e.siteUid==`string`?e.siteUid:null,altMode:r,alt:typeof e.alt==`string`?e.alt:null,title:typeof e.title==`string`?e.title:null,size:n,link:i,imageUid:typeof e.imageUid==`string`?e.imageUid:null}}function La(e,t){if(!e)return Promise.resolve(null);let n=window.Craft;return typeof n?.sendActionRequest==`function`?n.sendActionRequest(`POST`,t?`assets/generate-transform`:`vizy/assets/info`,{data:{assetId:e,handle:t}}).then(e=>e.data.url??null).catch(()=>null):Promise.resolve(null)}async function Ra(e){let t=Da(e);if(!t)return null;let n=await La(t.assetId,t.transform);return!n||Da(e)!==t?null:(Ea(e,{...t,url:n}),ka(e))}var za=null,G=class extends t{#e=`Insert Image`;get dialogTitle(){return this.#e}set dialogTitle(e){this.#e=e}#t=`Insert`;get submitLabel(){return this.#t}set submitLabel(e){this.#t=e}#n=null;#r=null;#i=0;#a=!0;#o=Math.random().toString(36).slice(2,9);#s=null;get dialog(){return this.#s}set dialog(e){this.#s=e}#c=null;get altInput(){return this.#c}set altInput(e){this.#c=e}#l=null;get titleInput(){return this.#l}set titleInput(e){this.#l=e}#u=null;get urlInput(){return this.#u}set urlInput(e){this.#u=e}#d=null;get newTabCheckbox(){return this.#d}set newTabCheckbox(e){this.#d=e}#f=null;get sizeSelect(){return this.#f}set sizeSelect(e){this.#f=e}#p=null;get transformSelect(){return this.#p}set transformSelect(e){this.#p=e}#m=null;get previewImg(){return this.#m}set previewImg(e){this.#m=e}#h=[];get transforms(){return this.#h}set transforms(e){this.#h=e}static styles=o`
    ...
    `;async openForEditor(e,t,n){await la(),this.#n=e,this.#r={...t},this.#a=n?.focus??!0,n?.transforms&&(this.transforms=n.transforms),this.dialogTitle=t.updating?`Edit Image`:`Insert Image`,this.submitLabel=t.updating?`Update`:`Insert`,await this.updateComplete,this.#g(),await this.dialog?.updateComplete,await this.dialog?.show()}render(){return n`
        ...
        `}#g(){let e=this.#r;e&&(this.altInput&&(this.altInput.value=e.alt),this.titleInput&&(this.titleInput.value=e.title),this.urlInput&&(this.urlInput.value=e.linkUrl),this.newTabCheckbox&&(this.newTabCheckbox.checked=e.openInNewTab),this.sizeSelect&&(this.sizeSelect.value=e.size),this.transformSelect&&(this.transformSelect.value=e.transform),this.previewImg&&e.previewUrl&&(this.previewImg.src=e.previewUrl))}#_=()=>{let e=this.#r;if(!e||!this.transformSelect)return;let t=this.transformSelect.value,n=++this.#i;e.transform=t,La(e.assetId,t).then(t=>{!t||!this.isConnected||this.#r!==e||n!==this.#i||(e.previewUrl=t,this.previewImg&&(this.previewImg.src=t),this.requestUpdate())})};#v=()=>{let e=this.#n,t=this.#r;if(!e||!t)return;let n={...t,alt:this.altInput?.value??``,title:this.titleInput?.value??``,linkUrl:this.urlInput?.value??``,openInNewTab:!!this.newTabCheckbox?.checked,size:this.sizeSelect?.value||`default`,transform:this.transformSelect?.value??t.transform};Na(e,{attrs:Fa(n),preview:{assetId:n.assetId,url:n.previewUrl,label:n.alt||n.title||`Image`,transform:n.transform},focus:this.#a,replaceSelection:n.updating}),this.dialog?.hide(`submit`)};#y=()=>{this.#n=null,this.#r=null}};P([c()],G.prototype,`dialogTitle`,null),P([c()],G.prototype,`submitLabel`,null),P([e(`pk-dialog`)],G.prototype,`dialog`,null),P([e(`.image-dialog__alt`)],G.prototype,`altInput`,null),P([e(`.image-dialog__title`)],G.prototype,`titleInput`,null),P([e(`.image-dialog__url`)],G.prototype,`urlInput`,null),P([e(`pk-checkbox`)],G.prototype,`newTabCheckbox`,null),P([e(`.image-dialog__size`)],G.prototype,`sizeSelect`,null),P([e(`.image-dialog__transform`)],G.prototype,`transformSelect`,null),P([e(`.image-dialog__preview-img`)],G.prototype,`previewImg`,null),P([c({attribute:!1})],G.prototype,`transforms`,null),G=P([N(`vizy-image-dialog`)],G);async function Ba(e,t,n){await la(),(!za||!za.isConnected)&&(za=document.createElement(`vizy-image-dialog`),document.body.append(za),await za.updateComplete),await za.openForEditor(e,t,n)}function Va(e,t,n){if(e.isActive(`image`)){let r=Ma(e);if(r){Ba(e,r,{focus:n?.focus,transforms:t.transforms??[]});return}}Ha(e,t,n)}function Ha(e,t,n){let r=window.Craft;if(!r?.createElementSelectorModal)throw Error(`Craft element selector is not available in this environment.`);let i=(t.transforms??[]).filter(e=>e.handle&&e.name);t.defaultTransform,r.createElementSelectorModal(`craft\\elements\\Asset`,{storageKey:`${t.linkSelectorStorageKeyPrefix??`VizyInput`}.ChooseImage`,multiSelect:!1,sources:t.volumes,defaultSource:t.defaultSource??void 0,criteria:{siteId:t.elementSiteId,kind:`image`},transforms:i,closeOtherModals:!1,onSelect:(r,i)=>{Ua(e,t,r,i,n)}})}async function Ua(e,t,n,r,i){if(!n?.length)return;let[a]=n;if(!a.id){console.warn(`[vizy] Image select: asset has no id`);return}let o=Wa(a),s=a.url||``,c=a.label||``,l=a.label||``;if(!o||!U(o)){let e=await Ga(a.id,a.siteId??t.elementSiteId);if(!e?.uid||!U(e.uid)){console.warn(`[vizy] Image select: could not resolve asset uid`,a.id);return}o=e.uid,s=s||e.url||``,c=c||e.alt||e.title||``,l=l||e.title||``}let u=typeof r==`string`&&r?r:t.defaultTransform??``;if(u&&(!r||typeof r!=`string`)){let e=await Ka(a.id,u);e&&(s=e)}Ea(o,{assetId:a.id,url:s,label:l||c||`Image`,transform:u}),await Ba(e,{assetUid:o,assetId:a.id,previewUrl:s,alt:c,title:l,linkUrl:``,openInNewTab:!1,size:`default`,transform:u,updating:!1},{focus:i?.focus,transforms:t.transforms??[]})}function Wa(e){if(typeof e.uid==`string`&&U(e.uid))return e.uid;let t=e.$element?.data?.(`uid`);if(typeof t==`string`&&U(t))return t;let n=e.$element?.attr?.(`data-uid`);return typeof n==`string`&&U(n)?n:null}async function Ga(e,t){let n=window.Craft;if(typeof n?.sendActionRequest!=`function`)return null;try{let r=await n.sendActionRequest(`POST`,`vizy/assets/info`,{data:{assetId:e,siteId:t}});return r.data?.uid?{uid:r.data.uid,url:r.data.url??null,title:r.data.title??``,alt:r.data.alt??``}:null}catch(e){return console.warn(`[vizy] Image select: asset info request failed`,e),null}}async function Ka(e,t){let n=window.Craft;if(!t||typeof n?.sendActionRequest!=`function`)return null;try{return(await n.sendActionRequest(`POST`,`assets/generate-transform`,{data:{assetId:e,handle:t}})).data.url??null}catch{return null}}var qa=/(?:youtube\.com\/(?:watch\?v=|embed\/|shorts\/)|youtu\.be\/)([A-Za-z0-9_-]{6,})/i,Ja=/(?:vimeo\.com\/(?:video\/)?)(\d+)/i;function Ya(e){let t=e.trim();if(!t)return null;try{let e=/^https?:\/\//i.test(t)?t:`https://${t}`,n=new URL(e);return n.protocol!==`https:`&&n.protocol!==`http:`?null:(n.protocol===`http:`&&(n.protocol=`https:`),n.toString())}catch{return null}}function Xa(e){let t=Ya(e);if(!t)return null;let n=t.match(qa);if(n?.[1]){let e=n[1];return{provider:`youtube`,url:t,resourceId:e,html:Za(`https://www.youtube.com/embed/${encodeURIComponent(e)}`,`YouTube video`)}}let r=t.match(Ja);if(r?.[1]){let e=r[1];return{provider:`vimeo`,url:t,resourceId:e,html:Za(`https://player.vimeo.com/video/${encodeURIComponent(e)}`,`Vimeo video`)}}return{provider:`unknown`,url:t,resourceId:null,html:null}}function Za(e,t){return`<div class="vizy-media-embed__frame" style="position:relative;padding-bottom:56.25%;height:0;overflow:hidden;"><iframe src="${e}" title="${Qa(t)}" style="position:absolute;inset:0;width:100%;height:100%;border:0;" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen loading="lazy" referrerpolicy="strict-origin-when-cross-origin"></iframe></div>`}function Qa(e){return e.replace(/&/g,`&amp;`).replace(/"/g,`&quot;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`)}var $a=null,eo=class extends t{#e=`Insert Media Embed`;get dialogTitle(){return this.#e}set dialogTitle(e){this.#e=e}#t=`Insert`;get submitLabel(){return this.#t}set submitLabel(e){this.#t=e}#n=null;#r={kind:`mediaEmbed`,url:``,updating:!1};#i=!0;#a=`vizy-url-node-${Math.random().toString(36).slice(2,9)}`;#o=null;get dialog(){return this.#o}set dialog(e){this.#o=e}#s=null;get urlInput(){return this.#s}set urlInput(e){this.#s=e}#c=null;get submitButton(){return this.#c}set submitButton(e){this.#c=e}static styles=o`
        :host { display: contents; }
        .fields {
            display: flex;
            flex-direction: column;
    ...
    `;async openForEditor(e,t,n){await la(),this.#n=e,this.#r={...t},this.#i=n?.focus??!0;let r=t.kind===`iframe`?`iFrame`:`Media Embed`;this.dialogTitle=t.updating?`Edit ${r}`:`Insert ${r}`,this.submitLabel=t.updating?`Update`:`Insert`,await this.updateComplete,this.#l(),await this.dialog?.updateComplete,await this.dialog?.show()}render(){return n`
            <pk-dialog
        ...
        `}#l(){this.urlInput&&(this.urlInput.value=this.#r.url??``),this.#u()}#u(){let e=!!Ya(this.urlInput?.value??``);this.submitButton&&(this.submitButton.disabled=!e)}#d=()=>{this.#u()};#f=e=>{e.key===`Enter`&&(e.preventDefault(),e.stopPropagation(),this.#p())};#p=()=>{let e=this.#n,t=Ya(this.urlInput?.value??``);if(!e||!t)return;let n=this.#i?e.chain().focus():e.chain(),r=this.#r.updating&&e.isActive(this.#r.kind);if(this.#r.kind===`iframe`)r?n.updateAttributes(`iframe`,{url:t,frameborder:0,allowfullscreen:!0}).run():n.setVizyIframe({url:t}).run();else{let e=Xa(t);if(!e)return;let i={url:e.url,data:e.html?{html:e.html}:null};r?n.updateAttributes(`mediaEmbed`,i).run():n.setVizyMediaEmbed({url:e.url}).run()}this.dialog?.hide(`submit`)};#m=()=>{this.#n=null}};P([c()],eo.prototype,`dialogTitle`,null),P([c()],eo.prototype,`submitLabel`,null),P([e(`pk-dialog`)],eo.prototype,`dialog`,null),P([e(`.url-node-dialog__url`)],eo.prototype,`urlInput`,null),P([e(`.url-node-dialog__submit`)],eo.prototype,`submitButton`,null),eo=P([N(`vizy-url-node-dialog`)],eo);async function to(e,t,n){await la(),(!$a||!$a.isConnected)&&($a=document.createElement(`vizy-url-node-dialog`),document.body.append($a),await $a.updateComplete),await $a.openForEditor(e,t,n)}function no(e,t){if(!e.isActive(t))return null;let n=e.getAttributes(t);return{kind:t,url:typeof n.url==`string`?n.url:``,updating:!0}}function ro(e,t,n){let r=n?.focus??!0?e.chain().focus():e.chain(),{selection:i}=e.state;if(i instanceof A&&i.node.type.name===t){r.deleteSelection().run();return}if(e.isActive(t)){let n=i.$from.before(i.$from.depth);e.state.doc.nodeAt(n)?.type.name===t&&r.setNodeSelection(n).deleteSelection().run()}}function io(e,t,n){if(e.isActive(t)){let r=no(e,t);if(r){to(e,r,{focus:n?.focus});return}}to(e,{kind:t,url:``,updating:!1},{focus:n?.focus})}var ao=new gn;function oo(e,t={}){if(!e.schema.nodes.layout||!e.schema.nodes.column)return!1;if(e.isActive(`layout`)){let n=t.focus?e.chain().focus():e.chain();return typeof n.unwrapLayout==`function`&&n.unwrapLayout().run()}let{from:n}=e.state.selection;if(Ye(e.state.doc,n))return!1;let r=t.presets?.length?t.presets:Je;if(r.length===1)return so(e,r[0],t.focus);let i=e.view.dom.closest(`.vizy-editor-surface`)?.parentElement??e.view.dom.parentElement;if(!i)return!1;let a=t.invoker?.getBoundingClientRect()??(()=>{let t=e.view.coordsAtPos(n);return new DOMRect(t.left,t.top,1,t.bottom-t.top)})();return ao.open(a,r,i,{returnFocus:t.invoker??e.view.dom,onSelect:t=>{let n=nt(r,t);n&&so(e,n,!0)}}),!0}function so(e,t,n){n&&e.view.focus();let r=()=>crypto.randomUUID(),{from:i,to:a}=e.state.selection;return e.state.selection instanceof A||ft(e,i,a)?qe(e,i,a,t,r):Ge(e,t,i,r)}var co={rows:3,cols:3,withHeaderRow:!0};function lo(e,t,n){let r=n?.focus??e.view.hasFocus(),i=n?.controlId?yt(n.controlId):void 0;if(i)return r&&e.chain().focus().run(),i.run(e)!==!1;if(t.command===`registeredControl`)return!1;if(t.command===`setLink`)return ha(e,`link`,{focus:r}),!0;if(t.command===`insertNode`&&t.nodeName===`image`)return Va(e,n?.imageAuthoring??{},{focus:r}),!0;if(t.command===`insertNode`&&(t.nodeName===`iframe`||t.nodeName===`mediaEmbed`))return io(e,t.nodeName,{focus:r}),!0;if(t.command===`wrapInLayout`)return oo(e,{focus:r,presets:n?.layoutPresets,invoker:n?.invoker});let a=r?e.chain().focus():e.chain();switch(t.command){case`toggleMark`:return a.toggleMark(t.markName).run(),!0;case`setParagraph`:return a.setParagraph().run(),!0;case`setHeading`:return vo(t.level)?(a.toggleHeading({level:t.level}).run(),!0):!1;case`toggleNode`:return fo(a,t.nodeName);case`insertNode`:return po(e,t.nodeName,r);case`setTextAlign`:return e.isActive({textAlign:t.align})?(a.unsetTextAlign().run(),!0):(a.setTextAlign(t.align).run(),!0);case`clearFormatting`:return a.unsetAllMarks().clearNodes().run(),!0;case`openAddBlock`:return!1;case`undo`:return a.undo().run(),!0;case`redo`:return a.redo().run(),!0;case`tableOperation`:return uo(a,t.operation);default:return!1}}function uo(e,t){let n=e[t];return typeof n==`function`&&n.call(e).run()}function fo(e,t){switch(t){case`heading`:return e.toggleHeading({level:2}).run(),!0;case`bulletList`:return e.toggleBulletList().run(),!0;case`orderedList`:return e.toggleOrderedList().run(),!0;case`blockquote`:return e.toggleBlockquote().run(),!0;case`codeBlock`:return e.toggleCodeBlock().run(),!0;default:return!1}}function po(e,t,n){let r=n?e.chain().focus():e.chain();if(t===`horizontalRule`)return r.setHorizontalRule().run();if(t===`table`)return r.insertTable(co).run();if(t===`hardBreak`)return r.setHardBreak().run();let i=e.schema.nodes[t];if(!i)return!1;try{let e=i.createAndFill();return e?r.insertContent(e.toJSON()).run():!1}catch{return!1}}function mo(e){if(yt(e.id))return!0;let t=e.action;return t?t.command===`toggleNode`?go.includes(t.nodeName):t.command===`setHeading`?vo(t.level):_o.includes(t.command):!1}function ho(e,t,n){let r=n?yt(n):void 0;if(r?.isActive)return!!r.isActive(e);if(!t)return!1;switch(t.command){case`toggleMark`:return e.isActive(t.markName);case`setLink`:return e.isActive(`link`);case`insertNode`:return t.nodeName===`image`?e.isActive(`image`):t.nodeName===`iframe`?e.isActive(`iframe`):t.nodeName===`mediaEmbed`&&e.isActive(`mediaEmbed`);case`toggleNode`:return e.isActive(t.nodeName);case`setParagraph`:return e.isActive(`paragraph`);case`setHeading`:return e.isActive(`heading`,{level:t.level});case`setTextAlign`:return e.isActive({textAlign:t.align});case`wrapInLayout`:return e.isActive(`layout`);default:return!1}}var go=[`heading`,`bulletList`,`orderedList`,`blockquote`,`codeBlock`],_o=[`toggleNode`,`insertNode`,`toggleMark`,`setParagraph`,`setHeading`,`setLink`,`setTextAlign`,`clearFormatting`,`undo`,`redo`,`wrapInLayout`,`openAddBlock`,`tableOperation`];function vo(e){return Number.isInteger(e)&&e>=1&&e<=6}var yo=o`
    .vizy-control {
        box-sizing: border-box;
        display: flex;
        align-items: center;
...
`;function bo(e){return e.icon?n`${te(e.icon)}`:e.abbr?n`<span class="abbr">${e.abbr}</span>`:e.label}function xo(){return n`<span class="chevron" aria-hidden="true">${te(Dt)}</span>`}function So(e,t=``){return[`vizy-control`,!e.icon&&!e.abbr?`is-text`:``,t].filter(Boolean).join(` `)}var Co=200,wo=0;function To(e,t){typeof e[t]==`function`&&e[t]()}function Eo(e){let t=e.shadowRoot;if(!t)return()=>{};let n=document.createElement(`pk-tooltip`);n.setAttribute(`trigger`,`manual`),n.setAttribute(`placement`,`top`),t.append(n);let r=null,i=()=>{r!==null&&(window.clearTimeout(r),r=null)},a=e=>e instanceof Element?e.closest(`.vizy-control`):null,o=e=>{let t=a(e.target);if(!t)return;let o=t.getAttribute(`aria-label`)?.trim();o&&(i(),r=window.setTimeout(()=>{r=null,t.isConnected&&(t.id||=`vizy-tb-${++wo}`,n.for=t.id,n.content=o,To(n,`show`))},Co))},s=e=>{a(e.target)&&(a(e.relatedTarget)||(i(),To(n,`hide`)))},c=()=>{i(),To(n,`hide`)};return t.addEventListener(`pointerover`,o),t.addEventListener(`pointerout`,s),t.addEventListener(`pointerdown`,c),()=>{i(),t.removeEventListener(`pointerover`,o),t.removeEventListener(`pointerout`,s),t.removeEventListener(`pointerdown`,c),To(n,`hide`),n.remove()}}var Do=class extends t{#e=[];get controls(){return this.#e}set controls(e){this.#e=e}#t=null;get editor(){return this.#t}set editor(e){this.#t=e}#n=!1;get canAddBlock(){return this.#n}set canAddBlock(e){this.#n=e}#r=!0;get addBlockNeedsMenu(){return this.#r}set addBlockNeedsMenu(e){this.#r=e}#i=null;get addBlockDirectLabel(){return this.#i}set addBlockDirectLabel(e){this.#i=e}#a=!1;get addBlockOpen(){return this.#a}set addBlockOpen(e){this.#a=e}#o={};get linkAuthoring(){return this.#o}set linkAuthoring(e){this.#o=e}#s={};get imageAuthoring(){return this.#s}set imageAuthoring(e){this.#s=e}#c=[];get layoutPresets(){return this.#c}set layoutPresets(e){this.#c=e}#l=null;#u=null;#d=!1;#f=new Set;#p=!1;#m=!1;#h=!1;static styles=[yo,o`
        ...
        `];connectedCallback(){super.connectedCallback(),document.addEventListener(`keydown`,this.#P),document.addEventListener(`pointerdown`,this.#j,!0)}firstUpdated(){this.#l=Eo(this)}updated(e){e.has(`editor`)&&this.#T()}disconnectedCallback(){document.removeEventListener(`keydown`,this.#P),document.removeEventListener(`pointerdown`,this.#j,!0),this.#l?.(),this.#l=null,this.#u?.(),this.#u=null,this.#f.clear(),this.#p=!1,this.#N(),super.disconnectedCallback()}render(){let e=this.#_();return e.length?n`
            <div role="toolbar" aria-label="Formatting">
                ${e.map(e=>this.#y(e))}
            </div>
        `:null}#g(e,t){let n=t.currentTarget;n instanceof HTMLElement&&this.dispatchEvent(new CustomEvent(`vizy-toolbar-ui`,{detail:{action:e,invoker:n,hadEditorFocus:this.#m||Vt(this.editor)},bubbles:!0,composed:!0}))}#_(){let e=this.controls.filter(e=>this.#v(e)),t=[];for(let n of e){if(n.presentation===`separator`){if(!t.length||t[t.length-1]?.presentation===`separator`)continue;t.push(n);continue}t.push(n)}return t.at(-1)?.presentation===`separator`&&t.pop(),t}#v(e){return e.presentation===`separator`?!0:e.action?.command===`openAddBlock`?this.canAddBlock:e.kind===`group`?(e.items??[]).some(e=>this.#v(e)):mo(e)}#y(e){if(e.presentation===`separator`)return n`<span class="vizy-separator" role="separator"></span>`;if(e.kind===`group`){let t=(e.items??[]).filter(e=>this.#v(e));return t.length?this.#x(e,t):r}if(!this.#v(e))return r;if(e.action?.command===`setLink`)return this.#b(e);let t=e.action?.command===`openAddBlock`,i=t&&this.addBlockNeedsMenu,a=t&&this.addBlockDirectLabel?this.addBlockDirectLabel:e.label;return n`
            <button
                type="button"
                class=${So(e,i?`has-menu`:``)}
                aria-label=${a}
                ...
                @mousedown=${this.#O}
                @click=${t=>this.#k(e,t)}
                >${t?n`<pk-icon icon="plus" label=""></pk-icon>`:bo(e)}${i?xo():r}</button>
        `}#b(e){let t=va(this.linkAuthoring),i=this.#D(e),a=()=>this.#m||this.#h,o=async(e,t)=>{let n=e.currentTarget;await(n instanceof HTMLElement?n.closest(`pk-dropdown-menu`):null)?.whenClosed?.(),t()};return n`
            <pk-dropdown-menu
                size="sm"
            ...
            >
                ...
                ${t.map((e,t)=>n`
                    <pk-dropdown-item
                        value=${`craft-link:${t}`}
                        @click=${t=>{o(t,()=>{this.editor&&ya(this.editor,e,this.linkAuthoring,{focus:a()})})}}
                    >${e.optionTitle}</pk-dropdown-item>
                `)}
                ${t.length>0?n`<pk-dropdown-separator></pk-dropdown-separator>`:r}
                <pk-dropdown-item
                    value="insert-link"
                    @click=${e=>{o(e,()=>{this.editor&&ga(this.editor,{focus:a()})})}}
                >${i?`Edit Link`:`Insert Link`}</pk-dropdown-item>
                <pk-dropdown-item
                    value="unlink"
                    ?disabled=${!i}
                    @click=${()=>{!this.editor||!i||(_a(this.editor,{focus:a()}),this.requestUpdate())}}
            ...
            >
                ...
                ${a.map(t=>n`
                    <pk-dropdown-item
                        ...
                        ?disabled=${this.#C(e,t)}
                    >
                        ${t.icon?n`<span slot="start" class="menu-icon">${bo(t)}</span>`:r}
                        <span class="preview-label" data-preview=${t.preview??r}>${t.label}</span>
                    </pk-dropdown-item>
                `)}
            </pk-dropdown-menu>
        `}#S(e,t){if(!this.#w(e))return t;let n=t.filter(e=>e.id===`table`),r=t.filter(e=>e.id!==`table`);return this.editor?.isActive(`table`)?r.length>0?r:t:n.length>0?n:r}#C(e,t){return!this.#w(e)||t.id===`table`?!1:!this.editor?.isActive(`table`)}#w(e){return e.id===`dropdown:table`||e.id.endsWith(`:table`)}#T(){this.#u?.(),this.#u=null;let e=this.editor;if(!e)return;let t=()=>{this.requestUpdate()};e.on(`selectionUpdate`,t),this.#u=()=>{e.off(`selectionUpdate`,t)}}#E(e){let t=e.id.toLowerCase();return t.includes(`formatting`)||t.includes(`alignment`)||t.includes(`align`)}#D(e){return this.editor?ho(this.editor,e.action,e.id):!1}#O=e=>{this.#m=Vt(this.editor),zt(e)};#k(e,t){if(!e.action)return;if(e.action.command===`openAddBlock`){t?.currentTarget instanceof HTMLElement&&this.#g(`insert-block`,t);return}if(!this.editor)return;let n=this.#f.size>0?this.#h:this.#m,r=t?.currentTarget instanceof HTMLElement?t.currentTarget:null;lo(this.editor,e.action,{focus:n,imageAuthoring:this.imageAuthoring,layoutPresets:this.layoutPresets,invoker:r,controlId:e.id}),this.requestUpdate()}#A=e=>{let t=e.currentTarget;if(!(t instanceof HTMLElement))return;if(e.detail?.open){this.#f.add(t),this.#p=!1,this.#h=this.#m||Vt(this.editor),this.#h&&this.#M();return}if(!this.#f.delete(t)||this.#f.size>0)return;let n=!this.#p&&this.#h;this.#p=!1,this.#h=!1,this.#N(),n&&Ut(this.editor)};#j=e=>{if(this.#f.size===0)return;let t=e.composedPath();if([...this.#f].some(e=>t.includes(e))){t.some(e=>e instanceof HTMLElement&&e.getAttribute(`slot`)===`trigger`)&&(this.#p=!0);return}this.#p=!0};#M(){if(this.#d||!this.editor)return;let e=Pt(this.editor.view.dom);e&&(Ft(e,!0),this.#d=!0)}#N(){if(!this.#d||!this.editor){this.#d=!1;return}Ft(Pt(this.editor.view.dom),!1),this.#d=!1}#P=e=>{e.key===`Escape`&&(!this.shadowRoot?.querySelector(`pk-dropdown-menu[open], pk-dropdown-menu[aria-expanded="true"]`)||!this.#h||Ut(this.editor))}};P([c({attribute:!1})],Do.prototype,`controls`,null),P([c({attribute:!1})],Do.prototype,`editor`,null),P([c({type:Boolean,attribute:!1})],Do.prototype,`canAddBlock`,null),P([c({type:Boolean,attribute:!1})],Do.prototype,`addBlockNeedsMenu`,null),P([c({type:String,attribute:!1})],Do.prototype,`addBlockDirectLabel`,null),P([c({type:Boolean,attribute:!1})],Do.prototype,`addBlockOpen`,null),P([c({attribute:!1})],Do.prototype,`linkAuthoring`,null),P([c({attribute:!1})],Do.prototype,`imageAuthoring`,null),P([c({attribute:!1})],Do.prototype,`layoutPresets`,null),Do=P([N(`vizy-toolbar`)],Do);var Oo=10,ko=8,Ao=class extends t{#e=[];get controls(){return this.#e}set controls(e){this.#e=e}#t=null;get editor(){return this.#t}set editor(e){this.#t=e}#n=!1;get visible(){return this.#n}set visible(e){this.#n=e}#r=null;#i=null;#a={getClientRect:null,contextElement:void 0};static styles=[yo,o`
            :host {
                display: none;
            }
            :host([visible]) {
        ...
        `];syncToSelection(e){if(!this.controls.length){this.hide();return}this.#a.getClientRect=e.getClientRect,this.#a.contextElement=e.contextElement,this.#o(),this.visible=!0,this.#i&&(this.#i.active=!0,this.#i.reposition())}hide(){this.visible=!1,this.#i&&(this.#i.active=!1)}firstUpdated(){this.#r=Eo(this)}disconnectedCallback(){this.#r?.(),this.#r=null;let e=this.#i;this.#i=null,e?.isConnected&&(e.active=!1,e.remove()),super.disconnectedCallback()}render(){return!this.visible||!this.controls.length?null:n`
            <div
                class="panel"
                role="toolbar"
        ...
        `}#o(){if(this.#i)return;let e=document.createElement(`pk-popup`);e.className=`vizy-bubble-popup`,e.placement=`top`,e.distance=ko,e.flip=!0,e.flipPadding=this.#s(),e.shift=!0,e.shiftPadding=Oo,e.anchorTracking=!0,e.positionMethod=`fixed`;let t=this.#a;e.anchor={getBoundingClientRect:()=>t.getClientRect?.()??new DOMRect,get contextElement(){return t.contextElement}},e.append(this),document.body.append(e),this.#i=e}#s(){let e=getComputedStyle(document.documentElement).getPropertyValue(`--header-height`).trim(),t=Number.parseFloat(e);return!Number.isFinite(t)||t<=0?Oo:Math.max(Oo,Math.round(t)+8)}#c(e){return this.editor?ho(this.editor,e.action,e.id):!1}#l(e){!this.editor||!e.action||(lo(this.editor,e.action,{controlId:e.id}),this.requestUpdate())}};P([c({attribute:!1})],Ao.prototype,`controls`,null),P([c({attribute:!1})],Ao.prototype,`editor`,null),P([c({type:Boolean,reflect:!0})],Ao.prototype,`visible`,null),Ao=P([N(`vizy-bubble`)],Ao);var jo={selected:!1,editing:!1,expanded:!0,dragging:!1,dropTarget:`none`,menuOpen:!1,fieldLayout:`unmounted`},Mo=`Vizy.collapsedBlocks`;function No(){let e=window.Craft?.systemUid;return`${typeof e==`string`&&e!==``?`Craft-${e}`:`Craft`}.${Mo}`}function Po(){if(typeof localStorage>`u`)return[];try{let e=localStorage.getItem(No());return e?e.split(`,`).map(e=>e.trim()).filter(Boolean):[]}catch{return[]}}function Fo(e){if(!(typeof localStorage>`u`))try{localStorage.setItem(No(),e.join(`,`))}catch{}}function Io(e){return e?Po().includes(e):!1}function Lo(e){if(!e)return;let t=Po();t.includes(e)||(t.push(e),Fo(t))}function Ro(e){if(!e)return;let t=Po(),n=t.filter(t=>t!==e);n.length!==t.length&&Fo(n)}var zo=class{#e=new Map;get(e){let t=this.#e.get(e);if(!t){let n=Io(e);t={collapsed:n,editingFields:!1,activeTabUid:null,view:{...jo,expanded:!n},summary:null},this.#e.set(e,t)}return t}update(e,t){let n=this.get(e);return t.view&&Object.assign(n.view,t.view),t.summary!==void 0&&(n.summary=t.summary),t.collapsed!==void 0&&(n.collapsed=t.collapsed,n.view.expanded=!t.collapsed),t.editingFields!==void 0&&(n.editingFields=t.editingFields,n.view.editing=t.editingFields),t.activeTabUid!==void 0&&(n.activeTabUid=t.activeTabUid),n}reconcile(e){for(let t of this.#e.keys())e.has(t)||this.#e.delete(t)}clear(){this.#e.clear()}},Bo=class{#e=new Map;ensure(e,t=``,n=null,r=null){let i=this.#e.get(e);if(i&&(i.blockTypeUid!==t||i.fieldLayoutUid!==n||i.fieldLayoutHash!==r)&&(this.dispose(e),i=void 0),!i){let a=document.createElement(`div`);a.dataset.vizyFieldHost=``,a.contentEditable=`false`,i={blockUid:e,blockTypeUid:t,fieldLayoutUid:n,fieldLayoutHash:r,status:`idle`,root:a,abortController:null,requestId:null,requestKey:null,response:null,errorMessage:null,capturedValues:new Map,pending:null,disposals:[],attachedViewCount:0,removed:!1},this.#e.set(e,i)}return i.removed=!1,i}acquire(e,t=``,n=null,r=null){let i=this.ensure(e,t,n,r);return i.attachedViewCount+=1,i}roots(e){let t=this.#e.get(e);return t?[t.root]:[]}releaseView(e){let t=this.#e.get(e);t&&(t.attachedViewCount=Math.max(0,t.attachedViewCount-1))}get(e){return this.#e.get(e)}reconcile(e){for(let[t,n]of this.#e)e.has(t)||(n.removed=!0,this.dispose(t))}dispose(e){let t=this.#e.get(e);if(t&&(this.#e.delete(e),t.status!==`disposed`)){t.status=`disposed`,t.abortController?.abort();for(let e of t.disposals.splice(0))e();t.root.remove()}}destroy(){for(let e of[...this.#e.keys()])this.dispose(e)}},Vo=`:scope > .flex-fields`;function Ho(e){let t=[...e.querySelectorAll(Vo)];return t.forEach((e,t)=>{e instanceof HTMLElement&&(e.dataset.vizyLayoutTabIndex=String(t))}),t.length}function Uo(e,t,n){for(let n of e.root.querySelectorAll(Vo)){if(!(n instanceof HTMLElement))continue;let e=Number(n.dataset.vizyLayoutTabIndex??`0`);n.classList.toggle(`hidden`,e!==t)}}var Wo=new Set,Go=new Set;function Ko(e){return e.replace(/&/g,`&amp;`)}function qo(){if(Wo.size)return Wo;for(let e of document.querySelectorAll(`link[href]`))Wo.add(Ko(e.href));return Wo}function Jo(){if(Go.size)return Go;for(let e of document.querySelectorAll(`script[src]`))Go.add(Ko(e.src));return Go}function Yo(e){let t=e.trim();if(!t)return[];let n=window.jQuery;if(typeof n?.parseHTML==`function`)return n.parseHTML(t,document,!0)??[];let r=document.createElement(`template`);return r.innerHTML=t,[...r.content.childNodes]}function Xo(e){let t=e.href;if(!t)return;let n=Ko(t),r=qo();r.has(n)||(r.add(n),document.head.appendChild(e))}function Zo(e,t){let n=e.getAttribute(`src`);if(n){let r=Ko(e.src||n),i=Jo();if(i.has(r))return;i.add(r);let a=document.createElement(`script`);for(let t of Array.from(e.attributes))a.setAttribute(t.name,t.value);t.appendChild(a);return}let r=document.createElement(`script`);for(let t of Array.from(e.attributes))r.setAttribute(t.name,t.value);r.textContent=e.textContent,t.appendChild(r)}function Qo(e,t=document.body){if(!e?.trim())return;let n=Yo(e);for(let e of n){if(!(e instanceof Element)){t.appendChild(e);continue}if(e.nodeName===`LINK`&&e.rel===`stylesheet`){Xo(e);continue}if(e.nodeName===`SCRIPT`){Zo(e,t);continue}if(e.nodeName===`STYLE`||e.nodeName===`LINK`){document.head.appendChild(e);continue}t.appendChild(e)}}var $o=`dismissedTips`,es=`data-vizy-tip-uid`;function ts(){let e=window.Craft;if(typeof e?.getLocalStorage==`function`){let t=e.getLocalStorage($o,[]);return Array.isArray(t)?t.filter(e=>typeof e==`string`):[]}try{let e=window.Craft?.systemUid??``,t=localStorage.getItem(`Craft-${e}.${$o}`);if(!t)return[];let n=JSON.parse(t);return Array.isArray(n)?n.filter(e=>typeof e==`string`):[]}catch{return[]}}function ns(e){let t=window.Craft,n=ts();if(n.includes(e))return;let r=[...n,e];if(typeof t?.setLocalStorage==`function`){t.setLocalStorage($o,r);return}try{let e=window.Craft?.systemUid??``;localStorage.setItem(`Craft-${e}.${$o}`,JSON.stringify(r))}catch{}}function rs(e){let t=e.getAttribute(es);if(t)return t;let n=e.getAttribute(`data-layout-element`);if(n&&n!==`true`&&n!==`1`)return n;for(let t of e.querySelectorAll(`script`)){let e=t.textContent?.match(/\.includes\('([^']+)'\)/);if(e?.[1])return e[1]}return null}function is(e){return!!e.querySelector(`.pane.dismissible`)}function as(e){let t=new Set(ts());for(let n of[...e.querySelectorAll(`[data-layout-element]`)]){if(!is(n))continue;let e=rs(n);e&&n.setAttribute(es,e);for(let e of[...n.querySelectorAll(`script`)])e.textContent?.includes(`dismissedTips`)&&e.remove();e&&t.has(e)&&n.remove()}}function os(e){as(e);let t=t=>{let n=t.target;if(!(n instanceof Element))return;let r=n.closest(`.tip-dismiss-btn`);if(!r||!e.contains(r))return;t.preventDefault(),t.stopPropagation();let i=r.closest(`[data-layout-element]`);if(!i||!e.contains(i)||!is(i))return;let a=rs(i);i.remove(),a&&ns(a)};return e.addEventListener(`click`,t),()=>e.removeEventListener(`click`,t)}var ss=class extends Error{code;authorMessage;constructor(e,t){let n=(t??``).trim()||cs(e);super(n),this.name=`FieldLayoutMountError`,this.code=e,this.authorMessage=n}};function cs(e){switch(e){case`unsupportedFieldCapability`:return`This Block includes a field type Vizy cannot render inside Blocks yet.`;case`fieldLayoutRenderFailed`:return`This Block’s fields failed to render.`;case`unknownBlockType`:return`This Block’s type is missing or no longer allowed on this field.`;case`staleLayout`:return`This Block’s field layout is missing. Re-save the Block Type.`;case`staleFieldLayoutResponse`:return`This Block’s fields went out of date while loading. Try Retry.`;case`fieldLayoutRejected`:case`missingBatchResult`:case`invalidBlock`:case`invalidDestination`:case`staleBlockHash`:return`This Block could not load its fields. Reload the page and try again.`;case`fieldHostDisconnected`:return`This Block’s fields could not initialize. Reload the page and try again.`;case`loaderDestroyed`:case`blockRemoved`:return`This Block was removed before its fields finished loading.`;default:return e.startsWith(`fieldLayoutRequest:`)?`This Block could not load its fields (HTTP ${e.slice(19)}).`:`This Block could not load its fields (${e}).`}}function ls(e){if(e instanceof ss)return e.authorMessage;if(e instanceof Error){let t=e.message.trim();return t?/^[a-zA-Z][a-zA-Z0-9]+$/.test(t)||t.startsWith(`fieldLayoutRequest:`)?cs(t):t:cs(`fieldLayoutRejected`)}return String(e)}var us=new Set,ds=new TextEncoder,fs=25;async function ps(e){let t=(e,t)=>{let n=ds.encode(e),r=ds.encode(t);for(let e=0;e<Math.min(n.length,r.length);e++)if(n[e]!==r[e])return n[e]-r[e];return n.length-r.length},n=e=>Array.isArray(e)?`[${e.map(n).join(`,`)}]`:e&&typeof e==`object`?`{${Object.entries(e).filter(([,e])=>e!==void 0).sort(([e],[n])=>t(e,n)).map(([e,t])=>`${JSON.stringify(e)}:${n(t)}`).join(`,`)}}`:JSON.stringify(e)??`null`,r=n(e),i=await crypto.subtle.digest(`SHA-256`,ds.encode(r));return[...new Uint8Array(i)].map(e=>e.toString(16).padStart(2,`0`)).join(``)}var ms=class{hosts;manifest;contextToken;findBlock;onMounted;constructor(e,t,n,r,i){this.hosts=e,this.manifest=t,this.contextToken=n,this.findBlock=r,this.onMounted=i}#e=[];#t=null;#n=new Set;#r=new Map;#i=new Set;#a=new Map;#o=!1;destroy(){this.#o=!0,this.#t!==null&&window.clearTimeout(this.#t),this.#t=null,this.#r.clear(),this.#a.clear();for(let e of this.#n)e.abort();this.#n.clear();for(let e of this.#e.splice(0))e.reject(Error(`loaderDestroyed`))}async prefetchNewBlock(e){await this.prefetchNewBlocks([e])}async prefetchNewBlocks(e){if(this.#o)throw Error(`loaderDestroyed`);let t=e.filter(e=>!!this.manifest.blockTypes[e.blockTypeUid]?.fieldLayoutUid);if(!t.length)return;let n=await Promise.all(t.map(async e=>({item:e,blockHash:await ps(e.block),requestId:crypto.randomUUID()})));for(let e=0;e<n.length;e+=fs){let t=n.slice(e,e+fs),r=new AbortController;this.#n.add(r);try{let e=await this.#d({editorContextToken:this.contextToken,items:t.map(({item:e,blockHash:t,requestId:n})=>({requestId:n,documentRevision:e.documentRevision,blockHash:t,block:e.block,destination:e.destination}))},r.signal),n=new Map(e.results.map(e=>[e.requestId,e]));for(let{item:e,requestId:r}of t){let t=n.get(r);if(!t||t.ok===!1)throw new ss((t&&t.ok===!1?t.error:null)??`fieldLayoutRejected`,t&&t.ok===!1?t.message:null);this.#a.set(e.blockUid,t)}}finally{this.#n.delete(r)}}}open(e){let t=this.hosts.get(e);if(!t||t.status===`disposed`)return Promise.reject(Error(`blockRemoved`));if(t.status===`mounted`)return Promise.resolve(t);if(t.status===`loading`&&t.pending){let n=this.findBlock(e);if(!n)return Promise.reject(Error(`blockRemoved`));let r=`${e}:${n.revision}`,i=this.#r.get(r);if(i?.record===t)return i.promise;if(t.requestKey?.startsWith(`${n.revision}:`))return t.pending}let n=this.#a.get(e);if(n){this.#a.delete(e);let r=this.#f(t,n);return t.pending=r.finally(()=>{t.pending===r&&(t.pending=null)}),t.pending}let r=this.findBlock(e);if(!r)return Promise.reject(Error(`blockRemoved`));let i=`${e}:${r.revision}`,a=this.#r.get(i);if(a?.record===t)return a.promise;t.status=`loading`,t.errorMessage=null;let o=this.#s(e).finally(()=>{this.#r.get(i)?.promise===o&&this.#r.delete(i)});return this.#r.set(i,{record:t,promise:o}),o}retry(e){let t=this.hosts.get(e);if(!t||t.status===`disposed`)return Promise.reject(Error(`blockRemoved`));if(t.status===`mounted`)return Promise.resolve(t);t.abortController?.abort(),t.abortController=null,t.pending=null,t.requestId=null,t.requestKey=null,t.errorMessage=null,t.status=`idle`;let n=this.findBlock(e);return n&&this.#r.delete(`${e}:${n.revision}`),this.open(e)}async#s(e){let t=this.hosts.get(e),n=this.findBlock(e);if(!t||!n||t.status===`disposed`)throw Error(`blockRemoved`);if(t.status===`mounted`)return t;let r=n.node.toJSON(),i=ps(r);this.#i.add(i);let a;try{a=await i}finally{this.#i.delete(i)}if(this.#o||this.hosts.get(e)!==t)throw Error(`blockRemoved`);let o=this.manifest.blockTypes[String(n.node.attrs.blockTypeUid)];if(!o?.fieldLayoutUid)return t;let s=`${n.revision}:${a}:${o.fieldLayoutUid}:${o.fieldLayoutHash??``}`;if(t.status===`loading`&&t.requestKey===s&&t.pending)return t.pending;t.abortController?.abort();let c=new AbortController,l=crypto.randomUUID();return t.status=`loading`,t.abortController=c,t.requestId=l,t.requestKey=s,t.pending=this.#c({blockUid:e,requestId:l,blockHash:a,record:t,payload:{requestId:l,documentRevision:n.revision,blockHash:a,block:r,destination:n.destination}}).then(n=>{let r=this.findBlock(e),i=this.manifest.blockTypes[String(r?.node.attrs.blockTypeUid)];if(t.status===`disposed`||t.requestId!==n.requestId||!r||n.blockUid!==e||n.blockTypeUid!==String(r.node.attrs.blockTypeUid)||n.documentRevision!==r.revision||n.blockHash!==a||n.fieldLayoutUid!==i?.fieldLayoutUid||n.fieldLayoutHash!==i?.fieldLayoutHash)throw Error(`staleFieldLayoutResponse`);return this.#f(t,n)}).catch(n=>{throw t.status!==`disposed`&&t.requestId===l&&!c.signal.aborted&&(t.status=`failed`,t.errorMessage=ls(n),console.error(`[Vizy] FieldLayout failed for block ${e}`,n)),n}).finally(()=>{t.requestId===l&&(t.pending=null)}),t.pending}#c(e){return new Promise((t,n)=>{if(this.#o){n(Error(`loaderDestroyed`));return}this.#e.push({...e,resolve:t,reject:n}),this.#t===null&&(this.#t=window.setTimeout(async()=>{await Promise.allSettled([...this.#i]),this.#t=null,this.#o||this.#l()},0))})}#l(){let e=this.#e.splice(0);for(let t=0;t<e.length;t+=fs)this.#u(e.slice(t,t+fs))}async#u(e){let t=new AbortController;this.#n.add(t);try{let n=await this.#d({editorContextToken:this.contextToken,items:e.map(e=>e.payload)},t.signal),r=new Map(n.results.map(e=>[e.requestId,e]));for(let t of e){let e=r.get(t.requestId);e?e.ok===!1?t.reject(new ss(e.error??`fieldLayoutRejected`,e.message)):t.resolve(e):t.reject(new ss(`missingBatchResult`))}}catch(t){for(let n of e)n.reject(t)}finally{this.#n.delete(t)}}async#d(e,t){if(window.Craft?.sendActionRequest){let n=await window.Craft.sendActionRequest(`POST`,`vizy/field-layout/render-batch`,{data:e,headers:{"Content-Type":`application/json`},signal:t});if(t.aborted)throw new DOMException(`Aborted`,`AbortError`);return n.data}let n=await fetch(`/actions/vizy/field-layout/render-batch`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(e),signal:t});if(!n.ok)throw Error(`fieldLayoutRequest:${n.status}`);return n.json()}adoptInitial(e){let t=this.hosts.get(e.blockUid),n=this.findBlock(e.blockUid),r=n?this.manifest.blockTypes[String(n.node.attrs.blockTypeUid)]:void 0;return!t||!n||t.status===`disposed`||e.blockTypeUid!==String(n.node.attrs.blockTypeUid)||e.fieldLayoutUid!==r?.fieldLayoutUid||e.fieldLayoutHash!==r?.fieldLayoutHash?null:t.status===`mounted`?t:(t.abortController?.abort(),t.requestId=null,t.requestKey=null,this.#f(t,e),t)}adoptInitialFailure(e){let t=e.blockUid;if(!t)return null;let n=this.hosts.get(t),r=this.findBlock(t);return!n||!r||n.status===`disposed`||n.status===`mounted`?null:(n.abortController?.abort(),n.requestId=null,n.requestKey=null,n.status=`failed`,n.errorMessage=ls(new ss(e.error,e.message)),n.root.innerHTML=``,console.error(`[Vizy] Initial FieldLayout failed for block ${t}`,e),this.#g(n),n)}#f(e,t){return e.root.isConnected?(this.#p(e,t),Promise.resolve(e)):(e.status=`loading`,e.errorMessage=null,new Promise(n=>{let r=r=>{if(e.status===`disposed`){n(e);return}r&&e.root.isConnected?this.#p(e,t):this.#m(e,new ss(`fieldHostDisconnected`,`Block fields could not initialize because the field host was not in the document.`)),n(e)};queueMicrotask(()=>{if(e.status===`disposed`){n(e);return}if(e.root.isConnected){r(!0);return}requestAnimationFrame(()=>r(e.root.isConnected))})}))}#p(e,t){try{if(e.root.innerHTML=t.html,Ho(e.root),!e.root.isConnected)throw new ss(`fieldHostDisconnected`,`Block fields could not initialize because the field host was not in the document.`);let n=`${t.fieldLayoutHash}:${t.headHtml}`;t.headHtml&&!us.has(n)&&(Qo(t.headHtml,document.head),us.add(n)),Qo(t.bodyHtml,document.body),window.Craft?.initUiElements?.(e.root),e.response=t,e.errorMessage=null,e.status=`mounted`,this.#h(e,t),this.onMounted(e),e.disposals.push(os(e.root))}catch(t){this.#m(e,t)}}#m(e,t){e.status=`failed`,e.response=null,e.errorMessage=ls(t),e.root.innerHTML=``,console.error(`[Vizy] FieldLayout mount crashed for block ${e.blockUid}`,t),this.#g(e)}#h(e,t){let n=e.root.closest(`vizy-block`),r=t.tabLabels??[];n&&(n.layoutTabLabels=r,n.fieldLayoutError=null,n.fieldLayoutState=`mounted`),Uo(e,0)}#g(e){let t=e.root.closest(`vizy-block`);t&&(t.fieldLayoutState=`error`,t.fieldLayoutError=e.errorMessage,t.fieldLayoutRetrying=!1)}};function hs(e,t){let n=[];return e.descendants(e=>{e.type.name===`vizyBlock`&&t[String(e.attrs.blockTypeUid)]?.fieldLayoutUid&&n.push(String(e.attrs.blockUid))}),n}var gs=(e,t)=>{let n=()=>t();return e.addEventListener(`input`,n),e.addEventListener(`change`,n),()=>{e.removeEventListener(`input`,n),e.removeEventListener(`change`,n)}},_s=e=>{let t=e.querySelector(`input:not([type=hidden]), textarea, select`);if(!t)throw Error(`adapterControlMissing`);return t},vs={read:e=>_s(e).value,bind:gs},ys={read(e){let t=e.querySelector(`input[type=hidden]`);if(!t)throw Error(`adapterControlMissing`);return t.value===`1`},bind:gs},bs={read(e){let t=e.querySelector(`textarea`);if(!t)throw Error(`adapterControlMissing`);t.CodeMirror?.save?.();let n=t.value;if(n.trim()===``)return null;try{return JSON.parse(n)}catch(e){return{__ERROR__:e instanceof Error?e.message:`Invalid JSON`,__VALUE__:n}}},bind:gs},xs={read(e){return[...e.querySelectorAll(`input[type=hidden][name]`)].filter(e=>!e.disabled&&e.value!==``&&ws(e.name)).map(e=>e.value)},bind:gs},Ss={read(e){let t=(e.querySelector(`select[name*="[type]"], input[type="hidden"][name*="[type]"]`)?.value||``).trim()||`url`,n=(((e.querySelector(`[data-link-type="${CSS.escape(t)}"]`)??e.querySelector(`[data-link-type]:not(.hidden)`))?.querySelector(`input[name*="[value]"]`)??e.querySelector(`input[name*="[${CSS.escape(t)}][value]"]`))?.value||``).trim();if(!n)return null;let r={type:t,value:n};for(let t of[`label`,`urlSuffix`,`target`,`title`,`class`,`id`,`rel`,`ariaLabel`,`filename`]){let n=e.querySelector(`input[name*="[${t}]"], textarea[name*="[${t}]"]`);if(!n||n.disabled||!ws(n.name)||(n.type===`checkbox`||n.type===`radio`)&&!n.checked)continue;let i=n.value.trim();i!==``&&i!==`0`&&(r[t]=i)}let i=e.querySelector(`input[name*="[download]"]`);return i&&!i.disabled&&(i.checked||i.value===`1`)&&(r.download=!0),r},bind:gs},Cs={read:e=>Ts(e),bind:gs};function ws(e){return e!==``&&e!==`null`}function Ts(e){let t=[];for(let n of e.querySelectorAll(`input[name], textarea[name], select[name]`))if(!n.disabled&&ws(n.name)){if(n instanceof HTMLInputElement){let e=n.type;if(e===`button`||e===`submit`||e===`reset`||e===`image`||e===`file`||(e===`checkbox`||e===`radio`)&&!n.checked)continue}if(n instanceof HTMLSelectElement&&n.multiple){for(let e of n.selectedOptions)t.push({name:n.name,value:e.value});continue}t.push({name:n.name,value:n.value})}return t.length?ks(Es(t),t[0].name):null}function Es(e){let t={};for(let{name:n,value:r}of e){let e=Ds(n);e.length&&Os(t,e,r)}return t}function Ds(e){let t=[],n=/([^[\]]+)|\[([^\]]*)\]/g,r;for(;(r=n.exec(e))!==null;)t.push(r[1]??r[2]??``);return t}function Os(e,t,n){let r=e;for(let e=0;e<t.length;e++){let i=t[e],a=e===t.length-1,o=t[e+1],s=i===``||/^\d+$/.test(i);if(a){if(Array.isArray(r)){i===``?r.push(n):r[Number(i)]=n;return}if(!r||typeof r!=`object`)return;let e=r;e[i]=n;return}if(Array.isArray(r)){let e=i===``?r.length:Number(i);r[e]??(r[e]=o===``||o!==void 0&&/^\d+$/.test(o)?[]:{}),r=r[e];continue}if(!r||typeof r!=`object`)return;let c=r;c[i]??(c[i]=o===``||o!==void 0&&/^\d+$/.test(o)?[]:{}),(typeof c[i]!=`object`||c[i]===null)&&(c[i]=s?[]:{}),r=c[i]}}function ks(e,t){let n=Ds(t),r=n[0]===`vizyHost`&&n[3]===`fields`&&n[4]===`fields`?6:n[0]===`fields`?2:1,i=e;for(let e of n.slice(0,r)){if(!i||typeof i!=`object`)return null;i=i[e]}return i??null}var As=new Map([[`craft.plainText`,vs],[`craft.lightswitch`,ys],[`craft.json`,bs],[`craft.link`,Ss],[`craft.entries`,xs],[`craft.categories`,xs],[`craft.tags`,xs],[`craft.users`,xs],[`craft.assets`,xs],[`craft.generic`,Cs],[`craft.matrix`,Cs],[`vizy.hosted`,{read(e){let t=e.querySelector(`input[data-vizy-document]`),n={type:`doc`,attrs:{schemaVersion:2},content:[]},r=()=>{if(!t?.value)return n;try{return JSON.parse(t.value)}catch{throw Error(`hostedVizyDocumentInvalid`)}},i=e.querySelector(`vizy-editor`);if(!i?.editor||typeof i.flush!=`function`)return r();try{return JSON.parse(i.flush(`serialize`))}catch{return r()}},bind(e,t){let n=e.querySelector(`vizy-editor`);if(!n)return()=>{};let r=()=>t();return n.addEventListener(`input`,r),n.addEventListener(`change`,r),()=>{n.removeEventListener(`input`,r),n.removeEventListener(`change`,r)}}}]]);function js(e){let t=As.get(e)??As.get(`craft.generic`);if(!t)throw Error(`unsupportedFieldAdapter:${e}`);return t}var Ms=new Set([`blockUid`,`layoutUid`,`columnUid`,`linkUid`,`imageUid`,`tableUid`,`rowUid`,`cellUid`]);function Ns(e){if(!e||typeof e!=`object`||Array.isArray(e))return!1;let t=e;return t.type===`doc`&&!!t.attrs&&typeof t.attrs==`object`&&Array.isArray(t.content)}function Ps(e){return!!e&&typeof e==`object`&&!Array.isArray(e)&&`entries`in e&&typeof e.entries==`object`&&e.entries!==null&&!Array.isArray(e.entries)}function Fs(e,t){let n=new Map,r={};for(let[i,a]of Object.entries(e.entries)){if(!a||typeof a!=`object`||Array.isArray(a))continue;let e=t();n.set(i,e),i.startsWith(`uid:`)&&n.set(i.slice(4),e);let o={...a,uid:e};delete o.id,delete o.ownerId,delete o.canonicalId,r[e]=o}let i=[];for(let r of Array.isArray(e.sortOrder)?e.sortOrder:[]){let e=String(r);i.push(n.get(e)??n.get(`uid:${e}`)??t())}return i.length||i.push(...Object.keys(r)),{entries:r,sortOrder:i}}function Is(e,t=Ls,n={}){let r=new Map,i=e=>{let n=r.get(e);return n||(n=t(),r.set(e,n)),n},a=e=>{let r={...e.attrs??{}};for(let e of Ms)typeof r[e]==`string`&&r[e]!==``&&(r[e]=i(r[e]));if(e.type===`vizyBlock`){`matrixAnchorUid`in r&&(r.matrixAnchorUid=null);let e=r.fieldSlots;if(e&&typeof e==`object`&&!Array.isArray(e)){let i={};for(let[a,s]of Object.entries(e)){let e=n[String(r.blockTypeUid)]?.fieldSlotKinds?.[a];i[a]=e===`hosted`&&Ns(s)?o(s):e===`matrix`&&Ps(s)?Fs(s,t):s}r.fieldSlots=i}}let s=Array.isArray(e.content)?e.content.map(e=>e&&typeof e==`object`?a(e):e):e.content;return{...e,...e.attrs||Object.keys(r).length?{attrs:r}:{},...s===void 0?{}:{content:s}}},o=e=>({...e,content:Array.isArray(e.content)?e.content.map(e=>e&&typeof e==`object`?a(e):e):e.content});if(e&&typeof e==`object`&&!Array.isArray(e)){let t=e;return t.type===`doc`?o(t):a(t)}return e}function Ls(){if(typeof crypto.randomUUID==`function`)return crypto.randomUUID();let e=crypto.getRandomValues(new Uint8Array(16));e[6]=e[6]&15|64,e[8]=e[8]&63|128;let t=[...e].map(e=>e.toString(16).padStart(2,`0`));return`${t.slice(0,4).join(``)}-${t.slice(4,6).join(``)}-${t.slice(6,8).join(``)}-${t.slice(8,10).join(``)}-${t.slice(10).join(``)}`}function Rs(e,t,n){return Is(e,t,n)}var zs=new Set([`href`,`target`]),Bs=new Set([`src`,`width`,`height`]),Vs=new Set([`colwidth`]);function Hs(e,t){let n={};for(let[r,i]of Object.entries(e))t.has(r)||(n[r]=i);return n}function Us(e){return e&&e.map(e=>e.type!==`link`||!e.attrs?e:{...e,attrs:Hs(e.attrs,zs)})}function Ws(e,t){let n={...e};if(n.marks&&=Us(n.marks),n.type===`image`){let e=Hs(n.attrs??{},Bs),r=e.assetUid;if(typeof r!=`string`||!U(r))throw Error(`semanticImageMissingAssetUid at ${t}`);n.attrs=e}if(n.type===`table`){let e=n.attrs??{},r=e.columnWidths;if(r!=null){if(!Array.isArray(r))throw Error(`semanticTableInvalidColumnWidths at ${t}`);let i=r.map(e=>Number.parseInt(String(e),10));if(i.some(e=>!Number.isInteger(e)||e<1))throw Error(`semanticTableInvalidColumnWidths at ${t}`);if(Wi(i)!==1e3)throw Error(`semanticTableColumnWidthTotal at ${t}`);n.attrs={...e,columnWidths:i}}}return(n.type===`tableCell`||n.type===`tableHeader`)&&(n.attrs&&=Hs(n.attrs,Vs)),n.content&&=n.content.map((e,n)=>Ws(e,`${t}.content[${n}]`)),n}function Gs(e){return Ws(structuredClone(e),`$`)}var Ks=`application/x-vizy-opaque-slice+json`,qs=new Set([`unsupportedNode`,`unsupportedInlineNode`]),Js=Object.freeze({maxDocumentBytes:256e3,maxRawBytes:64e3,maxNodes:2e3,maxDepth:32,maxObjectDepth:128,maxObjectWidth:1024,maxPlaceholders:256,maxPlacementAttempts:2048}),Ys=Object.freeze({...Js,maxDocumentBytes:1/0,maxNodes:1/0,maxObjectWidth:1/0,maxObjectDepth:512}),K=class extends Error{code;path;constructor(e,t){super(`${e} at ${t}`),this.code=e,this.path=t}},Xs=e=>structuredClone(e),Zs=e=>new TextEncoder().encode(JSON.stringify(e)).length,Qs=e=>typeof e==`object`&&!!e&&!Array.isArray(e);function $s(e,t,n,r=0){if(r>n.maxObjectDepth)throw new K(`objectDepthExceeded`,t);if(Array.isArray(e)){if(e.length>n.maxObjectWidth)throw new K(`objectWidthExceeded`,t);e.forEach((e,i)=>$s(e,`${t}[${i}]`,n,r+1))}else if(Qs(e)){if(Object.keys(e).length>n.maxObjectWidth)throw new K(`objectWidthExceeded`,t);Object.entries(e).forEach(([e,i])=>$s(i,`${t}.${e}`,n,r+1))}else if(e!==null&&![`string`,`number`,`boolean`].includes(typeof e))throw new K(`nonJsonValue`,t);else if(typeof e==`number`&&!Number.isFinite(e))throw new K(`nonJsonValue`,t)}function ec(e,t,n,r,i=0,a=!1){if(!Qs(e)||typeof e.type!=`string`||!e.type)throw new K(`invalidNode`,t);if(!a&&qs.has(e.type))throw new K(`reservedCanonicalType`,t);if(++r.nodes>n.maxNodes)throw new K(`nodeCountExceeded`,t);if(i>n.maxDepth)throw new K(`nodeDepthExceeded`,t);if(`attrs`in e&&!Qs(e.attrs))throw new K(`invalidNodeAttrs`,`${t}.attrs`);if(`marks`in e){if(!Array.isArray(e.marks))throw new K(`invalidMarks`,`${t}.marks`);e.marks.forEach((e,n)=>{let r=`${t}.marks[${n}]`;if(!Qs(e)||typeof e.type!=`string`||!e.type)throw new K(`invalidMark`,r);if(`attrs`in e&&!Qs(e.attrs))throw new K(`invalidMarkAttrs`,`${r}.attrs`)})}if(e.type===`text`&&(typeof e.text!=`string`||!e.text))throw new K(`missingText`,t);if(e.type!==`text`&&`text`in e)throw new K(`nonTextNodeText`,t);if(`content`in e){if(!Array.isArray(e.content))throw new K(`invalidContent`,`${t}.content`);e.content.forEach((e,o)=>ec(e,`${t}.content[${o}]`,n,r,i+1,a))}}function tc(e,t,n){if(Number.isFinite(t.maxDocumentBytes)&&Zs(e)>t.maxDocumentBytes)throw new K(`documentBytesExceeded`,`$`);if($s(e,`$`,t),ec(e,`$`,t,{nodes:0},0,n),e.type!==`doc`)throw new K(`invalidDocumentRoot`,`$`)}var nc=(e,t)=>({opaque:!0,rawNode:Xs(e),reason:t}),rc=e=>`opaque`in e,ic=(e,t)=>({type:e,attrs:{transportVersion:1,reason:t.reason,originalType:t.rawNode.type,rawNode:Xs(t.rawNode)}}),ac=(e,t)=>{try{return e.nodeFromJSON(t).check(),!0}catch{return!1}};function oc(e,t,n,r){let i=n.flatMap((e,t)=>rc(e)?[t]:[]),a=[...n],o=0,s=c=>{if(++o>r.maxPlacementAttempts)throw new K(`placementAttemptsExceeded`,`$`);if(c===i.length)return ac(e,{...t,content:a});let l=i[c],u=n[l];for(let e of[`unsupportedInlineNode`,`unsupportedNode`])if(a[l]=ic(e,u),s(c+1))return!0;return!1};return s(0)?a:null}function sc(e,t,n,r={}){let i={...Ys,...r};tc(e,i,!1);let a=new Set(n.nodes),o=new Set(n.marks);if([...qs].some(e=>a.has(e)))throw new K(`reservedManifestType`,`$`);let s=0,c=e=>{if(!a.has(e.type))return nc(e,`unknownNode`);if(e.marks?.some(e=>!o.has(e.type)))return nc(e,`unknownMark`);if(!e.content)return Xs(e);let n=e.content.map(c),r=oc(t,e,n,i);if(!r)return nc(e,n.find(rc)?.reason??`unknownNode`);if(s+=n.filter(rc).length,s>i.maxPlaceholders)throw new K(`placeholderCountExceeded`,`$`);let{content:l,...u}=e;return{...Xs(u),content:r}},l=c(e);if(rc(l))throw new K(`noSafePlaceholderPlacement`,`$`);if(!ac(t,l))throw new K(`transportSchemaMismatch`,`$`);return l}function cc(e,t,n){if(Object.keys(e).sort().join(`,`)!==`attrs,type`||!Qs(e.attrs))throw new K(`invalidPlaceholderShape`,t);let r=e.attrs;if(Object.keys(r).sort().join(`,`)!==`originalType,rawNode,reason,transportVersion`)throw new K(`invalidPlaceholderAttrs`,`${t}.attrs`);if(r.transportVersion!==1)throw new K(`unsupportedTransportVersion`,t);if(![`unknownNode`,`unknownMark`].includes(String(r.reason)))throw new K(`invalidPlaceholderReason`,t);if(!Qs(r.rawNode)||r.originalType!==r.rawNode.type)throw new K(`placeholderTypeMismatch`,t);if(Zs(r.rawNode)>n.maxRawBytes)throw new K(`rawBytesExceeded`,t);return $s(r.rawNode,`${t}.attrs.rawNode`,n),ec(r.rawNode,`${t}.attrs.rawNode`,n,{nodes:0}),Xs(r.rawNode)}function lc(e,t={}){let n={...Ys,...t};tc(e,n,!0);let r=0,i=(e,t)=>{if(qs.has(e.type)){if(++r>n.maxPlaceholders)throw new K(`placeholderCountExceeded`,t);return cc(e,t,n)}let{content:a,...o}=e,s=Xs(o);return a&&(s.content=a.map((e,n)=>i(e,`${t}.content[${n}]`))),s},a=i(e,`$`);(!(`content`in a)||a.content===void 0)&&(a.content=[]),tc(a,n,!1);try{return uc(Gs(a))}catch(e){throw new K(e instanceof Error?e.message.split(` `)[0]:`semanticSanitizeFailed`,`$`)}}function uc(e){let t=e;if(Qs(t.attrs)){let e=Object.entries(t.attrs).filter(([,e])=>e!==null);e.length!==Object.keys(t.attrs).length&&(e.length===0?delete t.attrs:t.attrs=Object.fromEntries(e))}return t.marks?.forEach(e=>uc(e)),t.content?.forEach(e=>uc(e)),t}function dc(e,t={}){let n={...Js,...t};if(!Qs(e)||Object.keys(e).some(e=>![`content`,`openStart`,`openEnd`].includes(e))||!Array.isArray(e.content)||`openStart`in e&&!Number.isInteger(e.openStart)||`openEnd`in e&&!Number.isInteger(e.openEnd)||Number(e.openStart??0)<0||Number(e.openEnd??0)<0)throw new K(`invalidSliceShape`,`$clipboard`);if(Zs(e)>n.maxDocumentBytes)throw new K(`documentBytesExceeded`,`$clipboard`);let r={nodes:0},i=0;e.content.forEach((e,t)=>{$s(e,`$clipboard.content[${t}]`,n),ec(e,`$clipboard.content[${t}]`,n,r,0,!0)});let a=(e,t)=>{let r=e;if(qs.has(r.type)){if(++i>n.maxPlaceholders)throw new K(`placeholderCountExceeded`,t);cc(r,t,n);return}r.content?.forEach((e,n)=>a(e,`${t}.content[${n}]`))};return e.content.forEach((e,t)=>a(e,`$clipboard.content[${t}]`)),{...Xs(e),content:Xs(e.content),openStart:Number(e.openStart??0),openEnd:Number(e.openEnd??0)}}function fc(e,t){return D.create({name:e,inline:t,group:t?`inline`:`block`,atom:!0,selectable:!0,draggable:!t,addAttributes:()=>({transportVersion:{default:null,rendered:!1},reason:{default:null,rendered:!1},originalType:{default:null,rendered:!1},rawNode:{default:null,rendered:!1}}),parseHTML:()=>[],renderHTML:()=>[t?`span`:`div`,{class:t?`vizy-unsupported-inline`:`vizy-unsupported-block`,contenteditable:`false`,"aria-label":t?`Unsupported formatting`:`Unsupported content`},t?`Unsupported formatting`:`Unsupported content`]})}var pc=fc(`unsupportedNode`,!1),mc=fc(`unsupportedInlineNode`,!0),hc=S.create({name:`opaqueClipboard`,addOptions:()=>({schemaIdentity:{}}),addProseMirrorPlugins(){let e=this.options.schemaIdentity,t=this.options.beforeCopy,n=(e,n,r)=>{let i=n.clipboardData,a=JSON.stringify(e.state.selection.content().toJSON());if(!i||!a.includes(`"unsupported`)&&!a.includes(`"blockUid"`))return!1;try{t?.(),a=JSON.stringify(e.state.selection.content().toJSON()),r&&dc(JSON.parse(a))}catch(t){return n.preventDefault(),e.dom.dispatchEvent(new CustomEvent(`vizy-clipboard-rejected`,{bubbles:!0,detail:{code:t instanceof K?t.code:`fieldCaptureFailed`}})),!0}let o=a.includes(`"unsupported`)?`Unsupported content`:`Vizy content`;return i.setData(Ks,a),i.setData(`text/plain`,o),i.setData(`text/html`,`<span class="vizy-private-clipboard">${o}</span>`),n.preventDefault(),r&&e.editable&&e.dispatch(e.state.tr.deleteSelection().setMeta(`uiEvent`,`cut`).scrollIntoView()),!0};return[new C({props:{handleDOMEvents:{copy:(e,t)=>n(e,t,!1),cut:(e,t)=>n(e,t,!0),paste(t,n){let r=n.clipboardData?.getData(Ks);if(!r)return!1;n.preventDefault();try{let n=Is(dc(JSON.parse(r)),void 0,e),i=j.fromJSON(t.state.schema,n);t.dispatch(t.state.tr.replaceSelection(i).scrollIntoView())}catch(e){t.dom.dispatchEvent(new CustomEvent(`vizy-clipboard-rejected`,{bubbles:!0,detail:{code:e instanceof K?e.code:`invalidPrivateSlice`}}))}return!0}}}})]}}),gc=new WeakSet,_c=new WeakSet;function vc(e){let t=e;return gc.add(t),t}function yc(e){return Array.isArray(e)&&gc.has(e)}function bc(e){return e.flatMap(e=>e==null?[]:Array.isArray(e)&&_c.has(e)&&!yc(e)?bc(e):[e])}function xc(e,t){if(e===`slot`)return 0;if(e instanceof Function){let n=e(t);return Array.isArray(n)&&!yc(n)&&!_c.has(n)?vc(n):n}let{children:n,...r}=t??{};if(e===`svg`)throw Error(`SVG elements are not supported in the JSX syntax, use the array syntax instead`);if(Array.isArray(n)){if(yc(n))return vc([e,r,n]);if(n.length===0)return vc([e,r]);let t=bc(n);return t.length===0?vc([e,r]):vc([e,r,...t])}return vc(n==null?[e,r]:[e,r,n])}var Sc=(e,t)=>xc(e,t),Cc=(e,t)=>{let{state:n}=e,{selection:r}=n;if(!r.empty)return!1;let{$from:i}=r;if(i.parentOffset!==0)return!1;let a=i.depth-1;if(a<0)return!1;let o=i.node(a),s=i.index(a);if(s===0)return!1;if(o.type===t)return e.commands.lift(t.name);let c=o.child(s-1);if(c.type!==t||!c.lastChild?.isTextblock)return!1;let l=i.before()-1-1;return e.commands.command(({tr:e,dispatch:t})=>{if(!t)return!0;let n=i.parent.content,r=new j(n,0,0);return e.replace(l,i.after(),r),e.setSelection(E.create(e.doc,l+n.size)),e.scrollIntoView(),t(e),!0})},wc=/^\s*>\s$/,Tc=D.create({name:`blockquote`,addOptions(){return{HTMLAttributes:{}}},content:`block+`,group:`block`,defining:!0,parseHTML(){return[{tag:`blockquote`}]},renderHTML({HTMLAttributes:e}){return Sc(`blockquote`,{...w(this.options.HTMLAttributes,e),children:Sc(`slot`,{})})},parseMarkdown:(e,t)=>{let n=t.parseBlockChildren??t.parseChildren;return t.createNode(`blockquote`,void 0,n(e.tokens||[]))},renderMarkdown:(e,t)=>{if(!e.content)return``;let n=[];return e.content.forEach((e,r)=>{let i=(t.renderChild?.call(t,e,r)??t.renderChildren([e])).split(`
`).map(e=>e.trim()===``?`>`:`> ${e}`);n.push(i.join(`
`))}),n.join(`
>
`)},addCommands(){return{setBlockquote:()=>({commands:e})=>e.wrapIn(this.name),toggleBlockquote:()=>({commands:e})=>e.toggleWrap(this.name),unsetBlockquote:()=>({commands:e})=>e.lift(this.name)}},addKeyboardShortcuts(){return{"Mod-Shift-b":()=>this.editor.commands.toggleBlockquote(),Backspace:()=>Cc(this.editor,this.type)}},addInputRules(){return[st({find:wc,type:this.type})]}}),Ec=/(?:^|\s)(\*\*(?!\s+\*\*)((?:[^*]+))\*\*(?!\s+\*\*))$/,Dc=/(?:^|\s)(\*\*(?!\s+\*\*)((?:[^*]+))\*\*(?!\s+\*\*))/g,Oc=/(?:^|\s)(__(?!\s+__)((?:[^_]+))__(?!\s+__))$/,kc=/(?:^|\s)(__(?!\s+__)((?:[^_]+))__(?!\s+__))/g,Ac=Ee.create({name:`bold`,addOptions(){return{HTMLAttributes:{}}},parseHTML(){return[{tag:`strong`},{tag:`b`,getAttrs:e=>e.style.fontWeight!==`normal`&&null},{style:`font-weight=400`,clearMark:e=>e.type.name===this.name},{style:`font-weight`,getAttrs:e=>/^(bold(er)?|[5-9]\d{2,})$/.test(e)&&null}]},renderHTML({HTMLAttributes:e}){return Sc(`strong`,{...w(this.options.HTMLAttributes,e),children:Sc(`slot`,{})})},markdownTokenName:`strong`,parseMarkdown:(e,t)=>t.applyMark(`bold`,t.parseInline(e.tokens||[])),markdownOptions:{htmlReopen:{open:`<strong>`,close:`</strong>`}},renderMarkdown:(e,t)=>`**${t.renderChildren(e)}**`,addCommands(){return{setBold:()=>({commands:e})=>e.setMark(this.name),toggleBold:()=>({commands:e})=>e.toggleMark(this.name),unsetBold:()=>({commands:e})=>e.unsetMark(this.name)}},addKeyboardShortcuts(){return{"Mod-b":()=>this.editor.commands.toggleBold(),"Mod-B":()=>this.editor.commands.toggleBold()}},addInputRules(){return[Oe({find:Ec,type:this.type}),Oe({find:Oc,type:this.type})]},addPasteRules(){return[de({find:Dc,type:this.type}),de({find:kc,type:this.type})]}}),jc=e=>{let t=/`([^`]+)`(?!`)$/.exec(e);return!t||t.index>0&&e[t.index-1]==="`"?null:{index:t.index,text:t[0],replaceWith:t[1]}},Mc=e=>{let t=/`([^`]+)`(?!`)/g,n=[],r;for(;(r=t.exec(e))!==null;)r.index>0&&e[r.index-1]==="`"||n.push({index:r.index,text:r[0],replaceWith:r[1]});return n},Nc=Ee.create({name:`code`,addOptions(){return{HTMLAttributes:{}}},excludes:`_`,code:!0,exitable:!0,parseHTML(){return[{tag:`code`}]},renderHTML({HTMLAttributes:e}){return[`code`,w(this.options.HTMLAttributes,e),0]},markdownTokenName:`codespan`,parseMarkdown:(e,t)=>t.applyMark(`code`,[{type:`text`,text:e.text||``}]),renderMarkdown:(e,t)=>e.content?`\`${t.renderChildren(e.content)}\``:``,addCommands(){return{setCode:()=>({commands:e})=>e.setMark(this.name),toggleCode:()=>({commands:e})=>e.toggleMark(this.name),unsetCode:()=>({commands:e})=>e.unsetMark(this.name)}},addKeyboardShortcuts(){return{"Mod-e":()=>this.editor.commands.toggleCode()}},addInputRules(){return[Oe({find:jc,type:this.type})]},addPasteRules(){return[de({find:Mc,type:this.type})]}}),Pc=4,Fc=/^```([a-z]+)?[\s\n]$/,Ic=/^~~~([a-z]+)?[\s\n]$/,Lc=D.create({name:`codeBlock`,addOptions(){return{languageClassPrefix:`language-`,exitOnTripleEnter:!0,exitOnArrowDown:!0,exitOnArrowUp:!0,defaultLanguage:null,enableTabIndentation:!1,tabSize:Pc,HTMLAttributes:{}}},content:`text*`,marks:``,group:`block`,code:!0,defining:!0,addAttributes(){return{language:{default:this.options.defaultLanguage,parseHTML:e=>{let{languageClassPrefix:t}=this.options;return t&&[...e.firstElementChild?.classList||[]].filter(e=>e.startsWith(t)).map(e=>e.replace(t,``))[0]||null},rendered:!1}}},parseHTML(){return[{tag:`pre`,preserveWhitespace:`full`}]},renderHTML({node:e,HTMLAttributes:t}){return[`pre`,w(this.options.HTMLAttributes,t),[`code`,{class:e.attrs.language?this.options.languageClassPrefix+e.attrs.language:null},0]]},markdownTokenName:`code`,parseMarkdown:(e,t)=>e.raw?.startsWith("```")===!1&&e.raw?.startsWith(`~~~`)===!1&&e.codeBlockStyle!==`indented`?[]:t.createNode(`codeBlock`,{language:e.lang||null},e.text?[t.createTextNode(e.text)]:[]),renderMarkdown:(e,t)=>{let n=``,r=e.attrs?.language||``;return n=e.content?[`\`\`\`${r}`,t.renderChildren(e.content),"```"].join(`
`):`\`\`\`${r}\n\n\`\`\``,n},addCommands(){return{setCodeBlock:e=>({commands:t})=>t.setNode(this.name,e),toggleCodeBlock:e=>({commands:t})=>t.toggleNode(this.name,`paragraph`,e)}},addKeyboardShortcuts(){return{"Mod-Alt-c":()=>this.editor.commands.toggleCodeBlock(),Backspace:()=>{let{empty:e,$anchor:t}=this.editor.state.selection,n=t.pos===1;return!e||t.parent.type.name!==this.name?!1:n||!t.parent.textContent.length?this.editor.commands.clearNodes():!1},Tab:({editor:e})=>{if(!this.options.enableTabIndentation)return!1;let t=this.options.tabSize??Pc,{state:n}=e,{selection:r}=n,{$from:i,empty:a}=r;if(i.parent.type!==this.type)return!1;let o=` `.repeat(t);return a?e.commands.insertContent(o):e.commands.command(({tr:e})=>{let{from:t,to:i}=r,a=n.doc.textBetween(t,i,`
`,`
`).split(`
`).map(e=>o+e).join(`
`);return e.replaceWith(t,i,n.schema.text(a)),!0})},"Shift-Tab":({editor:e})=>{if(!this.options.enableTabIndentation)return!1;let t=this.options.tabSize??Pc,{state:n}=e,{selection:r}=n,{$from:i,empty:a}=r;return i.parent.type===this.type?a?e.commands.command(({tr:e})=>{let{pos:r}=i,a=i.start(),o=i.end(),s=n.doc.textBetween(a,o,`
`,`
`).split(`
...
`);return!a||!o?!1:e.chain().command(({tr:e})=>(e.delete(r.pos-2,r.pos),!0)).exitCode().run()},ArrowUp:({editor:e})=>{if(!this.options.exitOnArrowUp)return!1;let{state:t}=e,{selection:n}=t,{$from:r,empty:i}=n;if(!i||r.parent.type!==this.type||r.parentOffset!==0)return!1;let a=r.before();return a>0?!1:e.commands.insertDefaultBlock({pos:a})},ArrowDown:({editor:e})=>{if(!this.options.exitOnArrowDown)return!1;let{state:t}=e,{selection:n,doc:r}=t,{$from:i,empty:a}=n;if(!a||i.parent.type!==this.type||i.parentOffset!==i.parent.nodeSize-2)return!1;let o=i.after();return o===void 0?!1:r.nodeAt(o)?e.commands.command(({tr:e})=>(e.setSelection(k.near(r.resolve(o))),!0)):e.commands.exitCode()}}},addInputRules(){return[He({find:Fc,type:this.type,getAttributes:e=>({language:e[1]})}),He({find:Ic,type:this.type,getAttributes:e=>({language:e[1]})})]},addProseMirrorPlugins(){return[new C({key:new T(`codeBlockVSCodeHandler`),props:{handlePaste:(e,t)=>{if(!t.clipboardData||this.editor.isActive(this.type.name))return!1;let n=t.clipboardData.getData(`text/plain`),r=t.clipboardData.getData(`vscode-editor-data`),i=(r?JSON.parse(r):void 0)?.mode;if(!n||!i)return!1;let{tr:a,schema:o}=e.state,s=o.text(n.replace(/\r\n?/g,`
`));return a.replaceSelectionWith(this.type.create({language:i},s)),a.selection.$from.parent.type!==this.type&&a.setSelection(E.near(a.doc.resolve(Math.max(0,a.selection.from-2)))),a.setMeta(`paste`,!0),e.dispatch(a),!0}}})]}}),Rc=D.create({name:`hardBreak`,markdownTokenName:`br`,addOptions(){return{keepMarks:!0,HTMLAttributes:{}}},inline:!0,group:`inline`,selectable:!1,linebreakReplacement:!0,parseHTML(){return[{tag:`br`}]},renderHTML({HTMLAttributes:e}){return[`br`,w(this.options.HTMLAttributes,e)]},renderText(){return`
`},renderMarkdown:()=>`  
`,parseMarkdown:()=>({type:`hardBreak`}),addCommands(){return{setHardBreak:()=>({commands:e,chain:t,state:n,editor:r})=>e.first([()=>e.exitCode(),()=>e.command(()=>{let{selection:e,storedMarks:i}=n;if(e.$from.parent.type.spec.isolating)return!1;let{keepMarks:a}=this.options,{splittableMarks:o}=r.extensionManager,s=i||e.$to.parentOffset&&e.$from.marks();return t().insertContent({type:this.name}).command(({tr:e,dispatch:t})=>{if(t&&s&&a){let t=s.filter(e=>o.includes(e.type.name));e.ensureMarks(t)}return!0}).scrollIntoView().run()})])}},addKeyboardShortcuts(){return{"Mod-Enter":()=>this.editor.commands.setHardBreak(),"Shift-Enter":()=>this.editor.commands.setHardBreak()}}}),zc=D.create({name:`heading`,addOptions(){return{levels:[1,2,3,4,5,6],HTMLAttributes:{}}},content:`inline*`,group:`block`,defining:!0,addAttributes(){return{level:{default:1,rendered:!1}}},parseHTML(){return this.options.levels.map(e=>({tag:`h${e}`,attrs:{level:e}}))},renderHTML({node:e,HTMLAttributes:t}){return[`h${this.options.levels.includes(e.attrs.level)?e.attrs.level:this.options.levels[0]}`,w(this.options.HTMLAttributes,t),0]},parseMarkdown:(e,t)=>t.createNode(`heading`,{level:e.depth||1},t.parseInline(e.tokens||[])),renderMarkdown:(e,t)=>{let n=e.attrs?.level?parseInt(e.attrs.level,10):1,r=`#`.repeat(n);return e.content?`${r} ${t.renderChildren(e.content)}`:``},addCommands(){return{setHeading:e=>({commands:t})=>this.options.levels.includes(e.level)?t.setNode(this.name,e):!1,toggleHeading:e=>({commands:t})=>this.options.levels.includes(e.level)?t.toggleNode(this.name,`paragraph`,e):!1}},addKeyboardShortcuts(){return this.options.levels.reduce((e,t)=>({...e,[`Mod-Alt-${t}`]:()=>this.editor.commands.toggleHeading({level:t})}),{})},addInputRules(){return this.options.levels.map(e=>He({find:RegExp(`^(#{${Math.min(...this.options.levels)},${e}})\\s$`),type:this.type,getAttributes:{level:e}}))}}),Bc=D.create({name:`horizontalRule`,addOptions(){return{HTMLAttributes:{},nextNodeType:`paragraph`}},group:`block`,parseHTML(){return[{tag:`hr`}]},renderHTML({HTMLAttributes:e}){return[`hr`,w(this.options.HTMLAttributes,e)]},markdownTokenName:`hr`,parseMarkdown:(e,t)=>t.createNode(`horizontalRule`),renderMarkdown:()=>`---`,addCommands(){return{setHorizontalRule:()=>({chain:e,state:t})=>{if(!we(t,t.schema.nodes[this.name]))return!1;let{selection:n}=t,{$to:r}=n,i=e();return Re(n)?i.insertContentAt(r.pos,{type:this.name}):i.insertContent({type:this.name}),i.command(({state:e,tr:t,dispatch:n})=>{if(n){let{$to:n}=t.selection,r=n.end();if(n.nodeAfter)n.nodeAfter.isTextblock?t.setSelection(E.create(t.doc,n.pos+1)):n.nodeAfter.isBlock?t.setSelection(A.create(t.doc,n.pos)):t.setSelection(E.create(t.doc,n.pos));else{let i=(e.schema.nodes[this.options.nextNodeType]||n.parent.type.contentMatch.defaultType)?.create();i&&(t.insert(r,i),t.setSelection(E.create(t.doc,r+1)))}t.scrollIntoView()}return!0}).run()}}},addInputRules(){return[ht({find:/^(?:---|—-|___\s|\*\*\*\s)$/,type:this.type})]}}),Vc=/(?:^|\s)(\*(?!\s+\*)((?:[^*]+))\*(?!\s+\*))$/,Hc=/(?:^|\s)(\*(?!\s+\*)((?:[^*]+))\*(?!\s+\*))/g,Uc=/(?:^|\s)(_(?!\s+_)((?:[^_]+))_(?!\s+_))$/,Wc=/(?:^|\s)(_(?!\s+_)((?:[^_]+))_(?!\s+_))/g,Gc=Ee.create({name:`italic`,addOptions(){return{HTMLAttributes:{}}},parseHTML(){return[{tag:`em`},{tag:`i`,getAttrs:e=>e.style.fontStyle!==`normal`&&null},{style:`font-style=normal`,clearMark:e=>e.type.name===this.name},{style:`font-style=italic`}]},renderHTML({HTMLAttributes:e}){return[`em`,w(this.options.HTMLAttributes,e),0]},addCommands(){return{setItalic:()=>({commands:e})=>e.setMark(this.name),toggleItalic:()=>({commands:e})=>e.toggleMark(this.name),unsetItalic:()=>({commands:e})=>e.unsetMark(this.name)}},markdownTokenName:`em`,parseMarkdown:(e,t)=>t.applyMark(`italic`,t.parseInline(e.tokens||[])),markdownOptions:{htmlReopen:{open:`<em>`,close:`</em>`}},renderMarkdown:(e,t)=>`*${t.renderChildren(e)}*`,addKeyboardShortcuts(){return{"Mod-i":()=>this.editor.commands.toggleItalic(),"Mod-I":()=>this.editor.commands.toggleItalic()}},addInputRules(){return[Oe({find:Vc,type:this.type}),Oe({find:Uc,type:this.type})]},addPasteRules(){return[de({find:Hc,type:this.type}),de({find:Wc,type:this.type})]}}),Kc=`listItem`,qc=`textStyle`,Jc=/^\s*([-+*])\s$/,Yc=D.create({name:`bulletList`,addOptions(){return{itemTypeName:`listItem`,HTMLAttributes:{},keepMarks:!1,keepAttributes:!1}},group:`block list`,content(){return`${this.options.itemTypeName}+`},parseHTML(){return[{tag:`ul`}]},renderHTML({HTMLAttributes:e}){return[`ul`,w(this.options.HTMLAttributes,e),0]},markdownTokenName:`list`,parseMarkdown:(e,t)=>e.type!==`list`||e.ordered?[]:{type:`bulletList`,content:e.items?t.parseChildren(e.items):[]},renderMarkdown:(e,t)=>e.content?t.renderChildren(e.content,`
`):``,markdownOptions:{indentsContent:!0},addCommands(){return{toggleBulletList:()=>({commands:e,chain:t})=>this.options.keepAttributes?t().toggleList(this.name,this.options.itemTypeName,this.options.keepMarks).updateAttributes(Kc,this.editor.getAttributes(qc)).run():e.toggleList(this.name,this.options.itemTypeName,this.options.keepMarks)}},addKeyboardShortcuts(){return{"Mod-Shift-8":()=>this.editor.commands.toggleBulletList()}},addInputRules(){let e=st({find:Jc,type:this.type});return(this.options.keepMarks||this.options.keepAttributes)&&(e=st({find:Jc,type:this.type,keepMarks:this.options.keepMarks,keepAttributes:this.options.keepAttributes,getAttributes:()=>this.editor.getAttributes(qc),editor:this.editor})),[e]}}),Xc=(e,t,n)=>{let{selection:r}=e;if(!r.empty)return null;let{$from:i}=r;if(!i.parent.isTextblock||i.parentOffset!==i.parent.content.size)return null;let a=-1;for(let e=i.depth;e>0;--e)if(i.node(e).type.name===t){a=e;break}if(a<0)return null;let o=i.node(a),s=i.index(a);if(s+1>=o.childCount)return null;let c=o.child(s+1);if(!n.includes(c.type.name))return null;let l=e.schema.nodes[t],u=!1;if(c.forEach(e=>{e.type===l&&e.childCount>1&&(u=!0)}),!u)return null;let d=e.doc.resolve(i.after()).nodeAfter;if(!d||!n.includes(d.type.name))return null;let f=[];return d.forEach(e=>{f.push(e)}),f.length===0?null:{listItemDepth:a,nestedList:d,nestedListPos:i.after(),insertPos:i.after(a),items:f}},Zc=(e,t,n,r)=>{let i=Xc(e,n,r);if(!i)return!1;let{selection:a}=e,{nestedList:o,nestedListPos:s,insertPos:c,items:l}=i,u=e.tr;u.delete(s,s+o.nodeSize);let d=u.mapping.map(c);return u.insert(d,M.from(l)),u.setSelection(a.map(u.doc,u.mapping)),t&&t(u),!0},Qc=(e,t,n)=>Zc(e.state,e.view.dispatch,t,n),$c=(e,t)=>S.create({name:`${e}BranchingDeleteKeymap`,priority:101,addKeyboardShortcuts(){let n=()=>Qc(this.editor,e,t);return{Delete:n,"Mod-Delete":n}}}),el=[[1e3,`m`],[900,`cm`],[500,`d`],[400,`cd`],[100,`c`],[90,`xc`],[50,`l`],[40,`xl`],[10,`x`],[9,`ix`],[5,`v`],[4,`iv`],[1,`i`]],tl=`abcdefghijklmnopqrstuvwxyz`,nl=String.raw`\d+|[ivxlcdmIVXLCDM]+|${`[a-zA-Z]{1,2}`}`;function rl(e){let t=e,n=``;for(let[e,r]of el)for(;t>=e;)n+=r,t-=e;return n}function il(e){return rl(e).toUpperCase()}function al(e){let t=e.toLowerCase(),n=0,r=0;for(;n<t.length;){let e=!1;for(let[i,a]of el)if(t.startsWith(a,n)){r+=i,n+=a.length,e=!0;break}if(!e)return 0}return r}function ol(e){if(!/^[ivxlcdmIVXLCDM]+$/.test(e))return!1;let t=al(e);return t<=0?!1:(e===e.toLowerCase()?rl(t):il(t))===e}function sl(e){let t=e.toLowerCase();if(t.length===1)return t.charCodeAt(0)-97+1;if(t.length===2){let e=t.charCodeAt(0)-97,n=t.charCodeAt(1)-97;return(e+1)*26+n+1}return 0}function cl(e){if(e<=26)return tl[e-1];let t=Math.floor((e-1)/26)-1,n=(e-1)%26;return t<0?tl[n]:tl[t]+tl[n]}function ll(e){if(!(!e||/^\d+$/.test(e))){if(ol(e))return e===e.toLowerCase()?`i`:`I`;if(/^[a-z]{1,2}$/.test(e))return`a`;if(/^[A-Z]{1,2}$/.test(e))return`A`}}function ul(e){if(/^\d+$/.test(e))return parseInt(e,10);let t=ll(e);if(t===`i`||t===`I`)return al(e);if(t===`a`||t===`A`){let t=sl(e);return t>0?t:1}let n=parseInt(e,10);return Number.isNaN(n)?1:n}function dl(e,t){if(e===`numeric`)return String(t);switch(e){case`a`:return cl(t);case`A`:return cl(t).toUpperCase();case`i`:return rl(t);case`I`:return il(t);default:return String(t)}}function fl(e){if(e.length===0)return!1;let t=ll(e[0])??`numeric`,n=ul(e[0]);if(n<1)return!1;for(let r=0;r<e.length;r++){let i=dl(t,n+r);if(e[r]!==i)return!1}return!0}function pl(e){return{type:ll(e),start:ul(e)}}function ml(e){let{type:t,start:n}=pl(e),r={};return t&&(r.type=t),n!==1&&(r.start=n),r}function hl(e,t,n=`. `){let r=t+1;if(!e||e===`1`)return`${r}${n}`;switch(e){case`a`:return`${cl(r)}${n}`;case`A`:return`${cl(r).toUpperCase()}${n}`;case`i`:return`${rl(r)}${n}`;case`I`:return`${il(r)}${n}`;default:return`${r}${n}`}}function gl(e){let t=e.tokens?.[0];return!!(e.text&&e.tokens?.length===1&&t?.type===`list`&&t.ordered&&t.raw===e.text)}function _l(e,t){return t.tokenizeInline?t.parseInline(t.tokenizeInline(e)):t.parseInline([{type:`text`,raw:e,text:e}])}var vl=D.create({name:`listItem`,addOptions(){return{HTMLAttributes:{},bulletListTypeName:`bulletList`,orderedListTypeName:`orderedList`}},content:`paragraph block*`,defining:!0,parseHTML(){return[{tag:`li`}]},renderHTML({HTMLAttributes:e}){return[`li`,w(this.options.HTMLAttributes,e),0]},markdownTokenName:`list_item`,parseMarkdown:(e,t)=>{if(e.type!==`list_item`)return[];let n=t.parseBlockChildren??t.parseChildren,r=[];if(e.tokens&&e.tokens.length>0){if(gl(e))return{type:`listItem`,content:[{type:`paragraph`,content:_l(e.text||``,t)}]};if(e.tokens.some(e=>e.type===`paragraph`))r=n(e.tokens);else{let i=e.tokens[0];if(i&&i.type===`text`&&i.tokens&&i.tokens.length>0){if(r=[{type:`paragraph`,content:t.parseInline(i.tokens)}],e.tokens.length>1){let t=n(e.tokens.slice(1));r.push(...t)}}else r=n(e.tokens)}}return r.length===0&&(r=[{type:`paragraph`,content:[]}]),{type:`listItem`,content:r}},renderMarkdown:(e,t,n)=>$e(e,t,e=>{if(e.parentType===`bulletList`)return`- `;if(e.parentType===`orderedList`){var t,n;let r=((t=e.meta)==null||(t=t.parentAttrs)==null?void 0:t.start)||1;return hl((n=e.meta)==null||(n=n.parentAttrs)==null?void 0:n.type,r-1+(e.index||0),`. `)}return`- `},n),addExtensions(){return[$c(this.name,[this.options.bulletListTypeName,this.options.orderedListTypeName])]},addKeyboardShortcuts(){return{Enter:()=>this.editor.commands.splitListItem(this.name),Tab:()=>this.editor.commands.sinkListItem(this.name),"Shift-Tab":()=>this.editor.commands.liftListItem(this.name)}}}),yl=(e,t)=>{let{$from:n}=t.selection,r=Ne(e,t.schema),i=null,a=n.depth,o=n.pos,s=null;for(;a>0&&s===null;)i=n.node(a),i.type===r?s=a:(--a,--o);return s===null?null:{$pos:t.doc.resolve(o),depth:s}},bl=(e,t)=>{let n=yl(e,t);if(!n)return!1;let[,r]=ye(t,e,n.$pos.pos+4);return r},xl=(e,t,n)=>{let{$anchor:r}=e.selection,i=Math.max(0,r.pos-2),a=e.doc.resolve(i).node();return!(!a||!n.includes(a.type.name))},Sl=(e,t,n)=>{if(e.commands.undoInputRule())return!0;if(e.state.selection.from!==e.state.selection.to)return!1;if(!Le(e.state,t)&&xl(e.state,t,n)){let{$anchor:n}=e.state.selection,r=e.state.doc.resolve(n.before()-1),i=[];r.node().descendants((e,n)=>{e.type.name===t&&i.push({node:e,pos:n})});let a=i.at(-1);if(!a)return!1;let o=e.state.doc.resolve(r.start()+a.pos+1);return e.chain().cut({from:n.start()-1,to:n.end()+1},o.end()).joinForward().run()}if(!Le(e.state,t)||!xe(e.state))return!1;let{$from:r}=e.state.selection,i=r.depth-1;return r.node(i).type!==e.schema.nodes[t]||r.index(i)!==0?!1:e.chain().liftListItem(t).run()},Cl=(e,t)=>{let n=bl(e,t),r=yl(e,t);return!r||!n?!1:n>r.depth},wl=(e,t)=>{let n=bl(e,t),r=yl(e,t);return!r||!n?!1:n<r.depth},Tl=(e,t)=>{if(!Le(e.state,t)||!lt(e.state,t))return!1;let{selection:n}=e.state,{$from:r,$to:i}=n;return!n.empty&&r.sameParent(i)?!1:Cl(t,e.state)?e.chain().focus(e.state.selection.from+4).lift(t).joinBackward().run():wl(t,e.state)?e.chain().joinForward().joinBackward().run():e.commands.joinItemForward()},El=(e,t,n)=>{let{state:r}=e,{selection:i}=r;if(!i.empty)return!1;let{$from:a}=i;if(a.parentOffset!==0||!a.parent.isTextblock||Le(r,t))return!1;let o=Fe(a);if(!o||!n.includes(o.type.name))return!1;let s=o.lastChild;if(!s||s.type.name!==t)return!1;let c=a.parent;if(!s.canReplace(s.childCount,s.childCount,M.from(c)))return!1;let l=a.before(),u=a.after(),d=l-2;return e.commands.command(({tr:e,dispatch:t})=>(t&&(e.delete(l,u).insert(d,M.from(c)),e.setSelection(E.create(e.doc,d+1)),e.scrollIntoView()),!0))},Dl=S.create({name:`listKeymap`,addOptions(){return{listTypes:[{itemName:`listItem`,wrapperNames:[`bulletList`,`orderedList`]},{itemName:`taskItem`,wrapperNames:[`taskList`]}]}},addKeyboardShortcuts(){return{Delete:({editor:e})=>{let t=!1;return this.options.listTypes.forEach(({itemName:n})=>{e.state.schema.nodes[n]!==void 0&&Tl(e,n)&&(t=!0)}),t},"Mod-Delete":({editor:e})=>{let t=!1;return this.options.listTypes.forEach(({itemName:n})=>{e.state.schema.nodes[n]!==void 0&&Tl(e,n)&&(t=!0)}),t},Backspace:({editor:e})=>{let t=!1;return this.options.listTypes.forEach(({itemName:n,wrapperNames:r})=>{e.state.schema.nodes[n]!==void 0&&Sl(e,n,r)&&(t=!0)}),t},"Mod-Backspace":({editor:e})=>{let t=!1;return this.options.listTypes.forEach(({itemName:n,wrapperNames:r})=>{e.state.schema.nodes[n]!==void 0&&Sl(e,n,r)&&(t=!0)}),t},Tab:({editor:e})=>{for(let{itemName:t,wrapperNames:n}of this.options.listTypes)if(e.state.schema.nodes[t]!==void 0&&El(e,t,n))return!0;return!1}}}}),Ol=RegExp(`^(\\s*)(${nl})([.)])\\s+(.*)$`),kl=/^\s/,Al={heading:/^#{1,6}(?:\s|$)/,bulletItem:/^[-+*]\s+/,codeFence:/^(?:```|~~~)/,blockMath:/^\$\$/,thematicBreak:/^(?:(?:-[ \t]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})$/};function jl(e){return Ol.test(e.trimStart())}function Ml(e){let t=e.trimStart();return Al.bulletItem.test(t)||jl(t)||Al.heading.test(t)||Al.thematicBreak.test(t)&&!t.startsWith(`-`)||/^>\s?/.test(t)||Al.codeFence.test(t)||Al.blockMath.test(t)}function Nl(e){return Object.values(Al).some(t=>t.test(e))}function Pl(e){let t=[],n=[],r=!1;return e.forEach(e=>{if(r){n.push(e);return}if(e.trim()===``){r=!0,n.push(e);return}if(t.length>0&&Ml(e)){r=!0,n.push(e);return}t.push(e)}),{paragraphLines:t,blockLines:n}}function Fl(e){let t=[],n=0,r=0;for(;n<e.length;){let i=e[n],a=i.match(Ol);if(!a)break;let[,o,s,c,l]=a,u=o.length,d=parseInt(s,10),f=isNaN(d)?ll(s):void 0,p=isNaN(d)?ul(s):d,m=[l],h=n+1,g=[i],_=!1;for(;h<e.length;){let t=e[h];if(t.match(Ol))break;if(t.trim()===``)g.push(t),m.push(``),_=!0,h+=1;else if(t.match(kl)){let e=t.length-t.trimStart().length,n=u+s.length+1;g.push(t),m.push(t.slice(Math.min(e,n))),h+=1}else{if(_||Nl(t))break;g.push(t),m.push(t),h+=1}}t.push({indent:u,number:p,type:f,content:m.join(`
`).trim(),contentLines:m,raw:g.join(`
`)}),r=h,n=h}return[t,r]}var Il=RegExp(`^(${nl})([.)])\\s+(.+)$`);function Ll(e){let t=e.split(`
`).filter(e=>e.trim().length>0);if(t.length===0)return null;let n=[];for(let e of t){let t=e.trim().match(Il);if(!t)return null;n.push({marker:t[1],content:t[3]})}return fl(n.map(e=>e.marker))?{type:`orderedList`,attrs:ml(n[0].marker),content:n.map(e=>({type:`listItem`,content:[{type:`paragraph`,content:[{type:`text`,text:e.content}]}]}))}:null}function Rl(e,t,n){let r=[],i=0;for(;i<e.length;){let a=e[i];if(a.indent===t){let{paragraphLines:o,blockLines:s}=Pl(a.contentLines),c=o.join(`
`).trim(),l=[];c&&l.push({type:`paragraph`,raw:c,tokens:n.inlineTokens(c)});let u=s.join(`
`).trim();if(u){let e=n.blockTokens(u);l.push(...e)}let d=i+1,f=[];for(;d<e.length&&e[d].indent>t;)f.push(e[d]),d+=1;if(f.length>0){let e=Rl(f,Math.min(...f.map(e=>e.indent)),n);l.push({type:`list`,ordered:!0,start:f[0].number,typeMarker:f[0].type,items:e,raw:f.map(e=>e.raw).join(`
`)})}r.push({type:`list_item`,raw:a.raw,tokens:l}),i=d}else i+=1}return r}function zl(e,t){return e.map(e=>{if(e.type!==`list_item`)return t.parseChildren([e])[0];let n=[];return e.tokens&&e.tokens.length>0&&e.tokens.forEach(e=>{if(e.type===`paragraph`||e.type===`list`||e.type===`blockquote`||e.type===`code`)n.push(...t.parseChildren([e]));else if(e.type===`text`&&e.tokens){let r=t.parseChildren([e]);n.push({type:`paragraph`,content:r})}else{let r=t.parseChildren([e]);r.length>0&&n.push(...r)}}),{type:`listItem`,content:n}})}var Bl=`listItem`,Vl=`textStyle`,Hl=/^(\d+)\.\s$/;function Ul(e){let t=e.match(/list-style-type\s*:\s*([^;]+)/i);if(!t)return null;switch(t[1].trim().toLowerCase()){case`upper-roman`:return`I`;case`lower-roman`:return`i`;case`upper-alpha`:case`upper-latin`:return`A`;case`lower-alpha`:case`lower-latin`:return`a`;default:return null}}var Wl=D.create({name:`orderedList`,addOptions(){return{itemTypeName:`listItem`,HTMLAttributes:{},keepMarks:!1,keepAttributes:!1}},group:`block list`,content(){return`${this.options.itemTypeName}+`},addAttributes(){return{start:{default:1,parseHTML:e=>e.hasAttribute(`start`)?parseInt(e.getAttribute(`start`)||``,10):1},type:{default:null,parseHTML:e=>{let t=e.getAttribute(`type`);if(t)return t;let n=e.getAttribute(`style`);if(n){let e=Ul(n);if(e)return e}let r=e.querySelector(`li`);if(r){let e=r.getAttribute(`style`);if(e){let t=Ul(e);if(t)return t}}return null}}}},parseHTML(){return[{tag:`ol`}]},renderHTML({HTMLAttributes:e}){let{start:t,type:n,...r}=e,i=w(this.options.HTMLAttributes,r);return t!==1&&(i.start=t),n&&n!==`1`&&(i.type=n),[`ol`,i,0]},markdownTokenName:`list`,parseMarkdown:(e,t)=>{if(e.type!==`list`||!e.ordered)return[];let n=e.start||1,r=e.typeMarker,i=e.items?zl(e.items,t):[],a={};return n!==1&&(a.start=n),r&&(a.type=r),Object.keys(a).length>0?{type:`orderedList`,attrs:a,content:i}:{type:`orderedList`,content:i}},renderMarkdown:(e,t)=>e.content?t.renderChildren(e.content,`
`):``,markdownTokenizer:{name:`orderedList`,level:`block`,start:()=>-1,tokenize:(e,t,n)=>{let r=e.split(`
`),[i,a]=Fl(r);if(i.length===0)return;let o=Rl(i,i[0].indent,n);if(o.length!==0)return{type:`list`,ordered:!0,start:i[0]?.number||1,typeMarker:i[0]?.type,items:o,raw:r.slice(0,a).join(`
`)}}},markdownOptions:{indentsContent:!0},addCommands(){return{toggleOrderedList:()=>({commands:e,chain:t})=>this.options.keepAttributes?t().toggleList(this.name,this.options.itemTypeName,this.options.keepMarks).updateAttributes(Bl,this.editor.getAttributes(Vl)).run():e.toggleList(this.name,this.options.itemTypeName,this.options.keepMarks)}},addKeyboardShortcuts(){return{"Mod-Shift-7":()=>this.editor.commands.toggleOrderedList()}},addProseMirrorPlugins(){return[new C({props:{handlePaste:(e,t)=>{if((t.clipboardData?.getData(`text/html`))?.trim())return!1;let n=t.clipboardData?.getData(`text/plain`);if(!n)return!1;let r=Ll(n);if(!r)return!1;try{let t=e.state.schema.nodeFromJSON(r),n=e.state.tr.replaceSelectionWith(t);return e.dispatch(n),!0}catch{return!1}}}})]},addInputRules(){let e=(e,t)=>(!t.attrs.type||t.attrs.type===`1`)&&t.childCount+t.attrs.start===+e[1],t=st({find:Hl,type:this.type,getAttributes:e=>({start:+e[1]}),joinPredicate:e});return(this.options.keepMarks||this.options.keepAttributes)&&(t=st({find:Hl,type:this.type,keepMarks:this.options.keepMarks,keepAttributes:this.options.keepAttributes,getAttributes:e=>({start:+e[1],...this.editor.getAttributes(Vl)}),joinPredicate:e,editor:this.editor})),[t]}}),Gl=/^\s*(\[([( |x])?\])\s$/,Kl=`position:absolute;width:1px;height:1px;padding:0;margin:-1px;overflow:hidden;clip:rect(0,0,0,0);white-space:nowrap;border:0`,ql=(e,t,n)=>{var r;return(n==null||(r=n.checkboxLabel)==null?void 0:r.call(n,e,t))||`Task item checkbox for ${e.textContent||`empty task item`}`},Jl=D.create({name:`taskItem`,addOptions(){return{nested:!1,HTMLAttributes:{},taskListTypeName:`taskList`,a11y:void 0}},content(){return this.options.nested?`paragraph block*`:`paragraph+`},defining:!0,addAttributes(){return{checked:{default:!1,keepOnSplit:!1,parseHTML:e=>{let t=e.getAttribute(`data-checked`);return t===``||t===`true`},renderHTML:e=>({"data-checked":e.checked})}}},parseHTML(){return[{tag:`li[data-type="${this.name}"]`,priority:51,contentElement:e=>e.querySelector(`div`)??e}]},renderHTML({node:e,HTMLAttributes:t}){return[`li`,w(this.options.HTMLAttributes,t,{"data-type":this.name}),[`label`,[`input`,{type:`checkbox`,checked:e.attrs.checked?`checked`:null}],[`span`]],[`div`,0]]},parseMarkdown:(e,t)=>{let n=[];if(e.tokens&&e.tokens.length>0?n.push(t.createNode(`paragraph`,{},t.parseInline(e.tokens))):e.text?n.push(t.createNode(`paragraph`,{},[t.createNode(`text`,{text:e.text})])):n.push(t.createNode(`paragraph`,{},[])),e.nestedTokens&&e.nestedTokens.length>0){let r=t.parseChildren(e.nestedTokens);n.push(...r)}return t.createNode(`taskItem`,{checked:e.checked||!1},n)},renderMarkdown:(e,t)=>{let n=`- [${e.attrs?.checked?`x`:` `}] `;return $e(e,t,n)},addExtensions(){return this.options.nested?[$c(this.name,[this.options.taskListTypeName])]:[]},addKeyboardShortcuts(){let e={Enter:()=>this.editor.commands.splitListItem(this.name),"Shift-Tab":()=>this.editor.commands.liftListItem(this.name)};return this.options.nested?{...e,Tab:()=>this.editor.commands.sinkListItem(this.name)}:e},addNodeView(){return({node:e,HTMLAttributes:t,getPos:n,editor:r})=>{let i=document.createElement(`li`),a=document.createElement(`label`),o=document.createElement(`span`),s=document.createElement(`input`),c=document.createElement(`div`);o.style.cssText=Kl;let l=e=>{let t=ql(e,e.attrs.checked,this.options.a11y);s.setAttribute(`aria-label`,t),o.textContent=t};l(e),a.contentEditable=`false`,s.type=`checkbox`,s.addEventListener(`mousedown`,e=>e.preventDefault()),s.addEventListener(`change`,t=>{if(!r.isEditable&&!this.options.onReadOnlyChecked){s.checked=!s.checked;return}let{checked:i}=t.target;r.isEditable&&typeof n==`function`&&r.chain().focus(void 0,{scrollIntoView:!1}).command(({tr:e})=>{let t=n();if(typeof t!=`number`)return!1;let r=e.doc.nodeAt(t);return e.setNodeMarkup(t,void 0,{...r?.attrs,checked:i}),!0}).run(),!r.isEditable&&this.options.onReadOnlyChecked&&(this.options.onReadOnlyChecked(e,i)||(s.checked=!s.checked))}),Object.entries(this.options.HTMLAttributes).forEach(([e,t])=>{i.setAttribute(e,t)}),i.dataset.checked=e.attrs.checked,s.checked=e.attrs.checked,a.append(s,o),i.append(a,c),Object.entries(t).forEach(([e,t])=>{i.setAttribute(e,t)});let u=new Set(Object.keys(t));return{dom:i,contentDOM:c,update:e=>{if(e.type!==this.type)return!1;i.dataset.checked=e.attrs.checked,s.checked=e.attrs.checked,l(e);let t=r.extensionManager.attributes,n=ve(e,t),a=new Set(Object.keys(n)),o=this.options.HTMLAttributes;return u.forEach(e=>{a.has(e)||(e in o?i.setAttribute(e,o[e]):i.removeAttribute(e))}),Object.entries(n).forEach(([e,t])=>{t==null?e in o?i.setAttribute(e,o[e]):i.removeAttribute(e):i.setAttribute(e,t)}),u=a,!0}}}},addInputRules(){return[st({find:Gl,type:this.type,getAttributes:e=>({checked:e[e.length-1]===`x`})})]}}),Yl=D.create({name:`taskList`,addOptions(){return{itemTypeName:`taskItem`,HTMLAttributes:{}}},group:`block list`,content(){return`${this.options.itemTypeName}+`},parseHTML(){return[{tag:`ul[data-type="${this.name}"]`,priority:51}]},renderHTML({HTMLAttributes:e}){return[`ul`,w(this.options.HTMLAttributes,e,{"data-type":this.name}),0]},parseMarkdown:(e,t)=>t.createNode(`taskList`,{},t.parseChildren(e.items||[])),renderMarkdown:(e,t)=>e.content?t.renderChildren(e.content,`
`):``,markdownTokenizer:{name:`taskList`,level:`block`,start(e){let t=e.match(/^\s*[-+*]\s+\[([ xX])\]\s+/)?.index;return t===void 0?-1:t},tokenize(e,t,n){let r=e=>{let t=at(e,{itemPattern:/^(\s*)([-+*])\s+\[([ xX])\]\s+(.*)$/,extractItemData:e=>({indentLevel:e[1].length,mainContent:e[4],checked:e[3].toLowerCase()===`x`}),createToken:(e,t)=>({type:`taskItem`,raw:``,mainContent:e.mainContent,indentLevel:e.indentLevel,checked:e.checked,text:e.mainContent,tokens:n.inlineTokens(e.mainContent),nestedTokens:t}),customNestedParser:r},n);if(t){let r={type:`taskList`,raw:t.raw,items:t.items},i=e.slice(t.raw.length);return i.trim()?[r,...n.blockTokens(i)]:[r]}return n.blockTokens(e)},i=at(e,{itemPattern:/^(\s*)([-+*])\s+\[([ xX])\]\s+(.*)$/,extractItemData:e=>({indentLevel:e[1].length,mainContent:e[4],checked:e[3].toLowerCase()===`x`}),createToken:(e,t)=>({type:`taskItem`,raw:``,mainContent:e.mainContent,indentLevel:e.indentLevel,checked:e.checked,text:e.mainContent,tokens:n.inlineTokens(e.mainContent),nestedTokens:t}),customNestedParser:r},n);if(i)return{type:`taskList`,raw:i.raw,items:i.items}}},markdownOptions:{indentsContent:!0},addCommands(){return{toggleTaskList:()=>({commands:e})=>e.toggleList(this.name,this.options.itemTypeName)}},addKeyboardShortcuts(){return{"Mod-Shift-9":()=>this.editor.commands.toggleTaskList()}}});S.create({name:`listKit`,addExtensions(){let e=[];return this.options.bulletList!==!1&&e.push(Yc.configure(this.options.bulletList)),this.options.listItem!==!1&&e.push(vl.configure(this.options.listItem)),this.options.listKeymap!==!1&&e.push(Dl.configure(this.options.listKeymap)),this.options.orderedList!==!1&&e.push(Wl.configure(this.options.orderedList)),this.options.taskItem!==!1&&e.push(Jl.configure(this.options.taskItem)),this.options.taskList!==!1&&e.push(Yl.configure(this.options.taskList)),e}});var Xl=`&nbsp;`,Zl=`\xA0`,Ql=D.create({name:`paragraph`,priority:1e3,addOptions(){return{HTMLAttributes:{}}},group:`block`,content:`inline*`,parseHTML(){return[{tag:`p`}]},renderHTML({HTMLAttributes:e}){return[`p`,w(this.options.HTMLAttributes,e),0]},parseMarkdown:(e,t)=>{let n=e.tokens||[];if(n.length===1&&n[0].type===`image`)return t.parseChildren([n[0]]);let r=t.parseInline(n);return n.length===1&&n[0].type===`text`&&(n[0].raw===Xl||n[0].text===Xl||n[0].raw===Zl||n[0].text===Zl)&&r.length===1&&r[0].type===`text`&&(r[0].text===Xl||r[0].text===Zl)?t.createNode(`paragraph`,void 0,[]):t.createNode(`paragraph`,void 0,r)},renderMarkdown:(e,t,n)=>{if(!e)return``;let r=Array.isArray(e.content)?e.content:[];if(r.length===0){var i,a;let e=Array.isArray(n==null||(i=n.previousNode)==null?void 0:i.content)?n.previousNode.content:[];return(n==null||(a=n.previousNode)==null?void 0:a.type)===`paragraph`&&e.length===0?Xl:``}return t.renderChildren(r)},addCommands(){return{setParagraph:()=>({commands:e})=>e.setNode(this.name)}},addKeyboardShortcuts(){return{"Mod-Alt-0":()=>this.editor.commands.setParagraph()}}}),$l=/(?:^|\s)(~~(?!\s+~~)((?:[^~]+))~~(?!\s+~~))$/,eu=/(?:^|\s)(~~(?!\s+~~)((?:[^~]+))~~(?!\s+~~))/g,tu=Ee.create({name:`strike`,addOptions(){return{HTMLAttributes:{}}},parseHTML(){return[{tag:`s`},{tag:`del`},{tag:`strike`},{style:`text-decoration`,consuming:!1,getAttrs:e=>e.includes(`line-through`)?{}:!1}]},renderHTML({HTMLAttributes:e}){return[`s`,w(this.options.HTMLAttributes,e),0]},markdownTokenName:`del`,parseMarkdown:(e,t)=>t.applyMark(`strike`,t.parseInline(e.tokens||[])),renderMarkdown:(e,t)=>`~~${t.renderChildren(e)}~~`,addCommands(){return{setStrike:()=>({commands:e})=>e.setMark(this.name),toggleStrike:()=>({commands:e})=>e.toggleMark(this.name),unsetStrike:()=>({commands:e})=>e.unsetMark(this.name)}},addKeyboardShortcuts(){return{"Mod-Shift-s":()=>this.editor.commands.toggleStrike()}},addInputRules(){return[Oe({find:$l,type:this.type})]},addPasteRules(){return[de({find:eu,type:this.type})]}}),nu=D.create({name:`text`,group:`inline`,parseMarkdown:e=>({type:`text`,text:e.text||``}),renderMarkdown:e=>e.text||``}),ru=Ee.create({name:`underline`,addOptions(){return{HTMLAttributes:{}}},parseHTML(){return[{tag:`u`},{style:`text-decoration`,consuming:!1,getAttrs:e=>e.includes(`underline`)?{}:!1}]},renderHTML({HTMLAttributes:e}){return[`u`,w(this.options.HTMLAttributes,e),0]},parseMarkdown(e,t){return t.applyMark(this.name||`underline`,t.parseInline(e.tokens||[]))},renderMarkdown(e,t){return`++${t.renderChildren(e)}++`},markdownTokenizer:{name:`underline`,level:`inline`,start(e){return e.indexOf(`++`)},tokenize(e,t,n){let r=/^(\+\+)([\s\S]+?)(\+\+)/.exec(e);if(!r)return;let i=r[2].trim();return{type:`underline`,raw:r[0],text:i,tokens:n.inlineTokens(i)}}},addCommands(){return{setUnderline:()=>({commands:e})=>e.setMark(this.name),toggleUnderline:()=>({commands:e})=>e.toggleMark(this.name),unsetUnderline:()=>({commands:e})=>e.unsetMark(this.name)}},addKeyboardShortcuts(){return{"Mod-u":()=>this.editor.commands.toggleUnderline(),"Mod-U":()=>this.editor.commands.toggleUnderline()}}}),iu=/(?:^|\s)(==(?!\s+==)((?:[^=]+))==(?!\s+==))$/,au=/(?:^|\s)(==(?!\s+==)((?:[^=]+))==(?!\s+==))/g,ou=Ee.create({name:`highlight`,addOptions(){return{multicolor:!1,HTMLAttributes:{}}},addAttributes(){return this.options.multicolor?{color:{default:null,parseHTML:e=>e.getAttribute(`data-color`)||Se(e,`background-color`)||e.style.backgroundColor,renderHTML:e=>e.color?{"data-color":e.color,style:`background-color: ${e.color}; color: inherit`}:{}}}:{}},parseHTML(){return[{tag:`mark`}]},renderHTML({HTMLAttributes:e}){return[`mark`,w(this.options.HTMLAttributes,e),0]},renderMarkdown:(e,t)=>`==${t.renderChildren(e)}==`,parseMarkdown:(e,t)=>t.applyMark(`highlight`,t.parseInline(e.tokens||[])),markdownTokenizer:{name:`highlight`,level:`inline`,start:e=>e.indexOf(`==`),tokenize(e,t,n){let r=/^(==)([^=]+)(==)/.exec(e);if(r){let e=r[2].trim(),t=n.inlineTokens(e);return{type:`highlight`,raw:r[0],text:e,tokens:t}}}},addCommands(){return{setHighlight:e=>({commands:t})=>t.setMark(this.name,e),toggleHighlight:e=>({commands:t})=>t.toggleMark(this.name,e),unsetHighlight:()=>({commands:e})=>e.unsetMark(this.name)}},addKeyboardShortcuts(){return{"Mod-Shift-h":()=>this.editor.commands.toggleHighlight()}},addInputRules(){return[Oe({find:iu,type:this.type})]},addPasteRules(){return[de({find:au,type:this.type})]}}),su=Ee.create({name:`subscript`,addOptions(){return{HTMLAttributes:{}}},parseHTML(){return[{tag:`sub`},{style:`vertical-align`,getAttrs(e){return e===`sub`&&null}}]},renderHTML({HTMLAttributes:e}){return[`sub`,w(this.options.HTMLAttributes,e),0]},addCommands(){return{setSubscript:()=>({commands:e})=>e.setMark(this.name),toggleSubscript:()=>({commands:e})=>e.toggleMark(this.name),unsetSubscript:()=>({commands:e})=>e.unsetMark(this.name)}},addKeyboardShortcuts(){return{"Mod-,":()=>this.editor.commands.toggleSubscript()}}}),cu=Ee.create({name:`superscript`,addOptions(){return{HTMLAttributes:{}}},parseHTML(){return[{tag:`sup`},{style:`vertical-align`,getAttrs(e){return e===`super`&&null}}]},renderHTML({HTMLAttributes:e}){return[`sup`,w(this.options.HTMLAttributes,e),0]},addCommands(){return{setSuperscript:()=>({commands:e})=>e.setMark(this.name),toggleSuperscript:()=>({commands:e})=>e.toggleMark(this.name),unsetSuperscript:()=>({commands:e})=>e.unsetMark(this.name)}},addKeyboardShortcuts(){return{"Mod-.":()=>this.editor.commands.toggleSuperscript()}}}),lu,uu;if(typeof WeakMap<`u`){let e=new WeakMap;lu=t=>e.get(t),uu=(t,n)=>(e.set(t,n),n)}else{let e=[],t=0;lu=t=>{for(let n=0;n<e.length;n+=2)if(e[n]==t)return e[n+1]},uu=(n,r)=>(t==10&&(t=0),e[t++]=n,e[t++]=r)}var q=class{constructor(e,t,n,r){this.width=e,this.height=t,this.map=n,this.problems=r}findCell(e){for(let t=0;t<this.map.length;t++){let n=this.map[t];if(n!=e)continue;let r=t%this.width,i=t/this.width|0,a=r+1,o=i+1;for(let e=1;a<this.width&&this.map[t+e]==n;e++)a++;for(let e=1;o<this.height&&this.map[t+this.width*e]==n;e++)o++;return{left:r,top:i,right:a,bottom:o}}throw RangeError(`No cell with offset ${e} found`)}colCount(e){for(let t=0;t<this.map.length;t++)if(this.map[t]==e)return t%this.width;throw RangeError(`No cell with offset ${e} found`)}nextCell(e,t,n){let{left:r,right:i,top:a,bottom:o}=this.findCell(e);return t==`horiz`?(n<0?r==0:i==this.width)?null:this.map[a*this.width+(n<0?r-1:i)]:(n<0?a==0:o==this.height)?null:this.map[r+this.width*(n<0?a-1:o)]}rectBetween(e,t){let{left:n,right:r,top:i,bottom:a}=this.findCell(e),{left:o,right:s,top:c,bottom:l}=this.findCell(t);return{left:Math.min(n,o),top:Math.min(i,c),right:Math.max(r,s),bottom:Math.max(a,l)}}cellsInRect(e){let t=[],n={};for(let r=e.top;r<e.bottom;r++)for(let i=e.left;i<e.right;i++){let a=r*this.width+i,o=this.map[a];n[o]||(n[o]=!0,!(i==e.left&&i&&this.map[a-1]==o||r==e.top&&r&&this.map[a-this.width]==o)&&t.push(o))}return t}positionAt(e,t,n){for(let r=0,i=0;;r++){let a=i+n.child(r).nodeSize;if(r==e){let n=t+e*this.width,r=(e+1)*this.width;for(;n<r&&this.map[n]<i;)n++;return n==r?a-1:this.map[n]}i=a}}static get(e){return lu(e)||uu(e,du(e))}};function du(e){if(e.type.spec.tableRole!=`table`)throw RangeError(`Not a table node: `+e.type.name);let t=fu(e),n=e.childCount,r=[],i=0,a=null,o=[];for(let e=0,i=t*n;e<i;e++)r[e]=0;for(let s=0,c=0;s<n;s++){let l=e.child(s);c++;for(let e=0;;e++){for(;i<r.length&&r[i]!=0;)i++;if(e==l.childCount)break;let u=l.child(e),{colspan:d,rowspan:f,colwidth:p}=u.attrs;for(let e=0;e<f;e++){if(e+s>=n){(a||=[]).push({type:`overlong_rowspan`,pos:c,n:f-e});break}let l=i+e*t;for(let e=0;e<d;e++){r[l+e]==0?r[l+e]=c:(a||=[]).push({type:`collision`,row:s,pos:c,n:d-e});let n=p&&p[e];if(n){let r=(l+e)%t*2,i=o[r];i==null||i!=n&&o[r+1]==1?(o[r]=n,o[r+1]=1):i==n&&o[r+1]++}}}i+=d,c+=u.nodeSize}let u=(s+1)*t,d=0;for(;i<u;)r[i++]==0&&d++;d&&(a||=[]).push({type:`missing`,row:s,n:d}),c++}(t===0||n===0)&&(a||=[]).push({type:`zero_sized`});let s=new q(t,n,r,a),c=!1;for(let e=0;!c&&e<o.length;e+=2)o[e]!=null&&o[e+1]<n&&(c=!0);return c&&pu(s,o,e),s}function fu(e){let t=-1,n=!1;for(let r=0;r<e.childCount;r++){let i=e.child(r),a=0;if(n)for(let t=0;t<r;t++){let n=e.child(t);for(let e=0;e<n.childCount;e++){let i=n.child(e);t+i.attrs.rowspan>r&&(a+=i.attrs.colspan)}}for(let e=0;e<i.childCount;e++){let t=i.child(e);a+=t.attrs.colspan,t.attrs.rowspan>1&&(n=!0)}t==-1?t=a:t!=a&&(t=Math.max(t,a))}return t}function pu(e,t,n){e.problems||=[];let r={};for(let i=0;i<e.map.length;i++){let a=e.map[i];if(r[a])continue;r[a]=!0;let o=n.nodeAt(a);if(!o)throw RangeError(`No cell with offset ${a} found`);let s=null,c=o.attrs;for(let n=0;n<c.colspan;n++){let r=t[(i+n)%e.width*2];r!=null&&(!c.colwidth||c.colwidth[n]!=r)&&((s||=mu(c))[n]=r)}s&&e.problems.unshift({type:`colwidth mismatch`,pos:a,colwidth:s})}}function mu(e){if(e.colwidth)return e.colwidth.slice();let t=[];for(let n=0;n<e.colspan;n++)t.push(0);return t}function J(e){let t=e.cached.tableNodeTypes;if(!t){t=e.cached.tableNodeTypes={};for(let n in e.nodes){let r=e.nodes[n],i=r.spec.tableRole;i&&(t[i]=r)}}return t}var hu=new T(`selectingCells`);function gu(e){for(let t=e.depth-1;t>0;t--)if(e.node(t).type.spec.tableRole==`row`)return e.node(0).resolve(e.before(t+1));return null}function _u(e){for(let t=e.depth;t>0;t--){let n=e.node(t).type.spec.tableRole;if(n===`cell`||n===`header_cell`)return e.node(t)}return null}function vu(e){let t=e.selection.$head;for(let e=t.depth;e>0;e--)if(t.node(e).type.spec.tableRole==`row`)return!0;return!1}function yu(e){let t=e.selection;if(`$anchorCell`in t&&t.$anchorCell)return t.$anchorCell.pos>t.$headCell.pos?t.$anchorCell:t.$headCell;if(`node`in t&&t.node&&t.node.type.spec.tableRole==`cell`)return t.$anchor;let n=gu(t.$head)||bu(t.$head);if(n)return n;throw RangeError(`No cell found around position ${t.head}`)}function bu(e){for(let t=e.nodeAfter,n=e.pos;t;t=t.firstChild,n++){let r=t.type.spec.tableRole;if(r==`cell`||r==`header_cell`)return e.doc.resolve(n)}for(let t=e.nodeBefore,n=e.pos;t;t=t.lastChild,n--){let r=t.type.spec.tableRole;if(r==`cell`||r==`header_cell`)return e.doc.resolve(n-t.nodeSize)}}function xu(e){return e.parent.type.spec.tableRole==`row`&&!!e.nodeAfter}function Su(e){return e.node(0).resolve(e.pos+e.nodeAfter.nodeSize)}function Cu(e,t){return e.depth==t.depth&&e.pos>=t.start(-1)&&e.pos<=t.end(-1)}function wu(e,t,n){let r=e.node(-1),i=q.get(r),a=e.start(-1),o=i.nextCell(e.pos-a,t,n);return o==null?null:e.node(0).resolve(a+o)}function Tu(e,t,n=1){let r={...e,colspan:e.colspan-n};return r.colwidth&&(r.colwidth=r.colwidth.slice(),r.colwidth.splice(t,n),r.colwidth.some(e=>e>0)||(r.colwidth=null)),r}function Eu(e,t,n=1){let r={...e,colspan:e.colspan+n};if(r.colwidth){r.colwidth=r.colwidth.slice();for(let e=0;e<n;e++)r.colwidth.splice(t,0,0)}return r}function Du(e,t,n){let r=J(t.type.schema).header_cell;for(let i=0;i<e.height;i++)if(t.nodeAt(e.map[n+i*e.width]).type!=r)return!1;return!0}var Y=class e extends k{constructor(e,t=e){let n=e.node(-1),r=q.get(n),i=e.start(-1),a=r.rectBetween(e.pos-i,t.pos-i),o=e.node(0),s=r.cellsInRect(a).filter(e=>e!=t.pos-i);s.unshift(t.pos-i);let c=s.map(e=>{let t=n.nodeAt(e);if(!t)throw RangeError(`No cell with offset ${e} found`);let r=i+e+1;return new rt(o.resolve(r),o.resolve(r+t.content.size))});super(c[0].$from,c[0].$to,c),this.$anchorCell=e,this.$headCell=t}map(t,n){let r=t.resolve(n.map(this.$anchorCell.pos)),i=t.resolve(n.map(this.$headCell.pos));if(xu(r)&&xu(i)&&Cu(r,i)){let t=this.$anchorCell.node(-1)!=r.node(-1);return t&&this.isRowSelection()?e.rowSelection(r,i):t&&this.isColSelection()?e.colSelection(r,i):new e(r,i)}return E.between(r,i)}content(){let e=this.$anchorCell.node(-1),t=q.get(e),n=this.$anchorCell.start(-1),r=t.rectBetween(this.$anchorCell.pos-n,this.$headCell.pos-n),i={},a=[];for(let n=r.top;n<r.bottom;n++){let o=[];for(let a=n*t.width+r.left,s=r.left;s<r.right;s++,a++){let n=t.map[a];if(i[n])continue;i[n]=!0;let s=t.findCell(n),c=e.nodeAt(n);if(!c)throw RangeError(`No cell with offset ${n} found`);let l=r.left-s.left,u=s.right-r.right;if(l>0||u>0){let e=c.attrs;if(l>0&&(e=Tu(e,0,l)),u>0&&(e=Tu(e,e.colspan-u,u)),s.left<r.left){if(c=c.type.createAndFill(e),!c)throw RangeError(`Could not create cell with attrs ${JSON.stringify(e)}`)}else c=c.type.create(e,c.content)}if(s.top<r.top||s.bottom>r.bottom){let e={...c.attrs,rowspan:Math.min(s.bottom,r.bottom)-Math.max(s.top,r.top)};c=s.top<r.top?c.type.createAndFill(e):c.type.create(e,c.content)}o.push(c)}a.push(e.child(n).copy(M.from(o)))}let o=this.isColSelection()&&this.isRowSelection()?e:a;return new j(M.from(o),1,1)}replace(e,t=j.empty){let n=e.steps.length,r=this.ranges;for(let i=0;i<r.length;i++){let{$from:a,$to:o}=r[i],s=e.mapping.slice(n);e.replace(s.map(a.pos),s.map(o.pos),i?j.empty:t)}let i=k.findFrom(e.doc.resolve(e.mapping.slice(n).map(this.to)),-1);i&&e.setSelection(i)}replaceWith(e,t){this.replace(e,new j(M.from(t),0,0))}forEachCell(e){let t=this.$anchorCell.node(-1),n=q.get(t),r=this.$anchorCell.start(-1),i=n.cellsInRect(n.rectBetween(this.$anchorCell.pos-r,this.$headCell.pos-r));for(let n=0;n<i.length;n++)e(t.nodeAt(i[n]),r+i[n])}isColSelection(){let e=this.$anchorCell.index(-1),t=this.$headCell.index(-1);if(Math.min(e,t)>0)return!1;let n=e+this.$anchorCell.nodeAfter.attrs.rowspan,r=t+this.$headCell.nodeAfter.attrs.rowspan;return Math.max(n,r)==this.$headCell.node(-1).childCount}static colSelection(t,n=t){let r=t.node(-1),i=q.get(r),a=t.start(-1),o=i.findCell(t.pos-a),s=i.findCell(n.pos-a),c=t.node(0);return o.top<=s.top?(o.top>0&&(t=c.resolve(a+i.map[o.left])),s.bottom<i.height&&(n=c.resolve(a+i.map[i.width*(i.height-1)+s.right-1]))):(s.top>0&&(n=c.resolve(a+i.map[s.left])),o.bottom<i.height&&(t=c.resolve(a+i.map[i.width*(i.height-1)+o.right-1]))),new e(t,n)}isRowSelection(){let e=this.$anchorCell.node(-1),t=q.get(e),n=this.$anchorCell.start(-1),r=t.colCount(this.$anchorCell.pos-n),i=t.colCount(this.$headCell.pos-n);if(Math.min(r,i)>0)return!1;let a=r+this.$anchorCell.nodeAfter.attrs.colspan,o=i+this.$headCell.nodeAfter.attrs.colspan;return Math.max(a,o)==t.width}eq(t){return t instanceof e&&t.$anchorCell.pos==this.$anchorCell.pos&&t.$headCell.pos==this.$headCell.pos}static rowSelection(t,n=t){let r=t.node(-1),i=q.get(r),a=t.start(-1),o=i.findCell(t.pos-a),s=i.findCell(n.pos-a),c=t.node(0);return o.left<=s.left?(o.left>0&&(t=c.resolve(a+i.map[o.top*i.width])),s.right<i.width&&(n=c.resolve(a+i.map[i.width*(s.top+1)-1]))):(s.left>0&&(n=c.resolve(a+i.map[s.top*i.width])),o.right<i.width&&(t=c.resolve(a+i.map[i.width*(o.top+1)-1]))),new e(t,n)}toJSON(){return{type:`cell`,anchor:this.$anchorCell.pos,head:this.$headCell.pos}}static fromJSON(t,n){return new e(t.resolve(n.anchor),t.resolve(n.head))}static create(t,n,r=n){return new e(t.resolve(n),t.resolve(r))}getBookmark(){return new Ou(this.$anchorCell.pos,this.$headCell.pos)}};Y.prototype.visible=!1,k.jsonID(`cell`,Y);var Ou=class e{constructor(e,t){this.anchor=e,this.head=t}map(t){return new e(t.map(this.anchor),t.map(this.head))}resolve(e){let t=e.resolve(this.anchor),n=e.resolve(this.head);return t.parent.type.spec.tableRole==`row`&&n.parent.type.spec.tableRole==`row`&&t.index()<t.parent.childCount&&n.index()<n.parent.childCount&&Cu(t,n)?new Y(t,n):k.near(n,1)}};function ku(e){if(!(e.selection instanceof Y))return null;let t=[];return e.selection.forEachCell((e,n)=>{t.push(Ke.node(n,n+e.nodeSize,{class:`selectedCell`}))}),O.create(e.doc,t)}function Au({$from:e,$to:t}){if(e.pos==t.pos||e.pos<t.pos-6)return!1;let n=e.pos,r=t.pos,i=e.depth;for(;i>=0&&!(e.after(i+1)<e.end(i));i--,n++);for(let e=t.depth;e>=0&&!(t.before(e+1)>t.start(e));e--,r--);return n==r&&/row|table/.test(e.node(i).type.spec.tableRole)}function ju({$from:e,$to:t}){let n,r;for(let t=e.depth;t>0;t--){let r=e.node(t);if(r.type.spec.tableRole===`cell`||r.type.spec.tableRole===`header_cell`){n=r;break}}for(let e=t.depth;e>0;e--){let n=t.node(e);if(n.type.spec.tableRole===`cell`||n.type.spec.tableRole===`header_cell`){r=n;break}}return n!==r&&t.parentOffset===0}function Mu(e,t,n){let r=(t||e).selection,i=(t||e).doc,a,o;if(r instanceof A&&(o=r.node.type.spec.tableRole)){if(o==`cell`||o==`header_cell`)a=Y.create(i,r.from);else if(o==`row`){let e=i.resolve(r.from+1);a=Y.rowSelection(e,e)}else if(!n){let e=q.get(r.node),t=r.from+1,n=t+e.map[e.width*e.height-1];a=Y.create(i,t+1,n)}}else r instanceof E&&Au(r)?a=E.create(i,r.from):r instanceof E&&ju(r)&&(a=E.create(i,r.$from.start(),r.$from.end()));return a&&(t||=e.tr).setSelection(a),t}var Nu=new T(`fix-tables`);function Pu(e,t,n,r){let i=e.childCount,a=t.childCount;outer:for(let o=0,s=0;o<a;o++){let a=t.child(o);for(let t=s,r=Math.min(i,o+3);t<r;t++)if(e.child(t)==a){s=t+1,n+=a.nodeSize;continue outer}r(a,n),s<i&&e.child(s).sameMarkup(a)?Pu(e.child(s),a,n+1,r):a.nodesBetween(0,a.content.size,r,n+1),n+=a.nodeSize}}function Fu(e,t){let n,r=(t,r)=>{t.type.spec.tableRole==`table`&&(n=Iu(e,t,r,n))};return t?t.doc!=e.doc&&Pu(t.doc,e.doc,0,r):e.doc.descendants(r),n}function Iu(e,t,n,r){let i=q.get(t);if(!i.problems)return r;r||=e.tr;let a=[];for(let e=0;e<i.height;e++)a.push(0);for(let e=0;e<i.problems.length;e++){let o=i.problems[e];if(o.type==`collision`){let e=t.nodeAt(o.pos);if(!e)continue;let i=e.attrs;for(let e=0;e<i.rowspan;e++)a[o.row+e]+=o.n;r.setNodeMarkup(r.mapping.map(n+1+o.pos),null,Tu(i,i.colspan-o.n,o.n))}else if(o.type==`missing`)a[o.row]+=o.n;else if(o.type==`overlong_rowspan`){let e=t.nodeAt(o.pos);if(!e)continue;r.setNodeMarkup(r.mapping.map(n+1+o.pos),null,{...e.attrs,rowspan:e.attrs.rowspan-o.n})}else if(o.type==`colwidth mismatch`){let e=t.nodeAt(o.pos);if(!e)continue;r.setNodeMarkup(r.mapping.map(n+1+o.pos),null,{...e.attrs,colwidth:o.colwidth})}else if(o.type==`zero_sized`){let e=r.mapping.map(n);r.delete(e,e+t.nodeSize)}}let o,s;for(let e=0;e<a.length;e++)a[e]&&(o??=e,s=e);for(let c=0,l=n+1;c<i.height;c++){let n=t.child(c),i=l+n.nodeSize,u=a[c];if(u>0){let t=`cell`;n.firstChild&&(t=n.firstChild.type.spec.tableRole);let a=[];for(let n=0;n<u;n++){let n=J(e.schema)[t].createAndFill();n&&a.push(n)}let d=(c==0||o==c-1)&&s==c?l+1:i-1;r.insert(r.mapping.map(d),a)}l=i}return r.setMeta(Nu,{fixTables:!0})}function Lu(e){let t=e.selection,n=yu(e),r=n.node(-1),i=n.start(-1),a=q.get(r);return{...t instanceof Y?a.rectBetween(t.$anchorCell.pos-i,t.$headCell.pos-i):a.findCell(n.pos-i),tableStart:i,map:a,table:r}}function Ru(e,{map:t,tableStart:n,table:r},i){let a=i>0?-1:0;Du(t,r,i+a)&&(a=i==0||i==t.width?null:0);for(let o=0;o<t.height;o++){let s=o*t.width+i;if(i>0&&i<t.width&&t.map[s-1]==t.map[s]){let a=t.map[s],c=r.nodeAt(a);e.setNodeMarkup(e.mapping.map(n+a),null,Eu(c.attrs,i-t.colCount(a))),o+=c.attrs.rowspan-1}else{let c=a==null?J(r.type.schema).cell:r.nodeAt(t.map[s+a]).type,l=t.positionAt(o,i,r);e.insert(e.mapping.map(n+l),c.createAndFill())}}return e}function zu(e,t){if(!vu(e))return!1;if(t){let n=Lu(e);t(Ru(e.tr,n,n.left))}return!0}function Bu(e,t){if(!vu(e))return!1;if(t){let n=Lu(e);t(Ru(e.tr,n,n.right))}return!0}function Vu(e,{map:t,table:n,tableStart:r},i){let a=e.mapping.maps.length;for(let o=0;o<t.height;){let s=o*t.width+i,c=t.map[s],l=n.nodeAt(c),u=l.attrs;if(i>0&&t.map[s-1]==c||i<t.width-1&&t.map[s+1]==c)e.setNodeMarkup(e.mapping.slice(a).map(r+c),null,Tu(u,i-t.colCount(c)));else{let t=e.mapping.slice(a).map(r+c);e.delete(t,t+l.nodeSize)}o+=u.rowspan}}function Hu(e,t){if(!vu(e))return!1;if(t){let n=Lu(e),r=e.tr;if(n.left==0&&n.right==n.map.width)return!1;for(let e=n.right-1;Vu(r,n,e),e!=n.left;e--){let e=n.tableStart?r.doc.nodeAt(n.tableStart-1):r.doc;if(!e)throw RangeError(`No table found`);n.table=e,n.map=q.get(e)}t(r)}return!0}function Uu(e,t,n){let r=J(t.type.schema).header_cell;for(let i=0;i<e.width;i++)if(t.nodeAt(e.map[i+n*e.width])?.type!=r)return!1;return!0}function Wu(e,{map:t,tableStart:n,table:r},i){let a=n;for(let e=0;e<i;e++)a+=r.child(e).nodeSize;let o=[],s=i>0?-1:0;Uu(t,r,i+s)&&(s=i==0||i==t.height?null:0);for(let a=0,c=t.width*i;a<t.width;a++,c++)if(i>0&&i<t.height&&t.map[c]==t.map[c-t.width]){let i=t.map[c],o=r.nodeAt(i).attrs;e.setNodeMarkup(n+i,null,{...o,rowspan:o.rowspan+1}),a+=o.colspan-1}else{let e=(s==null?J(r.type.schema).cell:r.nodeAt(t.map[c+s*t.width])?.type)?.createAndFill();e&&o.push(e)}return e.insert(a,J(r.type.schema).row.create(null,o)),e}function Gu(e,t){if(!vu(e))return!1;if(t){let n=Lu(e);t(Wu(e.tr,n,n.top))}return!0}function Ku(e,t){if(!vu(e))return!1;if(t){let n=Lu(e);t(Wu(e.tr,n,n.bottom))}return!0}function qu(e,{map:t,table:n,tableStart:r},i){let a=0;for(let e=0;e<i;e++)a+=n.child(e).nodeSize;let o=a+n.child(i).nodeSize,s=e.mapping.maps.length;e.delete(a+r,o+r);let c=new Set;for(let a=0,o=i*t.width;a<t.width;a++,o++){let l=t.map[o];if(!c.has(l)){if(c.add(l),i>0&&l==t.map[o-t.width]){let t=n.nodeAt(l).attrs;e.setNodeMarkup(e.mapping.slice(s).map(l+r),null,{...t,rowspan:t.rowspan-1}),a+=t.colspan-1}else if(i<t.height&&l==t.map[o+t.width]){let o=n.nodeAt(l),c=o.attrs,u=o.type.create({...c,rowspan:o.attrs.rowspan-1},o.content),d=t.positionAt(i+1,a,n);e.insert(e.mapping.slice(s).map(r+d),u),a+=c.colspan-1}}}}function Ju(e,t){if(!vu(e))return!1;if(t){let n=Lu(e),r=e.tr;if(n.top==0&&n.bottom==n.map.height)return!1;for(let e=n.bottom-1;qu(r,n,e),e!=n.top;e--){let e=n.tableStart?r.doc.nodeAt(n.tableStart-1):r.doc;if(!e)throw RangeError(`No table found`);n.table=e,n.map=q.get(n.table)}t(r)}return!0}function Yu(e){let t=e.content;return t.childCount==1&&t.child(0).isTextblock&&t.child(0).childCount==0}function Xu({width:e,height:t,map:n},r){let i=r.top*e+r.left,a=i,o=(r.bottom-1)*e+r.left,s=i+(r.right-r.left-1);for(let t=r.top;t<r.bottom;t++){if(r.left>0&&n[a]==n[a-1]||r.right<e&&n[s]==n[s+1])return!0;a+=e,s+=e}for(let a=r.left;a<r.right;a++){if(r.top>0&&n[i]==n[i-e]||r.bottom<t&&n[o]==n[o+e])return!0;i++,o++}return!1}function Zu(e,t){let n=e.selection;if(!(n instanceof Y)||n.$anchorCell.pos==n.$headCell.pos)return!1;let r=Lu(e),{map:i}=r;if(Xu(i,r))return!1;if(t){let n=e.tr,a={},o=M.empty,s,c;for(let e=r.top;e<r.bottom;e++)for(let t=r.left;t<r.right;t++){let l=i.map[e*i.width+t],u=r.table.nodeAt(l);if(!(a[l]||!u)){if(a[l]=!0,s==null)s=l,c=u;else{Yu(u)||(o=o.append(u.content));let e=n.mapping.map(l+r.tableStart);n.delete(e,e+u.nodeSize)}}}if(s==null||c==null)return!0;if(n.setNodeMarkup(s+r.tableStart,null,{...Eu(c.attrs,c.attrs.colspan,r.right-r.left-c.attrs.colspan),rowspan:r.bottom-r.top}),o.size>0){let e=s+1+c.content.size,t=Yu(c)?s+1:e;n.replaceWith(t+r.tableStart,e+r.tableStart,o)}n.setSelection(new Y(n.doc.resolve(s+r.tableStart))),t(n)}return!0}function Qu(e,t){let n=J(e.schema);return $u(({node:e})=>n[e.type.spec.tableRole])(e,t)}function $u(e){return(t,n)=>{let r=t.selection,i,a;if(r instanceof Y){if(r.$anchorCell.pos!=r.$headCell.pos)return!1;i=r.$anchorCell.nodeAfter,a=r.$anchorCell.pos}else{if(i=_u(r.$from),!i)return!1;a=gu(r.$from)?.pos}if(i==null||a==null||i.attrs.colspan==1&&i.attrs.rowspan==1)return!1;if(n){let o=i.attrs,s=[],c=o.colwidth;o.rowspan>1&&(o={...o,rowspan:1}),o.colspan>1&&(o={...o,colspan:1});let l=Lu(t),u=t.tr;for(let e=0;e<l.right-l.left;e++)s.push(c?{...o,colwidth:c&&c[e]?[c[e]]:null}:o);let d;for(let t=l.top;t<l.bottom;t++){let n=l.map.positionAt(t,l.left,l.table);t==l.top&&(n+=i.nodeSize);for(let r=l.left,a=0;r<l.right;r++,a++)(r!=l.left||t!=l.top)&&u.insert(d=u.mapping.map(n+l.tableStart,1),e({node:i,row:t,col:r}).createAndFill(s[a]))}u.setNodeMarkup(a,e({node:i,row:l.top,col:l.left}),s[0]),r instanceof Y&&u.setSelection(new Y(u.doc.resolve(r.$anchorCell.pos),d?u.doc.resolve(d):void 0)),n(u)}return!0}}function ed(e,t){return function(n,r){if(!vu(n))return!1;let i=yu(n);if(i.nodeAfter.attrs[e]===t)return!1;if(r){let a=n.tr;n.selection instanceof Y?n.selection.forEachCell((n,r)=>{n.attrs[e]!==t&&a.setNodeMarkup(r,null,{...n.attrs,[e]:t})}):a.setNodeMarkup(i.pos,null,{...i.nodeAfter.attrs,[e]:t}),r(a)}return!0}}function td(e){return function(t,n){if(!vu(t))return!1;if(n){let r=J(t.schema),i=Lu(t),a=t.tr,o=i.map.cellsInRect(e==`column`?{left:i.left,top:0,right:i.right,bottom:i.map.height}:e==`row`?{left:0,top:i.top,right:i.map.width,bottom:i.bottom}:i),s=o.map(e=>i.table.nodeAt(e));for(let e=0;e<o.length;e++)s[e].type==r.header_cell&&a.setNodeMarkup(i.tableStart+o[e],r.cell,s[e].attrs);if(a.steps.length===0)for(let e=0;e<o.length;e++)a.setNodeMarkup(i.tableStart+o[e],r.header_cell,s[e].attrs);n(a)}return!0}}function nd(e,t,n){let r=t.map.cellsInRect({left:0,top:0,right:e==`row`?t.map.width:1,bottom:e==`column`?t.map.height:1});for(let e=0;e<r.length;e++){let i=t.table.nodeAt(r[e]);if(i&&i.type!==n.header_cell)return!1}return!0}function rd(e,t){return t||={useDeprecatedLogic:!1},t.useDeprecatedLogic?td(e):function(t,n){if(!vu(t))return!1;if(n){let r=J(t.schema),i=Lu(t),a=t.tr,o=nd(`row`,i,r),s=nd(`column`,i,r),c=(e===`column`?o:e===`row`&&s)?1:0,l=e==`column`?{left:0,top:c,right:1,bottom:i.map.height}:e==`row`?{left:c,top:0,right:i.map.width,bottom:1}:i,u=e==`column`?s?r.cell:r.header_cell:e==`row`?o?r.cell:r.header_cell:r.cell;i.map.cellsInRect(l).forEach(e=>{let t=e+i.tableStart,n=a.doc.nodeAt(t);n&&a.setNodeMarkup(t,u,n.attrs)}),n(a)}return!0}}rd(`row`,{useDeprecatedLogic:!0}),rd(`column`,{useDeprecatedLogic:!0});var id=rd(`cell`,{useDeprecatedLogic:!0});function ad(e,t){if(t<0){let t=e.nodeBefore;if(t)return e.pos-t.nodeSize;for(let t=e.index(-1)-1,n=e.before();t>=0;t--){let r=e.node(-1).child(t),i=r.lastChild;if(i)return n-1-i.nodeSize;n-=r.nodeSize}}else{if(e.index()<e.parent.childCount-1)return e.pos+e.nodeAfter.nodeSize;let t=e.node(-1);for(let n=e.indexAfter(-1),r=e.after();n<t.childCount;n++){let e=t.child(n);if(e.childCount)return r+1;r+=e.nodeSize}}return null}function od(e){return function(t,n){if(!vu(t))return!1;let r=ad(yu(t),e);if(r==null)return!1;if(n){let e=t.doc.resolve(r);n(t.tr.setSelection(E.between(e,Su(e))).scrollIntoView())}return!0}}function sd(e,t){let n=e.selection.$anchor;for(let r=n.depth;r>0;r--)if(n.node(r).type.spec.tableRole==`table`)return t&&t(e.tr.delete(n.before(r),n.after(r)).scrollIntoView()),!0;return!1}function cd(e,t){let n=e.selection;if(!(n instanceof Y))return!1;if(t){let r=e.tr,i=J(e.schema).cell.createAndFill().content;n.forEachCell((e,t)=>{e.content.eq(i)||r.replace(r.mapping.map(t+1),r.mapping.map(t+e.nodeSize-1),new j(i,0,0))}),r.docChanged&&t(r)}return!0}function ld(e){if(e.size===0)return null;let{content:t,openStart:n,openEnd:r}=e;for(;t.childCount==1&&(n>0&&r>0||t.child(0).type.spec.tableRole==`table`);)n--,r--,t=t.child(0).content;let i=t.child(0),a=i.type.spec.tableRole,o=i.type.schema,s=[];if(a==`row`)for(let e=0;e<t.childCount;e++){let i=t.child(e).content,a=e?0:Math.max(0,n-1),c=e<t.childCount-1?0:Math.max(0,r-1);(a||c)&&(i=dd(J(o).row,new j(i,a,c)).content),s.push(i)}else if(a==`cell`||a==`header_cell`)s.push(n||r?dd(J(o).row,new j(t,n,r)).content:t);else return null;return ud(o,s)}function ud(e,t){let n=[];for(let e=0;e<t.length;e++){let r=t[e];for(let t=r.childCount-1;t>=0;t--){let{rowspan:i,colspan:a}=r.child(t).attrs;for(let t=e;t<e+i;t++)n[t]=(n[t]||0)+a}}let r=0;for(let e=0;e<n.length;e++)r=Math.max(r,n[e]);for(let i=0;i<n.length;i++)if(i>=t.length&&t.push(M.empty),n[i]<r){let a=J(e).cell.createAndFill(),o=[];for(let e=n[i];e<r;e++)o.push(a);t[i]=t[i].append(M.from(o))}return{height:t.length,width:r,rows:t}}function dd(e,t){let n=e.createAndFill();return new Be(n).replace(0,n.content.size,t).doc}function fd({width:e,height:t,rows:n},r,i){if(e!=r){let t=[],i=[];for(let e=0;e<n.length;e++){let a=n[e],o=[];for(let n=t[e]||0,i=0;n<r;i++){let s=a.child(i%a.childCount);n+s.attrs.colspan>r&&(s=s.type.createChecked(Tu(s.attrs,s.attrs.colspan,n+s.attrs.colspan-r),s.content)),o.push(s),n+=s.attrs.colspan;for(let n=1;n<s.attrs.rowspan;n++)t[e+n]=(t[e+n]||0)+s.attrs.colspan}i.push(M.from(o))}n=i,e=r}if(t!=i){let e=[];for(let r=0,a=0;r<i;r++,a++){let o=[],s=n[a%t];for(let e=0;e<s.childCount;e++){let t=s.child(e);r+t.attrs.rowspan>i&&(t=t.type.create({...t.attrs,rowspan:Math.max(1,i-t.attrs.rowspan)},t.content)),o.push(t)}e.push(M.from(o))}n=e,t=i}return{width:e,height:t,rows:n}}function pd(e,t,n,r,i,a,o){let s=e.doc.type.schema,c=J(s),l,u;if(i>t.width)for(let a=0,s=0;a<t.height;a++){let d=n.child(a);s+=d.nodeSize;let f=[],p;p=d.lastChild==null||d.lastChild.type==c.cell?l||=c.cell.createAndFill():u||=c.header_cell.createAndFill();for(let e=t.width;e<i;e++)f.push(p);e.insert(e.mapping.slice(o).map(s-1+r),f)}if(a>t.height){let s=[];for(let e=0,r=(t.height-1)*t.width;e<Math.max(t.width,i);e++){let i=e>=t.width?!1:n.nodeAt(t.map[r+e]).type==c.header_cell;s.push(i?u||=c.header_cell.createAndFill():l||=c.cell.createAndFill())}let d=c.row.create(null,M.from(s)),f=[];for(let e=t.height;e<a;e++)f.push(d);e.insert(e.mapping.slice(o).map(r+n.nodeSize-2),f)}return!!(l||u)}function md(e,t,n,r,i,a,o,s){if(o==0||o==t.height)return!1;let c=!1;for(let l=i;l<a;l++){let i=o*t.width+l,a=t.map[i];if(t.map[i-t.width]==a){c=!0;let i=n.nodeAt(a),{top:u,left:d}=t.findCell(a);e.setNodeMarkup(e.mapping.slice(s).map(a+r),null,{...i.attrs,rowspan:o-u}),e.insert(e.mapping.slice(s).map(t.positionAt(o,d,n)),i.type.createAndFill({...i.attrs,rowspan:u+i.attrs.rowspan-o})),l+=i.attrs.colspan-1}}return c}function hd(e,t,n,r,i,a,o,s){if(o==0||o==t.width)return!1;let c=!1;for(let l=i;l<a;l++){let i=l*t.width+o,a=t.map[i];if(t.map[i-1]==a){c=!0;let i=n.nodeAt(a),u=t.colCount(a),d=e.mapping.slice(s).map(a+r);e.setNodeMarkup(d,null,Tu(i.attrs,o-u,i.attrs.colspan-(o-u))),e.insert(d+i.nodeSize,i.type.createAndFill(Tu(i.attrs,0,o-u))),l+=i.attrs.rowspan-1}}return c}function gd(e,t,n,r,i){let a=n?e.doc.nodeAt(n-1):e.doc;if(!a)throw Error(`No table found`);let o=q.get(a),{top:s,left:c}=r,l=c+i.width,u=s+i.height,d=e.tr,f=0;function p(){if(a=n?d.doc.nodeAt(n-1):d.doc,!a)throw Error(`No table found`);o=q.get(a),f=d.mapping.maps.length}pd(d,o,a,n,l,u,f)&&p(),md(d,o,a,n,c,l,s,f)&&p(),md(d,o,a,n,c,l,u,f)&&p(),hd(d,o,a,n,s,u,c,f)&&p(),hd(d,o,a,n,s,u,l,f)&&p();for(let e=s;e<u;e++){let t=o.positionAt(e,c,a),r=o.positionAt(e,l,a);d.replace(d.mapping.slice(f).map(t+n),d.mapping.slice(f).map(r+n),new j(i.rows[e-s],0,0))}p(),d.setSelection(new Y(d.doc.resolve(n+o.positionAt(s,c,a)),d.doc.resolve(n+o.positionAt(u-1,l-1,a)))),t(d)}var _d=pt({ArrowLeft:yd(`horiz`,-1),ArrowRight:yd(`horiz`,1),ArrowUp:yd(`vert`,-1),ArrowDown:yd(`vert`,1),"Shift-ArrowLeft":bd(`horiz`,-1),"Shift-ArrowRight":bd(`horiz`,1),"Shift-ArrowUp":bd(`vert`,-1),"Shift-ArrowDown":bd(`vert`,1),Backspace:cd,"Mod-Backspace":cd,Delete:cd,"Mod-Delete":cd});function vd(e,t,n){return!n.eq(e.selection)&&(t&&t(e.tr.setSelection(n).scrollIntoView()),!0)}function yd(e,t){return(n,r,i)=>{if(!i)return!1;let a=n.selection;if(a instanceof Y)return vd(n,r,k.near(a.$headCell,t));if(e!=`horiz`&&!a.empty)return!1;let o=wd(i,e,t);if(o==null)return!1;if(e==`horiz`)return vd(n,r,k.near(n.doc.resolve(a.head+t),t));{let i=n.doc.resolve(o),a=wu(i,e,t),s;return s=a?k.near(a,1):t<0?k.near(n.doc.resolve(i.before(-1)),-1):k.near(n.doc.resolve(i.after(-1)),1),vd(n,r,s)}}}function bd(e,t){return(n,r,i)=>{if(!i)return!1;let a=n.selection,o;if(a instanceof Y)o=a;else{let r=wd(i,e,t);if(r==null)return!1;o=new Y(n.doc.resolve(r))}let s=wu(o.$headCell,e,t);return s?vd(n,r,new Y(o.$anchorCell,s)):!1}}function xd(e,t){let n=e.state.doc,r=gu(n.resolve(t));return r?(e.dispatch(e.state.tr.setSelection(new Y(r))),!0):!1}function Sd(e,t,n){if(!vu(e.state))return!1;let r=ld(n),i=e.state.selection;if(i instanceof Y){r||={width:1,height:1,rows:[M.from(dd(J(e.state.schema).cell,n))]};let t=i.$anchorCell.node(-1),a=i.$anchorCell.start(-1),o=q.get(t).rectBetween(i.$anchorCell.pos-a,i.$headCell.pos-a);return r=fd(r,o.right-o.left,o.bottom-o.top),gd(e.state,e.dispatch,a,o,r),!0}if(r){let t=yu(e.state),n=t.start(-1);return gd(e.state,e.dispatch,n,q.get(t.node(-1)).findCell(t.pos-n),r),!0}return!1}function Cd(e,t){if(t.button!=0||t.ctrlKey||t.metaKey)return;let n=Td(e,t.target),r;if(t.shiftKey&&e.state.selection instanceof Y)i(e.state.selection.$anchorCell,t),t.preventDefault();else if(t.shiftKey&&n&&(r=gu(e.state.selection.$anchor))!=null&&Ed(e,t)?.pos!=r.pos)i(r,t),t.preventDefault();else if(!n)return;function i(t,n){let r=Ed(e,n),i=hu.getState(e.state)==null;if(!r||!Cu(t,r)){if(i)r=t;else return}let a=new Y(t,r);if(i||!e.state.selection.eq(a)){let n=e.state.tr.setSelection(a);i&&n.setMeta(hu,t.pos),e.dispatch(n)}}function a(){e.root.removeEventListener(`mouseup`,a),e.root.removeEventListener(`dragstart`,a),e.root.removeEventListener(`mousemove`,o),hu.getState(e.state)!=null&&e.dispatch(e.state.tr.setMeta(hu,-1))}function o(r){let o=r,s=hu.getState(e.state),c;if(s!=null)c=e.state.doc.resolve(s);else if(Td(e,o.target)!=n&&(c=Ed(e,t),!c))return a();c&&i(c,o)}e.root.addEventListener(`mouseup`,a),e.root.addEventListener(`dragstart`,a),e.root.addEventListener(`mousemove`,o)}function wd(e,t,n){if(!(e.state.selection instanceof E))return null;let{$head:r}=e.state.selection;for(let i=r.depth-1;i>=0;i--){let a=r.node(i);if((n<0?r.index(i):r.indexAfter(i))!=(n<0?0:a.childCount))return null;if(a.type.spec.tableRole==`cell`||a.type.spec.tableRole==`header_cell`){let a=r.before(i),o=t==`vert`?n>0?`down`:`up`:n>0?`right`:`left`;return e.endOfTextblock(o)?a:null}}return null}function Td(e,t){for(;t&&t!=e.dom;t=t.parentNode)if(t.nodeName==`TD`||t.nodeName==`TH`)return t;return null}function Ed(e,t){let n=e.posAtCoords({left:t.clientX,top:t.clientY});if(!n)return null;let{inside:r,pos:i}=n;return r>=0&&gu(e.state.doc.resolve(r))||gu(e.state.doc.resolve(i))}var Dd=class{constructor(e,t){this.node=e,this.defaultCellMinWidth=t,this.dom=document.createElement(`div`),this.dom.className=`tableWrapper`,this.table=this.dom.appendChild(document.createElement(`table`)),this.table.style.setProperty(`--default-cell-min-width`,`${t}px`),this.colgroup=this.table.appendChild(document.createElement(`colgroup`)),Od(e,this.colgroup,this.table,t),this.contentDOM=this.table.appendChild(document.createElement(`tbody`))}update(e){return e.type==this.node.type&&(this.node=e,Od(e,this.colgroup,this.table,this.defaultCellMinWidth),!0)}ignoreMutation(e){return e.type==`attributes`&&(e.target==this.table||this.colgroup.contains(e.target))}};function Od(e,t,n,r,i,a){let o=0,s=!0,c=t.firstChild,l=e.firstChild;if(l){for(let e=0,n=0;e<l.childCount;e++){let{colspan:u,colwidth:d}=l.child(e).attrs;for(let e=0;e<u;e++,n++){let l=i==n?a:d&&d[e],u=l?l+`px`:``;if(o+=l||r,l||(s=!1),c)c.style.width!=u&&(c.style.width=u),c=c.nextSibling;else{let e=document.createElement(`col`);e.style.width=u,t.appendChild(e)}}}for(;c;){var u;let e=c.nextSibling;(u=c.parentNode)==null||u.removeChild(c),c=e}s?(n.style.width=o+`px`,n.style.minWidth=``):(n.style.width=``,n.style.minWidth=o+`px`)}}var X=new T(`tableColumnResizing`);function kd({handleWidth:e=5,cellMinWidth:t=25,defaultCellMinWidth:n=100,View:r=Dd,lastColumnResizable:i=!0}={}){let a=new C({key:X,state:{init(e,t){var i;let o=(i=a.spec)==null||(i=i.props)==null?void 0:i.nodeViews,s=J(t.schema).table.name;return r&&o&&(o[s]=(e,t)=>new r(e,n,t)),new Ad(-1,!1)},apply(e,t){return t.apply(e)}},props:{attributes:e=>{let t=X.getState(e);return t&&t.activeHandle>-1?{class:`resize-cursor`}:{}},handleDOMEvents:{mousemove:(t,n)=>{jd(t,n,e,i)},mouseleave:e=>{Md(e)},mousedown:(e,r)=>{Nd(e,r,t,n)}},decorations:e=>{let t=X.getState(e);if(t&&t.activeHandle>-1)return Hd(e,t.activeHandle)},nodeViews:{}}});return a}var Ad=class e{constructor(e,t){this.activeHandle=e,this.dragging=t}apply(t){let n=this,r=t.getMeta(X);if(r&&r.setHandle!=null)return new e(r.setHandle,!1);if(r&&r.setDragging!==void 0)return new e(n.activeHandle,r.setDragging);if(n.activeHandle>-1&&t.docChanged){let r=t.mapping.map(n.activeHandle,-1);return xu(t.doc.resolve(r))||(r=-1),new e(r,n.dragging)}return n}};function jd(e,t,n,r){if(!e.editable)return;let i=X.getState(e.state);if(i&&!i.dragging){let a=Fd(t.target),o=-1;if(a){let{left:r,right:i}=a.getBoundingClientRect();t.clientX-r<=n?o=Id(e,t,`left`,n):i-t.clientX<=n&&(o=Id(e,t,`right`,n))}if(o!=i.activeHandle){if(!r&&o!==-1){let t=e.state.doc.resolve(o),n=t.node(-1),r=q.get(n),i=t.start(-1);if(r.colCount(t.pos-i)+t.nodeAfter.attrs.colspan-1==r.width-1)return}Rd(e,o)}}}function Md(e){if(!e.editable)return;let t=X.getState(e.state);t&&t.activeHandle>-1&&!t.dragging&&Rd(e,-1)}function Nd(e,t,n,r){if(!e.editable)return!1;let i=e.dom.ownerDocument.defaultView??window,a=X.getState(e.state);if(!a||a.activeHandle==-1||a.dragging)return!1;let o=e.state.doc.nodeAt(a.activeHandle),s=Pd(e,a.activeHandle,o.attrs);e.dispatch(e.state.tr.setMeta(X,{setDragging:{startX:t.clientX,startWidth:s}}));function c(t){i.removeEventListener(`mouseup`,c),i.removeEventListener(`mousemove`,l);let r=X.getState(e.state);r?.dragging&&(zd(e,r.activeHandle,Ld(r.dragging,t,n)),e.dispatch(e.state.tr.setMeta(X,{setDragging:null})))}function l(t){if(!t.which)return c(t);let i=X.getState(e.state);if(i&&i.dragging){let a=Ld(i.dragging,t,n);Bd(e,i.activeHandle,a,r)}}return Bd(e,a.activeHandle,s,r),i.addEventListener(`mouseup`,c),i.addEventListener(`mousemove`,l),t.preventDefault(),!0}function Pd(e,t,{colspan:n,colwidth:r}){let i=r&&r[r.length-1];if(i)return i;let a=e.domAtPos(t),o=a.node.childNodes[a.offset].offsetWidth,s=n;if(r)for(let e=0;e<n;e++)r[e]&&(o-=r[e],s--);return o/s}function Fd(e){for(;e&&e.nodeName!=`TD`&&e.nodeName!=`TH`;)e=e.classList&&e.classList.contains(`ProseMirror`)?null:e.parentNode;return e}function Id(e,t,n,r){let i=n==`right`?-r:r,a=e.posAtCoords({left:t.clientX+i,top:t.clientY});if(!a)return-1;let{pos:o}=a,s=gu(e.state.doc.resolve(o));if(!s)return-1;if(n==`right`)return s.pos;let c=q.get(s.node(-1)),l=s.start(-1),u=c.map.indexOf(s.pos-l);return u%c.width==0?-1:l+c.map[u-1]}function Ld(e,t,n){let r=t.clientX-e.startX;return Math.max(n,e.startWidth+r)}function Rd(e,t){e.dispatch(e.state.tr.setMeta(X,{setHandle:t}))}function zd(e,t,n){let r=e.state.doc.resolve(t),i=r.node(-1),a=q.get(i),o=r.start(-1),s=a.colCount(r.pos-o)+r.nodeAfter.attrs.colspan-1,c=e.state.tr;for(let e=0;e<a.height;e++){let t=e*a.width+s;if(e&&a.map[t]==a.map[t-a.width])continue;let r=a.map[t],l=i.nodeAt(r).attrs,u=l.colspan==1?0:s-a.colCount(r);if(l.colwidth&&l.colwidth[u]==n)continue;let d=l.colwidth?l.colwidth.slice():Vd(l.colspan);d[u]=n,c.setNodeMarkup(o+r,null,{...l,colwidth:d})}c.docChanged&&e.dispatch(c)}function Bd(e,t,n,r){let i=e.state.doc.resolve(t),a=i.node(-1),o=i.start(-1),s=q.get(a).colCount(i.pos-o)+i.nodeAfter.attrs.colspan-1,c=e.domAtPos(i.start(-1)).node;for(;c&&c.nodeName!=`TABLE`;)c=c.parentNode;c&&Od(a,c.firstChild,c,r,s,n)}function Vd(e){return Array(e).fill(0)}function Hd(e,t){let n=[],r=e.doc.resolve(t),i=r.node(-1);if(!i)return O.empty;let a=q.get(i),o=r.start(-1),s=a.colCount(r.pos-o)+r.nodeAfter.attrs.colspan-1;for(let t=0;t<a.height;t++){let r=s+t*a.width;if((s==a.width-1||a.map[r]!=a.map[r+1])&&(t==0||a.map[r]!=a.map[r-a.width])){let t=a.map[r],s=o+t+i.nodeAt(t).nodeSize-1,c=document.createElement(`div`);c.className=`column-resize-handle`,X.getState(e)?.dragging&&n.push(Ke.node(o+t,o+t+i.nodeAt(t).nodeSize,{class:`column-resize-dragging`})),n.push(Ke.widget(s,c))}}return O.create(e.doc,n)}function Ud({allowTableNodeSelection:e=!1}={}){return new C({key:hu,state:{init(){return null},apply(e,t){let n=e.getMeta(hu);if(n!=null)return n==-1?null:n;if(t==null||!e.docChanged)return t;let{deleted:r,pos:i}=e.mapping.mapResult(t);return r?null:i}},props:{decorations:ku,handleDOMEvents:{mousedown:Cd},createSelectionBetween(e){return hu.getState(e.state)==null?null:e.state.selection},handleTripleClick:xd,handleKeyDown:_d,handlePaste:Sd},appendTransaction(t,n,r){return Mu(r,Fu(r,n),e)}})}function Wd(e){return e===`left`||e===`right`||e===`center`?e:null}function Gd(e){let t=(e.style.textAlign||``).trim().toLowerCase(),n=(e.getAttribute(`align`)||``).trim().toLowerCase();return Wd(t||n)}function Kd(e){return Wd(e?.align)}function qd(){return{default:null,parseHTML:e=>Gd(e),renderHTML:e=>e.align?{style:`text-align: ${e.align}`}:{}}}function Jd(e){let t=e.parentElement,n=e.closest(`table`);if(!t||!n)return null;let r=Array.from(t.children).indexOf(e),i=n.querySelectorAll(`colgroup > col`)[r]?.getAttribute(`width`);return i?[parseInt(i,10)]:null}function Yd(e){let t=e.getAttribute(`colwidth`);return t?t.split(`,`).map(e=>parseInt(e,10)):Jd(e)}var Xd=/[ \t\r\n\f]+/g;function Zd(e){return e.children.length>0?!1:(e.textContent??``).replace(Xd,``)===``}function Qd(e){let t=e.createAndFill();if(!t)throw Error(`[tiptap error]: "${e.name}" has no default content to backfill.`);return t.content}var $d=D.create({name:`tableCell`,addOptions(){return{HTMLAttributes:{}}},content:`block+`,addAttributes(){return{colspan:{default:1},rowspan:{default:1},colwidth:{default:null,parseHTML:Yd},align:qd()}},tableRole:`cell`,isolating:!0,parseHTML(){return[{tag:`td`,getAttrs:e=>Zd(e)?{}:!1,getContent:(e,t)=>Qd(t.nodes[this.name])},{tag:`td`}]},renderHTML({HTMLAttributes:e}){return[`td`,w(this.options.HTMLAttributes,e),0]}}),ef=D.create({name:`tableHeader`,addOptions(){return{HTMLAttributes:{}}},content:`block+`,addAttributes(){return{colspan:{default:1},rowspan:{default:1},colwidth:{default:null,parseHTML:Yd},align:qd()}},tableRole:`header_cell`,isolating:!0,parseHTML(){return[{tag:`th`,getAttrs:e=>Zd(e)?{}:!1,getContent:(e,t)=>Qd(t.nodes[this.name])},{tag:`th`}]},renderHTML({HTMLAttributes:e}){return[`th`,w(this.options.HTMLAttributes,e),0]}}),tf=D.create({name:`tableRow`,addOptions(){return{HTMLAttributes:{}}},content:`(tableCell | tableHeader)*`,tableRole:`row`,parseHTML(){return[{tag:`tr`}]},renderHTML({HTMLAttributes:e}){return[`tr`,w(this.options.HTMLAttributes,e),0]}});function nf(e,t){return t?[`width`,`${Math.max(t,e)}px`]:[`min-width`,`${e}px`]}function rf(e,t,n,r,i,a){let o=0,s=!0,c=t.firstChild,l=e.firstChild;if(l!==null)for(let e=0,n=0;e<l.childCount;e+=1){let{colspan:u,colwidth:d}=l.child(e).attrs;for(let e=0;e<u;e+=1,n+=1){let l=i===n?a:d&&d[e],u=l?`${l}px`:``;if(o+=l||r,l||(s=!1),c){if(c.style.width!==u){let[e,t]=nf(r,l);c.style.setProperty(e,t)}c=c.nextSibling}else{let e=document.createElement(`col`),[n,i]=nf(r,l);e.style.setProperty(n,i),t.appendChild(e)}}}for(;c;){var u;let e=c.nextSibling;(u=c.parentNode)==null||u.removeChild(c),c=e}let d=e.attrs.style&&typeof e.attrs.style==`string`&&/\bwidth\s*:/i.test(e.attrs.style);s&&!d?(n.style.width=`${o}px`,n.style.minWidth=``):(n.style.width=``,n.style.minWidth=`${o}px`)}var af=class{constructor(e,t,n,r={}){this.node=e,this.cellMinWidth=t,this.dom=document.createElement(`div`),this.dom.className=`tableWrapper`,this.table=this.dom.appendChild(document.createElement(`table`));for(let[e,t]of Object.entries(r))t!=null&&(e===`style`?this.table.style.cssText=String(t):this.table.setAttribute(e,String(t)));e.attrs.style&&(this.table.style.cssText=e.attrs.style),this.colgroup=this.table.appendChild(document.createElement(`colgroup`)),rf(e,this.colgroup,this.table,t),this.contentDOM=this.table.appendChild(document.createElement(`tbody`))}update(e){return e.type===this.node.type&&(this.node=e,rf(e,this.colgroup,this.table,this.cellMinWidth),!0)}ignoreMutation(e){let t=e.target,n=this.dom.contains(t),r=this.contentDOM.contains(t);return!!(n&&!r&&(e.type===`attributes`||e.type===`childList`||e.type===`characterData`))}};function of(e,t,n,r){let i=0,a=!0,o=[],s=e.firstChild;if(!s)return{};for(let e=0,c=0;e<s.childCount;e+=1){let{colspan:l,colwidth:u}=s.child(e).attrs;for(let e=0;e<l;e+=1,c+=1){let s=n===c?r:u&&u[e];i+=s||t,s||(a=!1);let[l,d]=nf(t,s);o.push([`col`,{style:`${l}: ${d}`}])}}let c=a?`${i}px`:``,l=a?``:`${i}px`;return{colgroup:[`colgroup`,{},...o],tableWidth:c,tableMinWidth:l}}function sf(e,t){return t?e.createChecked(null,t):e.createAndFill()}function cf(e){if(e.cached.tableNodeTypes)return e.cached.tableNodeTypes;let t={};return Object.keys(e.nodes).forEach(n=>{let r=e.nodes[n];r.spec.tableRole&&(t[r.spec.tableRole]=r)}),e.cached.tableNodeTypes=t,t}function lf(e,t,n,r,i){let a=cf(e),o=[],s=[];for(let e=0;e<n;e+=1){let e=sf(a.cell,i);if(e&&s.push(e),r){let e=sf(a.header_cell,i);e&&o.push(e)}}let c=[];for(let e=0;e<t;e+=1)c.push(a.row.createChecked(null,r&&e===0?o:s));return a.table.createChecked(null,c)}function uf(e){return e instanceof Y}var df=({editor:e})=>{let{selection:t}=e.state;if(!uf(t))return!1;let n=0;return be(t.ranges[0].$from,e=>e.type.name===`table`)?.node.descendants(e=>{if(e.type.name===`table`)return!1;[`tableCell`,`tableHeader`].includes(e.type.name)&&(n+=1)}),n===t.ranges.length&&(e.commands.deleteTable(),!0)};function ff(e,t){let n=e.mapping.map(t);if(be(e.selection.$from,e=>e.type.name===`table`)?.pos===n)return;let r=e.doc.nodeAt(n);if(!r)return;let i=n+r.nodeSize-1;e.setSelection(E.near(e.doc.resolve(i),-1))}function pf(e){let t=``,n=0;for(;n<e.length;){if(e[n]===`\\`&&n+1<e.length){t+=e[n]+e[n+1],n+=2;continue}if(e[n]!=="`"){t+=e[n++];continue}let r=0;for(;n+r<e.length&&e[n+r]==="`";)r+=1;let i=n+r,a=!1;for(;i<e.length;){if(e[i]!=="`"){i+=1;continue}let o=0;for(;i+o<e.length&&e[i+o]==="`";)o+=1;if(o===r){let o=e.slice(n+r,i);t+=e.slice(n,n+r)+o.replace(/\\\||\|/g,e=>e===`|`?`\\|`:e)+e.slice(i,i+r),n=i+r,a=!0;break}i+=o}a||(t+=e.slice(n,n+r),n+=r)}return t}function mf(e){return e.split(`
`).map(e=>!e.includes(`|`)||!e.includes("`")?e:pf(e)).join(`
`)}function hf(e){return(e||``).replace(/\s+/g,` `).trim()}function gf(e,t,n={}){let r=n.cellLineSeparator??``;if(!e||!e.content||e.content.length===0)return``;let i=[];e.content.forEach(e=>{let n=[];e.content&&e.content.forEach(e=>{let i=``;i=e.content&&Array.isArray(e.content)&&e.content.length>1?e.content.map(e=>t.renderChildren(e)).join(r):e.content?t.renderChildren(e.content):``;let a=hf(i.split(r).join(`
`).replace(/[ \t]*\r?\n[ \t]*/g,`<br>`)),o=e.type===`tableHeader`,s=Kd(e.attrs);n.push({text:a,isHeader:o,align:s})}),i.push(n)});let a=i.reduce((e,t)=>Math.max(e,t.length),0);if(a===0)return``;let o=Array.from({length:a}).fill(0);i.forEach(e=>{for(let t=0;t<a;t+=1){let n=(e[t]?.text||``).length;n>o[t]&&(o[t]=n),o[t]<3&&(o[t]=3)}});let s=(e,t)=>e+` `.repeat(Math.max(0,t-e.length)),c=i[0],l=c.some(e=>e.isHeader),u=Array.from({length:a}).fill(null);i.forEach(e=>{for(let t=0;t<a;t+=1)!u[t]&&e[t]?.align&&(u[t]=e[t].align)});let d=`
`,f=Array.from({length:a}).map((e,t)=>l&&c[t]&&c[t].text||``);return d+=`| ${f.map((e,t)=>s(e,o[t])).join(` | `)} |\n`,d+=`| ${o.map((e,t)=>{let n=Math.max(3,e),r=u[t];return r===`left`?`:${`-`.repeat(n)}`:r===`right`?`${`-`.repeat(n)}:`:r===`center`?`:${`-`.repeat(n)}:`:`-`.repeat(n)}).join(` | `)} |\n`,(l?i.slice(1):i).forEach(e=>{d+=`| ${Array.from({length:a}).fill(0).map((t,n)=>s(e[n]&&e[n].text||``,o[n])).join(` | `)} |\n`}),d}var _f=D.create({name:`table`,addOptions(){return{HTMLAttributes:{},resizable:!1,renderWrapper:!1,handleWidth:5,cellMinWidth:25,View:af,lastColumnResizable:!0,allowTableNodeSelection:!1}},content:`tableRow+`,tableRole:`table`,isolating:!0,group:`block`,parseHTML(){return[{tag:`table`}]},renderHTML({node:e,HTMLAttributes:t}){let{colgroup:n,tableWidth:r,tableMinWidth:i}=of(e,this.options.cellMinWidth),a=t.style;function o(){return a||(r?`width: ${r}`:`min-width: ${i}`)}let s=[`table`,w(this.options.HTMLAttributes,t,{style:o()}),n,[`tbody`,0]];return this.options.renderWrapper?[`div`,{class:`tableWrapper`},s]:s},parseMarkdown:(e,t)=>{let n=[],r=Array.isArray(e.align)?e.align:[];if(e.header){let i=[];e.header.forEach((e,n)=>{let a=Wd(r[n]??e.align),o=a?{align:a}:{};i.push(t.createNode(`tableHeader`,o,[{type:`paragraph`,content:t.parseInline(e.tokens)}]))}),n.push(t.createNode(`tableRow`,{},i))}return e.rows&&e.rows.forEach(e=>{let i=[];e.forEach((e,n)=>{let a=Wd(r[n]??e.align),o=a?{align:a}:{};i.push(t.createNode(`tableCell`,o,[{type:`paragraph`,content:t.parseInline(e.tokens)}]))}),n.push(t.createNode(`tableRow`,{},i))}),t.createNode(`table`,void 0,n)},renderMarkdown:(e,t)=>gf(e,t),markdownTokenizer:{name:`table`,level:`block`,start:e=>{let t=e.split(`
...
`);if(a.length<2)return;let o=a[1];if(!/^[ \t|:]*-[ \t|:-]*$/.test(o)||!o.includes(`|`))return;let s=mf(i);if(s===i)return;let c=n.blockTokens(s)[0];if(c?.type!==`table`||!c.raw)return;let l=c.raw.split(`
`).length,u=e.split(`
`).slice(0,l).join(`
`);return{...c,raw:u}}},addCommands(){return{insertTable:({rows:e=3,cols:t=3,withHeaderRow:n=!0}={})=>({tr:r,dispatch:i,editor:a})=>{let o=lf(a.schema,e,t,n);if(i){let e=r.selection.from+1;r.replaceSelectionWith(o).scrollIntoView().setSelection(E.near(r.doc.resolve(e)))}return!0},addColumnBefore:()=>({state:e,dispatch:t})=>zu(e,t),addColumnAfter:()=>({state:e,dispatch:t})=>Bu(e,t),deleteColumn:()=>({state:e,dispatch:t})=>{let n=be(e.selection.$from,e=>e.type.name===`table`);return Hu(e,t&&(e=>{n&&ff(e,n.pos),t(e)}))},addRowBefore:()=>({state:e,dispatch:t})=>Gu(e,t),addRowAfter:()=>({state:e,dispatch:t})=>Ku(e,t),deleteRow:()=>({state:e,dispatch:t})=>{let n=be(e.selection.$from,e=>e.type.name===`table`);return Ju(e,t&&(e=>{n&&ff(e,n.pos),t(e)}))},deleteTable:()=>({state:e,dispatch:t})=>sd(e,t),mergeCells:()=>({state:e,dispatch:t})=>Zu(e,t),splitCell:()=>({state:e,dispatch:t})=>Qu(e,t),toggleHeaderColumn:()=>({state:e,dispatch:t})=>rd(`column`)(e,t),toggleHeaderRow:()=>({state:e,dispatch:t})=>rd(`row`)(e,t),toggleHeaderCell:()=>({state:e,dispatch:t})=>id(e,t),mergeOrSplit:()=>({state:e,dispatch:t})=>Zu(e,t)?!0:Qu(e,t),setCellAttribute:(e,t)=>({state:n,dispatch:r})=>ed(e,t)(n,r),goToNextCell:()=>({state:e,dispatch:t})=>od(1)(e,t),goToPreviousCell:()=>({state:e,dispatch:t})=>od(-1)(e,t),fixTables:()=>({state:e,dispatch:t})=>(t&&Fu(e),!0),setCellSelection:e=>({tr:t,dispatch:n})=>{if(n){let n=Y.create(t.doc,e.anchorCell,e.headCell);t.setSelection(n)}return!0}}},addKeyboardShortcuts(){return{Tab:()=>this.editor.commands.goToNextCell()?!0:this.editor.can().addRowAfter()?this.editor.chain().addRowAfter().goToNextCell().run():!1,"Shift-Tab":()=>this.editor.commands.goToPreviousCell(),Backspace:df,"Mod-Backspace":df,Delete:df,"Mod-Delete":df}},addProseMirrorPlugins(){return[...this.options.resizable&&this.editor.isEditable?[kd({handleWidth:this.options.handleWidth,cellMinWidth:this.options.cellMinWidth,defaultCellMinWidth:this.options.cellMinWidth,View:this.options.View,lastColumnResizable:this.options.lastColumnResizable})]:[],Ud({allowTableNodeSelection:this.options.allowTableNodeSelection})]},addNodeView(){let e=this.options.resizable&&this.editor.isEditable,t=this.options.View;return e||!t?null:({node:e,view:n,HTMLAttributes:r})=>{let i=w(this.options.HTMLAttributes,r);return new t(e,this.options.cellMinWidth,n,i)}},extendNodeSchema(e){let t={name:e.name,options:e.options,storage:e.storage};return{tableRole:et(St(e,`tableRole`,t))}}});S.create({name:`tableKit`,addExtensions(){let e=[];return this.options.table!==!1&&e.push(_f.configure(this.options.table)),this.options.tableCell!==!1&&e.push($d.configure(this.options.tableCell)),this.options.tableHeader!==!1&&e.push(ef.configure(this.options.tableHeader)),this.options.tableRow!==!1&&e.push(tf.configure(this.options.tableRow)),e}});var vf=tf;function yf(e){let t=typeof e.assetUid==`string`?e.assetUid:``;if(!U(t))return null;let n=[`asset`,`custom`,`decorative`,`missing`].includes(String(e.altMode))?e.altMode:`asset`,r=[`default`,`small`,`medium`,`large`,`full`].includes(String(e.size))?e.size:`default`,i=null;if(e.link&&typeof e.link==`object`){let t=e.link;i=Bi(t)}return{assetUid:t,siteMode:e.siteMode===`fixed`?`fixed`:`current`,siteUid:typeof e.siteUid==`string`?e.siteUid:null,altMode:n,alt:typeof e.alt==`string`?e.alt:null,title:typeof e.title==`string`?e.title:null,size:r,link:i,imageUid:typeof e.imageUid==`string`?e.imageUid:null}}function bf(){return D.create({name:`image`,group:`block`,atom:!0,draggable:!0,selectable:!0,addAttributes(){return{assetUid:{default:null},siteMode:{default:`current`},siteUid:{default:null},altMode:{default:`asset`},alt:{default:null},title:{default:null},size:{default:`default`},link:{default:null},imageUid:{default:null,rendered:!1}}},parseHTML(){return[{tag:`img[data-asset-uid]`,getAttrs:e=>{let t=e.getAttribute(`data-asset-uid`);return!t||!U(t)?!1:yf({assetUid:t})}}]},renderHTML({node:e}){let t=yf(e.attrs);if(!t)return[`span`,{class:`vizy-image-invalid`,"data-vizy-image":`invalid`,contenteditable:`false`},`Image requires asset`];let n=Da(t.assetUid),r=t.altMode===`decorative`?``:t.alt??`Asset ${t.assetUid.slice(0,8)}`;return n?.url?[`figure`,{class:`vizy-image`,"data-asset-uid":t.assetUid,"data-size":t.size,contenteditable:`false`},[`img`,w({src:n.url,alt:r,title:t.title??void 0,draggable:`false`})]]:[`figure`,{class:`vizy-image vizy-image--pending`,"data-asset-uid":t.assetUid,"data-size":t.size,contenteditable:`false`},[`span`,w({class:`vizy-image-placeholder`,role:`img`,"aria-label":r||`Image`}),r||`Image`]]},addNodeView(){return({node:e})=>{let t=yf(e.attrs),n=document.createElement(`figure`);n.className=`vizy-image`,n.contentEditable=`false`,t&&(n.dataset.assetUid=t.assetUid,n.dataset.size=t.size);let r=``,i=e=>{let t=yf(e.attrs),i=n.classList.contains(`ProseMirror-selectednode`);if(!t){r=``,n.replaceChildren(),n.className=`vizy-image vizy-image-invalid`,n.textContent=`Image requires asset`;return}let a=Da(t.assetUid),o=t.altMode===`decorative`?``:t.alt??`Asset ${t.assetUid.slice(0,8)}`,s=[t.assetUid,t.size,t.altMode,t.alt??``,t.title??``,a?.url??``].join(`\0`);if(s===r){n.className=i?`vizy-image ProseMirror-selectednode`:`vizy-image`;return}if(r=s,n.replaceChildren(),n.className=i?`vizy-image ProseMirror-selectednode`:`vizy-image`,n.dataset.assetUid=t.assetUid,n.dataset.size=t.size,a?.url){let e=document.createElement(`img`);e.src=a.url,e.alt=o,t.title&&(e.title=t.title),e.draggable=!1,n.append(e)}else{n.classList.add(`vizy-image--pending`);let e=document.createElement(`span`);e.className=`vizy-image-placeholder`,e.setAttribute(`role`,`img`),e.setAttribute(`aria-label`,o||`Image`),e.textContent=o||`Image`,n.append(e)}},a=e,o=t?.assetUid??``,s=Ta(o,()=>i(a));return i(e),{dom:n,ignoreMutation:e=>e.type!==`selection`,destroy:()=>s(),update:e=>{if(e.type.name!==`image`)return!1;a=e;let t=String(e.attrs.assetUid??``);return t!==o&&(s(),o=t,s=Ta(t,()=>i(a))),i(e),!0},selectNode:()=>{n.classList.add(`ProseMirror-selectednode`)},deselectNode:()=>{n.classList.remove(`ProseMirror-selectednode`)}}}},addCommands(){return{setSemanticImage:e=>({chain:t,state:n})=>{let r=yf(e);if(!r)return!1;let{$from:i}=n.selection,a=i.parent;return a.type.name===`paragraph`&&a.content.size===0?t().insertContentAt({from:i.before(),to:i.after()},{type:this.name,attrs:r}).run():t().insertContent({type:this.name,attrs:r}).run()}}}})}var xf=new Set([`entry`,`asset`,`category`,`url`,`email`,`tel`,`sms`,`unknown`]);function Sf(e){return typeof e==`string`&&e!==``?e:null}function Cf(e){return Array.isArray(e)?e.filter(e=>typeof e==`string`):typeof e==`string`&&e.trim()!==``?e.split(/\s+/):[]}function wf(e){return zi({type:xf.has(e.type)?e.type:`url`,targetUid:Sf(e.targetUid),siteMode:e.siteMode===`fixed`?`fixed`:`current`,siteUid:Sf(e.siteUid),value:Sf(e.value),suffix:Sf(e.suffix),newWindow:e.newWindow===!0,title:Sf(e.title),ariaLabel:Sf(e.ariaLabel),rel:Cf(e.rel),class:Sf(e.class),id:Sf(e.id),download:e.download===!0||typeof e.download==`string`?e.download:null,linkUid:Sf(e.linkUid)})}function Tf(){return Ee.create({name:`link`,priority:1e3,inclusive:!0,keepOnSplit:!1,addAttributes(){return{type:{default:`url`},targetUid:{default:null},siteMode:{default:`current`},siteUid:{default:null},value:{default:null},suffix:{default:null},newWindow:{default:!1},title:{default:null},ariaLabel:{default:null},rel:{default:[]},class:{default:null},id:{default:null},download:{default:null},linkUid:{default:null,rendered:!1}}},parseHTML(){return[{tag:`a[href]`,getAttrs:e=>{let t=e.getAttribute(`href`);return!t||t.startsWith(`#vizy-link:`)?!1:wf({type:`url`,value:t})}}]},renderHTML({mark:e}){let t=wf(e.attrs),n=Hi(t),r={href:Pi(n)?n:`#`,"data-vizy-link-type":t.type};if(t.newWindow&&(r.target=`_blank`,r.rel=`noopener noreferrer`),t.title&&(r.title=t.title),t.ariaLabel&&(r[`aria-label`]=t.ariaLabel),t.class&&(r.class=t.class),t.id&&(r.id=t.id),t.rel.length){let e=t.rel.filter(e=>!t.newWindow||e.toLowerCase()!==`opener`);t.newWindow&&e.push(`noopener`,`noreferrer`),r.rel=[...new Set(e)].join(` `)}return[`a`,w(r),0]},addCommands(){return{setSemanticLink:e=>({chain:t})=>t().setMark(this.name,wf(e)).setMeta(`preventAutolink`,!0).run(),toggleSemanticLink:e=>({editor:t,chain:n})=>t.isActive(this.name)?n().unsetMark(this.name).run():e?n().setMark(this.name,wf(e)).setMeta(`preventAutolink`,!0).run():!1,unsetSemanticLink:()=>({chain:e})=>e().unsetMark(this.name).run()}}})}var Ef=$d,Df=ef;function Of(e,t){if(!Array.isArray(e)||e.length!==t)return Ui(t);let n=e.map(e=>Number.parseInt(String(e),10));return n.some(e=>!Number.isInteger(e)||e<1)||n.reduce((e,t)=>e+t,0)!==1e3?Ui(t):n}function kf(e,t){let n=Of(e.attrs.columnWidths,t);return e.type.create({...e.attrs,columnWidths:n},e.content,e.marks)}function Af(){return _f.extend({addAttributes(){return{...this.parent?.(),columnWidths:{default:null,parseHTML:e=>{let t=e.getAttribute(`data-column-widths`);if(!t)return null;try{let e=JSON.parse(t);return Array.isArray(e)?e:null}catch{return null}},renderHTML:e=>e.columnWidths?{"data-column-widths":JSON.stringify(e.columnWidths)}:{}}}},addCommands(){return{...this.parent?.()??{},insertTable:({rows:e=3,cols:t=3,withHeaderRow:n=!0}={})=>({tr:r,dispatch:i,editor:a})=>{let o=kf(lf(a.schema,e,t,n),t);if(i){let e=r.selection.from+1;r.replaceSelectionWith(o).scrollIntoView().setSelection(E.near(r.doc.resolve(e)))}return!0}}},addProseMirrorPlugins(){return[...this.parent?.()??[],new C({appendTransaction:(e,t,n)=>{let r=n.tr,i=!1;return n.doc.descendants((e,t)=>{if(e.type.name!==`table`)return;let n=Gi(e);if(n<1)return;let a=Of(e.attrs.columnWidths,n),o=e.attrs.columnWidths,s=Array.isArray(o)?o.reduce((e,t)=>e+t,0):0;(!o||o.length!==n||s!==1e3)&&(r=r.setNodeMarkup(t,void 0,{...e.attrs,columnWidths:a}),i=!0)}),i?r:null}})]}})}function jf(){return Ef}function Mf(){return Df}function Nf(e){return typeof e!=`string`||!/^https?:\/\//i.test(e.trim())?null:Ya(e)}function Pf(){return D.create({name:`iframe`,group:`block`,atom:!0,draggable:!0,selectable:!0,addAttributes(){return{url:{default:null},frameborder:{default:0},allowfullscreen:{default:!0}}},parseHTML(){return[{tag:`iframe[src]`,getAttrs:e=>{let t=Ya(e.getAttribute(`src`)||``);return t?{url:t,frameborder:0,allowfullscreen:!0}:!1}}]},renderHTML({node:e}){let t=Nf(e.attrs.url);return t?[`iframe`,{src:t,frameborder:`0`,allowfullscreen:`true`,class:`vizy-iframe`}]:[`span`,{class:`vizy-iframe__empty`},`Iframe requires a valid URL`]},addNodeView(){return({node:e})=>{let t=document.createElement(`div`);t.className=`vizy-iframe`,t.contentEditable=`false`;let n,r=e=>{let r=t.classList.contains(`ProseMirror-selectednode`),i=Nf(e.attrs.url);if(t.className=r?`vizy-iframe ProseMirror-selectednode`:`vizy-iframe`,n===i)return;if(n=i,t.replaceChildren(),!i){let e=document.createElement(`p`);e.className=`vizy-iframe__empty`,e.textContent=`Iframe requires a URL`,t.append(e);return}let a=document.createElement(`iframe`);a.setAttribute(`sandbox`,`allow-scripts`),a.src=i,a.title=`Embedded content`,a.setAttribute(`frameborder`,`0`),a.allowFullscreen=!0,a.loading=`lazy`,a.referrerPolicy=`strict-origin-when-cross-origin`,a.style.pointerEvents=`none`,t.append(a)};return r(e),{dom:t,update:e=>e.type.name===`iframe`&&(r(e),!0),selectNode:()=>{t.classList.add(`ProseMirror-selectednode`)},deselectNode:()=>{t.classList.remove(`ProseMirror-selectednode`)}}}},addCommands(){return{setVizyIframe:e=>({chain:t,state:n})=>{let r=Ya(e.url);if(!r)return!1;let i={url:r,frameborder:0,allowfullscreen:!0},{$from:a}=n.selection,o=a.parent;return o.type.name===`paragraph`&&o.content.size===0?t().insertContentAt({from:a.before(),to:a.after()},{type:this.name,attrs:i}).run():t().insertContent({type:this.name,attrs:i}).run()}}}})}function Ff(){return D.create({name:`mediaEmbed`,group:`block`,atom:!0,draggable:!0,selectable:!0,addAttributes(){return{url:{default:null},data:{default:null}}},parseHTML(){return[{tag:`div[data-vizy-media-embed]`,getAttrs:e=>{let t=Xa(e.getAttribute(`data-url`)||``);return t?{url:t.url,data:t.html?{html:t.html}:null}:!1}}]},renderHTML({node:e}){return[`div`,{"data-vizy-media-embed":``,"data-url":typeof e.attrs.url==`string`?e.attrs.url:``,class:`vizy-media-embed`}]},addNodeView(){return({node:e})=>{let t=document.createElement(`div`);t.className=`vizy-media-embed`,t.contentEditable=`false`;let n=``,r=e=>{let r=t.classList.contains(`ProseMirror-selectednode`),i=typeof e.attrs.url==`string`?e.attrs.url:``,a=Xa(i)?.html??null,o=`${i}\0${a??``}`;if(o===n){t.className=r?`vizy-media-embed ProseMirror-selectednode`:`vizy-media-embed`;return}if(n=o,t.className=r?`vizy-media-embed ProseMirror-selectednode`:`vizy-media-embed`,t.replaceChildren(),a){let e=document.createElement(`div`);e.className=`vizy-media-embed__preview`,e.innerHTML=a,e.querySelectorAll(`iframe`).forEach(e=>{e.setAttribute(`sandbox`,`allow-scripts`),e.style.pointerEvents=`none`}),t.append(e);return}let s=document.createElement(`div`);s.className=`vizy-media-embed__card`,s.textContent=i||`Media embed requires a URL`,t.append(s)};return r(e),{dom:t,update:e=>e.type.name===`mediaEmbed`&&(r(e),!0),selectNode:()=>{t.classList.add(`ProseMirror-selectednode`)},deselectNode:()=>{t.classList.remove(`ProseMirror-selectednode`)}}}},addCommands(){return{setVizyMediaEmbed:e=>({chain:t,state:n})=>{let r=Xa(e.url);if(!r)return!1;let i={url:r.url,data:r.html?{html:r.html}:null},{$from:a}=n.selection,o=a.parent;return o.type.name===`paragraph`&&o.content.size===0?t().insertContentAt({from:a.before(),to:a.after()},{type:this.name,attrs:i}).run():t().insertContent({type:this.name,attrs:i}).run()}}}})}var If=20,Lf=(e,t=0)=>{let n=[];return!e.children.length||t>If||Array.from(e.children).forEach(e=>{e.tagName===`SPAN`?n.push(e):e.children.length&&n.push(...Lf(e,t+1))}),n},Rf=e=>{if(!e.children.length)return;let t=Lf(e);t&&t.forEach(e=>{var t;let n=e.getAttribute(`style`),r=(t=e.parentElement)==null||(t=t.closest(`span`))==null?void 0:t.getAttribute(`style`);e.setAttribute(`style`,`${r};${n}`)})},zf=Ee.create({name:`textStyle`,priority:101,addOptions(){return{HTMLAttributes:{},mergeNestedSpanStyles:!0}},parseHTML(){return[{tag:`span`,consuming:!1,getAttrs:e=>e.hasAttribute(`style`)?(this.options.mergeNestedSpanStyles&&Rf(e),{}):!1}]},renderHTML({HTMLAttributes:e}){return[`span`,w(this.options.HTMLAttributes,e),0]},addCommands(){return{toggleTextStyle:e=>({commands:t})=>t.toggleMark(this.name,e),removeEmptyTextStyle:()=>({tr:e})=>{let{selection:t}=e;return e.doc.nodesBetween(t.from,t.to,(t,n)=>{if(!t.isInline)return!0;t.marks.filter(e=>e.type===this.type).some(e=>Object.values(e.attrs).some(e=>!!e))||e.removeMark(n,n+t.nodeSize,this.type)}),!0}}}}),Bf=S.create({name:`backgroundColor`,addOptions(){return{types:[`textStyle`]}},addGlobalAttributes(){return[{types:this.options.types,attributes:{backgroundColor:{default:null,parseHTML:e=>(Se(e,`background-color`)??e.style.backgroundColor)?.replace(/['"]+/g,``),renderHTML:e=>e.backgroundColor?{style:`background-color: ${e.backgroundColor}`}:{}}}}]},addCommands(){return{setBackgroundColor:e=>({chain:t})=>t().setMark(`textStyle`,{backgroundColor:e}).run(),unsetBackgroundColor:()=>({chain:e})=>e().setMark(`textStyle`,{backgroundColor:null}).removeEmptyTextStyle().run()}}}),Vf=S.create({name:`color`,addOptions(){return{types:[`textStyle`]}},addGlobalAttributes(){return[{types:this.options.types,attributes:{color:{default:null,parseHTML:e=>(Se(e,`color`)??e.style.color)?.replace(/['"]+/g,``),renderHTML:e=>e.color?{style:`color: ${e.color}`}:{}}}}]},addCommands(){return{setColor:e=>({chain:t})=>t().setMark(`textStyle`,{color:e}).run(),unsetColor:()=>({chain:e})=>e().setMark(`textStyle`,{color:null}).removeEmptyTextStyle().run()}}}),Hf=S.create({name:`fontFamily`,addOptions(){return{types:[`textStyle`]}},addGlobalAttributes(){return[{types:this.options.types,attributes:{fontFamily:{default:null,parseHTML:e=>Se(e,`font-family`)??e.style.fontFamily,renderHTML:e=>e.fontFamily?{style:`font-family: ${e.fontFamily}`}:{}}}}]},addCommands(){return{setFontFamily:e=>({chain:t})=>t().setMark(`textStyle`,{fontFamily:e}).run(),unsetFontFamily:()=>({chain:e})=>e().setMark(`textStyle`,{fontFamily:null}).removeEmptyTextStyle().run()}}}),Uf=S.create({name:`fontSize`,addOptions(){return{types:[`textStyle`]}},addGlobalAttributes(){return[{types:this.options.types,attributes:{fontSize:{default:null,parseHTML:e=>Se(e,`font-size`)??e.style.fontSize,renderHTML:e=>e.fontSize?{style:`font-size: ${e.fontSize}`}:{}}}}]},addCommands(){return{setFontSize:e=>({chain:t})=>t().setMark(`textStyle`,{fontSize:e}).run(),unsetFontSize:()=>({chain:e})=>e().setMark(`textStyle`,{fontSize:null}).removeEmptyTextStyle().run()}}}),Wf=S.create({name:`lineHeight`,addOptions(){return{types:[`textStyle`]}},addGlobalAttributes(){return[{types:this.options.types,attributes:{lineHeight:{default:null,parseHTML:e=>Se(e,`line-height`)??e.style.lineHeight,renderHTML:e=>e.lineHeight?{style:`line-height: ${e.lineHeight}`}:{}}}}]},addCommands(){return{setLineHeight:e=>({chain:t})=>t().setMark(`textStyle`,{lineHeight:e}).run(),unsetLineHeight:()=>({chain:e})=>e().setMark(`textStyle`,{lineHeight:null}).removeEmptyTextStyle().run()}}});S.create({name:`textStyleKit`,addExtensions(){let e=[];return this.options.backgroundColor!==!1&&e.push(Bf.configure(this.options.backgroundColor)),this.options.color!==!1&&e.push(Vf.configure(this.options.color)),this.options.fontFamily!==!1&&e.push(Hf.configure(this.options.fontFamily)),this.options.fontSize!==!1&&e.push(Uf.configure(this.options.fontSize)),this.options.lineHeight!==!1&&e.push(Wf.configure(this.options.lineHeight)),this.options.textStyle!==!1&&e.push(zf.configure(this.options.textStyle)),e}});var Gf=120,Kf=160,qf=`Missing Block Type`;function Jf(e,t){if(e==null)return null;let n=String(e).replace(/\s+/g,` `).trim();return n?n.length<=t?n:`${n.slice(0,t-1)}…`:null}function Yf(e,t){let n=e[t];return n==null?null:typeof n==`string`?n:typeof n==`number`||typeof n==`boolean`?String(n):null}function Xf(e,t){let n=e[t];return Array.isArray(n)&&n.length?n[0]:typeof n==`number`||typeof n==`string`?n:null}function Zf(e,t,n,r,i){let a=t?[t,...n.filter(e=>e!==t)]:[...n];for(let t of a){let n=Jf(Yf(e,t),i);if(n)return n}return Jf(r,i)??r}function Qf(e){let t=!!e.type,n=e.type?.name??qf,r=e.inference??{titlePlacementUids:[],subtitlePlacementUids:[],mediaPlacementUids:[]},i=t?Zf(e.fieldSlots,e.explicitTitlePlacementUid,r.titlePlacementUids,n,Gf):qf,a=t?Jf(Zf(e.fieldSlots,e.explicitSubtitlePlacementUid,r.subtitlePlacementUids,``,Kf)||null,Kf):null,o=e.explicitMediaPlacementUid??r.mediaPlacementUids[0]??null,s=o?Xf(e.fieldSlots,o):null;return{blockUid:e.blockUid,blockTypeUid:e.blockTypeUid,typeName:n,title:i,subtitle:a||null,media:s==null?null:{kind:`asset`,reference:s,alt:null,thumbnailUrl:null},enabled:e.enabled,resolved:t,errorCount:e.validation?.errorCount??0,descendantErrorCount:e.validation?.descendantErrorCount??0,revision:e.revision}}function $f(e,t){let n=null;return e.state.doc.descendants((e,r)=>e.type.name===`vizyBlock`&&String(e.attrs.blockUid)===t?(n=r,!1):n===null),n}function ep(e,t){let n=$f(e,t);if(n==null)return null;let r=e.state.doc.nodeAt(n);return!r||r.type.name!==`vizyBlock`?null:{node:r,pos:n}}function tp(e,t){return ep(e,t)?{kind:`root`}:null}function np(e,t,n){let r=[],i=(e,t)=>{if(e.type!==`vizyBlock`){let n=e.content;if(Array.isArray(n))for(let e of n)e&&typeof e==`object`&&i(e,t);return}let a=e.attrs??{},o=String(a.blockUid??``),s=String(a.blockTypeUid??``),c=n.blockTypes[s];o&&c?.fieldLayoutUid&&r.push({blockUid:o,blockTypeUid:s,block:e,destination:t})};return i(e,t),r}async function rp(e,t,n){n?.flushMountedFields?.();let r=ep(e,t);if(!r)return!1;let i=Rs(r.node.toJSON(),void 0,n?.manifest.blockTypes),a=String(i.attrs?.blockUid??``);if(!a)return!1;if(n){let r=tp(e,t)??{kind:`root`},a=n.documentRevision(),o=np(i,r,n.manifest).map(e=>({...e,documentRevision:a}));if(o.length)try{await n.prefetchNewBlocks(o)}catch{}}let o=ep(e,t);if(!o)return!1;let s=e.schema.nodeFromJSON(i),c=o.pos+o.node.nodeSize;return e.view.dispatch(e.state.tr.insert(c,s).scrollIntoView()),(n?.animateInsert??qt)(a),!0}function ip(e,t){let n=ep(e,t);return n?(e.view.dispatch(e.state.tr.delete(n.pos,n.pos+n.node.nodeSize).scrollIntoView()),!0):!1}function ap(e,t){let n=ep(e,t);if(!n)return!1;let r=!n.node.attrs.enabled;return e.view.dispatch(e.state.tr.setNodeMarkup(n.pos,void 0,{...n.node.attrs,enabled:r}).scrollIntoView()),!0}function op(e,t,n){let r=ep(e,t);if(!r)return!1;let i=e.state.doc.resolve(r.pos),a=i.parent,o=i.index(),s=o+n;if(s<0||s>=a.childCount)return!1;let c=n<0?r.pos-a.child(o-1).nodeSize:r.pos+r.node.nodeSize+a.child(o+1).nodeSize,l=new j(M.from(r.node),0,0),u=e.state.tr.delete(r.pos,r.pos+r.node.nodeSize),d=u.mapping.map(c);return u=u.replaceRange(d,d,l),e.view.dispatch(u.scrollIntoView()),!0}function sp(e,t,n){let r=ep(e,n);if(!r)return[];let i=t.buildContext(`inline`,r.pos);return i?t.query({context:i,kinds:[`block`]}).filter(e=>!e.item.requiresInput):[]}function cp(e,t,n){let r=sp(e,t,n);return r.length===1?`Add ${r[0].item.label} above`:`Add Block above`}var lp=new WeakSet;function up(e){lp.add(e),e.draggable=!0}function dp(e){lp.delete(e),e.draggable=!1,e.removeAttribute(`draggable`)}function fp(e){return lp.has(e)}var pp=null,mp=0;function hp(e){let t=new Map,n=e.parentElement;if(n)for(let e of Array.from(n.children)){if(!(e instanceof HTMLElement)||e.localName!==`vizy-block`)continue;let n=e.getAttribute(`data-block-uid`);if(!n)continue;let r=e.getBoundingClientRect();t.set(n,{top:r.top,left:r.left})}let r=e.getAttribute(`data-block-uid`);if(r&&!t.has(r)){let n=e.getBoundingClientRect();t.set(r,{top:n.top,left:n.left})}pp=t,mp+=1}function gp(){pp=null}function _p(){let e=pp,t=mp;if(!e?.size||Kt()){pp=null;return}if(typeof document>`u`){pp=null;return}pp=null;let n=()=>{if(t===mp)for(let[t,n]of e){let e=document.querySelector(`vizy-block[data-block-uid="${CSS.escape(t)}"]`);if(!e||typeof e.animate!=`function`)continue;let r=e.getBoundingClientRect(),i=n.left-r.left,a=n.top-r.top;Math.abs(i)<1&&Math.abs(a)<1||e.animate([{transform:`translate(${i}px, ${a}px)`},{transform:`translate(0px, 0px)`}],{duration:Gt.duration,easing:Gt.easing,fill:`backwards`})}};requestAnimationFrame(()=>{requestAnimationFrame(n)})}function vp(e){if(e.type.name!==`vizyBlock`)return null;let t=e.attrs.blockUid;return t==null?null:String(t)}function yp(e,t){let n=null;return e.descendants((e,r)=>e.type.name===`vizyBlock`&&String(e.attrs.blockUid)===t?(n={node:e,from:r},!1):!n),n}var bp=null;function xp(e){bp=e}function Sp(){bp=null}function Cp(e){if(!bp)return null;let t=yp(e.state.doc,bp.uid);return t?{...bp,from:t.from,to:t.from+t.node.nodeSize,node:t.node}:null}function wp(e){let t=e.dragging;if(t?.move){let n=t.node;if(n instanceof A){let e=n.node,t=vp(e);return t?{uid:t,blockTypeUid:String(e.attrs.blockTypeUid),from:n.from,to:n.from+e.nodeSize,node:e}:null}let r=t.slice?.content.firstChild,i=r?vp(r):null;if(!i||!r)return null;let a=yp(e.state.doc,i);return a?{uid:i,blockTypeUid:String(r.attrs.blockTypeUid),from:a.from,to:a.from+a.node.nodeSize,node:r}:null}return Cp(e)}function Tp(e,t,n){let r=t;if(n){let t=vt(e,r,n);t!=null&&(r=t)}return r}function Ep(e,t){let n=e.resolve(t.from),r=n.depth;if(n.parent.type.name!==`doc`&&n.parent.type.name!==`column`){r=0;for(let e=n.depth;e>0;--e)if(n.node(e).type.name===`column`){r=e;break}}let i=n.node(r),a=n.start(r),o=[];return i.forEach((e,t)=>{let n=a+t;o.push({from:n,to:n+e.nodeSize})}),o}function Dp(e,t,n){let r=Ep(e.state.doc,n);if(r.length===0)return null;let i=[];for(let t of r){let n=e.nodeDOM(t.from);if(!(n instanceof HTMLElement))continue;let r=n.getBoundingClientRect(),a=r.bottom-r.top;i.push({from:t.from,to:t.to,midY:(r.top+r.bottom)/2,height:a})}if(i.length===0||i.every(e=>e.height<=0))return null;for(let e of i)if(t<e.midY)return e.from;return i[i.length-1].to}function Op(e,t,n,r){let i=Dp(e,n,r);if(i!=null)return i;let a=e.posAtCoords({left:t,top:n});return a?Tp(e.state.doc,a.pos,e.dragging?.slice??null):null}function kp(e,t,n){if(n===t.from||n===t.to)return!1;let r=t.to-t.from,i=e.state.tr;i.delete(t.from,t.to);let a=n<=t.from?n:n-r;i.insert(a,t.node);try{i.setSelection(A.create(i.doc,a))}catch{}return e.dispatch(i.scrollIntoView()),!0}function Ap(e,t){let n=e.resolve(t);if(n.parent.type.name===`doc`)return`root`;if(n.parent.type.name===`column`)return`column:${String(n.parent.attrs.columnUid??n.depth)}`;for(let e=n.depth;e>0;--e){let t=n.node(e);if(t.type.name===`column`)return`column:${String(t.attrs.columnUid??e)}`}return`root`}function jp(e,t,n){let r=Ap(e,t.from),i=Ap(e,n);return r!=null&&i!=null&&r===i}function Mp(e,t,n){if(n>t.from&&n<t.to)return!0;let r=e.resolve(n);for(let e=r.depth;e>0;--e){let n=r.node(e);if(n.type.name===`vizyBlock`&&String(n.attrs.blockUid)===t.uid)return!0}return!1}function Np(e,t){let n=e.resolve(t).parent;return n.type.name===`doc`||n.type.name===`column`}function Pp(e,t,n,r){return Np(t,n)?e.field.rootContentType===`blocks`?e.field.allowedBlockTypeUids.includes(r):e.field.allowedBlockTypeUids.includes(r)||e.field.insertableBlockTypeUids.includes(r):!1}function Fp(e,t,n){let r=wp(e);return!r||!(Mp(e.state.doc,r,t)||!jp(e.state.doc,r,t)||!Pp(n,e.state.doc,t,r.blockTypeUid)||!xt(e.state.doc,t,r.blockTypeUid,Ue(n)))}function Ip(e){let t=document.createElement(`div`);return t.className=`vizy-block-drag-ghost`,t.textContent=e,t.setAttribute(`aria-hidden`,`true`),Object.assign(t.style,{position:`fixed`,top:`-1000px`,left:`-1000px`,pointerEvents:`none`}),document.body.append(t),t}function Lp(e,t){let n=Ip(t);return e.dataTransfer?.setDragImage(n,16,14),()=>n.remove()}function Rp(e,t){let n=A.create(e.state.doc,t);e.state.selection.eq(n)||e.dispatch(e.state.tr.setSelection(n))}function zp(e){return e.composedPath().some(e=>e instanceof HTMLElement&&(e.matches(`[data-vizy-drag-handle]`)||e.closest?.(`[data-vizy-drag-handle]`)!=null))}function Bp(e,t){let n=null,r=null,i=!1,a=r=>{let a=t.getView(),o=t.getPos();if(o==null||!r.dataTransfer){r.preventDefault(),i=!1,dp(e);return}Rp(a,o);let s=A.create(a.state.doc,o),c=s.content(),{dom:l,text:u,slice:d}=a.serializeForClipboard(c);r.dataTransfer.clearData(),r.dataTransfer.setData(`text/html`,l.innerHTML),r.dataTransfer.setData(`text/plain`,u),r.dataTransfer.effectAllowed=`copyMove`,a.dragging={slice:d,move:!0,node:s},xp({uid:String(s.node.attrs.blockUid),blockTypeUid:String(s.node.attrs.blockTypeUid),from:s.from,to:s.from+s.node.nodeSize,node:s.node}),n?.(),n=Lp(r,t.getLabel()),hp(e),t.onDragChange(!0),r.stopPropagation()},o=n=>{if(n.button!==0)return;let r=t.getPos();r!=null&&(i=!0,up(e),Rp(t.getView(),r))},s=t=>{if(t.target===e){if(!(i||zp(t))){t.preventDefault(),t.stopPropagation();return}a(t)}},c=()=>{i=!1,dp(e),n?.(),n=null,t.onDragChange(!1);try{t.getView().dragging=null}catch{}window.setTimeout(()=>{gp(),Sp()},100)},l=()=>{if(i){try{if(t.getView().dragging)return}catch{}i=!1,dp(e)}},u=()=>{let t=e.shadowRoot?.querySelector(`[data-vizy-drag-handle]`)??null;t!==r&&(r?.removeEventListener(`mousedown`,o),r=t,r?.addEventListener(`mousedown`,o))};e.addEventListener(`dragstart`,s,{capture:!0}),e.addEventListener(`dragend`,c),window.addEventListener(`pointerup`,l,!0),dp(e),u();let d=e.shadowRoot?new MutationObserver(()=>u()):null;return d?.observe(e.shadowRoot,{childList:!0,subtree:!0}),()=>{d?.disconnect(),r?.removeEventListener(`mousedown`,o),e.removeEventListener(`dragstart`,s,{capture:!0}),e.removeEventListener(`dragend`,c),window.removeEventListener(`pointerup`,l,!0),c()}}function Vp(e,t){return e.composedPath().includes(t)}var Hp=class{dom;#e;#t;#n;#r;#i;#a;#o=!1;#s=null;#c=null;constructor(e,t){this.#a=e.node,this.#t=t,this.#n=e.editor,this.#i=e.getPos,this.#r=String(e.node.attrs.blockUid);let n=String(e.node.attrs.blockTypeUid),r=t.manifest.blockTypes[n],i=t.hosts.acquire(this.#r,n,r?.fieldLayoutUid??null,r?.fieldLayoutHash??null),a=t.ui.get(this.#r);this.dom=document.createElement(`vizy-block`),this.dom.blockUid=this.#r,this.dom.setAttribute(`data-block-uid`,this.#r),r?.color&&(this.dom.style.setProperty(`--vizy-block-accent-color`,r.color),this.dom.accentColor=r.color),r?.iconSvg&&(this.dom.typeIconSvg=r.iconSvg);let o=!!e.node.attrs.enabled;this.dom.enabled=o,this.dom.disabled=!o,this.dom.collapsed=!o||a.collapsed,!o&&!a.collapsed&&t.ui.update(this.#r,{collapsed:!0});let s=a.summary??Qf({blockUid:this.#r,blockTypeUid:n,enabled:!!e.node.attrs.enabled,fieldSlots:e.node.attrs.fieldSlots??{},type:r,inference:r?.summaryInference,revision:t.blockRevision(this.#r),explicitTitlePlacementUid:r?.summary?.titlePlacementUid,explicitSubtitlePlacementUid:r?.summary?.subtitlePlacementUid,explicitMediaPlacementUid:r?.summary?.mediaPlacementUid});a.summary||t.ui.update(this.#r,{summary:s}),this.dom.applySummary(s),this.#d(),this.dom.expectsFieldLayout=!!r?.fieldLayoutUid,r?.layoutTabLabels?.length&&(this.dom.layoutTabLabels=r.layoutTabLabels),this.#e=document.createElement(`div`),this.#e.dataset.vizyBlockContent=``,this.#e.slot=`layout`,this.#e.append(i.root),this.dom.append(this.#e),this.dom.addEventListener(`vizy-collapse-change`,this.#f),this.dom.addEventListener(`vizy-edit-fields`,this.#p),this.dom.addEventListener(`vizy-block-action`,this.#h),this.dom.addEventListener(`vizy-block-header-activate`,this.#m),queueMicrotask(()=>{this.#o||this.#g()}),r?.fieldLayoutUid&&(this.#s=t.observeFieldViewport(this.dom)),this.dom.draggable=!1,queueMicrotask(()=>{this.#o||(this.#c=Bp(this.dom,{getPos:()=>this.#i(),getLabel:()=>this.dom.typeName||`Block`,getView:()=>this.#n.view,onDragChange:e=>{this.dom.dragging=e,this.#t.ui.update(this.#r,{view:{dragging:e}})}}))})}#l=!1;#u(){fp(this.dom)||(this.dom.draggable=!1,this.dom.removeAttribute(`draggable`),!this.#l&&(this.#l=!0,queueMicrotask(()=>{this.#l=!1,!this.#o&&(fp(this.dom)||(this.dom.draggable=!1,this.dom.removeAttribute(`draggable`)))})))}#d(){let e=this.#t.hosts.get(this.#r),t=e?.status,n=t===`mounted`?`mounted`:t===`loading`?`loading`:t===`failed`?`error`:`unmounted`;this.#t.ui.get(this.#r).view.fieldLayout=n,this.dom.fieldLayoutState=n,this.dom.fieldLayoutError=t===`failed`?e?.errorMessage??null:null,(t===`mounted`||t===`failed`)&&(this.dom.fieldLayoutRetrying=!1)}#f=e=>{if(e.target!==this.dom)return;e.stopPropagation();let t=e.detail.collapsed;this.#t.ui.update(this.#r,{collapsed:t}),e.detail.persist!==!1&&(t?Lo(this.#r):Ro(this.#r))};#p=e=>{e.target===this.dom&&(e.stopPropagation(),this.#t.ui.update(this.#r,{editingFields:!0}),this.#t.openFields(this.#r))};#m=e=>{if(e.target!==this.dom)return;e.stopPropagation();let t=this.#i();if(t!=null)try{Rp(this.#n.view,t),Wt(Pt(this.#n.view.dom),()=>{Ut(this.#n,{force:!0})})}catch{}};#h=e=>{if(e.target!==this.dom)return;e.stopPropagation();let{action:t,invoker:n}=e.detail,r=this.#n;switch(t){case`duplicate`:this.#t.suspendInsertionSideEffects?.(),this.#t.duplicateBlock(this.#r).finally(()=>{this.#t.resumeInsertionSideEffects?.(),this.#t.refreshSummaries()});return;case`delete`:if(this.#t.manifest.field.confirmBlockDeletion===!0){let e=window.Craft?.t?.(`vizy`,`Delete this block?`)??`Delete this block?`;if(!window.confirm(e))break}Ro(this.#r),ip(r,this.#r);break;case`toggleEnabled`:ap(r,this.#r);break;case`moveUp`:op(r,this.#r,-1);break;case`moveDown`:op(r,this.#r,1);break;case`addAbove`:{let e=n??this.dom.shadowRoot?.querySelector(`[part="menu-trigger"]`)??null;e&&this.#t.openAddBlockAbove?.(this.#r,e);break}}this.#t.refreshSummaries()};update(e){if(e.type!==this.#a.type||String(e.attrs.blockUid)!==this.#r||String(e.attrs.blockTypeUid)!==String(this.#a.attrs.blockTypeUid))return!1;this.#a=e;let t=this.#t.ui.get(this.#r);return this.dom.enabled=!!e.attrs.enabled,this.dom.disabled=!e.attrs.enabled,this.dom.applySummary(t.summary),this.#d(),this.#g(),this.#u(),!0}#g(){let e=this.#t.insertion;if(!e?.buildContext){this.dom.canAddAbove=!1,this.dom.addAboveLabel=`Add Block above`;return}let t=sp(this.#n,e,this.#r);this.dom.canAddAbove=t.length>0,this.dom.addAboveLabel=cp(this.#n,e,this.#r)}selectNode(){this.dom.selected=!0,this.#t.ui.update(this.#r,{view:{selected:!0}}),this.#u()}deselectNode(){this.dom.selected=!1,this.#t.ui.update(this.#r,{view:{selected:!1}}),this.#u()}stopEvent(e){let t=this.dom.shadowRoot?.querySelector(`[data-vizy-drag-handle]`);return t&&Vp(e,t)?!1:this.#t.hosts.roots(this.#r).some(t=>Vp(e,t))||(this.dom.shadowRoot?e.composedPath().includes(this.dom.shadowRoot):!1)}ignoreMutation(e){return e.type!==`selection`}destroy(){this.#o||(this.#o=!0,this.#s?.(),this.#s=null,this.#c?.(),this.#c=null,this.dom.removeEventListener(`vizy-collapse-change`,this.#f),this.dom.removeEventListener(`vizy-edit-fields`,this.#p),this.dom.removeEventListener(`vizy-block-action`,this.#h),this.dom.removeEventListener(`vizy-block-header-activate`,this.#m),this.#t.hosts.releaseView(this.#r))}};function Up(e){return D.create({name:`vizyBlock`,group:`block`,content:``,defining:!0,isolating:!0,selectable:!0,draggable:!0,addAttributes:()=>({blockUid:{default:null,rendered:!1},blockTypeUid:{default:null,rendered:!1},enabled:{default:!0,rendered:!1},fieldSlots:{default:{},rendered:!1},matrixAnchorUid:{default:null,rendered:!1}}),parseHTML:()=>[],renderHTML:({HTMLAttributes:e})=>[`vizy-block`,w(e)],addNodeView:()=>t=>new Hp(t,e())})}function Wp(e,t,n){if(e.type===`selection`)return!1;let r=e.target;return!(r instanceof globalThis.Node)||r===t||t.shadowRoot?.contains(r)?!0:!n.contains(r)}var Gp=class{dom;contentDOM;#e;#t;constructor(e,t){this.#e=e.getPos,this.#t=t,this.dom=document.createElement(`vizy-layout`),this.dom.layoutUid=String(e.node.attrs.layoutUid),this.dom.stack=String(e.node.attrs.stack??`small`),this.contentDOM=document.createElement(`div`),this.contentDOM.className=`vizy-layout-columns`,this.contentDOM.slot=`columns`,this.contentDOM.style.display=`grid`,this.contentDOM.style.gridTemplateColumns=`repeat(12, minmax(0, 1fr))`,this.contentDOM.style.gap=`0.75rem`,this.contentDOM.style.width=`100%`,this.contentDOM.style.minHeight=`0`,this.contentDOM.style.alignItems=`start`,this.contentDOM.style.boxSizing=`border-box`,this.dom.append(this.contentDOM),this.#n(e.node)}#n(e){this.dom.layoutUid=String(e.attrs.layoutUid),this.dom.stack=String(e.attrs.stack??`small`);let t=[],n=[];for(let r=0;r<e.childCount;r++){let i=e.child(r);t.push(Number(i.attrs.span??12)),n.push(String(i.attrs.columnUid??``))}this.dom.columnSpans=t,this.dom.columnUids=n;let r=this.#t().editor;r&&(this.dom.editor=r,this.dom.layoutPos=this.#e()??null)}update(e){return e.type.name===`layout`&&(this.#n(e),!0)}ignoreMutation(e){return Wp(e,this.dom,this.contentDOM)}},Kp=class{dom;contentDOM;constructor(e){this.dom=document.createElement(`vizy-column`),this.contentDOM=document.createElement(`div`),this.contentDOM.slot=`content`,this.dom.append(this.contentDOM),this.#e(e.node)}#e(e){this.dom.columnUid=String(e.attrs.columnUid),this.dom.span=Number(e.attrs.span??12),this.dom.style.gridColumn=`span ${Math.min(12,Math.max(1,this.dom.span))}`;let t=this.dom.closest(`vizy-layout`);if(t){let e=t.columnUids??[];this.dom.columnIndex=e.indexOf(this.dom.columnUid),this.dom.columnCount=e.length}}update(e){return e.type.name===`column`&&(this.#e(e),!0)}ignoreMutation(e){return Wp(e,this.dom,this.contentDOM)}};function qp(e){return D.create({name:`layout`,group:`block`,content:`column+`,defining:!0,isolating:!0,addAttributes:()=>({layoutUid:{default:null,rendered:!1},stack:{default:`small`}}),parseHTML:()=>[{tag:`vizy-layout`}],renderHTML:({HTMLAttributes:e})=>[`vizy-layout`,w(e),0],addNodeView:()=>t=>new Gp(t,e)})}function Jp(){return D.create({name:`column`,content:`block*`,defining:!0,isolating:!0,addAttributes:()=>({columnUid:{default:null,rendered:!1},span:{default:12}}),parseHTML:()=>[{tag:`vizy-column`}],renderHTML:({HTMLAttributes:e})=>[`vizy-column`,w(e),0],addNodeView:()=>e=>new Kp(e)})}var Yp=D.create({name:`doc`,topNode:!0,content:`block*`,addAttributes:()=>({schemaVersion:{default:2,rendered:!1}})}),Xp=[1,2,3,4,5,6];function Zp(e){let t=(e?.headingLevels??[]).filter(e=>Xp.includes(e));return t.length?t:Xp}var Qp=Object.freeze({"vizy/core/node/doc":()=>Yp,"vizy/core/node/text":()=>nu,"vizy/core/node/vizyBlock":e=>Up(e?.services??(()=>{throw Error(`vizyNodeViewServicesMissing`)})),"vizy/core/node/layout":e=>qp(()=>({editor:e?.services?.().editor})),"vizy/core/node/column":()=>Jp(),"vizy/core/node/paragraph":()=>Ql,"vizy/core/node/heading":e=>zc.configure({levels:Zp(e?.manifest)}),"vizy/core/node/blockquote":()=>Tc,"vizy/core/node/codeBlock":()=>Lc,"vizy/core/node/horizontalRule":()=>Bc,"vizy/core/node/hardBreak":()=>Rc,"vizy/core/node/bulletList":()=>Yc,"vizy/core/node/orderedList":()=>Wl,"vizy/core/node/listItem":()=>vl,"vizy/core/node/image":()=>bf(),"vizy/core/node/iframe":()=>Pf(),"vizy/core/node/mediaEmbed":()=>Ff(),"vizy/core/node/table":()=>Af(),"vizy/core/node/tableRow":()=>vf,"vizy/core/node/tableCell":()=>jf(),"vizy/core/node/tableHeader":()=>Mf(),"vizy/core/mark/bold":()=>Ac,"vizy/core/mark/code":()=>Nc,"vizy/core/mark/highlight":()=>ou,"vizy/core/mark/italic":()=>Gc,"vizy/core/mark/link":()=>Tf(),"vizy/core/mark/strike":()=>tu,"vizy/core/mark/subscript":()=>su,"vizy/core/mark/superscript":()=>cu,"vizy/core/mark/textStyle":()=>zf,"vizy/core/mark/underline":()=>ru});function $p(e,t){let n=e.flatMap(e=>{let n=Qp[e]??me(e);if(!n)throw Error(`untrustedEditorModule:${e}`);let r=n(t);return Array.isArray(r)?r:[r]});return Ae(n,t)}function em(e){let t=[];return e.forEach(e=>{e.type.name===`vizyBlock`&&t.push(e)}),t}function tm(e,t){e.set(t,(e.get(t)??0)+1)}function nm(e){for(let t of[`blockUid`,`layoutUid`,`columnUid`,`nodeUid`]){let n=e.attrs?.[t];if(typeof n==`string`&&n)return`${t}:${n}`}return`shape:${JSON.stringify(e.toJSON(),(e,t)=>!t||typeof t!=`object`||Array.isArray(t)?t:Object.fromEntries(Object.entries(t).sort(([e],[t])=>e.localeCompare(t))))}`}function rm(e,t){let n=new Map,r=em(e);t.field.rootContentType===`blocks`&&e.forEach(e=>{e.type.name!==`vizyBlock`&&tm(n,`root:prose:${nm(e)}`)}),r.forEach(e=>{t.field.allowedBlockTypeUids.includes(String(e.attrs.blockTypeUid))||tm(n,`root:type:${String(e.attrs.blockUid)}:${String(e.attrs.blockTypeUid)}`)}),t.field.minBlocks!==null&&r.length<t.field.minBlocks&&tm(n,`root:min`),t.field.maxBlocks!==null&&r.length>t.field.maxBlocks&&tm(n,`root:max`);let i=Ue(t);return e.descendants((t,r)=>{if(t.type.name!==`vizyBlock`)return;let a=String(t.attrs.blockTypeUid);bt(e,r,a)>i&&tm(n,`depth:${String(t.attrs.blockUid)}:${a}`)}),n}var im=S.create({name:`vizyContentPolicy`,addOptions:()=>({manifest:null}),addProseMirrorPlugins(){let e=this.options.manifest;return[new C({filterTransaction(t,n){if(!t.docChanged||t.getMeta(`vizyAcceptedCanonical`)===!0)return!0;let r=rm(n.doc,e);return[...rm(t.doc,e)].every(([e,t])=>t<=(r.get(e)??0))}})]}});function am(e){return new C({view(t){return new om(t,e)}})}var om=class{editorView;#e;cursorPos=null;element=null;timeout=-1;lastDragEvent=null;width;color;className;handlers;constructor(e,t){this.editorView=e,this.#e=t.manifest,this.width=t.width??1,this.color=t.color===!1?void 0:t.color||`black`,this.className=t.class,this.handlers=[`dragover`,`dragend`,`drop`,`dragleave`].map(t=>{let n=e=>{this[t](e)};return e.dom.addEventListener(t,n,!0),{name:t,handler:n}})}destroy(){this.handlers.forEach(({name:e,handler:t})=>{this.editorView.dom.removeEventListener(e,t,!0)})}update(e,t){if(this.cursorPos!=null&&t.doc!==e.state.doc){if(this.lastDragEvent){let e=this.computeTarget(this.lastDragEvent);e===this.cursorPos?this.updateOverlay():this.setCursor(e)}else this.updateOverlay()}}setCursor(e){e!==this.cursorPos&&(this.cursorPos=e,e==null?(this.element?.parentNode?.removeChild(this.element),this.element=null):this.updateOverlay())}updateOverlay(){let e=this.editorView.state.doc.resolve(this.cursorPos),t=!e.parent.inlineContent,n,r=this.editorView.dom,i=r.getBoundingClientRect(),a=i.width/r.offsetWidth,o=i.height/r.offsetHeight;if(t){let t=e.nodeBefore,r=e.nodeAfter;if(t||r){let e=this.editorView.nodeDOM(this.cursorPos-(t?t.nodeSize:0));if(e instanceof HTMLElement){let i=e.getBoundingClientRect(),a=t?i.bottom:i.top;if(t&&r){let e=this.editorView.nodeDOM(this.cursorPos);e instanceof HTMLElement&&(a=(a+e.getBoundingClientRect().top)/2)}let s=this.width/2*o;n={left:i.left,right:i.right,top:a-s,bottom:a+s}}}}if(!n){let e=this.editorView.coordsAtPos(this.cursorPos),t=this.width/2*a;n={left:e.left-t,right:e.left+t,top:e.top,bottom:e.bottom}}let s=this.editorView.dom.offsetParent;this.element||(this.element=s.appendChild(document.createElement(`div`)),this.className&&(this.element.className=this.className),this.element.style.cssText=`position: absolute; z-index: 50; pointer-events: none;`,this.color&&(this.element.style.backgroundColor=this.color)),this.element.classList.toggle(`prosemirror-dropcursor-block`,t),this.element.classList.toggle(`prosemirror-dropcursor-inline`,!t);let c,l;if(!s||s===document.body&&getComputedStyle(s).position===`static`)c=-window.pageXOffset,l=-window.pageYOffset;else{let e=s.getBoundingClientRect(),t=e.width/s.offsetWidth,n=e.height/s.offsetHeight;c=e.left-s.scrollLeft*t,l=e.top-s.scrollTop*n}this.element.style.left=`${(n.left-c)/a}px`,this.element.style.top=`${(n.top-l)/o}px`,this.element.style.width=`${(n.right-n.left)/a}px`,this.element.style.height=`${(n.bottom-n.top)/o}px`}scheduleRemoval(e){window.clearTimeout(this.timeout),this.timeout=window.setTimeout(()=>this.setCursor(null),e)}computeTarget(e){let t=wp(this.editorView);if(!t)return null;let n=Op(this.editorView,e.clientX,e.clientY,t);return n==null||!Fp(this.editorView,n,this.#e)?null:n}dragover(e){if(!this.editorView.editable)return;this.lastDragEvent=e;let t=this.computeTarget(e);t==null?this.setCursor(null):(this.setCursor(t),this.scheduleRemoval(150))}dragend(){this.scheduleRemoval(20)}drop(){this.scheduleRemoval(20)}dragleave(e){let t=e.relatedTarget;(!(t instanceof Node)||!this.editorView.dom.contains(t))&&this.setCursor(null)}};function sm(e,t,n){let r=wp(e);if(!r)return!1;let i=Op(e,t.clientX,t.clientY,r);return i==null||!Fp(e,i,n)?(Sp(),!0):(kp(e,r,i)?(Sp(),_p()):Sp(),!0)}function cm(e){return S.create({name:`vizyBlockMoveDrop`,addProseMirrorPlugins(){return[am({color:`#0284c7`,width:2,class:`vizy-block-dropcursor`,manifest:e}),new C({view(t){let n=n=>{if(wp(t)&&sm(t,n,e)){n.preventDefault(),n.stopPropagation();try{t.dragging=null}catch{}}},r=e=>{wp(t)&&(e.preventDefault(),e.dataTransfer&&(e.dataTransfer.dropEffect=`move`))};return t.dom.addEventListener(`drop`,n,!0),t.dom.addEventListener(`dragover`,r,!0),{destroy(){t.dom.removeEventListener(`drop`,n,!0),t.dom.removeEventListener(`dragover`,r,!0)}}},props:{handleDrop(t,n,r,i){let a=wp(t);return!i||!a?!1:sm(t,n,e)}}})]}})}function lm(e){let{char:t,allowSpaces:n,allowToIncludeChar:r,allowedPrefixes:i,startOfLine:a,$position:o}=e,s=n&&!r,c=De(t),l=RegExp(`\\s${c}$`),u=a?`^`:``,d=r?``:c,f=RegExp(s?`${u}${c}.*?(?=\\s${d}|$)`:`${u}(?:^)?${c}[^\\s${d}]*`,`gm`),p=o.nodeBefore?.isText&&o.nodeBefore.text;if(!p)return null;let m=o.pos-p.length,h=Array.from(p.matchAll(f)).pop();if(!h||h.input===void 0||h.index===void 0)return null;let g=h.input.slice(Math.max(0,h.index-1),h.index),_=RegExp(`^[${i?.join(``)}\0]?$`).test(g);if(i!==null&&!_)return null;let ee=m+h.index,v=ee+h[0].length;return s&&l.test(p.slice(v-1,v+1))&&(h[0]+=` `,v+=1),ee<o.pos&&v>=o.pos?{range:{from:ee,to:v},query:h[0].slice(t.length),text:h[0]}:null}function um(e){return e.docChanged?e.steps.some(e=>{let t=e.slice;if(!t?.content)return!1;let n=t.content.textBetween(0,t.content.size,`
`);return/\s/.test(n)}):!1}function dm(e){return()=>{let t=e.state.selection.$anchor.pos,{top:n,right:r,bottom:i,left:a}=e.view.coordsAtPos(t);try{return new DOMRect(a,n,r-a,i-n)}catch{return null}}}function fm(e,t,n,r){return n?()=>{let n=r.getState(e.state)?.decorationId;return t.dom.querySelector(`[data-decoration-id="${n}"]`)?.getBoundingClientRect()||null}:dm(e)}function pm({match:e,dismissedRange:t,state:n,transaction:r,editor:i,shouldResetDismissed:a,effectiveAllowSpaces:o}){return a?.({editor:i,state:n,range:t,match:e,transaction:r,allowSpaces:o})?!1:o?e.range.from===t.from:e.range.from===t.from&&!um(r)}function mm({view:e,pluginKeyRef:t}){let n=e.state.tr.setMeta(t,{exit:!0});e.dispatch(n)}function hm({pluginKey:e,decorationTag:t,decorationClass:n,decorationContent:r,decorationEmptyClass:i,renderer:a,dispatchExit:o}){return{handleKeyDown(t,n){var r;let i=e.getState(t.state);if(!i.active)return!1;if(n.key===`Escape`||n.key===`Esc`){var s;return a==null||(s=a.onKeyDown)==null||s.call(a,{view:t,event:n,range:i.range}),o(t),!0}return(a==null||(r=a.onKeyDown)==null?void 0:r.call(a,{view:t,event:n,range:i.range}))||!1},decorations(a){let{active:o,range:s,decorationId:c,query:l}=e.getState(a);if(!o)return null;let u=!l?.length,d=[n];return u&&d.push(i),O.create(a.doc,[Ke.inline(s.from,s.to,{nodeName:t,class:d.join(` `),"data-decoration-id":c||void 0,"data-decoration-content":r})])}}}function gm({editor:e,char:t,effectiveAllowSpaces:n,allowToIncludeChar:r,allowedPrefixes:i,startOfLine:a,findSuggestionMatch:o,allow:s,shouldShow:c,shouldKeepDismissed:l,pluginKey:u}){return{init(){return{active:!1,range:{from:0,to:0},query:null,text:null,composing:!1,dismissedRange:null}},apply(d,f,p,m){let{isEditable:h}=e,{composing:g}=e.view,{selection:_}=d,{empty:ee,from:v}=_,y={...f},b=d.getMeta(u);if(b&&b.exit)return y.active=!1,y.decorationId=null,y.range={from:0,to:0},y.query=null,y.text=null,y.dismissedRange=f.active?{...f.range}:f.dismissedRange,y;if(y.composing=g,d.docChanged&&y.dismissedRange!==null&&(y.dismissedRange={from:d.mapping.map(y.dismissedRange.from),to:d.mapping.map(y.dismissedRange.to)}),h&&(ee||e.view.composing)){(v<f.range.from||v>f.range.to)&&!g&&!f.composing&&(y.active=!1);let u=o({char:t,allowSpaces:n,allowToIncludeChar:r,allowedPrefixes:i,startOfLine:a,$position:_.$from}),p=`id_${Math.floor(Math.random()*4294967295)}`;u&&s({editor:e,state:m,range:u.range,isActive:f.active})&&(!c||c({editor:e,range:u.range,query:u.query,text:u.text,transaction:d}))?(y.dismissedRange!==null&&!l({match:u,dismissedRange:y.dismissedRange,state:m,transaction:d})&&(y.dismissedRange=null),y.dismissedRange===null?(y.active=!0,y.decorationId=f.decorationId||p,y.range=u.range,y.query=u.query,y.text=u.text):y.active=!1):(u||(y.dismissedRange=null),y.active=!1)}else y.active=!1;return y.active||(y.decorationId=null,y.range={from:0,to:0},y.query=null,y.text=null),y}}}function _m({editor:e,items:t}){let n=null,r=null,i=null,a=()=>{r!==null&&(clearTimeout(r),r=null),i?.(),i=null},o=e=>new Promise(t=>{i=t,r=setTimeout(()=>{r=null;let e=i;i=null,e?.()},e)}),s=()=>{n?.abort(),a(),n=null};return{abort:s,fetch:async(r,i)=>{s(),n=new AbortController;let a=n;if(i>0&&await o(i),n!==a||a.signal.aborted)return{status:`aborted`};try{let i=await t({editor:e,query:r,signal:a.signal});return n!==a||a.signal.aborted?{status:`aborted`}:{status:`resolved`,items:i}}catch{return n!==a||a.signal.aborted?{status:`aborted`}:{status:`error`}}}}}function vm({placement:e,offset:t,flip:n,floatingUi:r}){var i;let a=[g({mainAxis:t.mainAxis??4,crossAxis:t.crossAxis??0})];return n&&a.push(_()),r!=null&&(i=r.middleware)!=null&&i.length&&a.push(...r.middleware),{placement:e,strategy:r?.strategy??`absolute`,middleware:a}}function ym(e){if(e instanceof HTMLElement)return e;if(typeof e==`string`)try{let t=document.querySelector(e);if(t)return t}catch{return document.body}return document.body}function bm({getReferenceRect:e,contextElement:t,config:n,container:r,dismissOnOutsideClick:i,dismiss:a}){return(o,s={})=>{let c={getBoundingClientRect:()=>e()??new DOMRect,contextElement:t},l=!1,u=!o.isConnected;u&&ym(r).appendChild(o),s.onPosition||(o.style.visibility=`hidden`,o.style.width=`max-content`);let d=v(c,o,()=>{y(c,o,{placement:n.placement,strategy:n.strategy,middleware:n.middleware}).then(({x:e,y:t,placement:n,strategy:r})=>{if(s.onPosition){s.onPosition({x:e,y:t,placement:n,strategy:r});return}Object.assign(o.style,{position:r,left:`${e}px`,top:`${t}px`}),l||(l=!0,o.style.visibility=``)})},s.autoUpdate),f;return i&&(f=e=>{let n=e.target;!(n instanceof Node)||o.contains(n)||t.contains(n)||a()},document.addEventListener(`pointerdown`,f,!0)),()=>{d(),f&&document.removeEventListener(`pointerdown`,f,!0),u&&o.remove()}}}function xm({editor:e,pluginKey:t,items:n,renderer:r,minQueryLength:i,debounce:a,initialItems:o,placement:s,offset:c,container:l,flip:u,floatingUi:d,dismissOnOutsideClick:f,command:p,clientRectFor:m,dispatchExit:h}){let g,_=_m({editor:e,items:n}),ee=vm({placement:s,offset:c,flip:u,floatingUi:d});function v(e,t){switch(e){case`started`:var n;r==null||(n=r.onStart)==null||n.call(r,t);break;case`updated`:var i;r==null||(i=r.onUpdate)==null||i.call(r,t);break;case`stopped`:var a;r==null||(a=r.onExit)==null||a.call(r,t)}}return{update:async(n,d)=>{let y=t.getState(d),b=t.getState(n.state);if(!y||!b)return;let x=null,te=y.query!==b.query,ne=y.text!==b.text,re=y.range.from!==b.range.from||y.range.to!==b.range.to,ie=te||ne||re;if(!y.active&&b.active)x=`started`;else if(y.active&&!b.active)x=`stopped`;else if(b.active&&ie)x=`updated`;else return;let ae=x===`stopped`?y:b,oe=n.dom.querySelector(`[data-decoration-id="${ae.decorationId}"]`),se=m(n,oe),ce=i===0||(ae.query?ae.query.length>=i:!1),le=(x===`started`||x===`updated`)&&ce;if(g={editor:e,range:ae.range,query:ae.query||``,text:ae.text||``,items:o??[],command:t=>p({editor:e,range:ae.range,props:t}),decorationNode:oe,clientRect:se,loading:le,placement:s,offset:{mainAxis:c.mainAxis??4,crossAxis:c.crossAxis??0},container:l,flip:u,floatingUi:ee,mount:bm({getReferenceRect:se,contextElement:n.dom,config:ee,container:l,dismissOnOutsideClick:f,dismiss:()=>h(e.view)})},x===`started`){var ue;r==null||(ue=r.onBeforeStart)==null||ue.call(r,g)}if(x===`updated`){var de;r==null||(de=r.onBeforeUpdate)==null||de.call(r,g)}if(x===`started`&&v(x,g),x===`started`||x===`updated`){if(!le)_.abort(),g={...g,items:o??[],loading:!1};else{g={...g,items:o??[],loading:!0},x=`updated`,v(x,g);let e=await _.fetch(ae.query||``,a);if(e.status===`aborted`)return;if(!t.getState(n.state)?.active){_.abort();return}g=e.status===`resolved`?{...g,items:e.items,loading:!1}:{...g,loading:!1}}}if(x===`stopped`){_.abort(),v(x,g),g=void 0;return}x===`updated`&&v(x,g)},destroy:()=>{var e;_.abort(),g&&(r==null||(e=r.onExit)==null||e.call(r,g))}}}var Sm=new T(`suggestion`);function Cm({pluginKey:e=Sm,editor:t,char:n=`@`,allowSpaces:r=!1,allowToIncludeChar:i=!1,allowedPrefixes:a=[` `],startOfLine:o=!1,decorationTag:s=`span`,decorationClass:c=`suggestion`,decorationContent:l=``,decorationEmptyClass:u=`is-empty`,command:d=()=>null,items:f=()=>[],minQueryLength:p=0,debounce:m=0,initialItems:h,placement:g=`bottom-start`,offset:_={},container:ee,flip:v=!0,floatingUi:y,dismissOnOutsideClick:b=!0,render:x=()=>({}),allow:te=()=>!0,findSuggestionMatch:ne=lm,shouldShow:re,shouldResetDismissed:ie}){let ae=x?.(),oe=r&&!i,se=(n,r)=>fm(t,n,r,e);function ce(e){return pm({...e,editor:t,shouldResetDismissed:ie,effectiveAllowSpaces:oe})}let le=t=>mm({view:t,pluginKeyRef:e});return new C({key:e,view:()=>xm({editor:t,pluginKey:e,items:f,renderer:ae,minQueryLength:p,debounce:m,initialItems:h,placement:g,offset:_,container:ee,flip:v,floatingUi:y,dismissOnOutsideClick:b,command:d,clientRectFor:se,dispatchExit:le}),state:gm({editor:t,char:n,effectiveAllowSpaces:oe,allowToIncludeChar:i,allowedPrefixes:a,startOfLine:o,findSuggestionMatch:ne,allow:te,shouldShow:re,shouldKeepDismissed:ce,pluginKey:e}),props:hm({pluginKey:e,decorationTag:s,decorationClass:c,decorationContent:l,decorationEmptyClass:u,renderer:ae,dispatchExit:le})})}function wm(e,t=Sm){let n=e.state.tr.setMeta(t,{exit:!0});e.dispatch(n)}var Tm=Cm,Em=[`block`];function Dm(e,t){return e&&t.some(t=>t.item.id===e)?e:null}function Om(e,t,n){if(!t.length)return null;let r=e?t.findIndex(t=>t.item.id===e):-1;return r<0?n===1?t[0]?.item.id??null:t[t.length-1]?.item.id??null:t[(r+n+t.length)%t.length]?.item.id??null}var km=new gn;function Am(e,t){return t?e.schemaRevision===t.schemaRevision&&JSON.stringify(e.container)===JSON.stringify(t.container):!1}function jm(e){return(e.field.insertableBlockTypeUids??[]).length===0}function Mm(e){let t=e.filter(e=>!e.item.requiresInput);return t.length===1?t[0]:null}async function Nm(e,t,n,r){let i=e.insertion.buildContext(t.surface,t.from);if(!i||!Am(t,i))return!1;let a=await e.insertion.execute({id:n,context:i});return a.status===`inserted`?!0:a.status===`opened`&&n===`transform:vizy:layout`?Pm(e,i,r):a.status===`opened`}function Pm(e,t,n){let r=Ze(e.manifest),i=e.editor.view.dom.closest(`.vizy-editor-surface`)?.parentElement??e.editor.view.dom.parentElement;if(!i||!r.length)return Promise.resolve(!1);let a=n??e.editor.view.coordsAtPos(t.from),o=n??new DOMRect(a.left,a.top,1,a.bottom-a.top);return new Promise(n=>{km.open(o,r,i,{returnFocus:e.editor.view.dom,onSelect:r=>{e.insertion.execute({id:ut,context:t,input:{presetId:r}}).then(e=>n(e.status===`inserted`))},onClose:()=>n(!1)})})}var Fm=null;function Im(){Fm=null}function Lm(e,t=`inline`){let{editor:n}=e,r=n.state.doc.content.size;if(Fm?.docSize===r)return Fm.anchors;let i=[];return jm(e.manifest)||((n,r,a)=>{let o=n.type.name===`doc`?r:r+1,s=[],c=o;n.forEach(e=>{let t=c;c+=e.nodeSize,(a!==`blocks`||e.type.name===`vizyBlock`)&&(s.length===0&&s.push({position:o,measurePos:t,measureSide:`top`}),s.push({position:c,measurePos:t,measureSide:`bottom`}))}),s.length===0&&s.push({position:o,measurePos:o,measureSide:`top`});for(let n of s){let r=e.insertion.buildContext(t,n.position);r&&e.insertion.query({context:r,limit:1}).length&&i.push({...n,context:r})}})(n.state.doc,0,e.manifest.field.rootContentType),Fm={docSize:r,anchors:i},i}function Rm(e,t,n={}){let r=n.distance??4,i=n.pad??10,a=n.capPx??320,o=n.minPx??120,s=n.viewportHeight??window.innerHeight,c=t.split(`-`)[0]||`bottom`,l;switch(c){case`top`:l=e.top-r-i;break;case`bottom`:l=s-e.bottom-r-i;break;default:l=s-i*2}return Math.max(o,Math.min(a,Math.floor(l)))}var zm=class{#e=null;#t=null;#n=0;#r=null;open(e,t,n,r={}){this.close({restoreFocus:!1,animate:!1});let i=r.search??``,a=r.kinds,o=r.list?[...r.list.items]:[...e.insertion.query({context:t,search:i||void 0,kinds:a})];if(!o.length&&!r.list)return;let s=r.list??new un;s.listId=s.listId||`vizy-popover-${t.surface}-${t.from}`,s.items=o.length?o:s.items,s.query=i,s.filterable=!0,s.view=`list`,s.showViewToggle=!0,s.activeId=null,s.revealActive=!1;let c=r.getClientRect??(()=>n),l=r.skipEnterMotion===!0,u=r.autofocusFilter!==!1,d=r.holdFieldFocus!==!1;this.#o(e,{context:t,list:s,getClientRect:c,returnFocus:r.returnFocus??null,onRestoreFocus:r.onRestoreFocus??null,invokerKey:r.invokerKey??null,onClose:r.onClose??(()=>void 0),onSelect:r.onSelect,onViewChange:r.onViewChange,search:i,filterMode:`panel`,autofocusFilter:u,holdFieldFocus:d,skipEnterMotion:l,kinds:a})}stepActive(e){return this.#e?(this.#e.activeId=Om(this.#e.activeId,this.#e.list.items,e),this.#e.list.activeId=this.#e.activeId,this.#e.list.revealActive=!0,this.#e.activeId):null}stepSlash(e){return this.stepActive(e)}get activeId(){return this.#e?.activeId??null}selectActive(){return this.#e&&this.#e.list.revealActive&&this.#e.activeId?this.#e.activeId:null}refresh(e){if(!this.#e)return;let t=e.insertion.buildContext(this.#e.context.surface,this.#e.context.from);if(!Am(this.#e.context,t)){this.close();return}this.#e.context=t;let n=[...e.insertion.query({context:t,search:this.#e.search||void 0,kinds:this.#e.kinds})];this.#e.list.items=n,this.#e.activeId=Dm(this.#e.activeId,n),this.#e.list.activeId=this.#e.activeId,this.#e.activeId||(this.#e.list.revealActive=!1)}close(e={}){this.#t?.(),this.#t=null;let t=this.#e;if(this.#e=null,!t){e.animate===!1&&this.#i();return}this.#i();let n=++this.#n;e.restoreFocus!==!1&&this.#a(t);let r=!1,i=()=>{r||n!==this.#n||(r=!0,this.#r===t&&(this.#r=null),Ft(t.fieldBody,!1),t.popup.active=!1,t.popup.remove(),t.list.remove(),t.onClose())};if(!(e.animate===!0&&t.list.hasAttribute(`data-open`))){t.list.classList.remove(`closing`),t.list.removeAttribute(`data-open`),t.list.removeAttribute(`data-instant`),i();return}this.#r=t,t.list.removeAttribute(`data-instant`),t.list.classList.add(`closing`);let a=e=>{e.target===t.list&&e.animationName===`vizy-insertion-menu-hide`&&(t.list.removeEventListener(`animationend`,a),i())};t.list.addEventListener(`animationend`,a),window.setTimeout(i,140)}#i(){let e=this.#r;this.#r=null,++this.#n,e&&(e.list.classList.remove(`closing`),e.list.removeAttribute(`data-open`),e.list.removeAttribute(`data-instant`),Ft(e.fieldBody,!1),e.popup.active=!1,e.popup.remove(),e.list.remove(),e.onClose())}#a(e){if(e.onRestoreFocus){e.onRestoreFocus();return}e.returnFocus?.classList.contains(`vizy-inline-add`)||e.returnFocus?.focus()}get isOpen(){return this.#e!==null}get isClosing(){return this.#r!==null}isClosingInvoker(e){return!e||!this.#r?!1:this.#r.invokerKey===e}isInvoker(e){return!e||!this.#e||!(e instanceof HTMLElement)||!this.#e.invokerKey?!1:e.dataset.vizyInvokerKey===this.#e.invokerKey}get invokerKey(){return this.#e?.invokerKey??null}#o(e,t){let n=document.createElement(`pk-popup`);n.className=`vizy-insertion-popup`,n.placement=`bottom-start`,n.distance=4,n.flip=!0,n.flipPadding=10,n.shift=!0,n.shiftPadding=10,n.anchorTracking=!0,n.positionMethod=`fixed`;let r={getClientRect:t.getClientRect};n.anchor={getBoundingClientRect:()=>r.getClientRect?.()??new DOMRect},n.append(t.list),document.body.append(n);let i=t.holdFieldFocus?Pt(e.editor.view.dom):null;i&&Ft(i,!0);let a={kind:`list`,popup:n,list:t.list,context:t.context,activeId:t.list.activeId,returnFocus:t.returnFocus,onRestoreFocus:t.onRestoreFocus,invokerKey:t.invokerKey,onClose:t.onClose,search:t.search,rectSource:r,fieldBody:i,filterMode:t.filterMode,kinds:t.kinds};this.#e=a,n.active=!0;let o=()=>{if(this.#e!==a)return;let e=Rm(a.rectSource.getClientRect?.()??new DOMRect,a.popup.getAttribute(`data-current-placement`)??a.popup.placement,{distance:a.popup.distance});a.list.style.maxHeight=`${e}px`};n.addEventListener(`pk-reposition`,o),o(),this.#s(a,{instant:t.skipEnterMotion});let s=n=>{let r=t.onSelect??(t=>Nm(e,a.context,t));e.suspendInsertionSideEffects?.();let i=r(n);this.close({restoreFocus:!1,animate:!1}),Promise.resolve(i).finally(()=>{e.resumeInsertionSideEffects?.()})};t.list.addEventListener(`vizy-insertion-select`,(e=>{s(e.detail.id)})),t.list.addEventListener(`vizy-insertion-view`,(e=>{t.onViewChange?.(e.detail.view)})),t.list.addEventListener(`vizy-insertion-filter`,(t=>{if(!this.#e)return;this.#e.search=t.detail.query;let n=[...e.insertion.query({context:this.#e.context,search:this.#e.search,kinds:this.#e.kinds})];this.#e.list.items=n,this.#e.list.query=this.#e.search,this.#e.activeId=null,this.#e.list.activeId=null,this.#e.list.revealActive=!1}));let c=e=>{if(this.#e){if(e.key===`Escape`){e.preventDefault(),this.close({restoreFocus:!0,animate:!0});return}if(e.key===`ArrowDown`||e.key===`ArrowUp`){e.preventDefault(),this.stepActive(e.key===`ArrowDown`?1:-1);return}if(e.key===`Enter`){let t=this.#e.list.revealActive?this.#e.activeId:null;if(!t)return;e.preventDefault(),s(t)}}},l=e=>{if(!this.#e)return;let t=e.composedPath();t.includes(this.#e.popup)||t.includes(this.#e.list)||t.some(e=>e instanceof HTMLElement&&(e.classList.contains(`vizy-inline-add`)||e.hasAttribute(`data-vizy-toolbar-add-block`)))||this.close({restoreFocus:!1,animate:!0})};document.addEventListener(`keydown`,c,!0),document.addEventListener(`pointerdown`,l,!0),this.#t=()=>{n.removeEventListener(`pk-reposition`,o),document.removeEventListener(`keydown`,c,!0),document.removeEventListener(`pointerdown`,l,!0)},t.autofocusFilter&&t.list.focusFilterWhenReady?.()}async#s(e,t={}){let n=await this.#c(e.popup);if(this.#e!==e)return;let r=n.split(`-`)[0]||`bottom`;e.list.dataset.side=r,t.instant?e.list.dataset.instant=``:delete e.list.dataset.instant;let i=e.popup.shadowRoot?.querySelector(`.popup`),a=i instanceof HTMLElement?getComputedStyle(i).getPropertyValue(`--pk-transform-origin`).trim():``;a&&e.list.style.setProperty(`--pk-transform-origin`,a),e.list.dataset.open=``}#c(e){let t=e.placement||`bottom-start`,n=()=>e.getAttribute(`data-current-placement`)??t;return new Promise(t=>{let r=!1,i=()=>{r||(r=!0,t(n()))};e.addEventListener(`pk-reposition`,i,{once:!0}),window.setTimeout(i,300)})}},Bm=o`
    @layer pk-component {
        :host {
            display: block;
            max-width: 100%;
...
`,Vm=class extends l{constructor(...e){super(...e),this.value=``,this.variant=`default`,this.orientation=`horizontal`,this.placement=`top`,this.activation=`manual`,this.disabled=!1,this.ariaLabel=null,this.baseId=ee(`pk-tabs`),this.tabs=[],this.panels=[],this.focusedValue=``,this.syncTabs=()=>{let e=this.shadowRoot?.querySelector(`slot[name="nav"]`);e&&(this.tabs=e.assignedElements({flatten:!0}).filter(e=>e.tagName===`PK-TAB`),this.ensureDefaultValue(),this.applySelection())},this.syncPanels=()=>{let e=this.shadowRoot?.querySelector(`slot:not([name])`);e&&(this.panels=e.assignedElements({flatten:!0}).filter(e=>e.tagName===`PK-TAB-PANEL`),this.applySelection())},this.handleTabSelect=e=>{if(!this.isOwnTabEvent(e)||this.disabled)return;e.stopPropagation();let{value:t}=e.detail;if(t===this.value&&this.activation===`manual`){this.focusedValue=t,this.applySelection();return}t!==this.value&&this.selectTab(t)},this.handleTabKeyDown=e=>{if(!this.isOwnTabEvent(e))return;e.stopPropagation();let t=e.detail.event,n=this.getEnabledTabs();if(n.length===0)return;let r=n.findIndex(t=>t.value===e.detail.value);if(r<0)return;let i=r,a=this.getEffectiveOrientation()===`horizontal`;switch(t.key){case`ArrowDown`:if(a)return;t.preventDefault(),i=r>=n.length-1?0:r+1;break;case`ArrowUp`:if(a)return;t.preventDefault(),i=r<=0?n.length-1:r-1;break;case`ArrowRight`:if(!a)return;t.preventDefault(),i=r>=n.length-1?0:r+1;break;case`ArrowLeft`:if(!a)return;t.preventDefault(),i=r<=0?n.length-1:r-1;break;case`Home`:t.preventDefault(),i=0;break;case`End`:t.preventDefault(),i=n.length-1;break;default:return}let o=n[i];o&&(this.activation===`auto`?o.value===this.value?o.focusControl():this.selectTab(o.value):(this.focusedValue=o.value,this.applySelection(),o.focusControl()))}}static{this.styles=Bm}connectedCallback(){super.connectedCallback(),this.addEventListener(`pk-tab-select`,this.handleTabSelect),this.addEventListener(`pk-tab-keydown`,this.handleTabKeyDown)}disconnectedCallback(){this.removeEventListener(`pk-tab-select`,this.handleTabSelect),this.removeEventListener(`pk-tab-keydown`,this.handleTabKeyDown),super.disconnectedCallback()}updated(e){(e.has(`value`)||e.has(`disabled`)||e.has(`activation`))&&(e.has(`value`)&&(this.focusedValue=this.value),this.applySelection())}ensureDefaultValue(){if(this.value||this.tabs.length===0)return;let e=this.tabs.find(e=>!e.disabled&&!this.disabled);e&&(this.value=e.value,this.focusedValue=this.value)}getEnabledTabs(){return this.tabs.filter(e=>!e.disabled&&!this.disabled)}getEffectiveOrientation(){return this.variant===`sidebar`?`vertical`:this.orientation}getEffectivePlacement(){return this.variant===`sidebar`&&(this.placement===`top`||this.placement===`bottom`)?`start`:this.placement}applySelection(){let e=this.getAttribute(`data-current-value`)??``,t=this.activation===`manual`?this.focusedValue:this.value;for(let e of this.tabs){let n=e.value===this.value,r=`${this.baseId}-tab-${e.value}`,i=`${this.baseId}-panel-${e.value}`;e.selected=n,e.disabled=this.disabled||e.hasAttribute(`disabled`),e.focusIndex=e.value===t?0:-1,e.panelId=i,e.id=r}for(let t of this.panels){let n=t.value===this.value,r=`${this.baseId}-tab-${t.value}`,i=`${this.baseId}-panel-${t.value}`;t.hidden!==!n&&(n?this.dispatchEvent(new CustomEvent(`pk-tab-show`,{detail:{value:t.value},bubbles:!0,composed:!0})):e===t.value&&this.dispatchEvent(new CustomEvent(`pk-tab-hide`,{detail:{value:t.value},bubbles:!0,composed:!0}))),t.hidden=!n,t.tabId=r,t.id=i}this.setAttribute(`data-current-value`,this.value)}isOwnTabEvent(e){let t=e.target;return t instanceof HTMLElement&&t.tagName===`PK-TAB`&&this.tabs.includes(t)}selectTab(e){this.value=e,this.focusedValue=e,this.applySelection(),this.dispatchEvent(new CustomEvent(`pk-change`,{detail:{value:this.value},bubbles:!0,composed:!0}))}render(){let e=this.getEffectiveOrientation();return n`
        ...
        `}};i([c()],Vm.prototype,`value`,void 0),i([c({reflect:!0})],Vm.prototype,`variant`,void 0),i([c({reflect:!0})],Vm.prototype,`orientation`,void 0),i([c({reflect:!0})],Vm.prototype,`placement`,void 0),i([c({reflect:!0})],Vm.prototype,`activation`,void 0),i([c({type:Boolean,reflect:!0})],Vm.prototype,`disabled`,void 0),i([c({attribute:`aria-label`})],Vm.prototype,`ariaLabel`,void 0),i([a()],Vm.prototype,`tabs`,void 0),i([a()],Vm.prototype,`panels`,void 0),i([a()],Vm.prototype,`focusedValue`,void 0),Vm=i([s(`pk-tabs`)],Vm);var Hm=class extends l{constructor(...e){super(...e),this.value=``,this.disabled=!1,this.selected=!1,this.focusIndex=-1}focusControl(){this.shadowRoot?.querySelector(`.trigger`)?.focus()}handleClick(){this.disabled||this.dispatchEvent(new CustomEvent(`pk-tab-select`,{detail:{value:this.value},bubbles:!0,composed:!0}))}handleKeyDown(e){this.dispatchEvent(new CustomEvent(`pk-tab-keydown`,{detail:{event:e,value:this.value},bubbles:!0,composed:!0}))}renderTrigger(e){return n`
            <button
                part="trigger"
                type="button"
                class=${e}
