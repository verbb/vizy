import{d as e,i as t,n,p as r,r as i,s as a,t as o}from"./decorate-R0X811qp-DTGsgM1e.js";import{Rt as s,t as c}from"./unsafe-html-DhD_KFJk.js";var l=r`
    @layer pk-component {
        .pk-popup-content {
...
`,u=class extends c{};u.directiveName=`unsafeSVG`,u.resultType=2;var d=s(u),f=[];function p(e){f.push(e)}function m(e){for(let t=f.length-1;t>=0;--t)if(f[t]===e){f.splice(t,1);break}}function h(e){return f.length>0&&f[f.length-1]===e}var g=[t,r`
        @layer pk-component {
            :host {
                display: block;
    ...
    `],_=class extends o{constructor(...e){super(...e),this.variant=`default`,this.size=`sm`,this.centered=!1}static{this.styles=g}render(){return e`
            <div part="base" class="spinner" aria-hidden="true"></div>
        `}};n([a({reflect:!0})],_.prototype,`variant`,void 0),n([a({reflect:!0})],_.prototype,`size`,void 0),n([a({reflect:!0})],_.prototype,`tone`,void 0),n([a({type:Boolean,reflect:!0})],_.prototype,`centered`,void 0),_=n([i(`pk-spinner`)],_);export{l as a,d as i,p as n,m as r,h as t};
//# sourceMappingURL=pk-spinner-DweuYJ_Z-BKBHTf_C.js.map