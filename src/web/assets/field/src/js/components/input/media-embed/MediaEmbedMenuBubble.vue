<template>
    <div class="vui-media-embed-menu-bubble" style="display: none;">
...
export default {
    ...
    watch: {
        editor: {
            ...
            handler(editor) {
                if (editor) {
                    this.$nextTick(() => {
                        // Attach a custom event to the editor whenever a media embed node is clicked
                        editor.on('vui:media-embed-clicked', this.renderBubble);
                    });
                }
            },
        },
    ...
    methods: {
        renderBubble(event) {
            ...
            const model = this.editor.getAttributes('mediaEmbed');
            ...
            // Attach it to the editor dom, rather than the media embed node
