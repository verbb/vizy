...
`,Rm=class extends Im{static{this.styles=Lm}render(){return this.renderPanel(`content pk-tabs__content`)}};Rm=l([f(`pk-tab-panel`)],Rm);var zm=class extends r{#e=[];get items(){return this.#e}set items(e){this.#e=e}#t=``;get query(){return this.#t}set query(e){this.#t=e}#n=`grid`;get view(){return this.#n}set view(e){this.#n=e}#r=`all`;get activeTab(){return this.#r}set activeTab(e){this.#r=e}#i=null;get activeId(){return this.#i}set activeId(e){this.#i=e}static styles=e`
    ...
    `;updated(e){e.has(`editor`)&&this.#m()}syncToImage(){let e=this.editor;if(!e)return;this.#m();let t=qg(e);if(t!==this.#a){let e=this.#a;this.#a=t,e!==null&&Date.now()-this.#c>Wg&&(this.#o=null)}this.#l.contextElement=e.view.dom,this.#v();let n=!!this.#r?.active,r=this.#o!==null||this.#s!==null;this.visible=!0,this.updateComplete.then(()=>{!this.#r||!this.visible||(this.#r.active=!0,(n||r)&&this.#r.reposition())})}hide(e){this.visible=!1,this.#a=null,e?.clearAnchor&&(this.#o=null,this.#s=null,this.#c=0),this.#r&&(this.#r.active=!1)}disconnectedCallback(){this.#h();let e=this.#r;this.#r=null,e?.isConnected&&(e.active=!1,e.remove()),super.disconnectedCallback()}render(){if(!this.visible)return u;let e=this.#u();return i`
        ...
        `}#u(){let e=this.editor;if(!e?.isActive(`image`))return null;let t=String(e.getAttributes(`image`).assetUid??``);return t?Ca(t):null}#d=()=>{let e=this.editor;if(!e)return;let t=Oa(e);t&&(this.hide({clearAnchor:!0}),Ia(e,t,{focus:!0,transforms:this.imageAuthoring.transforms??[]}))};#f=()=>{let e=this.editor;e&&(Aa(e,{focus:!0}),this.hide({clearAnchor:!0}))};#p=()=>{let e=this.editor,t=this.#u();if(!e||!t?.assetId)return;let n=window.Craft;if(typeof n?.AssetImageEditor!=`function`)return;let r=String(e.getAttributes(`image`).assetUid??``);new n.AssetImageEditor(t.assetId,{allowSavingAsNew:!1,allowDegreeFractions:n.isImagick,onSave:()=>{if(!r)return;Ta(r);let t=e.getAttributes(`image`);e.chain().focus().updateAttributes(`image`,{...t}).run()}}),this.hide({clearAnchor:!0})};#m(){let e=this.editor?.view.dom??null;e!==this.#i&&(this.#h(),e&&(this.#i=e,e.addEventListener(`pointerdown`,this.#g,!0)))}#h(){this.#i?.removeEventListener(`pointerdown`,this.#g,!0),this.#i=null}#g=e=>{let t=e.target;if(!(t instanceof Element))return;let n=t.closest(`.vizy-image`);if(!n||!this.#i?.contains(n))return;let r=(n.querySelector(`img`)??n).getBoundingClientRect();if(r.width<=0||r.height<=0)return;this.#o={x:Kg((e.clientX-r.left)/r.width),y:Kg((e.clientY-r.top)/r.height)},this.#s={x:e.clientX,y:e.clientY},this.#c=Date.now();let i=this.editor;Wt(Pt(i?.view.dom??null),()=>{i&&!i.isDestroyed&&Ut(i)}),requestAnimationFrame(()=>{!i||i.isDestroyed||Yg(i)&&this.syncToImage()})};#_(){if(this.#s&&Date.now()-this.#c<=Wg)return new DOMRect(this.#s.x-12,this.#s.y-12,24,24);let e=Jg(this.editor);if(!e)return new DOMRect;if(this.#o){let t=e.left+this.#o.x*e.width,n=e.top+this.#o.y*e.height;return new DOMRect(t-12,n-12,24,24)}return new DOMRect(e.left+e.width/2-12,e.top,24,24)}#v(){if(this.#r)return;let e=document.createElement(`pk-popup`);e.className=`vizy-image-bubble-popup`,e.placement=`top`,e.distance=Ug,e.flip=!0,e.flipPadding=Hg,e.shift=!0,e.shiftPadding=Hg,e.arrow=!0,e.arrowPlacement=`center`,e.anchorTracking=!0,e.positionMethod=`fixed`;let t=this.#l;e.anchor={getBoundingClientRect:()=>t.getClientRect(),get contextElement(){return t.contextElement}},e.append(this),document.body.append(e),this.#r=e}};N([n({attribute:!1})],Gg.prototype,`editor`,null),N([n({attribute:!1})],Gg.prototype,`imageAuthoring`,null),N([n({type:Boolean,reflect:!0})],Gg.prototype,`visible`,null),Gg=N([M(`vizy-image-bubble`)],Gg);function Kg(e){return Math.min(1,Math.max(0,e))}function qg(e){if(!e)return null;let{selection:t}=e.state;if(t instanceof A&&t.node.type.name===`image`)return t.from;if(!e.isActive(`image`))return null;let n=t.$from;for(let e=n.depth;e>=0;e--)if(n.node(e).type.name===`image`)return e===0?0:n.before(e);return null}function Jg(e){let t=qg(e);if(t==null||!e)return null;let n=e.view.nodeDOM(t);return n instanceof HTMLElement?(n.matches(`img`)?n:n.querySelector(`img`)??n).getBoundingClientRect():null}function Yg(e){let{selection:t}=e.state;return t instanceof A&&t.node.type.name===`image`||e.isActive(`image`)}var Xg=10,Zg=8,Qg=500,$g=`.vizy-iframe, .vizy-media-embed`,e_=class extends r{#e=null;get editor(){return this.#e}set editor(e){this.#e=e}#t=!1;get visible(){return this.#t}set visible(e){this.#t=e}#n=null;#r=`mediaEmbed`;#i=null;#a=null;#o=null;#s=null;#c=0;#l={getClientRect:()=>this.#h(),contextElement:void 0};static styles=e`
        :host { display: none; }
        :host([visible]) { display: block; }
        .panel {
            display: flex;
    ...
    `;updated(e){e.has(`editor`)&&this.#f()}syncToEmbed(e){let t=this.editor;if(!t)return;this.#r=e,this.#f();let n=n_(t);if(n!==this.#a){let e=this.#a;this.#a=n,e!==null&&Date.now()-this.#c>Qg&&(this.#o=null)}this.#l.contextElement=t.view.dom,this.#g();let r=!!this.#n?.active,i=this.#o!==null||this.#s!==null;this.visible=!0,this.updateComplete.then(()=>{!this.#n||!this.visible||(this.#n.active=!0,(r||i)&&this.#n.reposition())})}hide(e){this.visible=!1,this.#a=null,e?.clearAnchor&&(this.#o=null,this.#s=null,this.#c=0),this.#n&&(this.#n.active=!1)}disconnectedCallback(){this.#p();let e=this.#n;this.#n=null,e?.isConnected&&(e.active=!1,e.remove()),super.disconnectedCallback()}render(){return this.visible?i`
