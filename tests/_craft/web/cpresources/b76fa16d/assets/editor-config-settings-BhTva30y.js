...
`:`<br>
`:`
`},F.text=function(e,t){return M(e[t].content)},F.html_block=function(e,t){return e[t].content},F.html_inline=function(e,t){return e[t].content};function I(){this.rules=et({},F)}I.prototype.renderAttrs=function(e){let t,n,r;if(!e.attrs)return``;for(r=``,t=0,n=e.attrs.length;t<n;t++)r+=` `+M(e.attrs[t][0])+`="`+M(e.attrs[t][1])+`"`;return r},I.prototype.renderToken=function(e,t,n){let r=e[t],i=``;if(r.hidden)return``;r.block&&r.nesting!==-1&&t&&e[t-1].hidden&&(i+=`
...
`,Y=class extends a{constructor(...e){super(...e),this.hasSlotController=new u(this,`label`,`instructions`,`hint`,`header-end`,`warning`,`tip`,`errors`),this.baseId=l(`pk-field`),this.label=``,this.instructions=``,this.required=!1,this.translatable=!1,this.warning=``,this.tip=``,this.errors=[],this.for=``,this.onLabelClick=e=>{let t=e.target;t instanceof Element&&(t.closest(`button, a, input, select, textarea, [role="button"], [role="link"]`)||this.focusControl())},this.onControlSlotChange=()=>{this.syncControlAria(),this.requestUpdate()}}static{this.styles=[_,ei,ii]}connectedCallback(){super.connectedCallback();let e=this.getAttribute(`hint`);e&&!this.instructions&&(this.instructions=e)}updated(e){super.updated(e),(e.has(`label`)||e.has(`instructions`)||e.has(`errors`)||e.has(`warning`)||e.has(`tip`)||e.has(`required`)||e.has(`for`))&&this.syncControlAria()}get labelId(){return`${this.baseId}-label`}get instructionsId(){return`${this.baseId}-instructions`}get errorsId(){return`${this.baseId}-errors`}get warningId(){return`${this.baseId}-warning`}get tipId(){return`${this.baseId}-tip`}get controlId(){return this.for||`${this.baseId}-control`}hasLabel(){return!!this.label||this.hasSlotController.test(`label`)}hasInstructions(){return!!this.instructions||this.hasSlotController.test(`instructions`)||this.hasSlotController.test(`hint`)}hasHeaderEnd(){return this.hasSlotController.test(`header-end`)}hasErrors(){return this.errors.length>0||this.hasSlotController.test(`errors`)}hasWarning(){return!!this.warning||this.hasSlotController.test(`warning`)}hasTip(){return!!this.tip||this.hasSlotController.test(`tip`)}getControlElement(){let[e]=this.controlSlot?.assignedElements({flatten:!0})??[];return e instanceof HTMLElement?e:this.for?this.getRootNode().getElementById(this.for):null}focusControl(){let e=this.getControlElement();!e||typeof e.focus!=`function`||e.focus()}syncControlAria(){let e=this.getControlElement();e&&ti({control:e,labelId:this.labelId,instructionsId:this.instructionsId,errorsId:this.errorsId,warningId:this.warningId,tipId:this.tipId,controlId:this.controlId,hasLabel:this.hasLabel(),hasInstructions:this.hasInstructions(),hasErrors:this.hasErrors(),hasWarning:this.hasWarning(),hasTip:this.hasTip(),hasRequired:this.required,invalid:this.hasErrors()})}render(){let e=this.hasLabel(),t=this.hasInstructions(),n=this.hasHeaderEnd(),r=this.hasErrors(),a=this.hasWarning(),o=this.hasTip(),s=this.for||(e?this.controlId:b);return v`
        ...
        `}};t([y()],Y.prototype,`label`,void 0),t([y()],Y.prototype,`instructions`,void 0),t([y({type:Boolean,reflect:!0})],Y.prototype,`required`,void 0),t([y({type:Boolean,reflect:!0})],Y.prototype,`translatable`,void 0),t([y()],Y.prototype,`warning`,void 0),t([y()],Y.prototype,`tip`,void 0),t([y({attribute:!1})],Y.prototype,`errors`,void 0),t([y({reflect:!0})],Y.prototype,`for`,void 0),t([h(`slot:not([name])`)],Y.prototype,`controlSlot`,void 0),Y=t([x(`pk-field`)],Y);function X(e){return e===`available`||e===`dropdowns`}var ai=class t{#e;#t=[];#n=[];#r;#i={x:0,y:0};#a=null;#o=null;#s=null;#c=null;#l=0;#u=`active`;#d=!1;#f={x:0,y:0};static#p=10;static#m=5;constructor(i){this.#r=i,this.#e=new r({plugins:t=>[...t,e.configure({dropAnimation:null})],sensors:[n.configure({activationConstraints:[new s.Distance({value:t.#m})]})]}),this.#L()}refresh(){this.#H(),this.#y(this.#r.availableList(),`available`),this.#y(this.#g(),`dropdowns`),this.#y(this.#r.activeList(),`active`),this.#y(this.#h(),`members`)}#h(){return this.#r.memberList?.()??null}#g(){return this.#r.dropdownList?.()??null}#_(){return[this.#r.availableList(),this.#g()].filter(e=>!!e)}#v(){let e=[],t=this.#h();if(this.#s?.list===`members`)return t&&e.push({name:`members`,element:t}),e;let n=this.#r.activeList();return n&&e.push({name:`active`,element:n}),e}destroy(){this.#n.forEach(e=>e()),this.#n=[],this.#I(),this.#H(),this.#e.destroy()}#y(e,t){e&&this.#b(e).forEach((e,n)=>{let r=e.dataset.toolbarItem;r&&this.#t.push(new o({id:`${this.#r.type}-${t}-${n}-${r}`,element:e,type:this.#r.type,data:{itemId:r,list:t,index:n,repeatable:e.hasAttribute(`data-toolbar-repeatable`)}},this.#e))})}#b(e){return[...e.querySelectorAll(`[data-toolbar-item]`)]}#x=new Map;#S(){this.#x.clear();for(let e of this.#v())this.#x.set(e.name,this.#C(e.element))}#C(e){let t=this.#o,n=e.getBoundingClientRect(),r=[];return{element:e,peers:this.#b(e).map((e,t)=>({peer:e,index:t})).filter(({peer:e})=>e!==t).map(({peer:e,index:t})=>{let i=e.getBoundingClientRect(),a=i.top-n.top,o=i.bottom-n.top,s=r.at(-1);return!s||Math.abs(s.start-a)>1?r.push({start:a,end:o}):s.end=Math.max(s.end,o),{band:r.length-1,middle:i.left+i.width/2-n.left,index:t}}),bands:r}}#w(e,t){let n=0,r=1/0;return e.bands.forEach((e,i)=>{let a=t<e.start?e.start-t:Math.max(0,t-e.end);a<r&&(r=a,n=i)}),n}#T(e){let t=e.element.getBoundingClientRect(),n=this.#i.x-t.left,r=this.#w(e,this.#i.y-t.top),i=0;for(let t of e.peers){if(!(t.band<r||!(t.band>r)&&n>t.middle))break;i+=1}return i}#E(){if(this.#c)return this.#c;let e=this.#o.cloneNode(!0);return e.removeAttribute(`id`),e.removeAttribute(`data-toolbar-item`),e.removeAttribute(`aria-label`),e.removeAttribute(`aria-describedby`),e.setAttribute(`aria-hidden`,`true`),e.classList.remove(`is-lifted`),e.style.marginInlineEnd=``,e.classList.add(`is-slot`),this.#c=e,e}#D(e,t){if(!this.#o)return;let n=t.element,r=this.#T(t);this.#u=e,this.#l=r;let i=this.#b(n).filter(e=>e!==this.#o)[r]??n.querySelector(`[data-builder-tail]`),a=this.#E();(a.parentElement!==n||a.nextElementSibling!==i)&&n.insertBefore(a,i??null)}#O(){this.#c?.isConnected&&this.#c.remove()}#k(){if(!this.#o)return;let e=this.#A();if(!e){this.#O();return}this.#D(e.name,e.zone)}#A(){for(let{name:e,element:t}of this.#v()){let n=t.getBoundingClientRect();if(!(this.#i.x>=n.left&&this.#i.x<=n.right&&this.#i.y>=n.top&&this.#i.y<=n.bottom))continue;let r=this.#x.get(e);return r?{name:e,zone:r}:null}return null}#j(){return!!this.#c?.isConnected}#M(){let e=this.#o;if(!e||this.#N())return;e.classList.add(`is-lifted`);let t=e.parentElement,n=parseFloat((t?getComputedStyle(t).columnGap:``)||``)||0;e.style.marginInlineEnd=`-${e.getBoundingClientRect().width+n}px`}#N(){return!!this.#s?.repeatable&&X(this.#s.list)}#P(e){let n=this.#F();if(!n)return;let r=e.cloneNode(!0);r.removeAttribute(`id`),r.removeAttribute(`aria-describedby`),r.removeAttribute(`aria-roledescription`),r.setAttribute(`aria-hidden`,`true`),r.classList.add(`is-drag-helper`);let i=e.getBoundingClientRect(),a=this.#f.x-i.left+t.#p,o=this.#f.y-i.top+t.#p;r.style.setProperty(`transform`,`translate(${a}px, ${o}px)`,`important`),document.body.appendChild(r),this.#a=r,n.overlay=r}#F(){return this.#e.plugins.find(t=>t instanceof e)}#I(){let e=this.#F();e&&(e.overlay=void 0),this.#a?.remove(),this.#a=null}#L(){let e=e=>{this.#i={x:e.clientX,y:e.clientY},this.#k()},t=e=>{this.#f={x:e.clientX,y:e.clientY},this.#i={x:e.clientX,y:e.clientY}},n=e=>{let t=e.target instanceof Element&&e.target.closest(`[data-toolbar-item]`)!==null;this.#d&&t&&(e.preventDefault(),e.stopPropagation()),this.#d=!1};document.addEventListener(`pointerdown`,t,!0),document.addEventListener(`pointermove`,e,!0),document.addEventListener(`click`,n,!0),this.#n.push(()=>{document.removeEventListener(`pointerdown`,t,!0),document.removeEventListener(`pointermove`,e,!0),document.removeEventListener(`click`,n,!0)}),this.#n.push(this.#e.monitor.addEventListener(`beforedragstart`,e=>{let{source:t}=e.operation;t?.element instanceof HTMLElement&&this.#P(t.element)}),this.#e.monitor.addEventListener(`dragstart`,e=>{this.#r.container()?.classList.add(`is-sorting`);let{source:t}=e.operation;t?.element instanceof HTMLElement&&(this.#o=t.element,this.#s=t.data,this.#B(),this.#S(),this.#M(),this.#k())}),this.#e.monitor.addEventListener(`dragend`,e=>{let t=this.#s,n=this.#j(),r=this.#l,i=this.#u;if(this.#R(),this.#d=!0,!t?.itemId||e.canceled){this.#z(this.#r.onRevert);return}if(!n){if(X(t.list)){this.#z(this.#r.onRevert);return}this.#z(()=>this.#r.onDrop({itemId:t.itemId,from:t.list,to:`available`,fromIndex:t.index,index:t.index}));return}if(t.list===i&&r===t.index){this.#z(this.#r.onRevert);return}this.#z(()=>this.#r.onDrop({itemId:t.itemId,from:t.list,to:i,fromIndex:t.index,index:r}))}))}#R(){let e=this.#r.container();e?.classList.remove(`is-sorting`),e?.querySelectorAll(`.is-lifted`).forEach(e=>{e.classList.remove(`is-lifted`),e.style.marginInlineEnd=``}),this.#O(),this.#c=null,this.#o=null,this.#s=null,this.#u=`active`,this.#x.clear(),this.#V(),this.#I()}#z(e){requestAnimationFrame(()=>e())}#B(){this.#_().forEach(e=>{e.style.minHeight=`${e.getBoundingClientRect().height}px`})}#V(){this.#_().forEach(e=>{e.style.minHeight=``})}#H(){this.#t.forEach(e=>{e.unregister(),e.destroy()}),this.#t=[]}},oi=`dropdown:`;function Z(e){return e.startsWith(oi)}function si(e){return Z(e)?e.slice(9):e}var ci=`headingLevels`;function li(e,t){let n=t.filter(t=>e.includes(t)),r=e.filter(e=>!n.includes(e));return[...n,...r]}function ui(e,t,n){return n!==void 0&&n>=0&&n<e.length&&e[n]===t?n:e.indexOf(t)}function di(e){return new Set(e)}var fi=`modulepreload`,pi=function(e,t){return new URL(e,t).href},mi={},hi=function(e,t,n){let r=Promise.resolve();if(t&&t.length>0){let e=document.getElementsByTagName(`link`),i=document.querySelector(`meta[property=csp-nonce]`),a=i?.nonce||i?.getAttribute(`nonce`);function o(e){return Promise.all(e.map(e=>Promise.resolve(e).then(e=>({status:`fulfilled`,value:e}),e=>({status:`rejected`,reason:e}))))}function s(e){return import.meta.resolve?import.meta.resolve(e):new URL(e,import.meta.url).href}r=o(t.map(t=>{if(t=pi(t,n),t=s(t),t in mi)return;mi[t]=!0;let r=t.endsWith(`.css`);for(let n=e.length-1;n>=0;n--){let i=e[n];if(i.href===t&&(!r||i.rel===`stylesheet`))return}let i=document.createElement(`link`);if(i.rel=r?`stylesheet`:fi,r||(i.as=`script`),i.crossOrigin=``,i.href=t,a&&i.setAttribute(`nonce`,a),document.head.appendChild(i),r)return new Promise((e,n)=>{i.addEventListener(`load`,e),i.addEventListener(`error`,()=>n(Error(`Unable to preload CSS for ${t}`)))})}))}function i(e){let t=new Event(`vite:preloadError`,{cancelable:!0});if(t.payload=e,window.dispatchEvent(t),!t.defaultPrevented)throw e}return r.then(t=>{for(let e of t||[])e.status===`rejected`&&i(e.reason);return e().catch(i)})},gi=[1,2,3,4,5,6],_i=[2,3,4];function Q(e,t,n={}){return window.Craft?.t(e,t,n)??t.replace(/\{(\w+)\}/g,(e,t)=>n[t]??e)}function $(e){return e.replace(/[&<>"']/g,e=>({"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`})[e])}var vi=class e extends HTMLElement{#e={capabilities:{nodes:[],marks:[]},headings:{levels:[..._i]},toolbar:[],dropdowns:{},bubble:{enabled:!0,items:[]}};#t=[];#n=[];#r=[];#i={nodes:[],marks:[],headingAvailable:!1};#a=`visual`;#o=!1;#s=null;#c=!1;#l=``;#u=``;#d=null;#f=new Map;#p;#m=0;#h=null;static#g=200;connectedCallback(){this.#d=this.querySelector(`[data-vizy-config-sync]`),this.#ce();let e=this.getAttribute(`data-initial`);if(e){let t=JSON.parse(e);this.#e={...t.config,dropdowns:t.config.dropdowns??{}},this.#j(),this.#t=t.toolbarCatalog,this.#n=t.dropdownCatalog??[],this.#r=t.bubbleCatalog,this.#i=t.capabilityCatalog}this.#l=this.#_();let t=this.closest(`form`);t&&!t.dataset.vizyConfigBound&&(t.dataset.vizyConfigBound=`1`,t.addEventListener(`submit`,e=>{if(this.#a===`advanced`&&!this.#v()){e.preventDefault(),this.render();return}this.#Z()})),this.render()}disconnectedCallback(){this.#f.forEach(e=>e.destroy()),this.#f.clear()}#_(){return JSON.stringify({capabilities:this.#e.capabilities,headings:this.#e.headings,toolbar:this.#e.toolbar,dropdowns:this.#e.dropdowns,bubble:this.#e.bubble},null,2)}#v(){try{let e=JSON.parse(this.#l);return this.#e={capabilities:{nodes:[...e.capabilities?.nodes??[]],marks:[...e.capabilities?.marks??[]]},headings:{levels:[...e.headings?.levels??_i]},toolbar:[...e.toolbar??[]],dropdowns:{...e.dropdowns??{}},bubble:{enabled:e.bubble?.enabled??!0,items:[...e.bubble?.items??[]]}},this.#j(),this.#u=``,!0}catch{return this.#u=Q(`vizy`,`Invalid JSON`),!1}}#y(e,t){return t.find(t=>t.id===e)}#b(e){if(!Z(e))return this.#y(e,this.#t);let t=this.#y(e,this.#n);return t?{...t,kind:`group`}:void 0}#x(e){return e.pending||e.kind===`presentation`||e.kind===`dropdown`?!0:e.kind===`action`?e.capabilityName===void 0||this.#e.capabilities.nodes.includes(e.capabilityName):e.kind===`mark`?this.#e.capabilities.marks.includes(e.id):e.headingLevel===void 0?e.kind===`node`?e.id===`paragraph`||e.id===`hardBreak`||this.#e.capabilities.nodes.includes(e.capabilityName??e.id):!1:this.#e.headings.levels.includes(e.headingLevel)}#S(e){if(Z(e))return!0;let t=this.#y(e,this.#t);return!t||t.kind===`presentation`||this.#x(t)}#C(){let e=di(this.#e.toolbar);return this.#n.filter(t=>!e.has(t.id))}#w(){let e=di(this.#e.toolbar);return this.#t.filter(t=>e.has(t.id)&&!this.#P(t.id)?!1:this.#x(t)).sort((e,t)=>Number(this.#P(e.id))-Number(this.#P(t.id)))}#T(){let e=new Set(this.#e.bubble.items);return this.#r.filter(t=>!e.has(t.id)&&this.#e.capabilities.marks.includes(t.id))}#E(e){if(e===`visual`&&this.#a===`advanced`&&!this.#v()){this.render();return}e===`advanced`&&(this.#l=this.#_(),this.#u=``,this.#D()),this.#a=e,this.render()}async#D(){this.#c||(await hi(()=>import(`./code-editor-1FfeIq4W.js`),__vite__mapDeps([0,1,2,3,4]),import.meta.url),this.#c=!0,this.#a===`advanced`&&this.render())}#O(e,t,n){let r=new Set(this.#e.capabilities[e]);n?r.add(t):r.delete(t),this.#e.capabilities[e]=[...r],this.render()}#k(e,t,n){let r=this.#e.capabilities[e].filter(e=>!n.includes(e));this.#e.capabilities[e]=[...new Set([...r,...t])],this.render()}#A(e,t,n){let r=t.length>0&&t.every(e=>n.includes(e.value))?`*`:JSON.stringify(n);return`
            <pk-checkbox-select
                ...
                value="${$(r)}"
            ></pk-checkbox-select>
        `}#j(){this.#e.capabilities.nodes.includes(`heading`)||(this.#e.headings.levels=[])}#M(){return this.#e.headings.levels.length>0}#N(e){this.#e.headings.levels=[...e].sort((e,t)=>e-t),this.#O(`nodes`,`heading`,this.#M())}#P(e){return e===`separator`}#F(e,t){return ui(this.#e.toolbar,e,t)}#I(e,t){!this.#P(e)&&this.#F(e)!==-1||(t===void 0?this.#e.toolbar.push(e):this.#e.toolbar.splice(t,0,e),this.render())}#L(){return this.#s?.list===`toolbar`?this.#e.toolbar[this.#s.index]??null:null}#R(){let e=this.#L();return e!==null&&Z(e)?si(e):null}#z(e){return this.#y(`dropdown:${e}`,this.#n)?.members??[]}#B(e){return this.#e.dropdowns[e]??this.#z(e)}#V(e,t){let n=this.#z(e);t.length===n.length&&t.every((e,t)=>e===n[t])?delete this.#e.dropdowns[e]:this.#e.dropdowns[e]=t,this.render()}#H(e,t){let n=this.#z(e);if(!n.includes(t))return;let r=this.#B(e);if(r.includes(t)){if(r.length<=1)return;this.#V(e,r.filter(e=>e!==t));return}let i=n.indexOf(t),a=r.findIndex(e=>n.indexOf(e)>i),o=[...r];o.splice(a===-1?o.length:a,0,t),this.#V(e,o)}#U(e,t,n){let r=[...this.#B(e)];if(t<0||n<0||t>=r.length||n>=r.length)return;let[i]=r.splice(t,1);r.splice(n,0,i),this.#V(e,r)}#W(e){delete this.#e.dropdowns[e],this.render()}#G(e,t){let n=this.#s?.list===e&&this.#s.index===t;this.#s=n?null:{list:e,index:t},this.render()}#K(e,t){let n=this.#F(e,t);n!==-1&&(this.#e.toolbar.splice(n,1),Z(e)&&delete this.#e.dropdowns[si(e)],this.#s=null,this.render())}#q(e,t){this.#e.bubble.items.includes(e)||(t===void 0?this.#e.bubble.items.push(e):this.#e.bubble.items.splice(t,0,e),this.render())}#J(e){this.#e.bubble.items=this.#e.bubble.items.filter(t=>t!==e),this.render()}#Y(e,t,n){let r=e===`toolbar`?this.#e.toolbar:this.#e.bubble.items;if(t<0||n<0||t>=r.length||n>=r.length)return;let[i]=r.splice(t,1);r.splice(n,0,i),this.render()}#X(e,t){if(e===`bubble`){X(t.to)?this.#J(t.itemId):X(t.from)?this.#q(t.itemId,t.index):this.#Y(`bubble`,t.fromIndex,t.index);return}if(t.from===`members`){let e=this.#R();e!==null&&t.to===`members`?this.#U(e,t.fromIndex,t.index):this.render();return}if(X(t.to)){this.#K(t.itemId,t.fromIndex);return}if(X(t.from)){this.#I(t.itemId,t.index);return}this.#s?.list===`toolbar`&&this.#s.index===t.fromIndex&&(this.#s={list:`toolbar`,index:t.index}),this.#Y(`toolbar`,t.fromIndex,t.index)}#Z(){if(!this.#d)return;this.#d.replaceChildren();let e=(e,t)=>{let n=document.createElement(`input`);n.type=`hidden`,n.name=e,n.value=t,this.#d?.append(n)};this.#e.capabilities.nodes.forEach(t=>e(`capabilityNodes[]`,t)),this.#e.capabilities.marks.forEach(t=>e(`capabilityMarks[]`,t)),this.#e.headings.levels.forEach(t=>e(`headingLevels[]`,String(t))),e(`toolbarJson`,JSON.stringify(this.#e.toolbar)),e(`dropdownsJson`,JSON.stringify(this.#e.dropdowns)),e(`bubbleJson`,JSON.stringify(this.#e.bubble)),e(`advancedConfig`,this.#_())}#Q(e){return e.icon?e.icon:e.abbr?`<span class="vizy-control-abbr">${$(e.abbr)}</span>`:`<span class="vizy-control-text">${$(e.label)}</span>`}#$(e,t,n,r={}){let i=e.kind===`group`||e.kind===`dropdown`;return`
            <button
                type="button"
                class="${[`vizy-control`,e.id===`separator`?`is-separator`:``,e.icon||e.abbr||e.id===`separator`?``:`is-text`,i?`has-menu`:``,n===`available`?`is-available`:``,r.selected?`is-selected`:``,r.excluded?`is-excluded`:``,r.unavailable?`is-unavailable`:``,e.pending?`is-pending`:``].filter(Boolean).join(` `)}"
                aria-label="${$(e.pending?Q(`vizy`,`{label} (not available yet)`,{label:e.label}):r.unavailable?Q(`vizy`,`{label} (not allowed by this config)`,{label:e.label}):r.excluded?Q(`vizy`,`{label} (not in this dropdown)`,{label:e.label}):e.label)}"
                ${n===`member`?`aria-pressed="${r.excluded?`false`:`true`}"`:``}
                ${n===`active`?`aria-current="${r.selected?`true`:`false`}"`:``}
                data-toolbar-item="${$(e.id)}"
                data-toolbar-list="${t}"
                data-toolbar-variant="${n}"
                ${this.#P(e.id)?`data-toolbar-repeatable`:``}
            >${e.id===`separator`?``:this.#Q(e)}${i?`<span class="vizy-control-chevron" aria-hidden="true"></span>`:``}</button>
        `}#ee(){let e=[...this.#i.nodes,...this.#i.marks],t=e.filter(e=>this.#e.capabilities.nodes.includes(e.value)||this.#e.capabilities.marks.includes(e.value));return`
            <details class="vizy-editor-config-section vizy-editor-config-schema" data-schema-details ${this.#o?`open`:``}>
                ...
                ${this.#A(`nodes`,this.#i.nodes,this.#e.capabilities.nodes)}
                ...
                ${this.#i.headingAvailable?`
                    ...
                    -->
                    ${this.#A(`headings`,gi.map(e=>({label:`H${e}`,value:String(e)})),this.#e.headings.levels.map(String))}
                `:``}

                <div class="vizy-editor-config-subhead">${Q(`vizy`,`Inline formatting`)}</div>
                ${this.#A(`marks`,this.#i.marks,this.#e.capabilities.marks)}
            </details>
        `}#te(){let e=this.#e.headings.levels;return{id:ci,label:e.length>0?Q(`vizy`,`Heading levels: {levels}`,{levels:e.map(e=>`H${e}`).join(`, `)}):Q(`vizy`,`Heading levels: none allowed`),kind:`node`,group:`Headings`,icon:null}}#ne(e){return e===`headingLevels`?this.#te():this.#y(e,this.#t)??null}#re(e){if(this.#s?.list!==e)return``;let t=e===`toolbar`?this.#e.toolbar[this.#s.index]:this.#e.bubble.items[this.#s.index];if(t===void 0)return``;let n=e===`toolbar`?this.#b(t):this.#y(t,this.#r);if(!n)return``;let r=e===`toolbar`&&Z(t)?si(t):null;return`
        ...
        `}#ie(e){let t=this.#z(e),n=this.#B(e),r=this.#e.dropdowns[e]!==void 0,i=(e,t)=>{let n=this.#ne(e);return n?this.#$(n,`toolbar`,`member`,{excluded:t,unavailable:e!==`headingLevels`&&!this.#x(n)}):``},a=n.map(e=>i(e,!1)).join(``),o=li(t,n).filter(e=>!n.includes(e)).map(e=>i(e,!0)).join(``);return`
            <div class="vizy-editor-config-roster">
                <span class="vizy-editor-config-roster-label">${Q(`vizy`,`In this dropdown`)}</span>
                <div class="vizy-editor-config-active is-members" data-builder-list="toolbar-members">
                    ${this.#se(a,Q(`vizy`,`Nothing left.`))}
                </div>
                ${o?`
                    <span class="vizy-editor-config-roster-label">${Q(`vizy`,`Left out`)}</span>
                    <div class="vizy-editor-config-available is-members">
                        ${o}
                    </div>
                `:``}
                <p class="instructions">${Q(`vizy`,`Click an item to take it out of this dropdown or put it back, and drag to reorder. A dropdown holds a fixed set registered by Vizy or a plugin, so items cannot be added to it — place them in the toolbar instead.`)}</p>
                ${r?`
        ...
        `}#oe(){return`<span class="vizy-editor-config-tail" data-builder-tail></span>`}#se(e,t,n=!0){let r=e||this.#ae(t);return n?r+this.#oe():r}#ce(){let t=document.createElement(`pk-tooltip`);t.setAttribute(`trigger`,`manual`),t.setAttribute(`placement`,`top`),this.appendChild(t),this.#p=t;let n=e=>e instanceof Element?e.closest(`.vizy-control`):null,r=e=>e instanceof Node&&t.contains(e),i=()=>{this.#h!==null&&(window.clearTimeout(this.#h),this.#h=null)},a=a=>{if(r(a.target))return;let o=n(a.target),s=o?.getAttribute(`aria-label`);if(i(),!o||!s||o.closest(`.is-sorting`)||o.hasAttribute(`data-dnd-placeholder`)){t.hide();return}this.#h=window.setTimeout(()=>{this.#h=null,!(!o.isConnected||o.closest(`.is-sorting`))&&(o.id||=`vizy-control-${++this.#m}`,t.for=o.id,t.content=s,t.show())},e.#g)},o=e=>{r(e.target)||(i(),t.hide())};this.addEventListener(`pointerover`,a),this.addEventListener(`focusin`,a),this.addEventListener(`pointerout`,o),this.addEventListener(`focusout`,o),this.addEventListener(`pointerdown`,o)}#le(e){let t=e=>{let t=[...e.parentElement?.children??[]].indexOf(e);return t===-1?void 0:t};e.querySelectorAll(`[data-toolbar-item]`).forEach(e=>{let n=e.dataset.toolbarItem,r=e.dataset.toolbarList,i=e.dataset.toolbarVariant;if(!n||!r)return;let a=()=>{if(i===`available`){r===`toolbar`?this.#I(n):this.#q(n);return}if(i===`member`){let e=this.#R();e!==null&&this.#H(e,n);return}this.#G(r,t(e)??-1)};e.onclick=a,e.onkeydown=o=>{if(o.key===`Delete`||o.key===`Backspace`){if(i!==`active`)return;o.preventDefault(),r===`toolbar`?this.#K(n,t(e)):this.#J(n);return}(o.key===`Enter`||o.key===` `)&&(o.preventDefault(),a())}})}#ue(e){[`toolbar`,`bubble`].forEach(t=>{let n=()=>e.querySelector(`[data-builder="${t}"]`);if(!n()){this.#f.get(t)?.destroy(),this.#f.delete(t);return}let r=this.#f.get(t);r||(r=new ai({container:n,type:`vizy-${t}-control`,availableList:()=>e.querySelector(`[data-builder-list="${t}-available"]`),dropdownList:()=>e.querySelector(`[data-builder-list="${t}-dropdowns"]`),activeList:()=>e.querySelector(`[data-builder-list="${t}-active"]`),memberList:()=>e.querySelector(`[data-builder-list="${t}-members"]`),onDrop:e=>this.#X(t,e),onRevert:()=>this.render()}),this.#f.set(t,r)),r.refresh()})}render(){let e=this.querySelector(`[data-vizy-config-host]`);if(!e)return;let t=this.#e.toolbar.map((e,t)=>{let n=this.#b(e);return n?this.#$(n,`toolbar`,`active`,{unavailable:!this.#S(e),selected:this.#s?.list===`toolbar`&&this.#s.index===t}):``}).join(``),n=this.#e.bubble.items.map((e,t)=>{let n=this.#y(e,this.#r);return n?this.#$(n,`bubble`,`active`,{selected:this.#s?.list===`bubble`&&this.#s.index===t}):``}).join(``);e.innerHTML=`
                ...
                ${this.#a===`visual`?`
                    <div class="vizy-editor-config-panel">
                        ...
                        <section class="vizy-editor-config-section">
                            ...
                            <p class="instructions">${Q(`vizy`,`Click or drag items into the toolbar below, and drag them out to remove them. Click an item already in the toolbar to select it; a dropdown also shows what is in it.`)}</p>
                            <div class="vizy-editor-config-builder" data-builder="toolbar">
                                <div class="vizy-editor-config-group">
                                    ...
                                    <div class="vizy-editor-config-available" data-builder-list="toolbar-available">
                                        ${this.#se(this.#w().map(e=>this.#$(e,`toolbar`,`available`)).join(``),Q(`vizy`,`Everything is in the toolbar.`),!1)}
                                    </div>
                                </div>
                                <!--
                                    ...
                                    Headings next to H1 through H6 with nothing to say that
                                    picking either one spent the same buttons.
                                ...
                                <div class="vizy-editor-config-group">
                                    ...
                                    <div class="vizy-editor-config-available" data-builder-list="toolbar-dropdowns">
                                        ${this.#se(this.#C().map(e=>this.#$(e,`toolbar`,`available`)).join(``),Q(`vizy`,`Every dropdown is in the toolbar.`),!1)}
                                    </div>
                                </div>
                                <div class="vizy-editor-config-group is-preview">
                                    ...
                                    <div class="vizy-editor-config-editor">
                                        <div class="vizy-editor-config-active" data-builder-list="toolbar-active">
                                            ${this.#se(t,Q(`vizy`,`Drag items here.`))}
                                        </div>
                                        <!--
                                ...
                                <div class="vizy-editor-config-builder" data-builder="bubble">
                                    <div class="vizy-editor-config-group">
                                        ...
                                        <div class="vizy-editor-config-available" data-builder-list="bubble-available">
                                            ${this.#se(this.#T().map(e=>this.#$(e,`bubble`,`available`)).join(``),Q(`vizy`,`Everything is in the Bubble Menu.`),!1)}
                                        </div>
                                    </div>
                                    <div class="vizy-editor-config-group">
                                        ...
                                        <div class="vizy-editor-config-active is-bubble" data-builder-list="bubble-active">
                                            ${this.#se(n,Q(`vizy`,`Drag items here.`))}
                                        </div>
                                    </div>
                                    ${this.#re(`bubble`)}
                                </div>
        ...
        `,e.querySelectorAll(`[data-mode]`).forEach(e=>{e.onclick=()=>this.#E(e.dataset.mode)});let r=e.querySelector(`[data-dropdown-reset]`),i=this.#R();r&&i!==null&&(r.onclick=()=>this.#W(i));let a=e.querySelector(`[data-selection-remove]`);if(a&&this.#s){let{list:e,index:t}=this.#s;a.onclick=()=>{if(e===`toolbar`){let e=this.#e.toolbar[t];e!==void 0&&this.#K(e,t);return}let n=this.#e.bubble.items[t];n!==void 0&&(this.#s=null,this.#J(n))}}let o=e.querySelector(`[data-schema-details]`);o&&o.addEventListener(`toggle`,()=>{this.#o=o.open}),e.querySelectorAll(`[data-capability-group]`).forEach(e=>{e.addEventListener(`pk-change`,t=>{let{value:n}=t.detail,r=n===`*`?e.options.map(e=>e.value):n,i=e.dataset.capabilityGroup;i===`headings`?this.#N(r.map(Number)):this.#k(i,r,e.options.map(e=>e.value))})});let s=e.querySelector(`[data-bubble-enabled]`);s&&s.addEventListener(`pk-change`,()=>{this.#e.bubble.enabled=s.checked,this.render()});let c=e.querySelector(`[data-advanced-json]`);c&&(c.value=this.#l,c.addEventListener(`pk-change`,e=>{this.#l=e.detail.value,this.#v()&&this.#Z()})),this.#le(e),this.#ue(e),this.#Z()}};customElements.get(`vizy-editor-config-settings`)||customElements.define(`vizy-editor-config-settings`,vi);
//# sourceMappingURL=editor-config-settings-BhTva30y.js.map