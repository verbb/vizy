...
`,X=class extends a{constructor(...e){super(...e),this.hasSlotController=new u(this,`label`,`instructions`,`hint`,`header-end`,`warning`,`tip`,`errors`),this.baseId=l(`pk-field`),this.label=``,this.instructions=``,this.required=!1,this.translatable=!1,this.warning=``,this.tip=``,this.errors=[],this.for=``,this.onLabelClick=e=>{let t=e.target;t instanceof Element&&(t.closest(`button, a, input, select, textarea, [role="button"], [role="link"]`)||this.focusControl())},this.onControlSlotChange=()=>{this.syncControlAria(),this.requestUpdate()}}static{this.styles=[_,$r,ri]}connectedCallback(){super.connectedCallback();let e=this.getAttribute(`hint`);e&&!this.instructions&&(this.instructions=e)}updated(e){super.updated(e),(e.has(`label`)||e.has(`instructions`)||e.has(`errors`)||e.has(`warning`)||e.has(`tip`)||e.has(`required`)||e.has(`for`))&&this.syncControlAria()}get labelId(){return`${this.baseId}-label`}get instructionsId(){return`${this.baseId}-instructions`}get errorsId(){return`${this.baseId}-errors`}get warningId(){return`${this.baseId}-warning`}get tipId(){return`${this.baseId}-tip`}get controlId(){return this.for||`${this.baseId}-control`}hasLabel(){return!!this.label||this.hasSlotController.test(`label`)}hasInstructions(){return!!this.instructions||this.hasSlotController.test(`instructions`)||this.hasSlotController.test(`hint`)}hasHeaderEnd(){return this.hasSlotController.test(`header-end`)}hasErrors(){return this.errors.length>0||this.hasSlotController.test(`errors`)}hasWarning(){return!!this.warning||this.hasSlotController.test(`warning`)}hasTip(){return!!this.tip||this.hasSlotController.test(`tip`)}getControlElement(){let[e]=this.controlSlot?.assignedElements({flatten:!0})??[];return e instanceof HTMLElement?e:this.for?this.getRootNode().getElementById(this.for):null}focusControl(){let e=this.getControlElement();!e||typeof e.focus!=`function`||e.focus()}syncControlAria(){let e=this.getControlElement();e&&ei({control:e,labelId:this.labelId,instructionsId:this.instructionsId,errorsId:this.errorsId,warningId:this.warningId,tipId:this.tipId,controlId:this.controlId,hasLabel:this.hasLabel(),hasInstructions:this.hasInstructions(),hasErrors:this.hasErrors(),hasWarning:this.hasWarning(),hasTip:this.hasTip(),hasRequired:this.required,invalid:this.hasErrors()})}render(){let e=this.hasLabel(),t=this.hasInstructions(),n=this.hasHeaderEnd(),r=this.hasErrors(),a=this.hasWarning(),o=this.hasTip(),s=this.for||(e?this.controlId:b);return v`
        ...
        `}};t([y()],X.prototype,`label`,void 0),t([y()],X.prototype,`instructions`,void 0),t([y({type:Boolean,reflect:!0})],X.prototype,`required`,void 0),t([y({type:Boolean,reflect:!0})],X.prototype,`translatable`,void 0),t([y()],X.prototype,`warning`,void 0),t([y()],X.prototype,`tip`,void 0),t([y({attribute:!1})],X.prototype,`errors`,void 0),t([y({reflect:!0})],X.prototype,`for`,void 0),t([h(`slot:not([name])`)],X.prototype,`controlSlot`,void 0),X=t([x(`pk-field`)],X);function Z(e){return e===`available`||e===`dropdowns`}var ii=class t{#e;#t=[];#n=[];#r;#i={x:0,y:0};#a=null;#o=null;#s=null;#c=null;#l=0;#u=`active`;#d=!1;#f={x:0,y:0};static#p=10;static#m=5;constructor(i){this.#r=i,this.#e=new r({plugins:t=>[...t,e.configure({dropAnimation:null})],sensors:[n.configure({activationConstraints:[new s.Distance({value:t.#m})]})]}),this.#I()}refresh(){this.#V(),this.#v(this.#r.availableList(),`available`),this.#v(this.#h(),`dropdowns`),this.#v(this.#r.activeList(),`active`)}#h(){return this.#r.dropdownList?.()??null}#g(){return[this.#r.availableList(),this.#h()].filter(e=>!!e)}#_(){let e=this.#r.activeList();return e?[{name:`active`,element:e}]:[]}destroy(){this.#n.forEach(e=>e()),this.#n=[],this.#F(),this.#V(),this.#e.destroy()}#v(e,t){e&&this.#y(e).forEach((e,n)=>{let r=e.dataset.toolbarItem;r&&this.#t.push(new o({id:`${this.#r.type}-${t}-${n}-${r}`,element:e,type:this.#r.type,data:{itemId:r,list:t,index:n,repeatable:e.hasAttribute(`data-toolbar-repeatable`)}},this.#e))})}#y(e){return[...e.querySelectorAll(`[data-toolbar-item]`)]}#b=new Map;#x(){this.#b.clear();for(let e of this.#_())this.#b.set(e.name,this.#S(e.element))}#S(e){let t=this.#o,n=e.getBoundingClientRect(),r=[];return{element:e,peers:this.#y(e).map((e,t)=>({peer:e,index:t})).filter(({peer:e})=>e!==t).map(({peer:e,index:t})=>{let i=e.getBoundingClientRect(),a=i.top-n.top,o=i.bottom-n.top,s=r.at(-1);return!s||Math.abs(s.start-a)>1?r.push({start:a,end:o}):s.end=Math.max(s.end,o),{band:r.length-1,middle:i.left+i.width/2-n.left,index:t}}),bands:r}}#C(e,t){let n=0,r=1/0;return e.bands.forEach((e,i)=>{let a=t<e.start?e.start-t:Math.max(0,t-e.end);a<r&&(r=a,n=i)}),n}#w(e){let t=e.element.getBoundingClientRect(),n=this.#i.x-t.left,r=this.#C(e,this.#i.y-t.top),i=0;for(let t of e.peers){if(!(t.band<r||!(t.band>r)&&n>t.middle))break;i+=1}return i}#T(){if(this.#c)return this.#c;let e=this.#o.cloneNode(!0);return e.removeAttribute(`id`),e.removeAttribute(`data-toolbar-item`),e.removeAttribute(`aria-label`),e.removeAttribute(`aria-describedby`),e.setAttribute(`aria-hidden`,`true`),e.classList.remove(`is-lifted`),e.style.marginInlineEnd=``,e.classList.add(`is-slot`),this.#c=e,e}#E(e,t){if(!this.#o)return;let n=t.element,r=this.#w(t);this.#u=e,this.#l=r;let i=this.#y(n).filter(e=>e!==this.#o)[r]??n.querySelector(`[data-builder-tail]`),a=this.#T();(a.parentElement!==n||a.nextElementSibling!==i)&&n.insertBefore(a,i??null)}#D(){this.#c?.isConnected&&this.#c.remove()}#O(){if(!this.#o)return;let e=this.#k();if(!e){this.#D();return}this.#E(e.name,e.zone)}#k(){for(let{name:e,element:t}of this.#_()){let n=t.getBoundingClientRect();if(!(this.#i.x>=n.left&&this.#i.x<=n.right&&this.#i.y>=n.top&&this.#i.y<=n.bottom))continue;let r=this.#b.get(e);return r?{name:e,zone:r}:null}return null}#A(){return!!this.#c?.isConnected}#j(){let e=this.#o;if(!e||this.#M())return;e.classList.add(`is-lifted`);let t=e.parentElement,n=parseFloat((t?getComputedStyle(t).columnGap:``)||``)||0;e.style.marginInlineEnd=`-${e.getBoundingClientRect().width+n}px`}#M(){return!!this.#s?.repeatable&&Z(this.#s.list)}#N(e){let n=this.#P();if(!n)return;let r=e.cloneNode(!0);r.removeAttribute(`id`),r.removeAttribute(`aria-describedby`),r.removeAttribute(`aria-roledescription`),r.setAttribute(`aria-hidden`,`true`),r.classList.add(`is-drag-helper`);let i=e.getBoundingClientRect(),a=this.#f.x-i.left+t.#p,o=this.#f.y-i.top+t.#p;r.style.setProperty(`transform`,`translate(${a}px, ${o}px)`,`important`),document.body.appendChild(r),this.#a=r,n.overlay=r}#P(){return this.#e.plugins.find(t=>t instanceof e)}#F(){let e=this.#P();e&&(e.overlay=void 0),this.#a?.remove(),this.#a=null}#I(){let e=e=>{this.#i={x:e.clientX,y:e.clientY},this.#O()},t=e=>{this.#f={x:e.clientX,y:e.clientY},this.#i={x:e.clientX,y:e.clientY}},n=e=>{let t=e.target instanceof Element&&e.target.closest(`[data-toolbar-item]`)!==null;this.#d&&t&&(e.preventDefault(),e.stopPropagation()),this.#d=!1};document.addEventListener(`pointerdown`,t,!0),document.addEventListener(`pointermove`,e,!0),document.addEventListener(`click`,n,!0),this.#n.push(()=>{document.removeEventListener(`pointerdown`,t,!0),document.removeEventListener(`pointermove`,e,!0),document.removeEventListener(`click`,n,!0)}),this.#n.push(this.#e.monitor.addEventListener(`beforedragstart`,e=>{let{source:t}=e.operation;t?.element instanceof HTMLElement&&this.#N(t.element)}),this.#e.monitor.addEventListener(`dragstart`,e=>{this.#r.container()?.classList.add(`is-sorting`);let{source:t}=e.operation;t?.element instanceof HTMLElement&&(this.#o=t.element,this.#s=t.data,this.#z(),this.#x(),this.#j(),this.#O())}),this.#e.monitor.addEventListener(`dragend`,e=>{let t=this.#s,n=this.#A(),r=this.#l,i=this.#u;if(this.#L(),this.#d=!0,!t?.itemId||e.canceled){this.#R(this.#r.onRevert);return}if(!n){if(Z(t.list)){this.#R(this.#r.onRevert);return}this.#R(()=>this.#r.onDrop({itemId:t.itemId,from:t.list,to:`available`,fromIndex:t.index,index:t.index}));return}if(t.list===i&&r===t.index){this.#R(this.#r.onRevert);return}this.#R(()=>this.#r.onDrop({itemId:t.itemId,from:t.list,to:i,fromIndex:t.index,index:r}))}))}#L(){let e=this.#r.container();e?.classList.remove(`is-sorting`),e?.querySelectorAll(`.is-lifted`).forEach(e=>{e.classList.remove(`is-lifted`),e.style.marginInlineEnd=``}),this.#D(),this.#c=null,this.#o=null,this.#s=null,this.#u=`active`,this.#b.clear(),this.#B(),this.#F()}#R(e){requestAnimationFrame(()=>e())}#z(){this.#g().forEach(e=>{e.style.minHeight=`${e.getBoundingClientRect().height}px`})}#B(){this.#g().forEach(e=>{e.style.minHeight=``})}#V(){this.#t.forEach(e=>{e.unregister(),e.destroy()}),this.#t=[]}},ai=`dropdown:`;function oi(e){return e.startsWith(ai)}function si(e,t,n){return n!==void 0&&n>=0&&n<e.length&&e[n]===t?n:e.indexOf(t)}function ci(e){return new Set(e)}var li=`modulepreload`,ui=function(e,t){return new URL(e,t).href},di={},fi=function(e,t,n){let r=Promise.resolve();if(t&&t.length>0){let e=document.getElementsByTagName(`link`),i=document.querySelector(`meta[property=csp-nonce]`),a=i?.nonce||i?.getAttribute(`nonce`);function o(e){return Promise.all(e.map(e=>Promise.resolve(e).then(e=>({status:`fulfilled`,value:e}),e=>({status:`rejected`,reason:e}))))}function s(e){return import.meta.resolve?import.meta.resolve(e):new URL(e,import.meta.url).href}r=o(t.map(t=>{if(t=ui(t,n),t=s(t),t in di)return;di[t]=!0;let r=t.endsWith(`.css`);for(let n=e.length-1;n>=0;n--){let i=e[n];if(i.href===t&&(!r||i.rel===`stylesheet`))return}let i=document.createElement(`link`);if(i.rel=r?`stylesheet`:li,r||(i.as=`script`),i.crossOrigin=``,i.href=t,a&&i.setAttribute(`nonce`,a),document.head.appendChild(i),r)return new Promise((e,n)=>{i.addEventListener(`load`,e),i.addEventListener(`error`,()=>n(Error(`Unable to preload CSS for ${t}`)))})}))}function i(e){let t=new Event(`vite:preloadError`,{cancelable:!0});if(t.payload=e,window.dispatchEvent(t),!t.defaultPrevented)throw e}return r.then(t=>{for(let e of t||[])e.status===`rejected`&&i(e.reason);return e().catch(i)})},pi=[1,2,3,4,5,6],mi=[2,3,4];function Q(e,t,n={}){return window.Craft?.t(e,t,n)??t.replace(/\{(\w+)\}/g,(e,t)=>n[t]??e)}function $(e){return e.replace(/[&<>"']/g,e=>({"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`})[e])}var hi=class e extends HTMLElement{#e={capabilities:{nodes:[],marks:[]},headings:{levels:[...mi]},toolbar:[],bubble:{enabled:!0,items:[]}};#t=[];#n=[];#r=[];#i={nodes:[],marks:[],headingAvailable:!1};#a=`visual`;#o=!1;#s=!1;#c=``;#l=``;#u=null;#d=new Map;#f;#p=0;#m=null;static#h=200;connectedCallback(){this.#u=this.querySelector(`[data-vizy-config-sync]`),this.#J();let e=this.getAttribute(`data-initial`);if(e){let t=JSON.parse(e);this.#e=t.config,this.#A(),this.#t=t.toolbarCatalog,this.#n=t.dropdownCatalog??[],this.#r=t.bubbleCatalog,this.#i=t.capabilityCatalog}this.#c=this.#g();let t=this.closest(`form`);t&&!t.dataset.vizyConfigBound&&(t.dataset.vizyConfigBound=`1`,t.addEventListener(`submit`,e=>{if(this.#a===`advanced`&&!this.#_()){e.preventDefault(),this.render();return}this.#V()})),this.render()}disconnectedCallback(){this.#d.forEach(e=>e.destroy()),this.#d.clear()}#g(){return JSON.stringify({capabilities:this.#e.capabilities,headings:this.#e.headings,toolbar:this.#e.toolbar,bubble:this.#e.bubble},null,2)}#_(){try{let e=JSON.parse(this.#c);return this.#e={capabilities:{nodes:[...e.capabilities?.nodes??[]],marks:[...e.capabilities?.marks??[]]},headings:{levels:[...e.headings?.levels??mi]},toolbar:[...e.toolbar??[]],bubble:{enabled:e.bubble?.enabled??!0,items:[...e.bubble?.items??[]]}},this.#A(),this.#l=``,!0}catch{return this.#l=Q(`vizy`,`Invalid JSON`),!1}}#v(e,t){return t.find(t=>t.id===e)}#y(e){if(!oi(e))return this.#v(e,this.#t);let t=this.#v(e,this.#n);return t?{...t,kind:`group`}:void 0}#b(e){return e.pending||e.kind===`presentation`||e.kind===`dropdown`?!0:e.kind===`action`?e.capabilityName===void 0||this.#e.capabilities.nodes.includes(e.capabilityName):e.kind===`mark`?this.#e.capabilities.marks.includes(e.id):e.kind===`node`?e.id===`paragraph`||e.id===`hardBreak`||this.#e.capabilities.nodes.includes(e.capabilityName??e.id):!1}#x(e){if(oi(e))return!0;let t=this.#v(e,this.#t);return!t||t.kind===`presentation`||this.#b(t)}#S(){let e=ci(this.#e.toolbar);return this.#n.filter(t=>!e.has(t.id))}#C(){let e=ci(this.#e.toolbar);return this.#t.filter(t=>e.has(t.id)&&!this.#N(t.id)?!1:this.#b(t)).sort((e,t)=>Number(this.#N(e.id))-Number(this.#N(t.id)))}#w(){let e=new Set(this.#e.bubble.items);return this.#r.filter(t=>!e.has(t.id)&&this.#e.capabilities.marks.includes(t.id))}#T(e){if(e===`visual`&&this.#a===`advanced`&&!this.#_()){this.render();return}e===`advanced`&&(this.#c=this.#g(),this.#l=``,this.#E()),this.#a=e,this.render()}async#E(){this.#s||(await fi(()=>import(`./code-editor-1FfeIq4W.js`),__vite__mapDeps([0,1,2,3,4]),import.meta.url),this.#s=!0,this.#a===`advanced`&&this.render())}#D(e,t,n){let r=new Set(this.#e.capabilities[e]);n?r.add(t):r.delete(t),this.#e.capabilities[e]=[...r],this.render()}#O(e,t,n){let r=this.#e.capabilities[e].filter(e=>!n.includes(e));this.#e.capabilities[e]=[...new Set([...r,...t])],this.render()}#k(e,t,n){let r=t.length>0&&t.every(e=>n.includes(e.value))?`*`:JSON.stringify(n);return`
            <pk-checkbox-select
                ...
                value="${$(r)}"
            ></pk-checkbox-select>
        `}#A(){this.#e.capabilities.nodes.includes(`heading`)||(this.#e.headings.levels=[])}#j(){return this.#e.headings.levels.length>0}#M(e){this.#e.headings.levels=[...e].sort((e,t)=>e-t),this.#D(`nodes`,`heading`,this.#j())}#N(e){return e===`separator`}#P(e,t){return si(this.#e.toolbar,e,t)}#F(e,t){!this.#N(e)&&this.#P(e)!==-1||(t===void 0?this.#e.toolbar.push(e):this.#e.toolbar.splice(t,0,e),this.render())}#I(e,t){let n=this.#P(e,t);n!==-1&&(this.#e.toolbar.splice(n,1),this.render())}#L(e,t){this.#e.bubble.items.includes(e)||(t===void 0?this.#e.bubble.items.push(e):this.#e.bubble.items.splice(t,0,e),this.render())}#R(e){this.#e.bubble.items=this.#e.bubble.items.filter(t=>t!==e),this.render()}#z(e,t,n){let r=e===`toolbar`?this.#e.toolbar:this.#e.bubble.items;if(t<0||n<0||t>=r.length||n>=r.length)return;let[i]=r.splice(t,1);r.splice(n,0,i),this.render()}#B(e,t){if(e===`bubble`){Z(t.to)?this.#R(t.itemId):Z(t.from)?this.#L(t.itemId,t.index):this.#z(`bubble`,t.fromIndex,t.index);return}if(Z(t.to)){if(t.from!==`active`)return;this.#I(t.itemId,t.fromIndex);return}if(Z(t.from)){this.#F(t.itemId,t.index);return}this.#z(`toolbar`,t.fromIndex,t.index)}#V(){if(!this.#u)return;this.#u.replaceChildren();let e=(e,t)=>{let n=document.createElement(`input`);n.type=`hidden`,n.name=e,n.value=t,this.#u?.append(n)};this.#e.capabilities.nodes.forEach(t=>e(`capabilityNodes[]`,t)),this.#e.capabilities.marks.forEach(t=>e(`capabilityMarks[]`,t)),this.#e.headings.levels.forEach(t=>e(`headingLevels[]`,String(t))),e(`toolbarJson`,JSON.stringify(this.#e.toolbar)),e(`bubbleJson`,JSON.stringify(this.#e.bubble)),e(`advancedConfig`,this.#g())}#H(e){return e.icon?e.icon:e.abbr?`<span class="vizy-control-abbr">${$(e.abbr)}</span>`:`<span class="vizy-control-text">${$(e.label)}</span>`}#U(e,t,n,r={}){let i=e.kind===`group`||e.kind===`dropdown`;return`
            <button
                type="button"
                class="${[`vizy-control`,e.id===`separator`?`is-separator`:``,e.icon||e.abbr||e.id===`separator`?``:`is-text`,i?`has-menu`:``,n===`available`?`is-available`:``,r.unavailable?`is-unavailable`:``,e.pending?`is-pending`:``].filter(Boolean).join(` `)}"
                ...
                ${this.#N(e.id)?`data-toolbar-repeatable`:``}
            >${e.id===`separator`?``:this.#H(e)}${i?`<span class="vizy-control-chevron" aria-hidden="true"></span>`:``}</button>
        `}#W(){let e=[...this.#i.nodes,...this.#i.marks],t=e.filter(e=>this.#e.capabilities.nodes.includes(e.value)||this.#e.capabilities.marks.includes(e.value));return`
            <details class="vizy-editor-config-section vizy-editor-config-schema" data-schema-details ${this.#o?`open`:``}>
                ...
                ${this.#k(`nodes`,this.#i.nodes,this.#e.capabilities.nodes)}

                <div class="vizy-editor-config-subhead">${Q(`vizy`,`Inline formatting`)}</div>
                ${this.#k(`marks`,this.#i.marks,this.#e.capabilities.marks)}
            </details>
        `}#G(e){return`
            <span class="vizy-editor-config-empty" data-empty-placeholder>
                ${$(e)}
            </span>
        `}#K(){return`<span class="vizy-editor-config-tail" data-builder-tail></span>`}#q(e,t,n=!0){let r=e||this.#G(t);return n?r+this.#K():r}#J(){let t=document.createElement(`pk-tooltip`);t.setAttribute(`trigger`,`manual`),t.setAttribute(`placement`,`top`),this.appendChild(t),this.#f=t;let n=e=>e instanceof Element?e.closest(`.vizy-control`):null,r=e=>e instanceof Node&&t.contains(e),i=()=>{this.#m!==null&&(window.clearTimeout(this.#m),this.#m=null)},a=a=>{if(r(a.target))return;let o=n(a.target),s=o?.getAttribute(`aria-label`);if(i(),!o||!s||o.closest(`.is-sorting`)||o.hasAttribute(`data-dnd-placeholder`)){t.hide();return}this.#m=window.setTimeout(()=>{this.#m=null,!(!o.isConnected||o.closest(`.is-sorting`))&&(o.id||=`vizy-control-${++this.#p}`,t.for=o.id,t.content=s,t.show())},e.#h)},o=e=>{r(e.target)||(i(),t.hide())};this.addEventListener(`pointerover`,a),this.addEventListener(`focusin`,a),this.addEventListener(`pointerout`,o),this.addEventListener(`focusout`,o),this.addEventListener(`pointerdown`,o)}#Y(e){let t=e=>{let t=[...e.parentElement?.children??[]].indexOf(e);return t===-1?void 0:t};e.querySelectorAll(`[data-toolbar-item]`).forEach(e=>{let n=e.dataset.toolbarItem,r=e.dataset.toolbarList,i=e.dataset.toolbarVariant;if(!n||!r)return;let a=()=>{if(i===`available`){r===`toolbar`?this.#F(n):this.#L(n);return}r===`toolbar`?this.#I(n,t(e)):this.#R(n)};e.onclick=a,e.onkeydown=e=>{(e.key===`Enter`||e.key===` `)&&(e.preventDefault(),a())}})}#X(e){[`toolbar`,`bubble`].forEach(t=>{let n=()=>e.querySelector(`[data-builder="${t}"]`);if(!n()){this.#d.get(t)?.destroy(),this.#d.delete(t);return}let r=this.#d.get(t);r||(r=new ii({container:n,type:`vizy-${t}-control`,availableList:()=>e.querySelector(`[data-builder-list="${t}-available"]`),dropdownList:()=>e.querySelector(`[data-builder-list="${t}-dropdowns"]`),activeList:()=>e.querySelector(`[data-builder-list="${t}-active"]`),onDrop:e=>this.#B(t,e),onRevert:()=>this.render()}),this.#d.set(t,r)),r.refresh()})}render(){let e=this.querySelector(`[data-vizy-config-host]`);if(!e)return;let t=this.#e.toolbar.map(e=>{let t=this.#y(e);return t?this.#U(t,`toolbar`,`active`,{unavailable:!this.#x(e)}):``}).join(``),n=this.#e.bubble.items.map(e=>{let t=this.#v(e,this.#r);return t?this.#U(t,`bubble`,`active`):``}).join(``);e.innerHTML=`
                ...
                ${this.#a===`visual`?`
                    <div class="vizy-editor-config-panel">
                        ...
                        <section class="vizy-editor-config-section">
                            ...
                            <p class="instructions">${Q(`vizy`,`Click or drag items into the toolbar below, and out of it to remove them. What is in a dropdown is fixed — untick the content type under Content schema to leave it out.`)}</p>
                            <div class="vizy-editor-config-builder" data-builder="toolbar">
                                <div class="vizy-editor-config-group">
                                    ...
                                    <div class="vizy-editor-config-available" data-builder-list="toolbar-available">
                                        ${this.#q(this.#C().map(e=>this.#U(e,`toolbar`,`available`)).join(``),Q(`vizy`,`Everything is in the toolbar.`),!1)}
                                    </div>
                                </div>
                                <!--
                                    ...
                                    picking either one spent the same buttons. The heading
                                    buttons are gone, and a level is placed by way of this list.

                                    The set is registered rather than authored, and what is in
                                    each one is fixed: a plugin adds to it through
                                ...
                                <div class="vizy-editor-config-group">
                                    ...
                                    <div class="vizy-editor-config-available" data-builder-list="toolbar-dropdowns">
                                        ${this.#q(this.#S().map(e=>this.#U(e,`toolbar`,`available`)).join(``),Q(`vizy`,`Every dropdown is in the toolbar.`),!1)}
                                    </div>
                                </div>
                        ...
                        <!--
                            Directly after the toolbar, because this is what the Headings
                            dropdown holds: the levels are read where the toolbar is built, so
                            the two settings are one decision seen from two angles.
                        -->
                        ${this.#i.headingAvailable?`
                            <section class="vizy-editor-config-section">
                                ...
                                -->
                                ${this.#k(`headings`,pi.map(e=>({label:`H${e}`,value:String(e)})),this.#e.headings.levels.map(String))}
                                <!--
                                    No "Default level" either. That was which level a bare
                                    Heading button applied — one button standing for six — and
                                    it made headings two things at once: that, plus a button per
                                    level. The levels are now named by the buttons themselves.
                                -->
                            </section>
                        `:``}
                                ...
                                <div class="vizy-editor-config-builder" data-builder="bubble">
                                    <div class="vizy-editor-config-group">
                                        ...
                                        <div class="vizy-editor-config-available" data-builder-list="bubble-available">
                                            ${this.#q(this.#w().map(e=>this.#U(e,`bubble`,`available`)).join(``),Q(`vizy`,`Everything is in the Bubble Menu.`),!1)}
                                        </div>
                                    </div>
                                    <div class="vizy-editor-config-group">
        ...
        `,e.querySelectorAll(`[data-mode]`).forEach(e=>{e.onclick=()=>this.#T(e.dataset.mode)});let r=e.querySelector(`[data-schema-details]`);r&&r.addEventListener(`toggle`,()=>{this.#o=r.open}),e.querySelectorAll(`[data-capability-group]`).forEach(e=>{e.addEventListener(`pk-change`,t=>{let{value:n}=t.detail,r=n===`*`?e.options.map(e=>e.value):n,i=e.dataset.capabilityGroup;i===`headings`?this.#M(r.map(Number)):this.#O(i,r,e.options.map(e=>e.value))})});let i=e.querySelector(`[data-bubble-enabled]`);i&&i.addEventListener(`pk-change`,()=>{this.#e.bubble.enabled=i.checked,this.render()});let a=e.querySelector(`[data-advanced-json]`);a&&(a.value=this.#c,a.addEventListener(`pk-change`,e=>{this.#c=e.detail.value,this.#_()&&this.#V()})),this.#Y(e),this.#X(e),this.#V()}};customElements.get(`vizy-editor-config-settings`)||customElements.define(`vizy-editor-config-settings`,hi);
//# sourceMappingURL=editor-config-settings-B-NFzo1Q.js.map