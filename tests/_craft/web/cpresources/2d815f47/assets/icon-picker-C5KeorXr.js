            ...
            <div class="vizy-icon-picker">
                ...
                ${this.#r?`
                    <div class="vizy-icon-picker-panel">
                        ...
                        <div class="vizy-icon-picker-results">${this.#T()}</div>
                    </div>
                `:``}
            </div>
        `,this.querySelector(`[data-icon-trigger]`)?.addEventListener(`click`,()=>{this.#_()}),this.querySelector(`[data-icon-clear]`)?.addEventListener(`click`,()=>{this.#v(``)}),this.#m();let e=this.#E().querySelector(`[data-icon-search]`);e&&e.addEventListener(`input`,()=>{this.#t=e.value,this.#n=b,this.#C()});let t=this.#E().querySelector(`.vizy-icon-picker-results`);t?.addEventListener(`scroll`,()=>this.#S(t)),this.#D()}#E(){return this.#f??this}#D(){this.#E().querySelectorAll(`[data-icon-value]`).forEach(e=>{e.addEventListener(`click`,()=>{this.#v(e.dataset.iconValue??``)})})}};customElements.get(`vizy-icon-picker`)||customElements.define(`vizy-icon-picker`,T);var E=class extends HTMLElement{#e=!1;connectedCallback(){if(this.#e)return;this.#e=!0;let e=this.getAttribute(`name`)??`color`,t=this.getAttribute(`value`)??``,n=this.id||`color`,r=this.getAttribute(`aria-label`)??`Color`;this.removeAttribute(`name`);let i=document.createElement(`input`);i.type=`hidden`,i.name=e,i.value=t,i.id=`${n}-value`;let a=document.createElement(`pk-color-input`);a.setAttribute(`value`,t),a.id=n,a.setAttribute(`aria-label`,r);let o=()=>{i.value=a.value??``};a.addEventListener(`pk-change`,o),a.addEventListener(`change`,o),a.addEventListener(`input`,o),this.append(i,a)}};customElements.get(`vizy-color-input`)||customElements.define(`vizy-color-input`,E);
//# sourceMappingURL=icon-picker-C5KeorXr.js.map