...
`,K=class extends r{static{this.styles=le}connectedCallback(){super.connectedCallback(),this.setAttribute(`role`,`presentation`)}render(){return e`
    ...
    `}connectedCallback(){super.connectedCallback(),this.setAttribute(`role`,`separator`)}render(){return e`<hr part="base" />`}};q=p([c(`pk-dropdown-separator`)],q);var J=class extends r{constructor(...e){super(...e),this.icon=``,this.name=``,this.unsubscribeRegistry=null}static{this.styles=n`
        :host {
            display: inline-flex;
            align-items: center;
            justify-content: center;
    ...
    `}connectedCallback(){super.connectedCallback(),this.unsubscribeRegistry=re(()=>{this.requestUpdate()})}disconnectedCallback(){this.unsubscribeRegistry?.(),this.unsubscribeRegistry=null,super.disconnectedCallback()}render(){let t=ie(this.icon||this.name);return t?e`${O(b(t,{title:this.label}))}`:m}};p([i()],J.prototype,`icon`,void 0),p([i()],J.prototype,`name`,void 0),p([i()],J.prototype,`label`,void 0),J=p([c(`pk-icon`)],J);var Y=`vizy-block-fallback`,X={width:512,height:512,path:`M224.3-2.5c19.8-11.4 44.2-11.4 64 0L464.2 99c19.8 11.4 32 32.6 32 55.4l0 203c0 22.9-12.2 44-32 55.4L288.3 514.5c-19.8 11.4-44.2 11.4-64 0L48.5 413c-19.8-11.4-32-32.6-32-55.4l0-203c0-22.9 12.2-44 32-55.4L224.3-2.5zm207.8 360l0-166.1-143.8 83 0 166.1 143.8-83z`},ue=!1;function de(){ue||=(ne({[Y]:X}),!0)}function fe(e=`default`){return e===`xxs`||e===`xs`?`xxs`:e===`lg`||e===`xl`?`sm`:`xs`}function pe(e=`default`,t){return t||(e===`primary`||e===`secondary`||e===`dashed`||e===`outline`||e===`transparent`?e:`default`)}var me=[h,n`
        @layer pk-component {
            :host {
                display: block;
                box-sizing: border-box;
    ...
    `],Z=class extends r{constructor(...e){super(...e),this.variant=`default`,this.size=`sm`,this.centered=!1}static{this.styles=me}render(){return e`
            <div part="base" class="spinner" aria-hidden="true"></div>
        `}};p([i({reflect:!0})],Z.prototype,`variant`,void 0),p([i({reflect:!0})],Z.prototype,`size`,void 0),p([i({reflect:!0})],Z.prototype,`tone`,void 0),p([i({type:Boolean,reflect:!0})],Z.prototype,`centered`,void 0),Z=p([c(`pk-spinner`)],Z);var Q=n`
    @layer pk-component {
...
`,he=[h,Q,F(),ce(`.button`),I(),L(`.button`),n`
    ...
    `],ge=b(_),$=class extends r{constructor(...e){super(...e),this.variant=`default`,this.size=`default`,this.disabled=!1,this.loading=!1,this.withCaret=!1,this.groupTrigger=!1,this.icon=!1,this.title=``,this.type=`button`,this.hasDefaultSlotContent=!1,this.hasStartSlotContent=!1,this.hasEndSlotContent=!1,this.startSlotChanged=e=>{this.iconSlotChanged(e,`start`)},this.endSlotChanged=e=>{this.iconSlotChanged(e,`end`)},this.handleHostClick=e=>{if(this.disabled||this.loading||this.href||this.type!==`submit`&&this.type!==`reset`)return;let t=this.resolveAssociatedForm();if(t){if(e.preventDefault(),e.stopPropagation(),this.type===`reset`){t.reset();return}if(typeof t.requestSubmit==`function`){t.requestSubmit();return}t.dispatchEvent(new Event(`submit`,{bubbles:!0,cancelable:!0}))}}}static{this.shadowRootOptions={mode:`open`,delegatesFocus:!0}}static{this.styles=he}defaultSlotChanged(e){let t=e.target;this.hasDefaultSlotContent=t.assignedNodes({flatten:!0}).some(e=>e.nodeType===Node.TEXT_NODE?e.textContent?.trim():e.nodeType===Node.ELEMENT_NODE)}iconSlotChanged(e,t){let n=e.target.assignedNodes({flatten:!0}).some(e=>e.nodeType===Node.TEXT_NODE?e.textContent?.trim():e.nodeType===Node.ELEMENT_NODE);t===`start`?this.hasStartSlotContent=n:this.hasEndSlotContent=n}buttonClasses(){return f({button:!0,"has-label":this.hasDefaultSlotContent,loading:this.loading,caret:this.withCaret,"group-trigger":this.groupTrigger})}connectedCallback(){super.connectedCallback(),this.setAttribute(`data-slot`,`button`),this.addEventListener(`click`,this.handleHostClick)}disconnectedCallback(){this.removeEventListener(`click`,this.handleHostClick),super.disconnectedCallback()}resolveAssociatedForm(){let e=(this.form||this.getAttribute(`form`)||``).trim();if(e){let t=this.ownerDocument?.getElementById(e);if(t instanceof HTMLFormElement&&t.id!==`main`)return t}let t=this.closest(`form`);return t&&t.id!==`main`?t:null}render(){let t=this.spinnerSize||fe(this.size),n=pe(this.variant,this.spinnerVariant);return e`
        ...
        `}};p([i({reflect:!0})],$.prototype,`variant`,void 0),p([i({reflect:!0})],$.prototype,`size`,void 0),p([i({type:Boolean,reflect:!0})],$.prototype,`disabled`,void 0),p([i({type:Boolean,reflect:!0})],$.prototype,`loading`,void 0),p([i({reflect:!0,attribute:`spinner-size`})],$.prototype,`spinnerSize`,void 0),p([i({reflect:!0,attribute:`spinner-variant`})],$.prototype,`spinnerVariant`,void 0),p([i({reflect:!0,attribute:`spinner-tone`})],$.prototype,`spinnerTone`,void 0),p([i({type:Boolean,reflect:!0,attribute:`with-caret`})],$.prototype,`withCaret`,void 0),p([i({type:Boolean,reflect:!0,attribute:`group-trigger`})],$.prototype,`groupTrigger`,void 0),p([i({type:Boolean,reflect:!0})],$.prototype,`icon`,void 0),p([i()],$.prototype,`href`,void 0),p([i()],$.prototype,`target`,void 0),p([i()],$.prototype,`rel`,void 0),p([i()],$.prototype,`name`,void 0),p([i()],$.prototype,`value`,void 0),p([i()],$.prototype,`title`,void 0),p([i()],$.prototype,`type`,void 0),p([i({reflect:!0})],$.prototype,`form`,void 0),p([u()],$.prototype,`hasDefaultSlotContent`,void 0),p([u()],$.prototype,`hasStartSlotContent`,void 0),p([u()],$.prototype,`hasEndSlotContent`,void 0),$=p([c(`pk-button`)],$);export{z as a,E as c,V as i,Y as n,B as o,de as r,O as s,Q as t};
//# sourceMappingURL=icon-DelmfeyF.js.map