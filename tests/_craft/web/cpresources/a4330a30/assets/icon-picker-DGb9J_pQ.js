        ...
        `).join(``)}render(){this.innerHTML=`
            ...
            <div class="vizy-icon-picker">
                <button
                    ...
                    data-icon-trigger
                >${this.#m()}</button>
                ${this.#i===``?``:`<button type="button" class="delete icon vizy-icon-picker-clear" title="${n(`Clear`)}" aria-label="${n(`Clear`)}" data-icon-clear></button>`}
                ${this.#n?`
...
//# sourceMappingURL=icon-picker-DGb9J_pQ.js.map