                ...
                ${this.#a===`visual`?`
                    <div class="vizy-editor-config-panel">
                        ...
                        <section class="vizy-editor-config-section">
                            ...
                            -->
                            <p class="instructions">${Q(`vizy`,`Click or drag items into the toolbar below. Drag an item out, or select it and press Delete, to remove it. Click a dropdown to open it, then click the items inside to switch them off or back on, and drag to reorder — a dropdown holds a fixed set registered by Vizy or a plugin, so place anything else in the toolbar itself.`)}</p>
                            <div class="vizy-editor-config-builder" data-builder="toolbar">
                                <div class="vizy-editor-config-group">
                                    ...
                                    <div class="vizy-editor-config-available" data-builder-list="toolbar-available">
                                        ${this.#se(this.#T().map(e=>this.#ee(e,`toolbar`,`available`)).join(``),Q(`vizy`,`Everything is in the toolbar.`),!1)}
                                    </div>
                                </div>
                                <!--
...
//# sourceMappingURL=editor-config-settings-ogG5nMKn.js.map