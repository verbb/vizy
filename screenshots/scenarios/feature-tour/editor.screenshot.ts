...
export default defineScreenshotScenario({
    ...
    expectedOutput: { width: 1164, height: 880 },
    async setup(context) {
    ...
    preSteps: [
        {
            ...
            expression: `
                (() => {
                    ...
                    document.querySelector('vizy-editor')?.scrollIntoView({ block: 'start' });
                })();
            `,
        },
    ...
    intent: 'Show the genuine Vizy 4 editor as the single surface where authors write and arrange blocks.',
});
